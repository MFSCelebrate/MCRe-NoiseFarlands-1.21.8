...
public class VarLongs {
    final static private int MAX_BYTES = 10;
    final static private int DATA_BITS_MASK = 127;
    final static private int MORE_BITS_MASK = 128;
    final static private int DATA_BITS_PER_BYTE = 7;
