...
public class StatusPackets {
    final static public PacketType<QueryResponseS2CPacket> STATUS_RESPONSE = StatusPackets.s2c("status_response");
    final static public PacketType<QueryRequestC2SPacket> STATUS_REQUEST = StatusPackets.c2s("status_request");
