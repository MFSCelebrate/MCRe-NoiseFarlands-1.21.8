...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, BlockBreakingProgressS2CPacket> CODEC = Packet.createCodec(BlockBreakingProgressS2CPacket::write, BlockBreakingProgressS2CPacket::new);
    ...
    private void write(PacketByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeByte(this.progress);
    }
