...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, ItemPickupAnimationS2CPacket> CODEC = Packet.createCodec(ItemPickupAnimationS2CPacket::write, ItemPickupAnimationS2CPacket::new);
    final private int entityId;
    final private int collectorEntityId;
    final private int stackAmount;
