...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<RegistryByteBuf, EntityAttributesS2CPacket> CODEC = PacketCodec.tuple(PacketCodecs.VAR_INT, EntityAttributesS2CPacket::getEntityId, Entry.CODEC.collect(PacketCodecs.toList()), EntityAttributesS2CPacket::getEntries, EntityAttributesS2CPacket::new);
    ...
    public record Entry(RegistryEntry<EntityAttribute> attribute, double base, Collection<EntityAttributeModifier> modifiers) {
        final static public PacketCodec<ByteBuf, EntityAttributeModifier> MODIFIER_CODEC = PacketCodec.tuple(Identifier.PACKET_CODEC, EntityAttributeModifier::id, PacketCodecs.DOUBLE, EntityAttributeModifier::value, EntityAttributeModifier.Operation.PACKET_CODEC, EntityAttributeModifier::operation, EntityAttributeModifier::new);
        final static public PacketCodec<RegistryByteBuf, Entry> CODEC = PacketCodec.tuple(EntityAttribute.PACKET_CODEC, Entry::attribute, PacketCodecs.DOUBLE, Entry::base, MODIFIER_CODEC.collect(PacketCodecs.toCollection(ArrayList::new)), Entry::modifiers, Entry::new);
    }
}
