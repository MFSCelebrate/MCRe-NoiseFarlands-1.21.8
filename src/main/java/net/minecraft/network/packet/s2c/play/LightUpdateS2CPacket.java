...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, LightUpdateS2CPacket> CODEC = Packet.createCodec(LightUpdateS2CPacket::write, LightUpdateS2CPacket::new);
    final private int chunkX;
    final private int chunkZ;
    final private LightData data;
