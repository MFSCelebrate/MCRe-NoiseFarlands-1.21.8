...
{
    final static public PacketCodec<RegistryByteBuf, EntityTrackerUpdateS2CPacket> CODEC = Packet.createCodec(EntityTrackerUpdateS2CPacket::write, EntityTrackerUpdateS2CPacket::new);
    final static public int MARKER_ID = 255;
    ...
    private static void write(List<DataTracker.SerializedEntry<?>> trackedValues, RegistryByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeByte(255);
    }
