...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, EntitiesDestroyS2CPacket> CODEC = Packet.createCodec(EntitiesDestroyS2CPacket::write, EntitiesDestroyS2CPacket::new);
    final private IntList entityIds;
