...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, SetCameraEntityS2CPacket> CODEC = Packet.createCodec(SetCameraEntityS2CPacket::write, SetCameraEntityS2CPacket::new);
