...
implements Packet<ClientConfigurationPacketListener> {
    final static public ResetChatS2CPacket INSTANCE = new ResetChatS2CPacket();
    final static public PacketCodec<ByteBuf, ResetChatS2CPacket> CODEC = PacketCodec.unit(INSTANCE);
