...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<RegistryByteBuf, EntityEquipmentUpdateS2CPacket> CODEC = Packet.createCodec(EntityEquipmentUpdateS2CPacket::write, EntityEquipmentUpdateS2CPacket::new);
    final static private byte field_33342 = -128;
    final private int entityId;
    final private List<Pair<EquipmentSlot, ItemStack>> equipmentList;
    ...
    private void write(RegistryByteBuf buf) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            buf.net_minecraft_network_PacketByteBuf_writeByte(bl ? k | 0xFFFFFF80 : k);
