...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, ScoreboardDisplayS2CPacket> CODEC = Packet.createCodec(ScoreboardDisplayS2CPacket::write, ScoreboardDisplayS2CPacket::new);
    final private ScoreboardDisplaySlot slot;
