...
{
    final static public PacketCodec<ByteBuf, SelectKnownPacksS2CPacket> CODEC = PacketCodec.tuple(VersionedIdentifier.PACKET_CODEC.collect(PacketCodecs.toList()), SelectKnownPacksS2CPacket::knownPacks, SelectKnownPacksS2CPacket::new);
