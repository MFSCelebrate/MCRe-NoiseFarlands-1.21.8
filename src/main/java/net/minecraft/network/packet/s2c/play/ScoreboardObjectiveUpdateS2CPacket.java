...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<RegistryByteBuf, ScoreboardObjectiveUpdateS2CPacket> CODEC = Packet.createCodec(ScoreboardObjectiveUpdateS2CPacket::write, ScoreboardObjectiveUpdateS2CPacket::new);
    final static public int ADD_MODE = 0;
    final static public int REMOVE_MODE = 1;
    final static public int UPDATE_MODE = 2;
    final private String name;
    final private Text displayName;
    final private ScoreboardCriterion.RenderType type;
    final private Optional<NumberFormat> numberFormat;
    ...
    private void write(RegistryByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeByte(this.mode);
        if (this.mode == 0 || this.mode == 2) {
