...
implements Packet<ClientCommonPacketListener> {
    final static public PacketCodec<PacketByteBuf, SynchronizeTagsS2CPacket> CODEC = Packet.createCodec(SynchronizeTagsS2CPacket::write, SynchronizeTagsS2CPacket::new);
    final private Map<RegistryKey<? extends Registry<?>>, TagPacketSerializer.Serialized> groups;
