...
{
    final static public PacketCodec<PacketByteBuf, ScoreboardScoreResetS2CPacket> CODEC = Packet.createCodec(ScoreboardScoreResetS2CPacket::write, ScoreboardScoreResetS2CPacket::new);
