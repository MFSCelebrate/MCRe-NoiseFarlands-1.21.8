...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, WorldBorderInterpolateSizeS2CPacket> CODEC = Packet.createCodec(WorldBorderInterpolateSizeS2CPacket::write, WorldBorderInterpolateSizeS2CPacket::new);
