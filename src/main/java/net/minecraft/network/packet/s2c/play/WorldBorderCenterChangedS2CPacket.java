...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, WorldBorderCenterChangedS2CPacket> CODEC = Packet.createCodec(WorldBorderCenterChangedS2CPacket::write, WorldBorderCenterChangedS2CPacket::new);
