...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, EndCombatS2CPacket> CODEC = Packet.createCodec(EndCombatS2CPacket::write, EndCombatS2CPacket::new);
    final private int timeSinceLastAttack;
