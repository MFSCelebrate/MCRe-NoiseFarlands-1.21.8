...
public class LightData {
    final static private PacketCodec<ByteBuf, byte[]> CODEC = PacketCodecs.byteArray(2048);
    final private BitSet initedSky;
    final private BitSet initedBlock;
    final private BitSet uninitedSky;
    final private BitSet uninitedBlock;
    final private List<byte[]> skyNibbles;
    final private List<byte[]> blockNibbles;
