...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, OpenWrittenBookS2CPacket> CODEC = Packet.createCodec(OpenWrittenBookS2CPacket::write, OpenWrittenBookS2CPacket::new);
