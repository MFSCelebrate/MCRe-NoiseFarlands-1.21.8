...
{
    final static public PacketCodec<PacketByteBuf, DebugGameEventCustomPayload> CODEC = CustomPayload.codecOf(DebugGameEventCustomPayload::write, DebugGameEventCustomPayload::new);
    final static public CustomPayload.Id<DebugGameEventCustomPayload> ID = CustomPayload.id("debug/game_event");
