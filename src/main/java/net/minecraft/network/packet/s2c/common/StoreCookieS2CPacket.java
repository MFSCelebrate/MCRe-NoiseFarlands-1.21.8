...
{
    final static public PacketCodec<PacketByteBuf, StoreCookieS2CPacket> CODEC = Packet.createCodec(StoreCookieS2CPacket::write, StoreCookieS2CPacket::new);
    final static private int MAX_COOKIE_LENGTH = 5120;
    final static public PacketCodec<ByteBuf, byte[]> COOKIE_PACKET_CODEC = PacketCodecs.byteArray(5120);
