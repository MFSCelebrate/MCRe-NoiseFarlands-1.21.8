...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, ChunkRenderDistanceCenterS2CPacket> CODEC = Packet.createCodec(ChunkRenderDistanceCenterS2CPacket::write, ChunkRenderDistanceCenterS2CPacket::new);
