...
{
    final static public PacketCodec<PacketByteBuf, LoginQueryRequestS2CPacket> CODEC = Packet.createCodec(LoginQueryRequestS2CPacket::write, LoginQueryRequestS2CPacket::new);
