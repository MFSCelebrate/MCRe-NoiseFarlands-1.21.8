...
{
    final static public PacketCodec<RegistryByteBuf, CooldownUpdateS2CPacket> CODEC = PacketCodec.tuple(Identifier.PACKET_CODEC, CooldownUpdateS2CPacket::cooldownGroup, PacketCodecs.VAR_INT, CooldownUpdateS2CPacket::cooldown, CooldownUpdateS2CPacket::new);
