...
{
    final static public PacketCodec<RegistryByteBuf, OverlayMessageS2CPacket> CODEC = PacketCodec.tuple(TextCodecs.UNLIMITED_REGISTRY_PACKET_CODEC, OverlayMessageS2CPacket::text, OverlayMessageS2CPacket::new);
