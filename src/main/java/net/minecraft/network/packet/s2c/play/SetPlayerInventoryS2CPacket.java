...
{
    final static public PacketCodec<RegistryByteBuf, SetPlayerInventoryS2CPacket> CODEC = PacketCodec.tuple(PacketCodecs.VAR_INT, SetPlayerInventoryS2CPacket::slot, ItemStack.OPTIONAL_PACKET_CODEC, SetPlayerInventoryS2CPacket::contents, SetPlayerInventoryS2CPacket::new);
