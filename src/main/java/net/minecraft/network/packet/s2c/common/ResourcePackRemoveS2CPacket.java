...
{
    final static public PacketCodec<PacketByteBuf, ResourcePackRemoveS2CPacket> CODEC = Packet.createCodec(ResourcePackRemoveS2CPacket::write, ResourcePackRemoveS2CPacket::new);
