...
{
    final static public PacketCodec<RegistryByteBuf, PlayerRespawnS2CPacket> CODEC = Packet.createCodec(PlayerRespawnS2CPacket::write, PlayerRespawnS2CPacket::new);
    final static public byte KEEP_ATTRIBUTES = 1;
    final static public byte KEEP_TRACKED_DATA = 2;
    final static public byte KEEP_ALL = 3;
    ...
    private void write(RegistryByteBuf registryByteBuf) {
        ...
        registryByteBuf.net_minecraft_network_PacketByteBuf_writeByte(this.flag);
    }
