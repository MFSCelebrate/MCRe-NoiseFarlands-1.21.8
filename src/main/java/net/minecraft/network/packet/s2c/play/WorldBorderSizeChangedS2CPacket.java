...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, WorldBorderSizeChangedS2CPacket> CODEC = Packet.createCodec(WorldBorderSizeChangedS2CPacket::write, WorldBorderSizeChangedS2CPacket::new);
