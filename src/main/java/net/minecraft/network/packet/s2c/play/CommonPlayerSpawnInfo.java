...
public record CommonPlayerSpawnInfo(RegistryEntry<DimensionType> dimensionType, RegistryKey<World> dimension, long seed, GameMode gameMode, @Nullable GameMode lastGameMode, boolean isDebug, boolean isFlat, Optional<GlobalPos> lastDeathLocation, int portalCooldown, int seaLevel) {
    ...
    public void write(RegistryByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeByte(this.gameMode.getIndex());
        buf.net_minecraft_network_PacketByteBuf_writeByte(GameMode.getId(this.lastGameMode));
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.isDebug);
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.isFlat);
