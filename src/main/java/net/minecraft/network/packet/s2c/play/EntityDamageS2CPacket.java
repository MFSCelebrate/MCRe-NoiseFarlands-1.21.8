...
{
    final static public PacketCodec<RegistryByteBuf, EntityDamageS2CPacket> CODEC = Packet.createCodec(EntityDamageS2CPacket::write, EntityDamageS2CPacket::new);
    ...
    private void write(RegistryByteBuf buf) {
        ...
        buf.writeOptional(this.sourcePosition, (bufx, pos) -> {
            bufx.net_minecraft_network_PacketByteBuf_writeDouble(pos.getX());
            bufx.net_minecraft_network_PacketByteBuf_writeDouble(pos.getY());
            bufx.net_minecraft_network_PacketByteBuf_writeDouble(pos.getZ());
        });
    }
