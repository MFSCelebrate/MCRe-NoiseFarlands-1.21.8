...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, ExperienceBarUpdateS2CPacket> CODEC = Packet.createCodec(ExperienceBarUpdateS2CPacket::write, ExperienceBarUpdateS2CPacket::new);
    final private float barProgress;
    final private int experienceLevel;
    ...
    private void write(PacketByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeFloat(this.barProgress);
