...
{
    final static public PacketCodec<PacketByteBuf, ServerTransferS2CPacket> CODEC = Packet.createCodec(ServerTransferS2CPacket::write, ServerTransferS2CPacket::new);
