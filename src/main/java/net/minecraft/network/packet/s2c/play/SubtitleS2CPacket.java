...
{
    final static public PacketCodec<RegistryByteBuf, SubtitleS2CPacket> CODEC = PacketCodec.tuple(TextCodecs.UNLIMITED_REGISTRY_PACKET_CODEC, SubtitleS2CPacket::text, SubtitleS2CPacket::new);
