...
{
    final static public PacketCodec<PacketByteBuf, WorldTimeUpdateS2CPacket> CODEC = PacketCodec.tuple(PacketCodecs.LONG, WorldTimeUpdateS2CPacket::time, PacketCodecs.LONG, WorldTimeUpdateS2CPacket::timeOfDay, PacketCodecs.BOOLEAN, WorldTimeUpdateS2CPacket::tickDayTime, WorldTimeUpdateS2CPacket::new);
