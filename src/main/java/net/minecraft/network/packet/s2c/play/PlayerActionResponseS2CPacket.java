...
{
    final static public PacketCodec<PacketByteBuf, PlayerActionResponseS2CPacket> CODEC = Packet.createCodec(PlayerActionResponseS2CPacket::write, PlayerActionResponseS2CPacket::new);
