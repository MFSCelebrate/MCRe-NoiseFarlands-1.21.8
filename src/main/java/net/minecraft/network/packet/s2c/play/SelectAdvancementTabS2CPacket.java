...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, SelectAdvancementTabS2CPacket> CODEC = Packet.createCodec(SelectAdvancementTabS2CPacket::write, SelectAdvancementTabS2CPacket::new);
    @Nullable
    final private Identifier tabId;
