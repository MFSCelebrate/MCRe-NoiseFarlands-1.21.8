...
{
    final static public PacketCodec<PacketByteBuf, RecipeBookSettingsS2CPacket> CODEC = PacketCodec.tuple(RecipeBookOptions.PACKET_CODEC, RecipeBookSettingsS2CPacket::bookSettings, RecipeBookSettingsS2CPacket::new);
