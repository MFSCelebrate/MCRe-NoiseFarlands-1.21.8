...
{
    final static public PacketCodec<PacketByteBuf, DebugVillageSectionsCustomPayload> CODEC = CustomPayload.codecOf(DebugVillageSectionsCustomPayload::write, DebugVillageSectionsCustomPayload::new);
    final static public CustomPayload.Id<DebugVillageSectionsCustomPayload> ID = CustomPayload.id("debug/village_sections");
