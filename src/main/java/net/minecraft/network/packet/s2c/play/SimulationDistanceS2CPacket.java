...
{
    final static public PacketCodec<PacketByteBuf, SimulationDistanceS2CPacket> CODEC = Packet.createCodec(SimulationDistanceS2CPacket::write, SimulationDistanceS2CPacket::new);
