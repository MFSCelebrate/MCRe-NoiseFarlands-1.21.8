...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, WorldBorderWarningTimeChangedS2CPacket> CODEC = Packet.createCodec(WorldBorderWarningTimeChangedS2CPacket::write, WorldBorderWarningTimeChangedS2CPacket::new);
