...
implements Packet<ClientLoginPacketListener> {
    final static public PacketCodec<PacketByteBuf, LoginHelloS2CPacket> CODEC = Packet.createCodec(LoginHelloS2CPacket::write, LoginHelloS2CPacket::new);
    final private String serverId;
    final private byte[] publicKey;
    final private byte[] nonce;
    final private boolean needsAuthentication;
    ...
    private void write(PacketByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.needsAuthentication);
    }
