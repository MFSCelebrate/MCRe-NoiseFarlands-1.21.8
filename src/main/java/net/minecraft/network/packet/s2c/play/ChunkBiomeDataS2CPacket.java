...
{
    final static public PacketCodec<PacketByteBuf, ChunkBiomeDataS2CPacket> CODEC = Packet.createCodec(ChunkBiomeDataS2CPacket::write, ChunkBiomeDataS2CPacket::new);
    final static private int MAX_SIZE = 0x200000;
