...
{
    final static public PacketCodec<PacketByteBuf, UpdateTickRateS2CPacket> CODEC = Packet.createCodec(UpdateTickRateS2CPacket::write, UpdateTickRateS2CPacket::new);
    ...
    private void write(PacketByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeFloat(this.tickRate);
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.isFrozen);
    }
