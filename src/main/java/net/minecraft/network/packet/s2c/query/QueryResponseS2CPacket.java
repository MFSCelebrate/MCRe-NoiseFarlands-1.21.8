...
{
    final static private RegistryOps<JsonElement> OPS = DynamicRegistryManager.EMPTY.getOps(JsonOps.INSTANCE);
    final static public PacketCodec<ByteBuf, QueryResponseS2CPacket> CODEC = PacketCodec.tuple(PacketCodecs.lenientJson(Short.MAX_VALUE).collect(PacketCodecs.fromCodec(OPS, ServerMetadata.CODEC)), QueryResponseS2CPacket::metadata, QueryResponseS2CPacket::new);
