...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, WorldBorderWarningBlocksChangedS2CPacket> CODEC = Packet.createCodec(WorldBorderWarningBlocksChangedS2CPacket::write, WorldBorderWarningBlocksChangedS2CPacket::new);
