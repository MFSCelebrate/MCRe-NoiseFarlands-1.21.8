...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<RegistryByteBuf, ChunkDataS2CPacket> CODEC = Packet.createCodec(ChunkDataS2CPacket::write, ChunkDataS2CPacket::new);
    final private int chunkX;
    final private int chunkZ;
    final private ChunkData chunkData;
    final private LightData lightData;
    ...
    private void write(RegistryByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeInt(this.chunkX);
        buf.net_minecraft_network_PacketByteBuf_writeInt(this.chunkZ);
