...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, ChunkLoadDistanceS2CPacket> CODEC = Packet.createCodec(ChunkLoadDistanceS2CPacket::write, ChunkLoadDistanceS2CPacket::new);
