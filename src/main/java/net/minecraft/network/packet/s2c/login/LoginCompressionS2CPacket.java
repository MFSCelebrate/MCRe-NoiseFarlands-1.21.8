...
implements Packet<ClientLoginPacketListener> {
    final static public PacketCodec<PacketByteBuf, LoginCompressionS2CPacket> CODEC = Packet.createCodec(LoginCompressionS2CPacket::write, LoginCompressionS2CPacket::new);
    final private int compressionThreshold;
