...
{
    final static public PacketCodec<ByteBuf, ServerLinksS2CPacket> CODEC = PacketCodec.tuple(ServerLinks.LIST_CODEC, ServerLinksS2CPacket::links, ServerLinksS2CPacket::new);
