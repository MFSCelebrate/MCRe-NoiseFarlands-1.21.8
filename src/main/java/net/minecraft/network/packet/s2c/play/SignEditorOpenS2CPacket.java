...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, SignEditorOpenS2CPacket> CODEC = Packet.createCodec(SignEditorOpenS2CPacket::write, SignEditorOpenS2CPacket::new);
