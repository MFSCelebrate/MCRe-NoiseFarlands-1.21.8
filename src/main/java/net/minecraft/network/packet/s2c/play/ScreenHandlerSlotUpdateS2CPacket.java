...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<RegistryByteBuf, ScreenHandlerSlotUpdateS2CPacket> CODEC = Packet.createCodec(ScreenHandlerSlotUpdateS2CPacket::write, ScreenHandlerSlotUpdateS2CPacket::new);
    ...
    private void write(RegistryByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeShort(this.slot);
