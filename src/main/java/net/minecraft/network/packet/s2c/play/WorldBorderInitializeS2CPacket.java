...
implements Packet<ClientPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, WorldBorderInitializeS2CPacket> CODEC = Packet.createCodec(WorldBorderInitializeS2CPacket::write, WorldBorderInitializeS2CPacket::new);
    ...
    private void write(PacketByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeDouble(this.centerX);
        buf.net_minecraft_network_PacketByteBuf_writeDouble(this.centerZ);
        buf.net_minecraft_network_PacketByteBuf_writeDouble(this.size);
        buf.net_minecraft_network_PacketByteBuf_writeDouble(this.sizeLerpTarget);
