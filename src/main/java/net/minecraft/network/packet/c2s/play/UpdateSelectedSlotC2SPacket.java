...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, UpdateSelectedSlotC2SPacket> CODEC = Packet.createCodec(UpdateSelectedSlotC2SPacket::write, UpdateSelectedSlotC2SPacket::new);
    final private int selectedSlot;
    ...
    private void write(PacketByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeShort(this.selectedSlot);
    }
