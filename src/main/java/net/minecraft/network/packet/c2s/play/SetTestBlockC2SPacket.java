...
{
    final static public PacketCodec<PacketByteBuf, SetTestBlockC2SPacket> CODEC = PacketCodec.tuple(BlockPos.PACKET_CODEC, SetTestBlockC2SPacket::position, TestBlockMode.PACKET_CODEC, SetTestBlockC2SPacket::mode, PacketCodecs.STRING, SetTestBlockC2SPacket::message, SetTestBlockC2SPacket::new);
