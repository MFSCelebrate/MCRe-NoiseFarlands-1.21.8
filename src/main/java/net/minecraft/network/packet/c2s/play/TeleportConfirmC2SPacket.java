...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, TeleportConfirmC2SPacket> CODEC = Packet.createCodec(TeleportConfirmC2SPacket::write, TeleportConfirmC2SPacket::new);
    final private int teleportId;
