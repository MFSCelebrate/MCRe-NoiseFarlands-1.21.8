...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, SelectMerchantTradeC2SPacket> CODEC = Packet.createCodec(SelectMerchantTradeC2SPacket::write, SelectMerchantTradeC2SPacket::new);
