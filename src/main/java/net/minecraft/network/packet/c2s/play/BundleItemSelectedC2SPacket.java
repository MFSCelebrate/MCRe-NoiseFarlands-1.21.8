...
{
    final static public PacketCodec<PacketByteBuf, BundleItemSelectedC2SPacket> CODEC = Packet.createCodec(BundleItemSelectedC2SPacket::write, BundleItemSelectedC2SPacket::new);
