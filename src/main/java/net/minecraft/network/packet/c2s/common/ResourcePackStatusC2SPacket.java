...
{
    final static public PacketCodec<PacketByteBuf, ResourcePackStatusC2SPacket> CODEC = Packet.createCodec(ResourcePackStatusC2SPacket::write, ResourcePackStatusC2SPacket::new);
    ...
    extends Enum<Status> {
        final static public Status SUCCESSFULLY_LOADED = new Status();
        final static public Status DECLINED = new Status();
        final static public Status FAILED_DOWNLOAD = new Status();
        final static public Status ACCEPTED = new Status();
        final static public Status DOWNLOADED = new Status();
        final static public Status INVALID_URL = new Status();
        final static public Status FAILED_RELOAD = new Status();
        final static public Status DISCARDED = new Status();
        final static private Status[] field_13019;
