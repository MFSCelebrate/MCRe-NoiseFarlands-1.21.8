...
{
    final static public ClientTickEndC2SPacket INSTANCE = new ClientTickEndC2SPacket();
    final static public PacketCodec<ByteBuf, ClientTickEndC2SPacket> CODEC = PacketCodec.unit(INSTANCE);
