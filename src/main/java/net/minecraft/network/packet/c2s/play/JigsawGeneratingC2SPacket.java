...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, JigsawGeneratingC2SPacket> CODEC = Packet.createCodec(JigsawGeneratingC2SPacket::write, JigsawGeneratingC2SPacket::new);
    final private BlockPos pos;
    final private int maxDepth;
    final private boolean keepJigsaws;
    ...
    private void write(PacketByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.keepJigsaws);
    }
