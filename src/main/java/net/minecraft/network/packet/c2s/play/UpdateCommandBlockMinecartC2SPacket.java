...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, UpdateCommandBlockMinecartC2SPacket> CODEC = Packet.createCodec(UpdateCommandBlockMinecartC2SPacket::write, UpdateCommandBlockMinecartC2SPacket::new);
    ...
    private void write(PacketByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.trackOutput);
    }
