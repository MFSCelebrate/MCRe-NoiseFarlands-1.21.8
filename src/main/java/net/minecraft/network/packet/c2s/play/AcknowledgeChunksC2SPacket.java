...
{
    final static public PacketCodec<PacketByteBuf, AcknowledgeChunksC2SPacket> CODEC = Packet.createCodec(AcknowledgeChunksC2SPacket::write, AcknowledgeChunksC2SPacket::new);
    ...
    private void write(PacketByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeFloat(this.desiredChunksPerTick);
    }
