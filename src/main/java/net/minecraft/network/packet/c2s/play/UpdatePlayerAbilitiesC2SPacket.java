...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, UpdatePlayerAbilitiesC2SPacket> CODEC = Packet.createCodec(UpdatePlayerAbilitiesC2SPacket::write, UpdatePlayerAbilitiesC2SPacket::new);
