...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, UpdateCommandBlockC2SPacket> CODEC = Packet.createCodec(UpdateCommandBlockC2SPacket::write, UpdateCommandBlockC2SPacket::new);
    final static private int TRACK_OUTPUT_MASK = 1;
    final static private int CONDITIONAL_MASK = 2;
    final static private int ALWAYS_ACTIVE_MASK = 4;
    final private BlockPos pos;
    final private String command;
    final private boolean trackOutput;
    final private boolean conditional;
    final private boolean alwaysActive;
    final private CommandBlockBlockEntity.Type type;
