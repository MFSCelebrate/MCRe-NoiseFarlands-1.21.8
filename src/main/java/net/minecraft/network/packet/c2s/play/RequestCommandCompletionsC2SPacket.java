...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, RequestCommandCompletionsC2SPacket> CODEC = Packet.createCodec(RequestCommandCompletionsC2SPacket::write, RequestCommandCompletionsC2SPacket::new);
    final private int completionId;
    final private String partialCommand;
