...
public record TestInstanceBlockActionC2SPacket(BlockPos pos, Action action, TestInstanceBlockEntity.Data data) implements Packet<ServerPlayPacketListener>
{
    ...
    extends Enum<Action> {
        final static public Action INIT = new Action(0);
        final static public Action QUERY = new Action(1);
        final static public Action SET = new Action(2);
        final static public Action RESET = new Action(3);
        final static public Action SAVE = new Action(4);
        final static public Action EXPORT = new Action(5);
        final static public Action RUN = new Action(6);
        final static private IntFunction<Action> INDEX_MAPPER;
        final static public PacketCodec<ByteBuf, Action> CODEC;
        final private int index;
        final static private Action[] field_55930;
