...
{
    final static public PacketCodec<PacketByteBuf, SlotChangedStateC2SPacket> CODEC = Packet.createCodec(SlotChangedStateC2SPacket::write, SlotChangedStateC2SPacket::new);
    ...
    private void write(PacketByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.newState);
    }
