...
{
    final static public PacketCodec<PacketByteBuf, MessageAcknowledgmentC2SPacket> CODEC = Packet.createCodec(MessageAcknowledgmentC2SPacket::write, MessageAcknowledgmentC2SPacket::new);
