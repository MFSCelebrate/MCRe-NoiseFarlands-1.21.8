...
{
    final static public PacketCodec<PacketByteBuf, CookieResponseC2SPacket> CODEC = Packet.createCodec(CookieResponseC2SPacket::write, CookieResponseC2SPacket::new);
