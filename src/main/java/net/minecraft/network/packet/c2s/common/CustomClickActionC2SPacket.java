...
{
    final static private PacketCodec<ByteBuf, Optional<NbtElement>> field_60958 = PacketCodecs.nbtElement(() -> new NbtSizeTracker(32768L, 16)).collect(PacketCodecs.lengthPrepended(65536));
    final static public PacketCodec<ByteBuf, CustomClickActionC2SPacket> CODEC = PacketCodec.tuple(Identifier.PACKET_CODEC, CustomClickActionC2SPacket::id, field_60958, CustomClickActionC2SPacket::payload, CustomClickActionC2SPacket::new);
