...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, PlayerInteractBlockC2SPacket> CODEC = Packet.createCodec(PlayerInteractBlockC2SPacket::write, PlayerInteractBlockC2SPacket::new);
    final private BlockHitResult blockHitResult;
