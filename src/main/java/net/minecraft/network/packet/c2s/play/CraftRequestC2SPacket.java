...
{
    final static public PacketCodec<PacketByteBuf, CraftRequestC2SPacket> CODEC = PacketCodec.tuple(PacketCodecs.SYNC_ID, CraftRequestC2SPacket::syncId, NetworkRecipeId.PACKET_CODEC, CraftRequestC2SPacket::recipeId, PacketCodecs.BOOLEAN, CraftRequestC2SPacket::craftAll, CraftRequestC2SPacket::new);
