...
{
    final static public PacketCodec<PacketByteBuf, LoginQueryResponseC2SPacket> CODEC = Packet.createCodec(LoginQueryResponseC2SPacket::write, LoginQueryResponseC2SPacket::read);
    ...
    private static LoginQueryResponsePayload getVanillaPayload(PacketByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_skipBytes(i);
