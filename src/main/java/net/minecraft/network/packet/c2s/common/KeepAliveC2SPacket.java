...
implements Packet<ServerCommonPacketListener> {
    final static public PacketCodec<PacketByteBuf, KeepAliveC2SPacket> CODEC = Packet.createCodec(KeepAliveC2SPacket::write, KeepAliveC2SPacket::new);
    ...
    private void write(PacketByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeLong(this.id);
    }
