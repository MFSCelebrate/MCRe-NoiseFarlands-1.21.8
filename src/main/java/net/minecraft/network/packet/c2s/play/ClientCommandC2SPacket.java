...
implements Packet<ServerPlayPacketListener> {
    final static public PacketCodec<PacketByteBuf, ClientCommandC2SPacket> CODEC = Packet.createCodec(ClientCommandC2SPacket::write, ClientCommandC2SPacket::new);
    final private int entityId;
    final private Mode mode;
    final private int mountJumpHeight;
    ...
    extends Enum<Mode> {
        final static public Mode STOP_SLEEPING = new Mode();
        final static public Mode START_SPRINTING = new Mode();
        final static public Mode STOP_SPRINTING = new Mode();
        final static public Mode START_RIDING_JUMP = new Mode();
        final static public Mode STOP_RIDING_JUMP = new Mode();
        final static public Mode OPEN_INVENTORY = new Mode();
        final static public Mode START_FALL_FLYING = new Mode();
        final static private Mode[] field_12983;
