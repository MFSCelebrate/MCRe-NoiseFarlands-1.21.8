...
{
    final static public PacketCodec<PacketByteBuf, CommandExecutionC2SPacket> CODEC = Packet.createCodec(CommandExecutionC2SPacket::write, CommandExecutionC2SPacket::new);
