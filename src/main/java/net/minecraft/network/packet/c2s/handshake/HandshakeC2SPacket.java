...
{
    final static public PacketCodec<PacketByteBuf, HandshakeC2SPacket> CODEC = Packet.createCodec(HandshakeC2SPacket::write, HandshakeC2SPacket::new);
    final static private int MAX_ADDRESS_LENGTH = 255;
    ...
    private void write(PacketByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeShort(this.port);
