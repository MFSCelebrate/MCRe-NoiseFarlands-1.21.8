...
{
    final static public PacketCodec<ByteBuf, ChangeGameModeC2SPacket> CODEC = PacketCodec.tuple(GameMode.PACKET_CODEC, ChangeGameModeC2SPacket::mode, ChangeGameModeC2SPacket::new);
