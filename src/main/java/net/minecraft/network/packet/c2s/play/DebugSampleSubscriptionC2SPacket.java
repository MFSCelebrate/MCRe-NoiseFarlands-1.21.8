...
{
    final static public PacketCodec<PacketByteBuf, DebugSampleSubscriptionC2SPacket> CODEC = Packet.createCodec(DebugSampleSubscriptionC2SPacket::write, DebugSampleSubscriptionC2SPacket::new);
