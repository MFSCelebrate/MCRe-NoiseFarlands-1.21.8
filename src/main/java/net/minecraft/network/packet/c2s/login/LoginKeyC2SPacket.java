...
implements Packet<ServerLoginPacketListener> {
    final static public PacketCodec<PacketByteBuf, LoginKeyC2SPacket> CODEC = Packet.createCodec(LoginKeyC2SPacket::write, LoginKeyC2SPacket::new);
    final private byte[] encryptedSecretKey;
