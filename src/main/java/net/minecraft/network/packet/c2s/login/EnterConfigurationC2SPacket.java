...
implements Packet<ServerLoginPacketListener> {
    final static public EnterConfigurationC2SPacket INSTANCE = new EnterConfigurationC2SPacket();
    final static public PacketCodec<ByteBuf, EnterConfigurationC2SPacket> CODEC = PacketCodec.unit(INSTANCE);
