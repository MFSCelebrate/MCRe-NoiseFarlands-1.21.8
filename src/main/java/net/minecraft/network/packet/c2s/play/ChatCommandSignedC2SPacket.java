...
{
    final static public PacketCodec<PacketByteBuf, ChatCommandSignedC2SPacket> CODEC = Packet.createCodec(ChatCommandSignedC2SPacket::write, ChatCommandSignedC2SPacket::new);
    ...
    private void write(PacketByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeLong(this.salt);
