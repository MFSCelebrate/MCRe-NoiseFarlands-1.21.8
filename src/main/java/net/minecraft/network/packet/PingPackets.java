...
public class PingPackets {
    final static public PacketType<PingResultS2CPacket> PONG_RESPONSE = PingPackets.s2c("pong_response");
    final static public PacketType<QueryPingC2SPacket> PING_REQUEST = PingPackets.c2s("ping_request");
