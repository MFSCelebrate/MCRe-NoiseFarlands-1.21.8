...
public class CookiePackets {
    final static public PacketType<CookieRequestS2CPacket> COOKIE_REQUEST = CookiePackets.s2c("cookie_request");
    final static public PacketType<CookieResponseC2SPacket> COOKIE_RESPONSE = CookiePackets.c2s("cookie_response");
