...
public interface CustomPayload {
    ...
    public static <B extends PacketByteBuf> PacketCodec<B, CustomPayload> createCodec(final CodecFactory<B> unknownCodecFactory, List<Type<? super B, ?>> types) {
        ...
        return new PacketCodec<B, CustomPayload>(){
            ...
            @Override
            public CustomPayload net_minecraft_network_packet_CustomPayload_decode(B packetByteBuf) {
            ...
            @Override
            public Object java_lang_Object_decode(Object object) {
                return this.net_minecraft_network_packet_CustomPayload_decode((B)((Object)((PacketByteBuf)((Object)object))));
            }
        };
    }
