...
public class NetworkEncryptionUtils {
    ...
    final static private int AES_KEY_LENGTH = 128;
    final static private String RSA = "RSA";
    final static private int RSA_KEY_LENGTH = 1024;
    final static private String ISO_8859_1 = "ISO_8859_1";
    final static private String SHA1 = "SHA-1";
    final static public String SHA256_WITH_RSA = "SHA256withRSA";
    final static public int SHA256_BITS = 256;
    final static private String RSA_PRIVATE_KEY_PREFIX = "-----BEGIN RSA PRIVATE KEY-----";
    final static private String RSA_PRIVATE_KEY_SUFFIX = "-----END RSA PRIVATE KEY-----";
    final static public String RSA_PUBLIC_KEY_PREFIX = "-----BEGIN RSA PUBLIC KEY-----";
    final static private String RSA_PUBLIC_KEY_SUFFIX = "-----END RSA PUBLIC KEY-----";
    final static public String LINEBREAK = "\n";
    final static public Base64.Encoder BASE64_ENCODER = Base64.getMimeEncoder(76, "\n".getBytes(StandardCharsets.UTF_8));
    final static public Codec<PublicKey> RSA_PUBLIC_KEY_CODEC = Codec.STRING.comapFlatMap(key -> {
        try {
    ...
    final static public Codec<PrivateKey> RSA_PRIVATE_KEY_CODEC = Codec.STRING.comapFlatMap(key -> {
        try {
    ...
    public record SignatureData(long salt, byte[] signature) {
        final static public SignatureData NONE = new SignatureData(0L, ByteArrays.EMPTY_ARRAY);
        ...
        public static void write(PacketByteBuf buf, SignatureData signatureData) {
            buf.net_minecraft_network_PacketByteBuf_writeLong(signatureData.salt);
