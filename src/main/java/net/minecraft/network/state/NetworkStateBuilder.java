...
public class NetworkStateBuilder<T extends PacketListener, B extends ByteBuf, C> {
    ...
    final private List<PacketType<T, ?, B, C>> packetTypes = new ArrayList();
    @Nullable
    ...
    extends Record {
        ...
        final private PacketCodec<? super B, P> codec;
        @Nullable
        final private PacketCodecModifier<B, P, C> modifier;

        PacketType(net.minecraft.network.packet.PacketType<P> packetType, PacketCodec<? super B, P> packetCodec, @Nullable PacketCodecModifier<B, P, C> packetCodecModifier) {
