...
public class PlayStateFactories {
    final static public PacketCodecModifier<RegistryByteBuf, CreativeInventoryActionC2SPacket, PacketCodecModifierContext> CREATIVE_INVENTORY_ACTION_C2S_MODIFIER = (packetCodec, context) -> new PacketCodec<RegistryByteBuf, CreativeInventoryActionC2SPacket>(){
