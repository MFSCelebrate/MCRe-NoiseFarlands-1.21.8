...
public record MessageType(Decoration chat, Decoration narration) {
    final static public Codec<MessageType> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Decoration.CODEC.fieldOf("chat").forGetter(MessageType::chat), (App)Decoration.CODEC.fieldOf("narration").forGetter(MessageType::narration)).apply((Applicative)instance, MessageType::new));
    final static public PacketCodec<RegistryByteBuf, MessageType> PACKET_CODEC = PacketCodec.tuple(Decoration.PACKET_CODEC, MessageType::chat, Decoration.PACKET_CODEC, MessageType::narration, MessageType::new);
    final static public PacketCodec<RegistryByteBuf, RegistryEntry<MessageType>> ENTRY_PACKET_CODEC = PacketCodecs.registryEntry(RegistryKeys.MESSAGE_TYPE, PACKET_CODEC);
    final static public Decoration CHAT_TEXT_DECORATION = Decoration.ofChat("chat.type.text");
    final static public RegistryKey<MessageType> CHAT = MessageType.register("chat");
    final static public RegistryKey<MessageType> SAY_COMMAND = MessageType.register("say_command");
    final static public RegistryKey<MessageType> MSG_COMMAND_INCOMING = MessageType.register("msg_command_incoming");
    final static public RegistryKey<MessageType> MSG_COMMAND_OUTGOING = MessageType.register("msg_command_outgoing");
    final static public RegistryKey<MessageType> TEAM_MSG_COMMAND_INCOMING = MessageType.register("team_msg_command_incoming");
    final static public RegistryKey<MessageType> TEAM_MSG_COMMAND_OUTGOING = MessageType.register("team_msg_command_outgoing");
    final static public RegistryKey<MessageType> EMOTE_COMMAND = MessageType.register("emote_command");
    ...
    public static Parameters params(RegistryKey<MessageType> typeKey, Entity entity) {
        return MessageType.params(typeKey, entity.net_minecraft_world_World_getWorld().getRegistryManager(), entity.getDisplayName());
    }
    ...
    public static Parameters params(RegistryKey<MessageType> typeKey, DynamicRegistryManager registryManager, Text name) {
        RegistryWrapper.Impl registry = registryManager.net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.MESSAGE_TYPE);
    ...
    public record Parameters(RegistryEntry<MessageType> type, Text name, Optional<Text> targetName) {
        final static public PacketCodec<RegistryByteBuf, Parameters> CODEC = PacketCodec.tuple(ENTRY_PACKET_CODEC, Parameters::type, TextCodecs.UNLIMITED_REGISTRY_PACKET_CODEC, Parameters::name, TextCodecs.OPTIONAL_UNLIMITED_REGISTRY_PACKET_CODEC, Parameters::targetName, Parameters::new);
