...
public record ArgumentSignatureDataMap(List<Entry> entries) {
    final static public ArgumentSignatureDataMap EMPTY = new ArgumentSignatureDataMap(List.of());
    final static private int MAX_ARGUMENTS = 8;
    final static private int MAX_ARGUMENT_NAME_LENGTH = 16;
