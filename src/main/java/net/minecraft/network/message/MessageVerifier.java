...
public interface MessageVerifier {
    ...
    final static public MessageVerifier NO_SIGNATURE = SignedMessage::stripSignature;
    final static public MessageVerifier UNVERIFIED = message -> {
    ...
    implements MessageVerifier {
        ...
        final private BooleanSupplier expirationChecker;
        @Nullable
