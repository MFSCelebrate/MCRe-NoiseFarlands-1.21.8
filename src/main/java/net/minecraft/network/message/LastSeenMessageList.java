...
public record LastSeenMessageList(List<MessageSignatureData> entries) {
    final static public Codec<LastSeenMessageList> CODEC = MessageSignatureData.CODEC.listOf().xmap(LastSeenMessageList::new, LastSeenMessageList::entries);
    static public LastSeenMessageList EMPTY = new LastSeenMessageList(List.of());
    final static public int MAX_ENTRIES = 20;
    ...
    public record Indexed(List<MessageSignatureData.Indexed> buf) {
        final static public Indexed EMPTY = new Indexed(List.of());
    ...
    public record Acknowledgment(int offset, BitSet acknowledged, byte checksum) {
        final static public byte NO_CHECKSUM = 0;
        ...
        public void write(PacketByteBuf buf) {
            ...
            buf.net_minecraft_network_PacketByteBuf_writeByte(this.checksum);
        }
