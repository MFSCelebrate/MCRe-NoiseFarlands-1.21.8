...
public abstract class Fluid {
    final static public IdList<FluidState> STATE_IDS = new IdList();
    final protected StateManager<Fluid, FluidState> stateManager;
    private FluidState defaultState;
    final private RegistryEntry.Reference<Fluid> registryEntry = Registries.FLUID.createEntry(this);
