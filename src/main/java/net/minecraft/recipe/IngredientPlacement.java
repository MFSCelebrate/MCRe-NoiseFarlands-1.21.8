...
public class IngredientPlacement {
    final static public int field_55495 = -1;
    final static public IngredientPlacement NONE = new IngredientPlacement(List.of(), IntList.of());
    final private List<Ingredient> ingredients;
    final private IntList placementSlots;
