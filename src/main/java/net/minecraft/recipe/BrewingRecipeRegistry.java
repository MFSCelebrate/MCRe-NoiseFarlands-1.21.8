...
public class BrewingRecipeRegistry {
    final static public int field_30942 = 20;
    final static public BrewingRecipeRegistry EMPTY = new BrewingRecipeRegistry(List.of(), List.of(), List.of());
    final private List<Ingredient> potionTypes;
    final private List<Recipe<Potion>> potionRecipes;
    final private List<Recipe<Item>> itemRecipes;
    ...
    extends Record {
        ...
        Recipe(RegistryEntry<T> registryEntry, Ingredient ingredient, RegistryEntry<T> registryEntry2) {
    ...
    implements FabricBrewingRecipeRegistryBuilder {
        final private List<Ingredient> potionTypes = new ArrayList<Ingredient>();
        final private List<Recipe<Potion>> potionRecipes = new ArrayList<Recipe<Potion>>();
        final private List<Recipe<Item>> itemRecipes = new ArrayList<Recipe<Item>>();
