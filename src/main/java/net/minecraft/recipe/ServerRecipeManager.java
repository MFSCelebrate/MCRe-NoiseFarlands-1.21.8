...
FabricServerRecipeManager {
    ...
    final static private Map<RegistryKey<RecipePropertySet>, SoleIngredientGetter> SOLE_INGREDIENT_GETTERS = Map.of(RecipePropertySet.SMITHING_ADDITION, recipe -> {
    ...
    final static private ResourceFinder FINDER = ResourceFinder.json(RegistryKeys.RECIPE);
    ...
    @Override
    protected PreparedRecipes net_minecraft_recipe_PreparedRecipes_prepare(ResourceManager resourceManager, Profiler profiler) {
    ...
    protected Object java_lang_Object_prepare(ResourceManager manager, Profiler profiler) {
        return this.net_minecraft_recipe_PreparedRecipes_prepare(manager, profiler);
    }

    private static int method_64687(Object2IntMap object2IntMap, Object group) {
    ...
    implements Consumer<Recipe<?>> {
        ...
        final private SoleIngredientGetter ingredientGetter;
        final private List<Ingredient> ingredients = new ArrayList<Ingredient>();
        ...
        @Override
        public void accept(Object recipe) {
