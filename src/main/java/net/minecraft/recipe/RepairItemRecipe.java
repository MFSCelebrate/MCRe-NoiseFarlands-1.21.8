...
extends SpecialCraftingRecipe {
    ...
    public ItemStack craft(CraftingRecipeInput craftingRecipeInput, RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        EnchantmentHelper.apply(itemStack3, builder -> wrapperLookup.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.ENCHANTMENT).streamEntries().filter(enchantment -> enchantment.isIn(EnchantmentTags.CURSE)).forEach(enchantment -> {
            ...
            if (1 > 0) {
                builder.add((RegistryEntry<Enchantment>)enchantment, 1);
            }
        }));
        return itemStack3;
    }
