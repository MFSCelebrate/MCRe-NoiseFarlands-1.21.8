...
public class PreparedRecipes {
    final static public PreparedRecipes EMPTY = new PreparedRecipes((Multimap<RecipeType<?>, RecipeEntry<?>>)ImmutableMultimap.of(), Map.of());
    final private Multimap<RecipeType<?>, RecipeEntry<?>> byType;
    final private Map<RegistryKey<Recipe<?>>, RecipeEntry<?>> byKey;
