...
extends SpecialCraftingRecipe {
    final static private Ingredient PAPER = Ingredient.ofItem(Items.PAPER);
    final static private Ingredient DURATION_MODIFIER = Ingredient.ofItem(Items.GUNPOWDER);
    final static private Ingredient FIREWORK_STAR = Ingredient.ofItem(Items.FIREWORK_STAR);
    ...
    public ItemStack craft(CraftingRecipeInput craftingRecipeInput, RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        itemStack2.set(DataComponentTypes.FIREWORKS, new FireworksComponent(1, list));
        return itemStack2;
    }
