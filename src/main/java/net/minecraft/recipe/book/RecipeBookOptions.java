...
public final class RecipeBookOptions {
    ...
    extends Record {
        ...
        final static public CategoryOption DEFAULT = new CategoryOption(false, false);
        final static public MapCodec<CategoryOption> CRAFTING = CategoryOption.createCodec("isGuiOpen", "isFilteringCraftable");
        final static public MapCodec<CategoryOption> FURNACE = CategoryOption.createCodec("isFurnaceGuiOpen", "isFurnaceFilteringCraftable");
        final static public MapCodec<CategoryOption> BLAST_FURNACE = CategoryOption.createCodec("isBlastingFurnaceGuiOpen", "isBlastingFurnaceFilteringCraftable");
        final static public MapCodec<CategoryOption> SMOKER = CategoryOption.createCodec("isSmokerGuiOpen", "isSmokerFilteringCraftable");
        final static public PacketCodec<ByteBuf, CategoryOption> PACKET_CODEC = PacketCodec.tuple(PacketCodecs.BOOLEAN, CategoryOption::guiOpen, PacketCodecs.BOOLEAN, CategoryOption::filteringCraftable, CategoryOption::new);
