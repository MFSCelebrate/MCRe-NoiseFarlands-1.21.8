...
implements StringIdentifiable {
    final static public CookingRecipeCategory FOOD = new CookingRecipeCategory(0, "food");
    final static public CookingRecipeCategory BLOCKS = new CookingRecipeCategory(1, "blocks");
    final static public CookingRecipeCategory MISC = new CookingRecipeCategory(2, "misc");
    final static private IntFunction<CookingRecipeCategory> BY_ID;
    final static public Codec<CookingRecipeCategory> CODEC;
    final static public PacketCodec<ByteBuf, CookingRecipeCategory> PACKET_CODEC;
    final private int id;
    final private String name;
    final static private CookingRecipeCategory[] field_40247;
