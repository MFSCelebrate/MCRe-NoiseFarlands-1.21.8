...
public class BoundedIntUnaryOperator {
    ...
    @Nullable
    final private LootNumberProvider min;
    @Nullable
    final private LootNumberProvider max;
