...
extends ConditionalLootFunction {
    final static public MapCodec<LimitCountLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> LimitCountLootFunction.addConditionsField(instance).and((App)BoundedIntUnaryOperator.CODEC.fieldOf("limit").forGetter(function -> function.limit)).apply((Applicative)instance, LimitCountLootFunction::new));
    final private BoundedIntUnaryOperator limit;
