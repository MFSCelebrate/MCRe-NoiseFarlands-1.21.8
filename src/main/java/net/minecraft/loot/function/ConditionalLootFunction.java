...
implements LootFunction {
    final protected List<LootCondition> conditions;
    ...
    extends Builder<Joiner> {
        final private Function<List<LootCondition>, LootFunction> joiner;
        ...
        @Override
        protected Joiner net_minecraft_loot_function_ConditionalLootFunction$Joiner_getThisBuilder() {
            return this;
        }
        ...
        @Override
        protected Builder net_minecraft_loot_function_ConditionalLootFunction$Builder_getThisBuilder() {
            return this.net_minecraft_loot_function_ConditionalLootFunction$Joiner_getThisBuilder();
        }
    }
    ...
    LootConditionConsumingBuilder<T> {
        final private ImmutableList.Builder<LootCondition> conditionList = ImmutableList.builder();

        @Override
        public T conditionally(LootCondition.Builder builder) {
            this.conditionList.add((Object)builder.net_minecraft_loot_condition_LootCondition_build());
