...
extends ConditionalLootFunction {
    ...
    final static public MapCodec<FurnaceSmeltLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> FurnaceSmeltLootFunction.addConditionsField(instance).apply((Applicative)instance, FurnaceSmeltLootFunction::new));
    ...
    public ItemStack process(ItemStack stack, LootContext context) {
        ...
        Optional<RecipeEntry<SmeltingRecipe>> optional = context.getWorld().net_minecraft_recipe_ServerRecipeManager_getRecipeManager().getFirstMatch(RecipeType.SMELTING, singleStackRecipeInput, context.getWorld());
