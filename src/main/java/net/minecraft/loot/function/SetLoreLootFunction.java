...
extends ConditionalLootFunction {
    final static public MapCodec<SetLoreLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetLoreLootFunction.addConditionsField(instance).and(instance.group((App)TextCodecs.CODEC.sizeLimitedListOf(256).fieldOf("lore").forGetter(function -> function.lore), (App)ListOperation.createCodec(256).forGetter(function -> function.operation), (App)LootContext.EntityTarget.CODEC.optionalFieldOf("entity").forGetter(function -> function.entity))).apply((Applicative)instance, SetLoreLootFunction::new));
    final private List<Text> lore;
    final private ListOperation operation;
    final private Optional<LootContext.EntityTarget> entity;
    ...
    extends ConditionalLootFunction.Builder<Builder> {
        ...
        final private ImmutableList.Builder<Text> lore = ImmutableList.builder();
        ...
        @Override
        protected Builder net_minecraft_loot_function_SetLoreLootFunction$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected ConditionalLootFunction.Builder net_minecraft_loot_function_ConditionalLootFunction$Builder_getThisBuilder() {
            return this.net_minecraft_loot_function_SetLoreLootFunction$Builder_getThisBuilder();
        }
    }
}
