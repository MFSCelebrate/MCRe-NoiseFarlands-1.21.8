...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Builder<Builder> {
        final private BannerPatternsComponent.Builder patterns = new BannerPatternsComponent.Builder();
        final private boolean append;
        ...
        @Override
        protected Builder net_minecraft_loot_function_SetBannerPatternLootFunction$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected ConditionalLootFunction.Builder net_minecraft_loot_function_ConditionalLootFunction$Builder_getThisBuilder() {
            return this.net_minecraft_loot_function_SetBannerPatternLootFunction$Builder_getThisBuilder();
        }
    }
}
