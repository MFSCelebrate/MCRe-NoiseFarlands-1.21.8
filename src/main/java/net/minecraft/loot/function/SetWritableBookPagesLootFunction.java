...
extends ConditionalLootFunction {
    ...
    public WritableBookContentComponent apply(WritableBookContentComponent current) {
        ...
        return current.java_lang_Object_withPages((List)list);
    }
