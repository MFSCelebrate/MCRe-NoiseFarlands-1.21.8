...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Builder<Builder> {
        final private LootNbtProvider source;
        final private List<Operation> operations = Lists.newArrayList();
        ...
        @Override
        protected Builder net_minecraft_loot_function_CopyNbtLootFunction$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected ConditionalLootFunction.Builder net_minecraft_loot_function_ConditionalLootFunction$Builder_getThisBuilder() {
            return this.net_minecraft_loot_function_CopyNbtLootFunction$Builder_getThisBuilder();
        }
    }
    ...
    implements StringIdentifiable {
        final static public Operator REPLACE = new Operator("replace"){
        ...
        final static public Operator APPEND = new Operator("append"){
            ...
            public void merge(NbtElement itemNbt, NbtPathArgumentType.NbtPath targetPath, List<NbtElement> sourceNbts) throws CommandSyntaxException {
                ...
                list.forEach(foundNbt -> {
                    if (foundNbt instanceof NbtList) {
                        sourceNbts.forEach(sourceNbt -> ((NbtList)foundNbt).add(sourceNbt.net_minecraft_nbt_NbtElement_copy()));
                    }
                });
            }
        };
        final static public Operator MERGE = new Operator("merge"){
        ...
        final static public Codec<Operator> CODEC;
        final private String name;
        final static private Operator[] field_17036;
