...
extends ConditionalLootFunction {
    final static public MapCodec<SetCustomDataLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetCustomDataLootFunction.addConditionsField(instance).and((App)StringNbtReader.NBT_COMPOUND_CODEC.fieldOf("tag").forGetter(function -> function.nbt)).apply((Applicative)instance, SetCustomDataLootFunction::new));
