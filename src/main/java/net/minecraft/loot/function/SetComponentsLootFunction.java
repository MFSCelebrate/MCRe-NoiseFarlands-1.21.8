...
extends ConditionalLootFunction {
    final static public MapCodec<SetComponentsLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetComponentsLootFunction.addConditionsField(instance).and((App)ComponentChanges.CODEC.fieldOf("components").forGetter(function -> function.changes)).apply((Applicative)instance, SetComponentsLootFunction::new));
    final private ComponentChanges changes;
