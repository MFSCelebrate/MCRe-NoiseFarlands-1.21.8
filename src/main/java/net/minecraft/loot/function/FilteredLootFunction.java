...
extends ConditionalLootFunction {
    final static public MapCodec<FilteredLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> FilteredLootFunction.addConditionsField(instance).and(instance.group((App)ItemPredicate.CODEC.fieldOf("item_filter").forGetter(lootFunction -> lootFunction.itemFilter), (App)LootFunctionTypes.CODEC.fieldOf("modifier").forGetter(lootFunction -> lootFunction.modifier))).apply((Applicative)instance, FilteredLootFunction::new));
    final private ItemPredicate itemFilter;
    final private LootFunction modifier;
