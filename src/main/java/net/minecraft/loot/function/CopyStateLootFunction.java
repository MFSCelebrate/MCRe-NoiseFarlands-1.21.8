...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Builder<Builder> {
        final private RegistryEntry<Block> block;
        final private ImmutableSet.Builder<Property<?>> properties = ImmutableSet.builder();
        ...
        @Override
        protected Builder net_minecraft_loot_function_CopyStateLootFunction$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected ConditionalLootFunction.Builder net_minecraft_loot_function_ConditionalLootFunction$Builder_getThisBuilder() {
            return this.net_minecraft_loot_function_CopyStateLootFunction$Builder_getThisBuilder();
        }
    }
}
