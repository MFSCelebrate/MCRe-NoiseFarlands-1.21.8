...
extends ConditionalLootFunction {
    final static public MapCodec<SetPotionLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> SetPotionLootFunction.addConditionsField(instance).and((App)Potion.CODEC.fieldOf("id").forGetter(function -> function.potion)).apply((Applicative)instance, SetPotionLootFunction::new));
    final private RegistryEntry<Potion> potion;
