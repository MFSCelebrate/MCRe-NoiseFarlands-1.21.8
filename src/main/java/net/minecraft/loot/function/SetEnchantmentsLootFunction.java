...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Builder<Builder> {
        final private ImmutableMap.Builder<RegistryEntry<Enchantment>, LootNumberProvider> enchantments = ImmutableMap.builder();
        final private boolean add;
        ...
        @Override
        protected Builder net_minecraft_loot_function_SetEnchantmentsLootFunction$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected ConditionalLootFunction.Builder net_minecraft_loot_function_ConditionalLootFunction$Builder_getThisBuilder() {
            return this.net_minecraft_loot_function_SetEnchantmentsLootFunction$Builder_getThisBuilder();
        }
    }
}
