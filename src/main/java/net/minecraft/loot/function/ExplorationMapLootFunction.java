...
extends ConditionalLootFunction {
    ...
    extends ConditionalLootFunction.Builder<Builder> {
        ...
        @Override
        protected Builder net_minecraft_loot_function_ExplorationMapLootFunction$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected ConditionalLootFunction.Builder net_minecraft_loot_function_ConditionalLootFunction$Builder_getThisBuilder() {
            return this.net_minecraft_loot_function_ExplorationMapLootFunction$Builder_getThisBuilder();
        }
    }
}
