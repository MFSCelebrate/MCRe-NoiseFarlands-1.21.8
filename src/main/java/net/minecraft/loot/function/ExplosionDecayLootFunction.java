...
extends ConditionalLootFunction {
    final static public MapCodec<ExplosionDecayLootFunction> CODEC = RecordCodecBuilder.mapCodec(instance -> ExplosionDecayLootFunction.addConditionsField(instance).apply((Applicative)instance, ExplosionDecayLootFunction::new));
