...
extends ConditionalLootFunction {
    ...
    implements StringIdentifiable {
        final static public Target CUSTOM_NAME = new Target("custom_name");
        final static public Target ITEM_NAME = new Target("item_name");
        final static public Codec<Target> CODEC;
        final private String id;
        final static private Target[] field_50214;
