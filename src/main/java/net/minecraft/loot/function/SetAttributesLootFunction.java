...
extends ConditionalLootFunction {
    ...
    public static class AttributeBuilder {
        ...
        final private RegistryEntry<EntityAttribute> attribute;
        final private EntityAttributeModifier.Operation operation;
        final private LootNumberProvider amount;
        final private Set<AttributeModifierSlot> slots = EnumSet.noneOf(AttributeModifierSlot.class);
    ...
    extends ConditionalLootFunction.Builder<Builder> {
        final private boolean replace;
        final private List<Attribute> attributes = Lists.newArrayList();
        ...
        @Override
        protected Builder net_minecraft_loot_function_SetAttributesLootFunction$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected ConditionalLootFunction.Builder net_minecraft_loot_function_ConditionalLootFunction$Builder_getThisBuilder() {
            return this.net_minecraft_loot_function_SetAttributesLootFunction$Builder_getThisBuilder();
        }
    }
}
