...
public interface ContainerComponentModifiers {
    final static public ContainerComponentModifier<ContainerComponent> CONTAINER = new ContainerComponentModifier<ContainerComponent>(){
        ...
        @Override
        public ContainerComponent net_minecraft_component_type_ContainerComponent_getDefault() {
        ...
        @Override
        public Object java_lang_Object_getDefault() {
            return this.net_minecraft_component_type_ContainerComponent_getDefault();
        }
    };
    final static public ContainerComponentModifier<BundleContentsComponent> BUNDLE_CONTENTS = new ContainerComponentModifier<BundleContentsComponent>(){
        ...
        @Override
        public BundleContentsComponent net_minecraft_component_type_BundleContentsComponent_getDefault() {
        ...
        @Override
        public Object java_lang_Object_getDefault() {
            return this.net_minecraft_component_type_BundleContentsComponent_getDefault();
        }
    };
    final static public ContainerComponentModifier<ChargedProjectilesComponent> CHARGED_PROJECTILES = new ContainerComponentModifier<ChargedProjectilesComponent>(){
        ...
        @Override
        public ChargedProjectilesComponent net_minecraft_component_type_ChargedProjectilesComponent_getDefault() {
        ...
        @Override
        public Object java_lang_Object_getDefault() {
            return this.net_minecraft_component_type_ChargedProjectilesComponent_getDefault();
        }
    };
    final static public Map<ComponentType<?>, ContainerComponentModifier<?>> TYPE_TO_MODIFIER = Stream.of(CONTAINER, BUNDLE_CONTENTS, CHARGED_PROJECTILES).collect(Collectors.toMap(ContainerComponentModifier::getComponentType, containerComponentModifier -> containerComponentModifier));
    final static public Codec<ContainerComponentModifier<?>> MODIFIER_CODEC = Registries.DATA_COMPONENT_TYPE.getCodec().comapFlatMap(componentType -> {
