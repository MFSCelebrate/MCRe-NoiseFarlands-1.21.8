...
{
    final static public MapCodec<ContextLootScoreProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)LootContext.EntityTarget.CODEC.fieldOf("target").forGetter(ContextLootScoreProvider::target)).apply((Applicative)instance, ContextLootScoreProvider::new));
    final static public Codec<ContextLootScoreProvider> INLINE_CODEC = LootContext.EntityTarget.CODEC.xmap(ContextLootScoreProvider::new, ContextLootScoreProvider::target);
