...
{
    final static public MapCodec<FixedLootScoreProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.STRING.fieldOf("name").forGetter(FixedLootScoreProvider::name)).apply((Applicative)instance, FixedLootScoreProvider::new));
