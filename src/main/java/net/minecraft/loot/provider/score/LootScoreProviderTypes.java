...
public class LootScoreProviderTypes {
    final static private Codec<LootScoreProvider> BASE_CODEC = Registries.LOOT_SCORE_PROVIDER_TYPE.getCodec().dispatch(LootScoreProvider::getType, LootScoreProviderType::codec);
    final static public Codec<LootScoreProvider> CODEC = Codec.lazyInitialized(() -> Codec.either(ContextLootScoreProvider.INLINE_CODEC, BASE_CODEC).xmap(Either::unwrap, provider -> {
        Either either;
    ...
    final static public LootScoreProviderType FIXED = LootScoreProviderTypes.register("fixed", FixedLootScoreProvider.CODEC);
    final static public LootScoreProviderType CONTEXT = LootScoreProviderTypes.register("context", ContextLootScoreProvider.CODEC);
