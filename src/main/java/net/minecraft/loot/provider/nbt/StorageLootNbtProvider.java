...
{
    final static public MapCodec<StorageLootNbtProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Identifier.CODEC.fieldOf("source").forGetter(StorageLootNbtProvider::source)).apply((Applicative)instance, StorageLootNbtProvider::new));
