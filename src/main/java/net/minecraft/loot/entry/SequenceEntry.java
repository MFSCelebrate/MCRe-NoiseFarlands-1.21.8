...
extends CombinedEntry {
    final static public MapCodec<SequenceEntry> CODEC = SequenceEntry.createCodec(SequenceEntry::new);
    ...
    extends LootPoolEntry.Builder<Builder> {
        ...
        @Override
        protected Builder net_minecraft_loot_entry_SequenceEntry$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected LootPoolEntry.Builder net_minecraft_loot_entry_LootPoolEntry$Builder_getThisBuilder() {
            return this.net_minecraft_loot_entry_SequenceEntry$Builder_getThisBuilder();
        }
    }
}
