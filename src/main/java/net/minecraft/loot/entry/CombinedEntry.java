...
extends LootPoolEntry {
    final static public ErrorReporter.Error EMPTY_CHILDREN_LIST_ERROR = new ErrorReporter.Error(){
    ...
    final protected List<LootPoolEntry> children;
    final private EntryCombiner predicate;
