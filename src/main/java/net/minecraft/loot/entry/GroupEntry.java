...
extends CombinedEntry {
    final static public MapCodec<GroupEntry> CODEC = GroupEntry.createCodec(GroupEntry::new);
    ...
    extends LootPoolEntry.Builder<Builder> {
        ...
        @Override
        protected Builder net_minecraft_loot_entry_GroupEntry$Builder_getThisBuilder() {
            return this;
        }
        ...
        protected LootPoolEntry.Builder net_minecraft_loot_entry_LootPoolEntry$Builder_getThisBuilder() {
            return this.net_minecraft_loot_entry_GroupEntry$Builder_getThisBuilder();
        }
    }
}
