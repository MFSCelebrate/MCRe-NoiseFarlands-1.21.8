...
extends LeafEntry {
    final static public MapCodec<EmptyEntry> CODEC = RecordCodecBuilder.mapCodec(instance -> EmptyEntry.addLeafFields(instance).apply((Applicative)instance, EmptyEntry::new));
