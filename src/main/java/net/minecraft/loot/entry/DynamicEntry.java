...
extends LeafEntry {
    final static public MapCodec<DynamicEntry> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Identifier.CODEC.fieldOf("name").forGetter(entry -> entry.name)).and(DynamicEntry.addLeafFields(instance)).apply((Applicative)instance, DynamicEntry::new));
