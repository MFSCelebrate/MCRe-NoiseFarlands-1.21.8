...
extends LeafEntry {
    final static public MapCodec<LootTableEntry> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.either(LootTable.TABLE_KEY, LootTable.CODEC).fieldOf("value").forGetter(entry -> entry.value)).and(LootTableEntry.addLeafFields(instance)).apply((Applicative)instance, LootTableEntry::new));
    final static public ErrorReporter.Context INLINE_CONTEXT = new ErrorReporter.Context(){
    ...
    final private Either<RegistryKey<LootTable>, LootTable> value;
