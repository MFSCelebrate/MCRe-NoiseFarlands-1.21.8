...
{
    final static public MapCodec<EntityPropertiesLootCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)EntityPredicate.CODEC.optionalFieldOf("predicate").forGetter(EntityPropertiesLootCondition::predicate), (App)LootContext.EntityTarget.CODEC.fieldOf("entity").forGetter(EntityPropertiesLootCondition::entity)).apply((Applicative)instance, EntityPropertiesLootCondition::new));
