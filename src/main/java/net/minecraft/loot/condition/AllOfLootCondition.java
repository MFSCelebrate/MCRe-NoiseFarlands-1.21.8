...
extends AlternativeLootCondition {
    final static public MapCodec<AllOfLootCondition> CODEC = AllOfLootCondition.createCodec(AllOfLootCondition::new);
    final static public Codec<AllOfLootCondition> INLINE_CODEC = AllOfLootCondition.createInlineCodec(AllOfLootCondition::new);
