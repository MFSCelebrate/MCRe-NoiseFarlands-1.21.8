...
implements LootCondition {
    final static private KilledByPlayerLootCondition INSTANCE = new KilledByPlayerLootCondition();
    final static public MapCodec<KilledByPlayerLootCondition> CODEC = MapCodec.unit((Object)INSTANCE);
