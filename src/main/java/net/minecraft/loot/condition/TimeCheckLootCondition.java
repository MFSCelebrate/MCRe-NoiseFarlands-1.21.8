...
public record TimeCheckLootCondition(Optional<Long> period, BoundedIntUnaryOperator value) implements LootCondition
{
    ...
    implements LootCondition.Builder {
        ...
        final private BoundedIntUnaryOperator value;
        ...
        @Override
        public TimeCheckLootCondition net_minecraft_loot_condition_TimeCheckLootCondition_build() {
        ...
        public LootCondition net_minecraft_loot_condition_LootCondition_build() {
            return this.net_minecraft_loot_condition_TimeCheckLootCondition_build();
        }
    }
}
