...
implements LootCondition {
    final protected List<LootCondition> terms;
    ...
    implements LootCondition.Builder {
        final private ImmutableList.Builder<LootCondition> terms = ImmutableList.builder();

        protected Builder(LootCondition.Builder ... terms) {
            for (LootCondition.Builder builder : terms) {
                this.terms.add((Object)builder.net_minecraft_loot_condition_LootCondition_build());
            }
        }
