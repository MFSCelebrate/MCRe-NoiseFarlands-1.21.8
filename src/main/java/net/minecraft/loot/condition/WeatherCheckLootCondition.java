...
public record WeatherCheckLootCondition(Optional<Boolean> raining, Optional<Boolean> thundering) implements LootCondition
{
    ...
    implements LootCondition.Builder {
        ...
        @Override
        public WeatherCheckLootCondition net_minecraft_loot_condition_WeatherCheckLootCondition_build() {
        ...
        public LootCondition net_minecraft_loot_condition_LootCondition_build() {
            return this.net_minecraft_loot_condition_WeatherCheckLootCondition_build();
        }
    }
}
