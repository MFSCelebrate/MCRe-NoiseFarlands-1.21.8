...
implements LootCondition {
    final static private SurvivesExplosionLootCondition INSTANCE = new SurvivesExplosionLootCondition();
    final static public MapCodec<SurvivesExplosionLootCondition> CODEC = MapCodec.unit((Object)INSTANCE);
