...
{
    final static public MapCodec<EnchantmentActiveCheckLootCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.BOOL.fieldOf("active").forGetter(EnchantmentActiveCheckLootCondition::active)).apply((Applicative)instance, EnchantmentActiveCheckLootCondition::new));
