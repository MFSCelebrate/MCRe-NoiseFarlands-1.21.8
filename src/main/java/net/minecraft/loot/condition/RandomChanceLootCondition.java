...
{
    final static public MapCodec<RandomChanceLootCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)LootNumberProviderTypes.CODEC.fieldOf("chance").forGetter(RandomChanceLootCondition::chance)).apply((Applicative)instance, RandomChanceLootCondition::new));
