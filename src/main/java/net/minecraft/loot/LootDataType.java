...
public record LootDataType<T>(RegistryKey<Registry<T>> registryKey, Codec<T> codec, Validator<T> validator) {
    final static public LootDataType<LootCondition> PREDICATES = new LootDataType<LootCondition>(RegistryKeys.PREDICATE, LootCondition.CODEC, LootDataType.simpleValidator());
    final static public LootDataType<LootFunction> ITEM_MODIFIERS = new LootDataType<LootFunction>(RegistryKeys.ITEM_MODIFIER, LootFunctionTypes.CODEC, LootDataType.simpleValidator());
    final static public LootDataType<LootTable> LOOT_TABLES = new LootDataType<LootTable>(RegistryKeys.LOOT_TABLE, LootTable.CODEC, LootDataType.tableValidator());
