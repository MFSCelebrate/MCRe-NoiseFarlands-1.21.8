...
class Scores {
    final private Reference2ObjectOpenHashMap<ScoreboardObjective, ScoreboardScore> scores = new Reference2ObjectOpenHashMap(16, 0.5f);
    ...
    private static void method_55392(Object2IntMap object2IntMap, ScoreboardObjective objective, ScoreboardScore score) {
