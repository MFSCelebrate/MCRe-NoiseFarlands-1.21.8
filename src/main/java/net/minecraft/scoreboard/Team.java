...
extends AbstractTeam {
    final static private int field_31884 = 0;
    final static private int field_31885 = 1;
    final private Scoreboard scoreboard;
    final private String name;
    final private Set<String> playerList = Sets.newHashSet();
