...
implements VertexConsumerProvider {
    final private VertexConsumerProvider.Immediate parent;
    final private VertexConsumerProvider.Immediate plainDrawer = VertexConsumerProvider.immediate(new BufferAllocator(1536));
    private int red = 255;
