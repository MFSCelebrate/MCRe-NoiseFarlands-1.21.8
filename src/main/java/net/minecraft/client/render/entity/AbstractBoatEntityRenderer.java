...
extends EntityRenderer<AbstractBoatEntity, BoatEntityRenderState> {
    ...
    public void render(BoatEntityRenderState boatEntityRenderState, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        entityModel.render(matrixStack, vertexConsumer, 1, OverlayTexture.DEFAULT_UV);
        this.renderWaterMask(boatEntityRenderState, matrixStack, vertexConsumerProvider, 1);
        matrixStack.pop();
        super.render(boatEntityRenderState, matrixStack, vertexConsumerProvider, 1);
    }
    ...
    @Override
    public BoatEntityRenderState net_minecraft_client_render_entity_state_BoatEntityRenderState_createRenderState() {
    ...
    @Override
    public EntityRenderState net_minecraft_client_render_entity_state_BoatEntityRenderState_createRenderState() {
        return this.net_minecraft_client_render_entity_state_BoatEntityRenderState_createRenderState();
    }
}
