...
extends EntityRenderer<PaintingEntity, PaintingEntityRenderState> {
    ...
    public void render(PaintingEntityRenderState paintingEntityRenderState, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        matrixStack.pop();
        super.render(paintingEntityRenderState, matrixStack, vertexConsumerProvider, 1);
    }

    @Override
    public PaintingEntityRenderState net_minecraft_client_render_entity_state_PaintingEntityRenderState_createRenderState() {
    ...
    public void updateRenderState(PaintingEntity paintingEntity, PaintingEntityRenderState paintingEntityRenderState, float f) {
        ...
        World world = paintingEntity.net_minecraft_world_World_getWorld();
        for (int k = 0; k < j; ++k) {
            for (int l = 0; l < i; ++l) {
    ...
    public EntityRenderState net_minecraft_client_render_entity_state_EntityRenderState_createRenderState() {
        return this.net_minecraft_client_render_entity_state_PaintingEntityRenderState_createRenderState();
    }
}
