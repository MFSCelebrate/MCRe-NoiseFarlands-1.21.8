...
public class EntityRenderers {
    ...
    final static private Map<EntityType<?>, EntityRendererFactory<?>> RENDERER_FACTORIES = new Object2ObjectOpenHashMap();
    final static private Map<SkinTextures.Model, EntityRendererFactory<AbstractClientPlayerEntity>> PLAYER_RENDERER_FACTORIES = Map.of(SkinTextures.Model.WIDE, context -> new PlayerEntityRenderer(context, false), SkinTextures.Model.SLIM, context -> new PlayerEntityRenderer(context, true));
    ...
    public static Map<SkinTextures.Model, EntityRenderer<? extends PlayerEntity, ?>> reloadPlayerRenderers(EntityRendererFactory.Context ctx) {
        ...
        PLAYER_RENDERER_FACTORIES.forEach((model, factory) -> {
            try {
                builder.put((Object)model, factory.create(ctx));
            }
            catch (Exception exception) {
    ...
    static {
        EntityRenderers.register(EntityType.ACACIA_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.ACACIA_BOAT));
        EntityRenderers.register(EntityType.ACACIA_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.ACACIA_CHEST_BOAT));
        ...
        EntityRenderers.register(EntityType.BAMBOO_CHEST_RAFT, context -> new RaftEntityRenderer(context, EntityModelLayers.BAMBOO_CHEST_BOAT));
        EntityRenderers.register(EntityType.BAMBOO_RAFT, context -> new RaftEntityRenderer(context, EntityModelLayers.BAMBOO_BOAT));
        ...
        EntityRenderers.register(EntityType.BIRCH_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.BIRCH_BOAT));
        EntityRenderers.register(EntityType.BIRCH_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.BIRCH_CHEST_BOAT));
        ...
        EntityRenderers.register(EntityType.CAMEL, CamelEntityRenderer::new);
        ...
        EntityRenderers.register(EntityType.CHERRY_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.CHERRY_BOAT));
        EntityRenderers.register(EntityType.CHERRY_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.CHERRY_CHEST_BOAT));
        ...
        EntityRenderers.register(EntityType.CREAKING, CreakingEntityRenderer::new);
        EntityRenderers.register(EntityType.CREEPER, CreeperEntityRenderer::new);
        EntityRenderers.register(EntityType.DARK_OAK_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.DARK_OAK_BOAT));
        EntityRenderers.register(EntityType.DARK_OAK_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.DARK_OAK_CHEST_BOAT));
        EntityRenderers.register(EntityType.DOLPHIN, DolphinEntityRenderer::new);
        EntityRenderers.register(EntityType.DONKEY, context -> new AbstractDonkeyEntityRenderer(context, AbstractDonkeyEntityRenderer.Type.DONKEY));
        ...
        EntityRenderers.register(EntityType.HAPPY_GHAST, HappyGhastEntityRenderer::new);
        ...
        EntityRenderers.register(EntityType.GLOW_SQUID, context -> new GlowSquidEntityRenderer(context, new SquidEntityModel(context.getPart(EntityModelLayers.GLOW_SQUID)), new SquidEntityModel(context.getPart(EntityModelLayers.GLOW_SQUID_BABY))));
        ...
        EntityRenderers.register(EntityType.JUNGLE_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.JUNGLE_BOAT));
        EntityRenderers.register(EntityType.JUNGLE_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.JUNGLE_CHEST_BOAT));
        ...
        EntityRenderers.register(EntityType.LINGERING_POTION, FlyingItemEntityRenderer::new);
        EntityRenderers.register(EntityType.LLAMA, context -> new LlamaEntityRenderer(context, EntityModelLayers.LLAMA, EntityModelLayers.LLAMA_BABY));
        ...
        EntityRenderers.register(EntityType.MANGROVE_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.MANGROVE_BOAT));
        EntityRenderers.register(EntityType.MANGROVE_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.MANGROVE_CHEST_BOAT));
        ...
        EntityRenderers.register(EntityType.MULE, context -> new AbstractDonkeyEntityRenderer(context, AbstractDonkeyEntityRenderer.Type.MULE));
        EntityRenderers.register(EntityType.OAK_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.OAK_BOAT));
        EntityRenderers.register(EntityType.OAK_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.OAK_CHEST_BOAT));
        ...
        EntityRenderers.register(EntityType.PALE_OAK_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.PALE_OAK_BOAT));
        EntityRenderers.register(EntityType.PALE_OAK_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.PALE_OAK_CHEST_BOAT));
        ...
        EntityRenderers.register(EntityType.PIGLIN, context -> new PiglinEntityRenderer(context, EntityModelLayers.PIGLIN, EntityModelLayers.PIGLIN_BABY, EntityModelLayers.PIGLIN_INNER_ARMOR, EntityModelLayers.PIGLIN_OUTER_ARMOR, EntityModelLayers.PIGLIN_BABY_INNER_ARMOR, EntityModelLayers.PIGLIN_BABY_OUTER_ARMOR));
        EntityRenderers.register(EntityType.PIGLIN_BRUTE, context -> new PiglinEntityRenderer(context, EntityModelLayers.PIGLIN_BRUTE, EntityModelLayers.PIGLIN_BRUTE, EntityModelLayers.PIGLIN_BRUTE_INNER_ARMOR, EntityModelLayers.PIGLIN_BRUTE_OUTER_ARMOR, EntityModelLayers.PIGLIN_BRUTE_INNER_ARMOR, EntityModelLayers.PIGLIN_BRUTE_OUTER_ARMOR));
        ...
        EntityRenderers.register(EntityType.SKELETON_HORSE, context -> new UndeadHorseEntityRenderer(context, UndeadHorseEntityRenderer.Type.SKELETON));
        ...
        EntityRenderers.register(EntityType.SPLASH_POTION, FlyingItemEntityRenderer::new);
        EntityRenderers.register(EntityType.SPRUCE_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.SPRUCE_BOAT));
        EntityRenderers.register(EntityType.SPRUCE_CHEST_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.SPRUCE_CHEST_BOAT));
        EntityRenderers.register(EntityType.SQUID, context -> new SquidEntityRenderer(context, new SquidEntityModel(context.getPart(EntityModelLayers.SQUID)), new SquidEntityModel(context.getPart(EntityModelLayers.SQUID_BABY))));
        ...
        EntityRenderers.register(EntityType.TRADER_LLAMA, context -> new LlamaEntityRenderer(context, EntityModelLayers.TRADER_LLAMA, EntityModelLayers.TRADER_LLAMA_BABY));
