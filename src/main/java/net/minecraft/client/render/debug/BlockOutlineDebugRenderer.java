...
implements DebugRenderer.Renderer {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
        ...
        World blockView = this.client.player.net_minecraft_world_World_getWorld();
        BlockPos blockPos = BlockPos.ofFloored(cameraX, cameraY, cameraZ);
        for (BlockPos blockPos2 : BlockPos.iterate(blockPos.net_minecraft_util_math_BlockPos_add(-6, -6, -6), blockPos.net_minecraft_util_math_BlockPos_add(6, 6, 6))) {
