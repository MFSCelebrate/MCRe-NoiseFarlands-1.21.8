...
implements DebugRenderer.Renderer {
    ...
    final static private boolean field_32874 = true;
    final static private boolean field_32875 = false;
    final static private boolean field_32876 = false;
    final static private boolean field_32877 = false;
    final static private boolean field_32878 = false;
    final static private boolean field_32879 = false;
    final static private boolean field_32880 = false;
    final static private boolean field_32881 = false;
    final static private boolean field_32882 = true;
    final static private boolean field_38346 = false;
    final static private boolean field_32883 = true;
    final static private boolean field_32884 = true;
    final static private boolean field_32885 = true;
    final static private boolean field_32886 = true;
    final static private boolean field_32887 = true;
    final static private boolean field_32888 = true;
    final static private boolean field_32889 = true;
    final static private boolean field_32890 = true;
    final static private boolean field_32891 = true;
    final static private boolean field_32892 = true;
    final static private boolean field_38347 = true;
    final static private boolean field_32893 = true;
    final static private int POI_RANGE = 30;
    final static private int BRAIN_RANGE = 30;
    final static private int TARGET_ENTITY_RANGE = 8;
    final static private float DEFAULT_DRAWN_STRING_SIZE = 0.02f;
    final static private int AQUA = -16711681;
    ...
    final private Map<BlockPos, PointOfInterest> pointsOfInterest = Maps.newHashMap();
    final private Map<UUID, DebugBrainCustomPayload.Brain> brains = Maps.newHashMap();
    @Nullable
    ...
    private void drawPointOfInterestInfo(MatrixStack matrices, VertexConsumerProvider vertexConsumers, PointOfInterest pointOfInterest) {
        ...
        if (set.size() < 4) {
            VillageDebugRenderer.drawString(matrices, vertexConsumers, "Owners: " + String.valueOf(set), pointOfInterest, 1, -256);
        } else {
            VillageDebugRenderer.drawString(matrices, vertexConsumers, set.size() + " ticket holders", pointOfInterest, 1, -256);
        }
        ++i;
        Set<String> set2 = this.getNamesOfJobSitePotentialOwners(pointOfInterest);
        if (set2.size() < 4) {
            VillageDebugRenderer.drawString(matrices, vertexConsumers, "Candidates: " + String.valueOf(set2), pointOfInterest, 1, -23296);
        } else {
            VillageDebugRenderer.drawString(matrices, vertexConsumers, set2.size() + " potential owners", pointOfInterest, 1, -23296);
        }
    ...
    private void drawBrain(MatrixStack matrices, VertexConsumerProvider vertexConsumers, DebugBrainCustomPayload.Brain brain, double cameraX, double cameraY, double cameraZ) {
        ...
        ++i;
        if (bl) {
            VillageDebugRenderer.drawString(matrices, vertexConsumers, brain.pos(), i, brain.profession() + " " + brain.experience() + " xp", -1, 0.02f);
            ++i;
        }
        if (bl) {
