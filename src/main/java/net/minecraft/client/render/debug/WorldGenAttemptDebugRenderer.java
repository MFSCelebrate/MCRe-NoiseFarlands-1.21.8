...
implements DebugRenderer.Renderer {
    final private List<BlockPos> positions = Lists.newArrayList();
    final private List<Float> sizes = Lists.newArrayList();
    final private List<Float> alphas = Lists.newArrayList();
    final private List<Float> reds = Lists.newArrayList();
    final private List<Float> greens = Lists.newArrayList();
    final private List<Float> blues = Lists.newArrayList();
