...
implements BlockEntityRenderer<T> {
    final static public Identifier SKY_TEXTURE = Identifier.ofVanilla("textures/environment/end_sky.png");
    final static public Identifier PORTAL_TEXTURE = Identifier.ofVanilla("textures/entity/end_portal.png");
