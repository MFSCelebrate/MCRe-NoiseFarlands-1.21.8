...
public class BlockEntityRendererFactories {
    final static private Map<BlockEntityType<?>, BlockEntityRendererFactory<?>> FACTORIES = Maps.newHashMap();
    ...
    static {
        ...
        BlockEntityRendererFactories.register(BlockEntityType.TEST_INSTANCE_BLOCK, TestInstanceBlockEntityRenderer::new);
