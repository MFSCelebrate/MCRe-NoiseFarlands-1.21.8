...
public class ChunkOcclusionDataBuilder {
    final static private int field_32833 = 4;
    final static private int field_32834 = 16;
    final static private int field_32835 = 15;
    final static private int field_32836 = 4096;
    final static private int field_32837 = 0;
    final static private int field_32838 = 4;
    final static private int field_32839 = 8;
    final static private int STEP_X = (int)Math.pow(16.0, 0.0);
    final static private int STEP_Z = (int)Math.pow(16.0, 1.0);
    final static private int STEP_Y = (int)Math.pow(16.0, 2.0);
    final static private int field_32840 = -1;
    final static private Direction[] DIRECTIONS = Direction.values();
    final private BitSet closed = new BitSet(4096);
    final static private int[] EDGE_POINTS = Util.make(new int[1352], edgePoints -> {
        boolean i = false;
        int j = 15;
        int k = 0;
        for (int l = 0; l < 16; ++l) {
    ...
    private Set<Direction> getOpenFaces(int pos) {
        ...
        while (!intPriorityQueue.isEmpty()) {
            ...
            this.addEdgeFaces(1, set);
            for (Direction direction : DIRECTIONS) {
                int j = this.offset(1, direction);
