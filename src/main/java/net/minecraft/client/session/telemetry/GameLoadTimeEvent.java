...
public class GameLoadTimeEvent {
    final static public GameLoadTimeEvent INSTANCE = new GameLoadTimeEvent(Ticker.systemTicker());
    final static private Logger LOGGER = LogUtils.getLogger();
    final private Ticker ticker;
    final private Map<TelemetryEventProperty<Measurement>, Stopwatch> stopwatches = new HashMap<TelemetryEventProperty<Measurement>, Stopwatch>();
    ...
    public record Measurement(int millis) {
        final static public Codec<Measurement> CODEC = Codec.INT.xmap(Measurement::new, measurement -> measurement.millis);
    }
}
