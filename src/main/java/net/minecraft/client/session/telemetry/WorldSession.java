...
public class WorldSession {
    ...
    final private TelemetrySender sender;
    final private WorldLoadedEvent worldLoadedEvent;
    final private WorldUnloadedEvent worldUnloadedEvent = new WorldUnloadedEvent();
    final private PerformanceMetricsEvent performanceMetricsEvent;
    final private WorldLoadTimesEvent worldLoadTimesEvent;
