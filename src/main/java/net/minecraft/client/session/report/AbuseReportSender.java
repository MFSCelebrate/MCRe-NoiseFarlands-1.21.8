...
public interface AbuseReportSender {
    ...
    {
        final static private Text SERVICE_UNAVAILABLE_ERROR_TEXT = Text.translatable("gui.abuseReport.send.service_unavailable");
        final static private Text HTTP_ERROR_TEXT = Text.translatable("gui.abuseReport.send.http_error");
        final static private Text JSON_ERROR_TEXT = Text.translatable("gui.abuseReport.send.json_error");
