...
extends Thread {
    final static private AtomicInteger THREAD_ID = new AtomicInteger(0);
    final static private Logger LOGGER = LogUtils.getLogger();
    final static public String PING_ADDRESS = "224.0.2.60";
    final static public int PING_PORT = 4445;
    final static private long PING_INTERVAL = 1500L;
    final private String motd;
    final private DatagramSocket socket;
    private boolean running = true;
    final private String addressPort;
