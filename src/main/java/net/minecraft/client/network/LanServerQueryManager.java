...
public class LanServerQueryManager {
    final static AtomicInteger THREAD_ID = new AtomicInteger(0);
    final static Logger LOGGER = LogUtils.getLogger();

    @Environment(value=EnvType.CLIENT)
    public static class LanServerDetector
    extends Thread {
        final private LanServerEntryList entryList;
    ...
    public static class LanServerEntryList {
        final private List<LanServerInfo> serverEntries = Lists.newArrayList();
