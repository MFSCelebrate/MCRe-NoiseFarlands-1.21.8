...
public class ClientAdvancementManager {
    ...
    final private WorldSession worldSession;
    final private AdvancementManager manager = new AdvancementManager();
    final private Map<AdvancementEntry, AdvancementProgress> advancementProgresses = new Object2ObjectOpenHashMap();
    @Nullable
