...
extends SpriteBillboardParticle {
    final static private int MIN_COLOR = 11993298;
    final static private int MAX_COLOR = 14614777;
    final static private float MIN_RED = 0.7176471f;
    final static private float MIN_GREEN = 0.0f;
    final static private float MIN_BLUE = 0.8235294f;
    final static private float MAX_RED = 0.8745098f;
    final static private float MAX_GREEN = 0.0f;
    final static private float MAX_BLUE = 0.9764706f;
