...
public class FireworksSparkParticle {
    ...
    extends NoRenderParticle {
        final static private double[][] CREEPER_PATTERN = new double[][]{{0.0, 0.2}, {0.2, 0.2}, {0.2, 0.6}, {0.6, 0.6}, {0.6, 0.2}, {0.2, 0.2}, {0.2, 0.0}, {0.4, 0.0}, {0.4, -0.6}, {0.2, -0.6}, {0.2, -0.4}, {0.0, -0.4}};
        final static private double[][] STAR_PATTERN = new double[][]{{0.0, 1.0}, {0.3455, 0.309}, {0.9511, 0.309}, {0.3795918367346939, -0.12653061224489795}, {0.6122448979591837, -0.8040816326530612}, {0.0, -0.35918367346938773}};
        private int age;
        final private ParticleManager particleManager;
        final private List<FireworkExplosionComponent> explosions;
        private boolean flicker;
