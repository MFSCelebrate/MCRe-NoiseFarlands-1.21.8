...
implements SoundInstanceListener {
    final static private long REMOVE_DELAY = 3000L;
    final private MinecraftClient client;
    final private List<SubtitleEntry> entries = Lists.newArrayList();
    private boolean enabled;
    final private List<SubtitleEntry> audibleEntries = new ArrayList<SubtitleEntry>();
    ...
    static class SubtitleEntry {
        ...
        final private List<SoundEntry> sounds = new ArrayList<SoundEntry>();
