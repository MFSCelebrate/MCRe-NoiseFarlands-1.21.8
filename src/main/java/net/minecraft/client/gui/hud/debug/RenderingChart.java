...
extends DebugChart {
    final static private int field_45929 = 30;
    final static private double field_45930 = 33.333333333333336;
    ...
    protected void renderThresholds(DrawContext context, int x, int width, int height) {
        ...
        context.drawHorizontalLine(x, x + width - 1, height - 30, Colors.WHITE);
