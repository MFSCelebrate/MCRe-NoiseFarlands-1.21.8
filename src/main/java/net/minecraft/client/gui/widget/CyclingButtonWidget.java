...
extends PressableWidget {
    final static public BooleanSupplier HAS_ALT_DOWN = Screen::hasAltDown;
    final static private List<Boolean> BOOLEAN_VALUES = ImmutableList.of((Object)Boolean.TRUE, (Object)Boolean.FALSE);
    final private Text optionText;
    private int index;
    private T value;
    final private Values<T> values;
    final private Function<T, Text> valueToText;
    final private Function<CyclingButtonWidget<T>, MutableText> narrationMessageFactory;
    final private UpdateCallback<T> callback;
    final private boolean optionTextOmitted;
    final private SimpleOption.TooltipFactory<T> tooltipFactory;
    ...
    public static interface Values<T> {
        ...
        public static <T> Values<T> of(final BooleanSupplier alternativeToggle, List<T> defaults, List<T> alternatives) {
            ...
            return new Values<T>((List)list2, (List)list){
                final List field_27981;
                final List field_27982;
                {
    ...
    public static class Builder<T> {
        ...
        public Builder<T> optionTextOmitted(boolean optionTextOmitted) {
            this.optionTextOmitted = optionTextOmitted;
            return this;
        }
