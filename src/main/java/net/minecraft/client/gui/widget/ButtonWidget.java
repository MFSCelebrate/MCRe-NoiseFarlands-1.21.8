...
extends PressableWidget {
    final static public int DEFAULT_WIDTH_SMALL = 120;
    final static public int DEFAULT_WIDTH = 150;
    final static public int field_49479 = 200;
    final static public int DEFAULT_HEIGHT = 20;
    final static public int field_46856 = 8;
    final static protected NarrationSupplier DEFAULT_NARRATION_SUPPLIER = textSupplier -> (MutableText)textSupplier.get();
    final protected PressAction onPress;
    final protected NarrationSupplier narrationSupplier;
    ...
    public static class Builder {
        ...
        final private PressAction onPress;
        @Nullable
