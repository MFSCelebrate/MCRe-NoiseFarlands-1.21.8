...
extends ButtonWidget {
    final protected Identifier texture;
    final protected int textureWidth;
    final protected int textureHeight;
    ...
    public static class Builder {
        ...
        final private ButtonWidget.PressAction onPress;
        final private boolean hideText;
    ...
    extends TextIconButtonWidget {
        ...
        public void drawMessage(DrawContext context, TextRenderer textRenderer, int color) {
            ...
            WithText.drawScrollableText(context, textRenderer, this.getMessage(), k, 1, this.getY(), j, this.getY() + this.getHeight(), color);
        }
    }
