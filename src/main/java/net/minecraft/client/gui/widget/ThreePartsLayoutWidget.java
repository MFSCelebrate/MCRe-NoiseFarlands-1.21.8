...
implements LayoutWidget {
    final static public int DEFAULT_HEADER_FOOTER_HEIGHT = 33;
    final static private int FOOTER_MARGIN_TOP = 30;
    final private SimplePositioningWidget header = new SimplePositioningWidget();
    final private SimplePositioningWidget footer = new SimplePositioningWidget();
    final private SimplePositioningWidget body = new SimplePositioningWidget();
    ...
    public ThreePartsLayoutWidget(Screen screen, int headerHeight, int footerHeight) {
        ...
        this.header.getMainPositioner().net_minecraft_client_gui_widget_Positioner_relative(0.5f, 0.5f);
        this.footer.getMainPositioner().net_minecraft_client_gui_widget_Positioner_relative(0.5f, 0.5f);
    }
