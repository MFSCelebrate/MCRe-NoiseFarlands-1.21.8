...
extends WrapperWidget {
    final private List<Widget> children = new ArrayList<Widget>();
    final private List<Element> grids = new ArrayList<Element>();
    ...
    public final class Adder {
        ...
        public <T extends Widget> T add(T widget, int occupiedColumns, Positioner positioner) {
            ...
            return GridWidget.this.add(widget, 1, j, 1, occupiedColumns, positioner);
        }
