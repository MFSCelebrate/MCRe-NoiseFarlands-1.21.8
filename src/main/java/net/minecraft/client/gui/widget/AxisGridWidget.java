...
extends WrapperWidget {
    final private DisplayAxis axis;
    final private List<Element> elements = new ArrayList<Element>();
    final private Positioner mainPositioner = Positioner.create();
    ...
    public Positioner copyPositioner() {
        return this.mainPositioner.net_minecraft_client_gui_widget_Positioner_copy();
    }
    ...
    extends Enum<DisplayAxis> {
        final static public DisplayAxis HORIZONTAL = new DisplayAxis();
        final static public DisplayAxis VERTICAL = new DisplayAxis();
        final static private DisplayAxis[] field_40791;
