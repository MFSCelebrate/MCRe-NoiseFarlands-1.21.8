...
extends Enum<NavigationAxis> {
    final static public NavigationAxis HORIZONTAL = new NavigationAxis();
    final static public NavigationAxis VERTICAL = new NavigationAxis();
    final static private NavigationAxis[] field_41824;
