...
public interface GuiNavigationPath {
    ...
    public Element net_minecraft_client_gui_Element_component();
    ...
    implements GuiNavigationPath {
        final private ParentElement component;
        final private GuiNavigationPath childPath;
        ...
        public void setFocused(boolean focused) {
            if (!focused) {
                ...
                this.component.setFocused(this.childPath.net_minecraft_client_gui_Element_component());
            }
        ...
        @Override
        public ParentElement net_minecraft_client_gui_ParentElement_component() {
        ...
        @Override
        public Element net_minecraft_client_gui_Element_component() {
            return this.net_minecraft_client_gui_ParentElement_component();
        }
    }
}
