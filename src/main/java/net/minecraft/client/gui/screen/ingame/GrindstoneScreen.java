...
extends HandledScreen<GrindstoneScreenHandler> {
    final static private Identifier ERROR_TEXTURE = Identifier.ofVanilla("container/grindstone/error");
    final static private Identifier TEXTURE = Identifier.ofVanilla("textures/gui/container/grindstone.png");
