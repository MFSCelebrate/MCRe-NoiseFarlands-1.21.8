...
extends HandledScreen<StonecutterScreenHandler> {
    final static private Identifier SCROLLER_TEXTURE = Identifier.ofVanilla("container/stonecutter/scroller");
    final static private Identifier SCROLLER_DISABLED_TEXTURE = Identifier.ofVanilla("container/stonecutter/scroller_disabled");
    final static private Identifier RECIPE_SELECTED_TEXTURE = Identifier.ofVanilla("container/stonecutter/recipe_selected");
    final static private Identifier RECIPE_HIGHLIGHTED_TEXTURE = Identifier.ofVanilla("container/stonecutter/recipe_highlighted");
    final static private Identifier RECIPE_TEXTURE = Identifier.ofVanilla("container/stonecutter/recipe");
    final static private Identifier TEXTURE = Identifier.ofVanilla("textures/gui/container/stonecutter.png");
    final static private int SCROLLBAR_WIDTH = 12;
    final static private int SCROLLBAR_HEIGHT = 15;
    final static private int RECIPE_LIST_COLUMNS = 4;
    final static private int RECIPE_LIST_ROWS = 3;
    final static private int RECIPE_ENTRY_WIDTH = 16;
    final static private int RECIPE_ENTRY_HEIGHT = 18;
    final static private int SCROLLBAR_AREA_HEIGHT = 54;
    final static private int RECIPE_LIST_OFFSET_X = 52;
    final static private int RECIPE_LIST_OFFSET_Y = 14;
