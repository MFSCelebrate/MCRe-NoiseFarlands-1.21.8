...
extends GameOptionsScreen {
    final static private Text LANGUAGE_WARNING_TEXT = Text.translatable("options.languageAccuracyWarning").withColor(Colors.ALTERNATE_WHITE);
    final static private int field_49497 = 53;
    ...
    extends AlwaysSelectedEntryListWidget<LanguageEntry> {
        ...
        extends AlwaysSelectedEntryListWidget.Entry<LanguageEntry> {
            ...
            final private Text languageDefinition;
            ...
            public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickProgress) {
                context.drawCenteredTextWithShadow(LanguageOptionsScreen.this.textRenderer, this.languageDefinition, LanguageSelectionListWidget.this.width / 2, y + entryHeight / 2 - ((LanguageOptionsScreen)LanguageOptionsScreen.this).textRenderer.fontHeight / 2, Colors.WHITE);
            }
