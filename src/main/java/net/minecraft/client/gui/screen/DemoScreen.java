...
extends Screen {
    final static private Identifier DEMO_BG = Identifier.ofVanilla("textures/gui/demo_background.png");
    final static private int field_52797 = 256;
    final static private int field_52798 = 256;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        this.fullWrappedText.draw(context, i, j + 20, this.textRenderer.fontHeight, -14737633);
    }
}
