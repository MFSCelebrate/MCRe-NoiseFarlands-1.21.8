...
extends Screen {
    final static private Text ENTER_IP_TEXT = Text.translatable("addServer.enterIp");
    private ButtonWidget selectServerButton;
    final private ServerInfo serverEntry;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        context.drawTextWithShadow(this.textRenderer, ENTER_IP_TEXT, this.width / 2 - 100 + 1, 100, Colors.LIGHT_GRAY);
