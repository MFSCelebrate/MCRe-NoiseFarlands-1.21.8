...
implements ClientAdvancementManager.Listener {
    final static private Identifier WINDOW_TEXTURE = Identifier.ofVanilla("textures/gui/advancements/window.png");
    final static public int WINDOW_WIDTH = 252;
    final static public int WINDOW_HEIGHT = 140;
    final static private int PAGE_OFFSET_X = 9;
    final static private int PAGE_OFFSET_Y = 18;
    final static public int PAGE_WIDTH = 234;
    final static public int PAGE_HEIGHT = 113;
    final static private int TITLE_OFFSET_X = 8;
    final static private int TITLE_OFFSET_Y = 6;
    final static private int field_52799 = 256;
    final static private int field_52800 = 256;
    final static public int field_32302 = 16;
    final static public int field_32303 = 16;
    final static public int field_32304 = 14;
    final static public int field_32305 = 7;
    final static private double field_45431 = 16.0;
    final static private Text SAD_LABEL_TEXT = Text.translatable("advancements.sad_label");
    final static private Text EMPTY_TEXT = Text.translatable("advancements.empty");
    ...
    final private Map<AdvancementEntry, AdvancementTab> tabs = Maps.newLinkedHashMap();
    @Nullable
