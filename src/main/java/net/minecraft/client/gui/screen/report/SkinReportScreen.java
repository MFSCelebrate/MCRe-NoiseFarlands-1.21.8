...
extends ReportScreen<SkinAbuseReport.Builder> {
    final static private int SKIN_WIDGET_WIDTH = 85;
    final static private int REASON_BUTTON_AND_COMMENTS_BOX_WIDTH = 178;
    final static private Text TITLE_TEXT = Text.translatable("gui.abuseReport.skin.title");
    ...
    protected void addContent() {
        ...
        directionalLayoutWidget2.add(LayoutWidgets.createLabeledWidget(this.textRenderer, this.commentsBox, MORE_COMMENTS_TEXT, positioner -> positioner.net_minecraft_client_gui_widget_Positioner_marginBottom(12)));
    }
