...
extends Screen {
    final static private Text WORLD_TITLE = Text.translatable("symlink_warning.title.world").formatted(Formatting.BOLD);
    final static private Text WORLD_MESSAGE = Text.translatable("symlink_warning.message.world", Text.of(Urls.MINECRAFT_SYMLINKS));
    final static private Text PACK_TITLE = Text.translatable("symlink_warning.title.pack").formatted(Formatting.BOLD);
    final static private Text PACK_MESSAGE = Text.translatable("symlink_warning.message.pack", Text.of(Urls.MINECRAFT_SYMLINKS));
    final private Text message;
    final private URI link;
    final private Runnable onClose;
    final private GridWidget grid = new GridWidget().setRowSpacing(10);
