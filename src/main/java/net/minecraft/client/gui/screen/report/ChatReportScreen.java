...
extends ReportScreen<ChatAbuseReport.Builder> {
    final static private Text TITLE_TEXT = Text.translatable("gui.chatReport.title");
    final static private Text SELECT_CHAT_TEXT = Text.translatable("gui.chatReport.select_chat");
    ...
    protected void addContent() {
        ...
        this.layout.add(LayoutWidgets.createLabeledWidget(this.textRenderer, this.commentsBox, MORE_COMMENTS_TEXT, positioner -> positioner.net_minecraft_client_gui_widget_Positioner_marginBottom(12)));
    }
