...
extends Screen {
    final static private Text JOINT_LABEL_TEXT = Text.translatable("jigsaw_block.joint_label");
    final static private Text POOL_TEXT = Text.translatable("jigsaw_block.pool");
    final static private Text NAME_TEXT = Text.translatable("jigsaw_block.name");
    final static private Text TARGET_TEXT = Text.translatable("jigsaw_block.target");
    final static private Text FINAL_STATE_TEXT = Text.translatable("jigsaw_block.final_state");
    final static private Text PLACEMENT_PRIORITY_TEXT = Text.translatable("jigsaw_block.placement_priority");
    final static private Text PLACEMENT_PRIORITY_TOOLTIP = Text.translatable("jigsaw_block.placement_priority.tooltip");
    final static private Text SELECTION_PRIORITY_TEXT = Text.translatable("jigsaw_block.selection_priority");
    final static private Text SELECTION_PRIORITY_TOOLTIP = Text.translatable("jigsaw_block.selection_priority.tooltip");
    final private JigsawBlockEntity jigsaw;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        context.drawTextWithShadow(this.textRenderer, POOL_TEXT, this.width / 2 - 153, 10, Colors.LIGHT_GRAY);
        this.poolField.render(context, mouseX, mouseY, deltaTicks);
        context.drawTextWithShadow(this.textRenderer, NAME_TEXT, this.width / 2 - 153, 45, Colors.LIGHT_GRAY);
        this.nameField.render(context, mouseX, mouseY, deltaTicks);
        context.drawTextWithShadow(this.textRenderer, TARGET_TEXT, this.width / 2 - 153, 80, Colors.LIGHT_GRAY);
        this.targetField.render(context, mouseX, mouseY, deltaTicks);
        context.drawTextWithShadow(this.textRenderer, FINAL_STATE_TEXT, this.width / 2 - 153, 115, Colors.LIGHT_GRAY);
        this.finalStateField.render(context, mouseX, mouseY, deltaTicks);
        context.drawTextWithShadow(this.textRenderer, SELECTION_PRIORITY_TEXT, this.width / 2 - 153, 150, Colors.LIGHT_GRAY);
        this.placementPriorityField.render(context, mouseX, mouseY, deltaTicks);
        context.drawTextWithShadow(this.textRenderer, PLACEMENT_PRIORITY_TEXT, this.width / 2 - 50, 150, Colors.LIGHT_GRAY);
        ...
        if (JigsawBlock.getFacing(this.jigsaw.getCachedState()).getAxis().isVertical()) {
            context.drawTextWithShadow(this.textRenderer, JOINT_LABEL_TEXT, this.width / 2 + 53, 150, Colors.LIGHT_GRAY);
        }
    }
}
