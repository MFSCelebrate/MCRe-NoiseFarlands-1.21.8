...
extends Screen {
    final static private int field_49538 = 100;
    final private Text messageText;
    @Nullable
    final private Text checkMessage;
    final private Text narratedText;
    @Nullable
    protected CheckboxWidget checkbox;
    @Nullable
    private NarratedMultilineTextWidget textWidget;
    final private SimplePositioningWidget positioningWidget;
    ...
    protected void init() {
        ...
        this.textWidget = directionalLayoutWidget.add(new NarratedMultilineTextWidget(this.width - 100, this.messageText, this.textRenderer, 12), positioner -> positioner.net_minecraft_client_gui_widget_Positioner_margin(12));
