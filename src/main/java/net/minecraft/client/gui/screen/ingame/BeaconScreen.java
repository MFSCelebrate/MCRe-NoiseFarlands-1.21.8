...
extends HandledScreen<BeaconScreenHandler> {
    final static private Identifier TEXTURE = Identifier.ofVanilla("textures/gui/container/beacon.png");
    final static Identifier BUTTON_DISABLED_TEXTURE = Identifier.ofVanilla("container/beacon/button_disabled");
    final static Identifier BUTTON_SELECTED_TEXTURE = Identifier.ofVanilla("container/beacon/button_selected");
    final static Identifier BUTTON_HIGHLIGHTED_TEXTURE = Identifier.ofVanilla("container/beacon/button_highlighted");
    final static Identifier BUTTON_TEXTURE = Identifier.ofVanilla("container/beacon/button");
    final static Identifier CONFIRM_TEXTURE = Identifier.ofVanilla("container/beacon/confirm");
    final static Identifier CANCEL_TEXTURE = Identifier.ofVanilla("container/beacon/cancel");
    final static private Text PRIMARY_POWER_TEXT = Text.translatable("block.minecraft.beacon.primary");
    final static private Text SECONDARY_POWER_TEXT = Text.translatable("block.minecraft.beacon.secondary");
    final private List<BeaconButtonWidget> buttons = Lists.newArrayList();
    @Nullable
