...
extends Screen {
    final static private AtomicInteger CONNECTOR_THREADS_COUNT = new AtomicInteger(0);
    final static Logger LOGGER = LogUtils.getLogger();
    final static private long NARRATOR_INTERVAL = 2000L;
    final static public Text ABORTED_TEXT = Text.translatable("connect.aborted");
    final static public Text UNKNOWN_HOST_TEXT = Text.translatable("disconnect.genericReason", Text.translatable("disconnect.unknownHost"));
    @Nullable
            ...
            public void run() {
                ...
                try {
                    ...
                    synchronized (connectScreen) {
                        ...
                        client.getServerResourcePackProvider().init(clientConnection, _1.toAcceptanceStatus(info.getResourcePackPolicy()));
                    }
