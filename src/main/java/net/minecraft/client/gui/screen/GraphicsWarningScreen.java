...
extends Screen {
    final static private int BUTTON_PADDING = 20;
    final static private int BUTTON_MARGIN = 5;
    final static private int BUTTON_HEIGHT = 20;
    final private Text narrationMessage;
    final private List<Text> message;
    final private ImmutableList<ChoiceButton> choiceButtons;
