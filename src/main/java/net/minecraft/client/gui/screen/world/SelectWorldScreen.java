...
extends Screen {
    ...
    final static public GeneratorOptions DEBUG_GENERATOR_OPTIONS = new GeneratorOptions("test1".hashCode(), true, false);
    ...
    protected void init() {
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.translatable("selectWorld.create"), button -> CreateWorldScreen.show(this.client, this)).dimensions(this.width / 2 + 4, this.height - 52, 150, 20).build());
