...
extends HandledScreen<CrafterScreenHandler> {
    final static private Identifier DISABLED_SLOT_TEXTURE = Identifier.ofVanilla("container/crafter/disabled_slot");
    final static private Identifier POWERED_REDSTONE_TEXTURE = Identifier.ofVanilla("container/crafter/powered_redstone");
    final static private Identifier UNPOWERED_REDSTONE_TEXTURE = Identifier.ofVanilla("container/crafter/unpowered_redstone");
    final static private Identifier TEXTURE = Identifier.ofVanilla("textures/gui/container/crafter.png");
    final static private Text TOGGLEABLE_SLOT_TEXT = Text.translatable("gui.togglable_slot");
