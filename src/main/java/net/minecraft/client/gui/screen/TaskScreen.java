...
extends Screen {
    final static private int TITLE_TEXT_Y = 80;
    final static private int DESCRIPTION_TEXT_Y = 120;
    final static private int DESCRIPTION_TEXT_WIDTH = 360;
    @Nullable
    final private Text descriptionText;
    final private Text closeButtonText;
    final private Runnable closeCallback;
    @Nullable
