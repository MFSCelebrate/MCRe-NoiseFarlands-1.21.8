...
public class RecoverWorldScreen extends Screen {
    ...
    public RecoverWorldScreen(MinecraftClient client, BooleanConsumer callback, LevelStorage.Session session) {
        ...
        directionalLayoutWidget.add(ButtonWidget.builder(RecoverWorldScreen.RESTORE_TEXT, button -> this.method_54586(client, button)).size(120, 20).tooltip(bl ? null : Tooltip.of(RecoverWorldScreen.NO_FALLBACK_TEXT)).build()).active = bl;
    ...
    private void method_54586(MinecraftClient minecraftClient, ButtonWidget buttonWidget) {
