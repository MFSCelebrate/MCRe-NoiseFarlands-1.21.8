...
public class FishingHookRenderer extends EntityRenderer<FishingHook, FishingHookRenderState> {
   ...
   private static void vertex(final VertexConsumer builder, final Pose pose, final int lightCoords, final float x, final int y, final int u, final int v) {
