...
public class ItemRenderer {
   ...
   public static void renderItem(
      ...
      if (foilType == ItemStackRenderState.FoilType.SPECIAL) {
         Pose cameraPose = poseStack.last().copy();
   ...
   private static VertexConsumer getSpecialFoilBuffer(final MultiBufferSource bufferSource, final RenderType renderType, final Pose cameraPose) {
