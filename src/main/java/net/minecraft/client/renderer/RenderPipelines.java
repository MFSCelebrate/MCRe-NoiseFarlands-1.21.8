...
public class RenderPipelines {
   ...
   private static final Snippet MATRICES_PROJECTION_SNIPPET = RenderPipeline.builder(new Snippet[0])
      ...
      .buildSnippet();
   private static final Snippet FOG_SNIPPET = RenderPipeline.builder(new Snippet[0]).withUniform("Fog", UniformType.UNIFORM_BUFFER).buildSnippet();
   private static final Snippet GLOBALS_SNIPPET = RenderPipeline.builder(new Snippet[0]).withUniform("Globals", UniformType.UNIFORM_BUFFER).buildSnippet();
   private static final Snippet MATRICES_FOG_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET, FOG_SNIPPET}).buildSnippet();
   private static final Snippet MATRICES_FOG_LIGHT_DIR_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET, FOG_SNIPPET})
      .withUniform("Lighting", UniformType.UNIFORM_BUFFER)
      .buildSnippet();
   private static final Snippet GENERIC_BLOCKS_SNIPPET = RenderPipeline.builder(new Snippet[]{FOG_SNIPPET})
      .withSampler("Sampler0")
      .withSampler("Sampler2")
      .withVertexFormat(DefaultVertexFormat.BLOCK, Mode.QUADS)
      .buildSnippet();
   private static final Snippet TERRAIN_SNIPPET = RenderPipeline.builder(new Snippet[]{GENERIC_BLOCKS_SNIPPET})
      .withUniform("Projection", UniformType.UNIFORM_BUFFER)
      .withUniform("ChunkSection", UniformType.UNIFORM_BUFFER)
      .withVertexShader("core/terrain")
      .withFragmentShader("core/terrain")
      .buildSnippet();
   private static final Snippet BLOCK_SNIPPET = RenderPipeline.builder(new Snippet[]{GENERIC_BLOCKS_SNIPPET, MATRICES_PROJECTION_SNIPPET})
      .withVertexShader("core/block")
      .withFragmentShader("core/block")
      .buildSnippet();
   private static final Snippet ENTITY_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_FOG_LIGHT_DIR_SNIPPET})
      ...
      .buildSnippet();
   private static final Snippet ENTITY_EMISSIVE_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_FOG_LIGHT_DIR_SNIPPET})
      .withVertexShader("core/entity")
      .withFragmentShader("core/entity")
      .withSampler("Sampler0")
      .withVertexFormat(DefaultVertexFormat.NEW_ENTITY, Mode.QUADS)
      ...
      .buildSnippet();
   private static final Snippet BEACON_BEAM_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_FOG_SNIPPET})
      .withVertexShader("core/rendertype_beacon_beam")
      .withFragmentShader("core/rendertype_beacon_beam")
      .withSampler("Sampler0")
      .withVertexFormat(DefaultVertexFormat.BLOCK, Mode.QUADS)
      .buildSnippet();
   private static final Snippet TEXT_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET})
      .withBlend(BlendFunction.TRANSLUCENT)
      .withVertexFormat(DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, Mode.QUADS)
      .buildSnippet();
   private static final Snippet END_PORTAL_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET, FOG_SNIPPET, GLOBALS_SNIPPET})
      ...
      .buildSnippet();
   private static final Snippet CLOUDS_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_FOG_SNIPPET})
      .withVertexShader("core/rendertype_clouds")
      .withFragmentShader("core/rendertype_clouds")
      .withBlend(BlendFunction.TRANSLUCENT)
      .withVertexFormat(DefaultVertexFormat.EMPTY, Mode.QUADS)
      .withUniform("CloudInfo", UniformType.UNIFORM_BUFFER)
      .withUniform("CloudFaces", UniformType.TEXEL_BUFFER, TextureFormat.RED8I)
      .buildSnippet();
   private static final Snippet LINES_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_FOG_SNIPPET, GLOBALS_SNIPPET})
      ...
      .buildSnippet();
   private static final Snippet DEBUG_FILLED_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET})
      ...
      .buildSnippet();
   private static final Snippet PARTICLE_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_FOG_SNIPPET})
      .withVertexShader("core/particle")
      .withFragmentShader("core/particle")
      .withSampler("Sampler0")
      .withSampler("Sampler2")
      .withVertexFormat(DefaultVertexFormat.PARTICLE, Mode.QUADS)
      .buildSnippet();
   private static final Snippet WEATHER_SNIPPET = RenderPipeline.builder(new Snippet[]{PARTICLE_SNIPPET})
      .withBlend(BlendFunction.TRANSLUCENT)
      .withCull(false)
      .buildSnippet();
   private static final Snippet GUI_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET})
      ...
      .buildSnippet();
   private static final Snippet GUI_TEXTURED_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET})
      ...
      .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
      .buildSnippet();
   private static final Snippet GUI_TEXT_SNIPPET = RenderPipeline.builder(new Snippet[]{TEXT_SNIPPET})
      .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
      .buildSnippet();
   private static final Snippet OUTLINE_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET})
      ...
      .withVertexFormat(DefaultVertexFormat.POSITION_TEX_COLOR, Mode.QUADS)
      .buildSnippet();
   public static final Snippet POST_PROCESSING_SNIPPET = RenderPipeline.builder(new Snippet[0])
      .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
      .withDepthWrite(false)
      .withVertexFormat(DefaultVertexFormat.EMPTY, Mode.TRIANGLES)
      .buildSnippet();
   public static final RenderPipeline SOLID_BLOCK = register(RenderPipeline.builder(new Snippet[]{BLOCK_SNIPPET}).withLocation("pipeline/solid_block").build());
   public static final RenderPipeline SOLID_TERRAIN = register(
      RenderPipeline.builder(new Snippet[]{TERRAIN_SNIPPET}).withLocation("pipeline/solid_terrain").build()
   );
   public static final RenderPipeline WIREFRAME = register(
      RenderPipeline.builder(new Snippet[]{TERRAIN_SNIPPET}).withLocation("pipeline/wireframe").withPolygonMode(PolygonMode.WIREFRAME).build()
   );
   public static final RenderPipeline CUTOUT_BLOCK = register(
      RenderPipeline.builder(new Snippet[]{BLOCK_SNIPPET}).withLocation("pipeline/cutout_block").withShaderDefine("ALPHA_CUTOUT", 0.5F).build()
   );
   public static final RenderPipeline CUTOUT_TERRAIN = register(
      RenderPipeline.builder(new Snippet[]{TERRAIN_SNIPPET}).withLocation("pipeline/cutout_terrain").withShaderDefine("ALPHA_CUTOUT", 0.5F).build()
   );
   ...
   public static final RenderPipeline TRIPWIRE_BLOCK = register(
      RenderPipeline.builder(new Snippet[]{BLOCK_SNIPPET})
   ...
   public static final RenderPipeline TRANSLUCENT_MOVING_BLOCK = register(
      RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET})
   ...
   public static final RenderPipeline ARMOR_CUTOUT_NO_CULL = register(
      RenderPipeline.builder(new Snippet[]{ENTITY_SNIPPET})
   ...
   public static final RenderPipeline ENTITY_SOLID = register(
      RenderPipeline.builder(new Snippet[]{ENTITY_SNIPPET}).withLocation("pipeline/entity_solid").withSampler("Sampler1").build()
   );
   public static final RenderPipeline ENTITY_SOLID_Z_OFFSET_FORWARD = register(
      RenderPipeline.builder(new Snippet[]{ENTITY_SNIPPET}).withLocation("pipeline/entity_solid_offset_forward").withSampler("Sampler1").build()
   );
   ...
   public static final RenderPipeline ENTITY_TRANSLUCENT_EMISSIVE = register(
      RenderPipeline.builder(new Snippet[]{ENTITY_EMISSIVE_SNIPPET})
   ...
   public static final RenderPipeline ENERGY_SWIRL = register(
      RenderPipeline.builder(new Snippet[]{MATRICES_FOG_SNIPPET})
   ...
   public static final RenderPipeline ENTITY_DECAL = register(
      RenderPipeline.builder(new Snippet[]{MATRICES_FOG_LIGHT_DIR_SNIPPET})
   ...
   public static final RenderPipeline BEACON_BEAM_OPAQUE = register(
      RenderPipeline.builder(new Snippet[]{BEACON_BEAM_SNIPPET}).withLocation("pipeline/beacon_beam_opaque").build()
   );
   public static final RenderPipeline BEACON_BEAM_TRANSLUCENT = register(
      RenderPipeline.builder(new Snippet[]{BEACON_BEAM_SNIPPET})
   ...
   public static final RenderPipeline LEASH = register(
      RenderPipeline.builder(new Snippet[]{MATRICES_FOG_SNIPPET})
         ...
         .withSampler("Sampler2")
         .withCull(false)
         .withVertexFormat(DefaultVertexFormat.POSITION_COLOR_LIGHTMAP, Mode.TRIANGLE_STRIP)
         .build()
   );
   ...
   public static final RenderPipeline GLINT = register(
      RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET, FOG_SNIPPET, GLOBALS_SNIPPET})
   ...
   public static final RenderPipeline TEXT = register(
      RenderPipeline.builder(new Snippet[]{TEXT_SNIPPET, FOG_SNIPPET})
   ...
   public static final RenderPipeline GUI_TEXT = register(
      RenderPipeline.builder(new Snippet[]{GUI_TEXT_SNIPPET, FOG_SNIPPET})
   ...
   public static final RenderPipeline TEXT_BACKGROUND = register(
      RenderPipeline.builder(new Snippet[]{TEXT_SNIPPET, FOG_SNIPPET})
         ...
         .withSampler("Sampler2")
         .withVertexFormat(DefaultVertexFormat.POSITION_COLOR_LIGHTMAP, Mode.QUADS)
         .build()
   );
   ...
   public static final RenderPipeline TEXT_SEE_THROUGH = register(
      RenderPipeline.builder(new Snippet[]{TEXT_SNIPPET})
   ...
   public static final RenderPipeline DRAGON_RAYS_DEPTH = register(
      RenderPipeline.builder(new Snippet[]{MATRICES_FOG_SNIPPET})
         ...
         .withColorWrite(false)
         .withVertexFormat(DefaultVertexFormat.POSITION, Mode.TRIANGLES)
         .build()
   );
   public static final RenderPipeline END_PORTAL = register(
      RenderPipeline.builder(new Snippet[]{END_PORTAL_SNIPPET}).withLocation("pipeline/end_portal").withShaderDefine("PORTAL_LAYERS", 15).build()
   );
   public static final RenderPipeline END_GATEWAY = register(
      RenderPipeline.builder(new Snippet[]{END_PORTAL_SNIPPET}).withLocation("pipeline/end_gateway").withShaderDefine("PORTAL_LAYERS", 16).build()
   );
   public static final RenderPipeline FLAT_CLOUDS = register(
      RenderPipeline.builder(new Snippet[]{CLOUDS_SNIPPET}).withLocation("pipeline/flat_clouds").withCull(false).build()
   );
   public static final RenderPipeline CLOUDS = register(RenderPipeline.builder(new Snippet[]{CLOUDS_SNIPPET}).withLocation("pipeline/clouds").build());
   public static final RenderPipeline LINES = register(RenderPipeline.builder(new Snippet[]{LINES_SNIPPET}).withLocation("pipeline/lines").build());
   public static final RenderPipeline LINES_TRANSLUCENT = register(
      RenderPipeline.builder(new Snippet[]{LINES_SNIPPET}).withDepthWrite(false).withLocation("pipeline/lines_translucent").build()
   );
   public static final RenderPipeline SECONDARY_BLOCK_OUTLINE = register(
      RenderPipeline.builder(new Snippet[]{LINES_SNIPPET})
   ...
   public static final RenderPipeline DEBUG_POINTS = register(
      RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET})
         ...
         .withFragmentShader("core/position_color")
         .withCull(false)
         .withVertexFormat(DefaultVertexFormat.POSITION_COLOR_LINE_WIDTH, Mode.POINTS)
         .build()
   );
   public static final RenderPipeline DEBUG_FILLED_BOX = register(
      RenderPipeline.builder(new Snippet[]{DEBUG_FILLED_SNIPPET}).withLocation("pipeline/debug_filled_box").build()
   );
   public static final RenderPipeline DEBUG_QUADS = register(
      RenderPipeline.builder(new Snippet[]{DEBUG_FILLED_SNIPPET}).withLocation("pipeline/debug_quads").withCull(false).build()
   );
   public static final RenderPipeline DEBUG_TRIANGLE_FAN = register(
      RenderPipeline.builder(new Snippet[]{DEBUG_FILLED_SNIPPET})
   ...
   public static final RenderPipeline OPAQUE_PARTICLE = register(
      RenderPipeline.builder(new Snippet[]{PARTICLE_SNIPPET}).withLocation("pipeline/opaque_particle").build()
   );
   public static final RenderPipeline TRANSLUCENT_PARTICLE = register(
      RenderPipeline.builder(new Snippet[]{PARTICLE_SNIPPET}).withLocation("pipeline/translucent_particle").withBlend(BlendFunction.TRANSLUCENT).build()
   );
   public static final RenderPipeline WEATHER_DEPTH_WRITE = register(
      RenderPipeline.builder(new Snippet[]{WEATHER_SNIPPET}).withLocation("pipeline/weather_depth_write").build()
   );
   public static final RenderPipeline WEATHER_NO_DEPTH_WRITE = register(
      RenderPipeline.builder(new Snippet[]{WEATHER_SNIPPET}).withLocation("pipeline/weather_no_depth_write").withDepthWrite(false).build()
   );
   ...
   public static final RenderPipeline GUI = register(RenderPipeline.builder(new Snippet[]{GUI_SNIPPET}).withLocation("pipeline/gui").build());
   public static final RenderPipeline GUI_INVERT = register(
      RenderPipeline.builder(new Snippet[]{GUI_SNIPPET}).withLocation("pipeline/gui_invert").withBlend(BlendFunction.INVERT).build()
   );
   public static final RenderPipeline GUI_TEXT_HIGHLIGHT = register(
      RenderPipeline.builder(new Snippet[]{GUI_SNIPPET}).withLocation("pipeline/gui_text_highlight").withBlend(BlendFunction.ADDITIVE).build()
   );
   public static final RenderPipeline GUI_TEXTURED = register(
      RenderPipeline.builder(new Snippet[]{GUI_TEXTURED_SNIPPET}).withLocation("pipeline/gui_textured").build()
   );
   public static final RenderPipeline GUI_TEXTURED_PREMULTIPLIED_ALPHA = register(
      RenderPipeline.builder(new Snippet[]{GUI_TEXTURED_SNIPPET})
   ...
   public static final RenderPipeline GUI_OPAQUE_TEXTURED_BACKGROUND = register(
      RenderPipeline.builder(new Snippet[]{GUI_TEXTURED_SNIPPET}).withLocation("pipeline/gui_opaque_textured_background").withoutBlend().build()
   );
   public static final RenderPipeline GUI_NAUSEA_OVERLAY = register(
      RenderPipeline.builder(new Snippet[]{GUI_TEXTURED_SNIPPET}).withLocation("pipeline/gui_nausea_overlay").withBlend(BlendFunction.ADDITIVE).build()
   );
   ...
   public static final RenderPipeline CROSSHAIR = register(
      RenderPipeline.builder(new Snippet[]{GUI_TEXTURED_SNIPPET}).withLocation("pipeline/crosshair").withBlend(BlendFunction.INVERT).build()
   );
   ...
   public static final RenderPipeline OUTLINE_CULL = register(
      RenderPipeline.builder(new Snippet[]{OUTLINE_SNIPPET}).withLocation("pipeline/outline_cull").build()
   );
   public static final RenderPipeline OUTLINE_NO_CULL = register(
      RenderPipeline.builder(new Snippet[]{OUTLINE_SNIPPET}).withLocation("pipeline/outline_no_cull").withCull(false).build()
   );
   ...
   public static final Snippet ANIMATE_SPRITE_SNIPPET = RenderPipeline.builder(new Snippet[0])
   ...
   public static final RenderPipeline ANIMATE_SPRITE_BLIT = register(
      RenderPipeline.builder(new Snippet[]{ANIMATE_SPRITE_SNIPPET})
