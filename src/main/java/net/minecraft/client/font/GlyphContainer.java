...
public class GlyphContainer<T> {
    final static private int ROW_SHIFT = 8;
    final static private int ENTRIES_PER_ROW = 256;
    final static private int LAST_ENTRY_NUM_IN_ROW = 255;
    final static private int LAST_ROW_NUM = 4351;
    final static private int NUM_ROWS = 4352;
    final private T[] defaultRow;
    final private T[][] rows;
    final private IntFunction<T[]> makeRow;
