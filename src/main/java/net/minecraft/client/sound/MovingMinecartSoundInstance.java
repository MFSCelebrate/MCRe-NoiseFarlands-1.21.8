...
extends MovingSoundInstance {
    final static private float field_33001 = 0.0f;
    final static private float field_33002 = 0.7f;
    final static private float field_33003 = 0.0f;
    final static private float field_33004 = 1.0f;
    final static private float field_33005 = 0.0025f;
    final private AbstractMinecartEntity minecart;
    ...
    public void tick() {
        ...
        if (f >= 0.01f && this.minecart.net_minecraft_world_World_getWorld().getTickManager().shouldTick() && !bl) {
