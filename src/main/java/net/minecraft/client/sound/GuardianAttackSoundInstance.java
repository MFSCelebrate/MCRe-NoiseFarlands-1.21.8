...
extends MovingSoundInstance {
    final static private float BASE_VOLUME = 0.0f;
    final static private float BEAM_PROGRESS_VOLUME_MULTIPLIER = 1.0f;
    final static private float BASE_PITCH = 0.7f;
    final static private float BEAM_PROGRESS_PITCH_MULTIPLIER = 0.5f;
