...
implements BufferedAudioStream {
    final static private int field_51442 = 8192;
    final static private int field_51443 = -1;
    final static private int field_51444 = 0;
    final static private int field_51445 = 1;
    final static private int field_51446 = -1;
    final static private int field_51447 = 0;
    final static private int field_51448 = 1;
    ...
    final private Block block = new Block(this.dspState);
