...
implements SoundInstance {
    ...
    final protected SoundCategory category;
    ...
    public WeightedSoundSet getSoundSet(SoundManager soundManager) {
        ...
        this.sound = weightedSoundSet == null ? SoundManager.MISSING_SOUND : weightedSoundSet.net_minecraft_client_sound_Sound_getSound(this.random);
