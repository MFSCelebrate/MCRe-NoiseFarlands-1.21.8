...
public class ServerResourcePackManager {
    final private DownloadQueuer queuer;
    final PackStateChangeCallback stateChangeCallback;
    final private ReloadScheduler reloadScheduler;
    final private Runnable packChangeCallback;
    ...
    extends Enum<AcceptanceStatus> {
        final static public AcceptanceStatus PENDING = new AcceptanceStatus();
        final static public AcceptanceStatus ALLOWED = new AcceptanceStatus();
        final static public AcceptanceStatus DECLINED = new AcceptanceStatus();
        final static private AcceptanceStatus[] field_47650;
    ...
    extends Enum<DiscardReason> {
        final static public DiscardReason DOWNLOAD_FAILED = new DiscardReason(PackStateChangeCallback.FinishState.DOWNLOAD_FAILED);
        final static public DiscardReason ACTIVATION_FAILED = new DiscardReason(PackStateChangeCallback.FinishState.ACTIVATION_FAILED);
        final static public DiscardReason DECLINED = new DiscardReason(PackStateChangeCallback.FinishState.DECLINED);
        final static public DiscardReason DISCARDED = new DiscardReason(PackStateChangeCallback.FinishState.DISCARDED);
        final static public DiscardReason SERVER_REMOVED = new DiscardReason(null);
        final static public DiscardReason SERVER_REPLACED = new DiscardReason(null);
        @Nullable
        final PackStateChangeCallback.FinishState state;
        final static private DiscardReason[] field_47658;
    ...
    extends Enum<LoadStatus> {
        final static public LoadStatus REQUESTED = new LoadStatus();
        final static public LoadStatus PENDING = new LoadStatus();
        final static public LoadStatus DONE = new LoadStatus();
        final static private LoadStatus[] field_47646;
    ...
    extends Enum<Status> {
        final static public Status INACTIVE = new Status();
        final static public Status PENDING = new Status();
        final static public Status ACTIVE = new Status();
        final static private Status[] field_47642;
