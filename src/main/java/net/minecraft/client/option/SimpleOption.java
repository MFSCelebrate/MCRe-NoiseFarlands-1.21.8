...
public final class SimpleOption<T> {
    ...
    final static public PotentialValuesBasedCallbacks<Boolean> BOOLEAN = new PotentialValuesBasedCallbacks(ImmutableList.of((Object)Boolean.TRUE, (Object)Boolean.FALSE), Codec.BOOL);
    final static public ValueTextGetter<Boolean> BOOLEAN_TEXT_GETTER = (optionText, value) -> value != false ? ScreenTexts.ON : ScreenTexts.OFF;
    final private TooltipFactory<T> tooltipFactory;
    final Function<T, Text> textGetter;
    final private Callbacks<T> callbacks;
    ...
    implements SliderCallbacks<Double> {
        final static public DoubleSliderCallbacks INSTANCE = new DoubleSliderCallbacks();
        final static private DoubleSliderCallbacks[] field_37876;
        ...
        @Override
        public Double java_lang_Double_toValue(double d) {
            return d;
        }
        ...
        public <R> SliderCallbacks<R> withModifier(final DoubleFunction<? extends R> sliderProgressValueToValue, final ToDoubleFunction<? super R> valueToSliderProgressValue) {
            return new SliderCallbacks<R>(){
                ...
                public R toValue(double sliderProgress) {
                    return sliderProgressValueToValue.apply(this.java_lang_Double_toValue(sliderProgress));
                }
        ...
        public Codec<Double> codec() {
            return Codec.withAlternative((Codec)Codec.doubleRange(0.0, 1.0), (Codec)Codec.BOOL, value -> value != false ? 1.0 : 0.0);
        }

        @Override
        public Object java_lang_Object_toValue(double sliderProgress) {
            return this.java_lang_Double_toValue(sliderProgress);
        }
    ...
    extends SliderCallbacks<Integer> {
        ...
        @Override
        default public Integer java_lang_Integer_toValue(double d) {
            if (d >= 1.0) {
                d = 0.99999f;
            }
        ...
        default public <R> SliderCallbacks<R> withModifier(final IntFunction<? extends R> sliderProgressValueToValue, final ToIntFunction<? super R> valueToSliderProgressValue) {
            return new SliderCallbacks<R>(){
                ...
                @Override
                public R toValue(double sliderProgress) {
                    return sliderProgressValueToValue.apply(this.java_lang_Integer_toValue(sliderProgress));
                }
        ...
        @Override
        default public Object java_lang_Object_toValue(double sliderProgress) {
            return this.java_lang_Integer_toValue(sliderProgress);
        }
    }
    ...
    extends OptionSliderWidget {
        final private SimpleOption<N> option;
        final private SliderCallbacks<N> callbacks;
        final private TooltipFactory<N> tooltipFactory;
        final private Consumer<N> changeCallback;
        @Nullable
        private Long timeToApply;
        final private boolean shouldApplyImmediately;
