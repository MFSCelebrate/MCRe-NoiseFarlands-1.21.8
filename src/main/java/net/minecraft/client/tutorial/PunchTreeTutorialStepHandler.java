...
implements TutorialStepHandler {
    ...
    final static private Text TITLE = Text.translatable("tutorial.punch_tree.title");
    final static private Text DESCRIPTION = Text.translatable("tutorial.punch_tree.description", TutorialManager.keyToText("attack"));
