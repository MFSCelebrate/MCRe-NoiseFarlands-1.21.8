...
extends ValueObject {
    ...
    final static private String HTTP_PROTOCOL = "http://";
    final static private int PORT = 8080;
    final static private Pattern PROTOCOL_PATTERN = Pattern.compile("^[a-zA-Z][-a-zA-Z0-9+.]+:");
    final private boolean worldClosed;
    @Nullable
    final private String token;
    final private URI uploadEndpoint;
