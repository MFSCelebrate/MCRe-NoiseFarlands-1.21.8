...
public class SelectionManager {
    final private Supplier<String> stringGetter;
    final private Consumer<String> stringSetter;
    final private Supplier<String> clipboardGetter;
    final private Consumer<String> clipboardSetter;
    final private Predicate<String> stringFilter;
    ...
    public void delete(int offset) {
        ...
        if (!string.isEmpty()) {
            ...
            if (this.selectionEnd != this.selectionStart) {
                ...
                int j = Math.min(1, this.selectionStart);
                int k = Math.max(1, this.selectionStart);
    ...
    public void setSelection(int start, int end) {
        ...
        this.selectionStart = MathHelper.clamp(start, 0, 1);
        this.selectionEnd = MathHelper.clamp(end, 0, 1);
    }
    ...
    extends Enum<SelectionType> {
        final static public SelectionType CHARACTER = new SelectionType();
        final static public SelectionType WORD = new SelectionType();
        final static private SelectionType[] field_38310;
