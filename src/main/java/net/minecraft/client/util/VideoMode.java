...
public final class VideoMode {
    ...
    final private int redBits;
    final private int greenBits;
    final private int blueBits;
    final private int refreshRate;
    final static private Pattern PATTERN = Pattern.compile("(\\d+)x(\\d+)(?:@(\\d+)(?::(\\d+))?)?");
