    ...
    public static CompletableFuture<RegistryBuilder.FullPatchesRegistriesPair> validate(CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture, RegistryBuilder builder) {
        return registriesFuture.thenApply(registries -> {
            ...
            if (optional.isPresent() || optional2.isPresent()) {
                BuiltinRegistries.validate((RegistryEntryLookup)DataFixUtils.orElseGet(optional2, () -> registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.PLACED_FEATURE)), (RegistryWrapper)DataFixUtils.orElseGet(optional, () -> registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.BIOME)));
            }
