...
extends ForwardingDynamicOps<T> {
    final private RegistryInfoGetter registryInfoGetter;
    ...
    implements RegistryInfoGetter {
        ...
        final private Map<RegistryKey<? extends Registry<?>>, Optional<? extends RegistryInfo<?>>> cache = new ConcurrentHashMap();
