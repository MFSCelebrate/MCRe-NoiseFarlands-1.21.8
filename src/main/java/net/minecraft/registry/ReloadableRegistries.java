...
public class ReloadableRegistries {
    ...
    final static private RegistryEntryInfo DEFAULT_REGISTRY_ENTRY_INFO = new RegistryEntryInfo(Optional.empty(), Lifecycle.experimental());
    ...
    private static <T> void validateLootData(LootTableReporter reporter, LootDataType<T> lootDataType, RegistryWrapper.WrapperLookup registries) {
        RegistryEntryLookup registryWrapper = registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(lootDataType.registryKey());
