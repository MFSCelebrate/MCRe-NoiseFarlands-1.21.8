...
public class RegistryBuilder {
    final private List<RegistryInfo<?>> registries = new ArrayList();
    ...
    private <T> RegistryWrapper.Impl<T> applyPatches(RegistryEntryOwner<T> owner, RegistryCloner.CloneableRegistries cloneableRegistries, RegistryKey<? extends Registry<? extends T>> registryRef, RegistryWrapper.WrapperLookup patches, RegistryWrapper.WrapperLookup base, MutableObject<RegistryWrapper.WrapperLookup> lazyWrapper) {
        ...
        RegistryEntryLookup impl = patches.net_minecraft_registry_RegistryEntryLookup_getOrThrow(registryRef);
        ...
        RegistryEntryLookup impl2 = base.net_minecraft_registry_RegistryEntryLookup_getOrThrow(registryRef);
    ...
    extends Record {
        ...
        final private Map<RegistryKey<T>, EntryAssociatedValue<T>> values;
    ...
    implements RegistryWrapper.Impl.Delegating<T> {
        final private RegistryWrapper.Impl<T> base;
    ...
    implements RegistryEntryLookup<T> {
        final protected RegistryEntryOwner<T> entryOwner;
