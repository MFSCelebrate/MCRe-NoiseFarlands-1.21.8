...
public interface RegistryEntry<T> {
    ...
    implements RegistryEntry<T> {
        final private RegistryEntryOwner<T> owner;
        @Nullable
        private Set<TagKey<T>> tags;
        final private Type referenceType;
        @Nullable
        ...
        extends Enum<Type> {
            final static public Type STAND_ALONE = new Type();
            final static public Type INTRUSIVE = new Type();
            final static private Type[] field_36456;
    ...
    extends Enum<Type> {
        final static public Type REFERENCE = new Type();
        final static public Type DIRECT = new Type();
        final static private Type[] field_36448;
