...
implements Codec<RegistryEntryList<E>> {
    final private RegistryKey<? extends Registry<E>> registry;
    final private Codec<RegistryEntry<E>> entryCodec;
    final private Codec<List<RegistryEntry<E>>> directEntryListCodec;
    final private Codec<Either<TagKey<E>, List<RegistryEntry<E>>>> entryListStorageCodec;
