...
extends ScreenHandler {
    final static public int MAP_SLOT_INDEX = 0;
    final static public int MATERIAL_SLOT_INDEX = 1;
    final static public int RESULT_SLOT_INDEX = 2;
    ...
    final public Inventory inventory = new SimpleInventory(2){
