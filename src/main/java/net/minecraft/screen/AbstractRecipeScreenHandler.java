...
extends ScreenHandler {
    ...
    extends Enum<PostFillAction> {
        final static public PostFillAction NOTHING = new PostFillAction();
        final static public PostFillAction PLACE_GHOST_RECIPE = new PostFillAction();
        final static private PostFillAction[] field_52574;
