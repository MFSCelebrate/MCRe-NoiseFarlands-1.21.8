...
extends ScreenHandler {
    final static private int field_41901 = 9;
    final static private int field_41902 = 3;
    final static private int field_54595 = 0;
    final protected ScreenHandlerContext context;
    final protected PlayerEntity player;
    final protected Inventory input;
    final protected CraftingResultInventory output = new CraftingResultInventory(){
    ...
    final private int resultSlotIndex;
