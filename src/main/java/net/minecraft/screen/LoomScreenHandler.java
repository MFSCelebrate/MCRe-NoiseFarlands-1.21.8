...
extends ScreenHandler {
    final static private int NO_PATTERN = -1;
    final static private int INVENTORY_START = 4;
    final static private int INVENTORY_END = 31;
    final static private int HOTBAR_START = 31;
    final static private int HOTBAR_END = 40;
    ...
    final private RegistryEntryLookup<BannerPattern> bannerPatternLookup;
    final Slot bannerSlot;
    final Slot dyeSlot;
    final private Slot patternSlot;
    final private Slot outputSlot;
    long lastTakeResultTime;
    final private Inventory input = new SimpleInventory(3){
    ...
    final private Inventory output = new SimpleInventory(1){
    ...
    public LoomScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        ...
        this.bannerPatternLookup = playerInventory.player.getRegistryManager().net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.BANNER_PATTERN);
    }
