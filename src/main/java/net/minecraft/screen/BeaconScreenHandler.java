...
extends ScreenHandler {
    final static private int PAYMENT_SLOT_ID = 0;
    final static private int BEACON_INVENTORY_SIZE = 1;
    final static private int PROPERTY_COUNT = 3;
    final static private int INVENTORY_START = 1;
    final static private int INVENTORY_END = 28;
    final static private int HOTBAR_START = 28;
    final static private int HOTBAR_END = 37;
    final static private int field_45758 = 0;
    final private Inventory payment = new SimpleInventory(this, 1){
    ...
    final private PaymentSlot paymentSlot;
