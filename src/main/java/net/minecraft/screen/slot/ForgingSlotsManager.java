...
public class ForgingSlotsManager {
    final private List<ForgingSlot> inputSlots;
    final private ForgingSlot resultSlot;
    ...
    extends Record {
        ...
        final private int x;
        final private int y;
        final private Predicate<ItemStack> mayPlace;
        final static ForgingSlot DEFAULT = new ForgingSlot(0, 0, 0, stack -> true);

        public ForgingSlot(int i, int j, int k, Predicate<ItemStack> predicate) {
            this.slotId = i;
            this.x = j;
            this.y = k;
    ...
    public static class Builder {
        final private List<ForgingSlot> inputs = new ArrayList<ForgingSlot>();
