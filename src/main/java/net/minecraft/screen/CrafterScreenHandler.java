...
implements ScreenHandlerListener {
    final static protected int field_46781 = 9;
    final static private int field_46782 = 9;
    final static private int field_46783 = 36;
    final static private int field_46784 = 36;
    final static private int field_46785 = 45;
    final private CraftingResultInventory resultInventory = new CraftingResultInventory();
    final private PropertyDelegate propertyDelegate;
    final private PlayerEntity player;
    final private RecipeInputInventory inputInventory;
    ...
    private void updateResult() {
        ...
        if (playerEntity instanceof ServerPlayerEntity) {
            ...
            ServerWorld serverWorld = serverPlayerEntity.net_minecraft_server_world_ServerWorld_getWorld();
