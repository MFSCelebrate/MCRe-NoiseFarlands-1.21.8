...
extends ScreenHandler {
    final static Identifier EMPTY_BREWING_FUEL_SLOT_TEXTURE = Identifier.ofVanilla("container/slot/brewing_fuel");
    final static Identifier EMPTY_POTION_SLOT_TEXTURE = Identifier.ofVanilla("container/slot/potion");
    final static private int field_30763 = 0;
    final static private int field_30764 = 2;
    final static private int INGREDIENT_SLOT_ID = 3;
    final static private int FUEL_SLOT_ID = 4;
    final static private int BREWING_STAND_INVENTORY_SIZE = 5;
    final static private int PROPERTY_COUNT = 2;
    final static private int INVENTORY_START = 5;
    final static private int INVENTORY_END = 32;
    final static private int HOTBAR_START = 32;
    final static private int HOTBAR_END = 41;
    final private Inventory inventory;
    final private PropertyDelegate propertyDelegate;
    final private Slot ingredientSlot;
    ...
    public BrewingStandScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        ...
        BrewingRecipeRegistry brewingRecipeRegistry = playerInventory.player.net_minecraft_world_World_getWorld().getBrewingRecipeRegistry();
