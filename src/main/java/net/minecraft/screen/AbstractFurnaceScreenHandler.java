...
extends AbstractRecipeScreenHandler {
    final static public int field_30738 = 0;
    final static public int field_30739 = 1;
    final static public int field_30740 = 2;
    final static public int field_30741 = 3;
    final static public int field_30742 = 4;
    final static private int field_30743 = 3;
    final static private int field_30744 = 30;
    final static private int field_30745 = 30;
    final static private int field_30746 = 39;
    final Inventory inventory;
    final private PropertyDelegate propertyDelegate;
    final protected World world;
    final private RecipeType<? extends AbstractCookingRecipe> recipeType;
    final private RecipePropertySet recipePropertySet;
    ...
    protected AbstractFurnaceScreenHandler(ScreenHandlerType<?> type, RecipeType<? extends AbstractCookingRecipe> recipeType, RegistryKey<RecipePropertySet> recipePropertySetKey, RecipeBookType category, int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        ...
        this.recipePropertySet = this.world.net_minecraft_recipe_RecipeManager_getRecipeManager().getPropertySet(recipePropertySetKey);
