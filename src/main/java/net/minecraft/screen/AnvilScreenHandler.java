...
extends ForgingScreenHandler {
    final static public int INPUT_1_ID = 0;
    final static public int INPUT_2_ID = 1;
    final static public int OUTPUT_ID = 2;
    final static private Logger LOGGER = LogUtils.getLogger();
    final static private boolean field_30752 = false;
    final static public int MAX_NAME_LENGTH = 50;
    private int repairItemUsage;
    @Nullable
    private String newItemName;
    final private Property levelCost = Property.create();
    private boolean keepSecondSlot = false;
    final static private int field_30753 = 0;
    final static private int field_30754 = 1;
    final static private int field_30755 = 1;
    final static private int field_30747 = 1;
    final static private int field_30748 = 2;
    final static private int field_30749 = 1;
    final static private int field_30750 = 1;
    final static private int INPUT_1_X = 27;
    final static private int INPUT_2_X = 76;
    final static private int OUTPUT_X = 134;
    final static private int SLOT_Y = 47;
