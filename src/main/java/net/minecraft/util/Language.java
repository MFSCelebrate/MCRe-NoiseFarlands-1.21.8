...
public abstract class Language {
    ...
    final static private Pattern TOKEN_PATTERN = Pattern.compile("%(\\d+\\$)?[\\d.]*[df]");
    final static public String DEFAULT_LANGUAGE = "en_us";
    static private volatile Language instance = Language.create();
