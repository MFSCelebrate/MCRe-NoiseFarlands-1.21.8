...
public class ContextType {
    final private Set<ContextParameter<?>> required;
    final private Set<ContextParameter<?>> allowed;
    ...
    public static class Builder {
        final private Set<ContextParameter<?>> required = Sets.newIdentityHashSet();
        final private Set<ContextParameter<?>> allowed = Sets.newIdentityHashSet();
