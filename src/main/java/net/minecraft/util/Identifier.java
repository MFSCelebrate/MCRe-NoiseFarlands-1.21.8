...
implements Comparable<Identifier> {
    final static public Codec<Identifier> CODEC = Codec.STRING.comapFlatMap(Identifier::validate, Identifier::toString).stable();
    final static public PacketCodec<ByteBuf, Identifier> PACKET_CODEC = PacketCodecs.STRING.xmap(Identifier::of, Identifier::toString);
    final static public SimpleCommandExceptionType COMMAND_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.id.invalid"));
    final static public char NAMESPACE_SEPARATOR = ':';
    final static public String DEFAULT_NAMESPACE = "minecraft";
    final static public String REALMS_NAMESPACE = "realms";
