...
public class Sampler {
    ...
    final private SampleType type;
    final private DoubleSupplier retriever;
    final private ByteBuf ticksBuffer;
    final private ByteBuf valueBuffer;
    private volatile boolean active;
    @Nullable
    final private Runnable startAction;
    @Nullable
    ...
    public Data collectData() {
        ...
        return new Data(i, j, (Int2DoubleMap)int2DoubleMap);
    }
    ...
    public static class Builder<T> {
        final private String name;
        final private SampleType type;
        final private DoubleSupplier timeGetter;
        final private T context;
        @Nullable
    ...
    public static class Data {
        final private Int2DoubleMap values;
