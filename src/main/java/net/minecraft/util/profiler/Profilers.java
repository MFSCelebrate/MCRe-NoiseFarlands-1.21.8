...
public final class Profilers {
    final static private ThreadLocal<TracyProfiler> TRACY_PROFILER = ThreadLocal.withInitial(TracyProfiler::new);
    final static private ThreadLocal<Profiler> BUILTIN_PROFILER = new ThreadLocal();
    final static private AtomicInteger ACTIVE_BUILTIN_PROFILER_COUNT = new AtomicInteger();
    ...
    private static void activate(Profiler profiler) {
        ...
        Profiler profiler2 = Profilers.union(profiler);
