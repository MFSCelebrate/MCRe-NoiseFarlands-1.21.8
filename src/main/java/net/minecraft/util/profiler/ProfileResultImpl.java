...
implements ProfileResult {
    ...
    final static private ProfileLocationInfo EMPTY_INFO = new ProfileLocationInfo(){
    ...
    final static private Comparator<Map.Entry<String, CounterInfo>> COMPARATOR = Map.Entry.comparingByValue(Comparator.comparingLong(counterInfo -> counterInfo.totalTime)).reversed();
    final private Map<String, ? extends ProfileLocationInfo> locationInfos;
    final private long startTime;
    final private int startTick;
    final private long endTime;
    final private int endTick;
    final private int tickDuration;
