...
implements Profiler {
    ...
    final static private StackWalker STACK_WALKER = StackWalker.getInstance(Set.of(StackWalker.Option.RETAIN_CLASS_REFERENCE), 5);
    final private List<Zone> zones = new ArrayList<Zone>();
    final private Map<String, Marker> markers = new HashMap<String, Marker>();
    final private String threadName = Thread.currentThread().getName();
    ...
    public void push(String location) {
        ...
        Zone zone = TracyClient.beginZone((String)location, (String)string, (String)string2, 1);
        this.zones.add(zone);
    }
