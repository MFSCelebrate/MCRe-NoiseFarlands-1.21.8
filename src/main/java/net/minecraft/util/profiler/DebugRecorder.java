...
implements Recorder {
    final static public int MAX_DURATION_IN_SECONDS = 10;
    @Nullable
    static private Consumer<Path> globalDumpConsumer = null;
    final private Map<Sampler, List<Deviation>> deviations = new Object2ObjectOpenHashMap();
    final private TickTimeTracker timeTracker;
    final private Executor dumpExecutor;
    final private RecordDumper dumper;
    final private Consumer<ProfileResult> resultConsumer;
    final private Consumer<Path> dumpConsumer;
    final private SamplerSource samplerSource;
    final private LongSupplier timeGetter;
