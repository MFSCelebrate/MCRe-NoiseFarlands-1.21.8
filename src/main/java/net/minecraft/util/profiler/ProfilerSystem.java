...
implements ReadableProfiler {
    final static private long TIMEOUT_NANOSECONDS = Duration.ofMillis(100L).toNanos();
    final static private Logger LOGGER = LogUtils.getLogger();
    final private List<String> path = Lists.newArrayList();
    final private LongList timeList = new LongArrayList();
    final private Map<String, LocatedInfo> locationInfos = Maps.newHashMap();
    final private IntSupplier endTickGetter;
    final private LongSupplier timeGetter;
    final private long startTime;
    final private int startTick;
    private String fullPath = "";
    private boolean tickStarted;
    @Nullable
    private LocatedInfo currentInfo;
    final private BooleanSupplier timeoutDisabled;
    final private Set<Pair<String, SampleType>> sampleTypes = new ObjectArraySet();
