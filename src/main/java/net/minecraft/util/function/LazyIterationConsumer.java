...
public interface LazyIterationConsumer<T> {
    ...
    extends Enum<NextIteration> {
        final static public NextIteration CONTINUE = new NextIteration();
        final static public NextIteration ABORT = new NextIteration();
        final static private NextIteration[] field_41285;
