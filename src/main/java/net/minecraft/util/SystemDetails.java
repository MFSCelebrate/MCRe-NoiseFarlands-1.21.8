...
public class SystemDetails {
    final static public long MEBI = 0x100000L;
    final static private long GIGA = 1000000000L;
    final static private Logger LOGGER = LogUtils.getLogger();
    final static private String OPERATING_SYSTEM = System.getProperty("os.name") + " (" + System.getProperty("os.arch") + ") version " + System.getProperty("os.version");
    final static private String JAVA_VERSION = System.getProperty("java.version") + ", " + System.getProperty("java.vendor");
    final static private String JVM_VERSION = System.getProperty("java.vm.name") + " (" + System.getProperty("java.vm.info") + "), " + System.getProperty("java.vm.vendor");
    final private Map<String, String> sections = Maps.newLinkedHashMap();
