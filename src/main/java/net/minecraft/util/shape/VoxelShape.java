...
public abstract class VoxelShape {
    final protected VoxelSet voxels;
    @Nullable
    ...
    private VoxelShape getUncachedFace(Direction facing) {
        ...
        SlicedVoxelShape slicedVoxelShape = new SlicedVoxelShape(this, axis, 1);
    ...
    private boolean isSquare(Direction.Axis axis) {
        ...
        return doubleList.size() == 2 && DoubleMath.fuzzyEquals((double)doubleList.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals((double)doubleList.getDouble(1), 1.0, 1.0E-7);
    }
