...
implements PairList {
    final static private DoubleList ZERO = DoubleLists.unmodifiable((DoubleList)DoubleArrayList.wrap((double[])new double[]{0.0}));
    final private double[] valueIndices;
    final private int[] minValues;
    ...
    public DoubleList getPairs() {
        return this.size <= 1 ? ZERO : DoubleArrayList.wrap((double[])this.valueIndices, (int)this.size);
    }
}
