...
public interface FlightProfiler {
    final static public FlightProfiler INSTANCE = Runtime.class.getModule().getLayer().findModule("jdk.jfr").isPresent() ? JfrProfiler.getInstance() : new NoopProfiler();
    ...
    implements FlightProfiler {
        ...
        final static Finishable NOOP = success -> {};
