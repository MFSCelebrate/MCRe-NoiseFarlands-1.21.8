...
public class StringHelper {
    final static private Pattern FORMATTING_CODE = Pattern.compile("(?i)\\u00A7[0-9A-FK-OR]");
    final static private Pattern LINE_BREAK = Pattern.compile("\\r\\n|\\v");
    final static private Pattern ENDS_WITH_LINE_BREAK = Pattern.compile("(?:\\r\\n|\\v)$");
