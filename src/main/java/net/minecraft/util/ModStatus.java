...
public record ModStatus(Confidence confidence, String description) {
    ...
    extends Enum<Confidence> {
        final static public Confidence PROBABLY_NOT = new Confidence("Probably not.", false);
        final static public Confidence VERY_LIKELY = new Confidence("Very likely;", true);
        final static public Confidence DEFINITELY = new Confidence("Definitely;", true);
        final String description;
        final boolean modded;
        final static private Confidence[] field_35179;
