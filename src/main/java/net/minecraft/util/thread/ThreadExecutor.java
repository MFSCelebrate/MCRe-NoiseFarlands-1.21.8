...
TaskExecutor<R>,
Executor {
    final static public long field_52421 = 100000L;
    final private String name;
    final static private Logger LOGGER = LogUtils.getLogger();
    final private Queue<R> tasks = Queues.newConcurrentLinkedQueue();
    ...
    protected void executeTask(R task) {
        try {
            ...
            if (!ThreadExecutor.isMemoryError(exception)) return;
            throw exception;
        }
    }
    ...
    public static boolean isMemoryError(Throwable exception) {
        if (exception instanceof CrashException) {
            ...
            return ThreadExecutor.isMemoryError(crashException.getCause());
        }
