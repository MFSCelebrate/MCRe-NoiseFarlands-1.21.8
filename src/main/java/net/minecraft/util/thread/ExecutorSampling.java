...
public class ExecutorSampling {
    final static public ExecutorSampling INSTANCE = new ExecutorSampling();
    final private WeakHashMap<SampleableExecutor, Void> activeExecutors = new WeakHashMap();
    ...
    extends Sampler {
        final private List<Sampler> delegates;
