...
public class AsyncHelper {
    final static private int MAX_TASKS = 16;
    ...
    public static <K, U, V> CompletableFuture<Map<K, V>> mapValues(Map<K, U> futures, BiFunction<K, U, V> function, int batchSize, Executor executor) {
        ...
        Batcher batcher = 1 <= batchSize ? new Single<K, U, V>(function, 1) : new Batch<K, U, V>(function, 1, batchSize);
    ...
    public static <K, U, V> CompletableFuture<Map<K, V>> mapValues(Map<K, U> futures, BiFunction<K, U, V> function, Executor executor) {
        ...
        return AsyncHelper.mapValues(futures, function, 1, executor);
    }
    ...
    static abstract class Batcher<K, U, V> {
        ...
        private int index;
        final private CompletableFuture<?>[] futures;
        private int batch;
        final private Future<K, U, V> entry;
