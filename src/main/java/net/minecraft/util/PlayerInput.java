...
public record PlayerInput(boolean forward, boolean backward, boolean left, boolean right, boolean jump, boolean sneak, boolean sprint) {
    final static private byte FORWARD = 1;
    final static private byte BACKWARD = 2;
    final static private byte LEFT = 4;
    final static private byte RIGHT = 8;
    final static private byte JUMP = 16;
    final static private byte SNEAK = 32;
    final static private byte SPRINT = 64;
    final static public PacketCodec<PacketByteBuf, PlayerInput> PACKET_CODEC = new PacketCodec<PacketByteBuf, PlayerInput>(){
        ...
        public void encode(PacketByteBuf packetByteBuf, PlayerInput playerInput) {
            ...
            packetByteBuf.net_minecraft_network_PacketByteBuf_writeByte(b);
        }
    ...
    static public PlayerInput DEFAULT = new PlayerInput(false, false, false, false, false, false, false);
