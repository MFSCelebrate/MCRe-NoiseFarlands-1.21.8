...
extends Enum<AxisCycleDirection> {
    final static public AxisCycleDirection NONE = new AxisCycleDirection(){
    ...
    final static public AxisCycleDirection FORWARD = new AxisCycleDirection(){
    ...
    final static public AxisCycleDirection BACKWARD = new AxisCycleDirection(){
    ...
    final static public Direction.Axis[] AXES;
    final static public AxisCycleDirection[] VALUES;
    final static private AxisCycleDirection[] field_10964;
