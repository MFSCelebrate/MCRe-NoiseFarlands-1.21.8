...
public class BlockBox {
    ...
    final static public Codec<BlockBox> CODEC = Codec.INT_STREAM.comapFlatMap(values -> Util.decodeFixedLengthArray(values, 6).map(array -> new BlockBox(array[0], array[1], array[2], array[3], array[4], array[5])), box -> IntStream.of(box.minX, box.minY, box.minZ, box.maxX, box.maxY, box.maxZ)).stable();
    private int minX;
    private int minY;
    private int minZ;
    private int maxX;
