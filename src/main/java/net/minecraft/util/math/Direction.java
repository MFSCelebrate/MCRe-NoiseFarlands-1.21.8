...
implements StringIdentifiable {
    final static public Direction DOWN = new Direction(0, 1, -1, "down", AxisDirection.NEGATIVE, Axis.Y, new Vec3i(0, -1, 0));
    final static public Direction UP = new Direction(1, 0, -1, "up", AxisDirection.POSITIVE, Axis.Y, new Vec3i(0, 1, 0));
    final static public Direction NORTH = new Direction(2, 3, 2, "north", AxisDirection.NEGATIVE, Axis.Z, new Vec3i(0, 0, -1));
    final static public Direction SOUTH = new Direction(3, 2, 0, "south", AxisDirection.POSITIVE, Axis.Z, new Vec3i(0, 0, 1));
    final static public Direction WEST = new Direction(4, 5, 1, "west", AxisDirection.NEGATIVE, Axis.X, new Vec3i(-1, 0, 0));
    final static public Direction EAST = new Direction(5, 4, 3, "east", AxisDirection.POSITIVE, Axis.X, new Vec3i(1, 0, 0));
    final static public StringIdentifiable.EnumCodec<Direction> CODEC;
    final static public Codec<Direction> VERTICAL_CODEC;
    final static public IntFunction<Direction> INDEX_TO_VALUE_FUNCTION;
    final static public PacketCodec<ByteBuf, Direction> PACKET_CODEC;
    @Deprecated
    final static public Codec<Direction> INDEX_CODEC;
    @Deprecated
    final static public Codec<Direction> HORIZONTAL_QUARTER_TURNS_CODEC;
    final private int index;
    final private int oppositeIndex;
    final private int horizontalQuarterTurns;
    final private String id;
    final private Axis axis;
    final private AxisDirection direction;
    final private Vec3i vec3i;
    final private Vec3d doubleVector;
    final private Vector3fc floatVector;
    final static private Direction[] ALL;
    final static private Direction[] VALUES;
    final static private Direction[] HORIZONTAL;
    final static private Direction[] field_11037;
    ...
    implements StringIdentifiable,
    Predicate<Direction> {
        final static public Axis X = new Axis("x"){
        ...
        final static public Axis Y = new Axis("y"){
        ...
        final static public Axis Z = new Axis("z"){
        ...
        final static public Axis[] VALUES;
        final static public StringIdentifiable.EnumCodec<Axis> CODEC;
        final private String id;
        final static private Axis[] field_11049;
    ...
    extends Enum<AxisDirection> {
        final static public AxisDirection POSITIVE = new AxisDirection(1, "Towards positive");
        final static public AxisDirection NEGATIVE = new AxisDirection(-1, "Towards negative");
        final private int offset;
        final private String description;
        final static private AxisDirection[] field_11058;
    ...
    Predicate<Direction> {
        final static public Type HORIZONTAL = new Type(new Direction[]{NORTH, EAST, SOUTH, WEST}, new Axis[]{Axis.X, Axis.Z});
        final static public Type VERTICAL = new Type(new Direction[]{UP, DOWN}, new Axis[]{Axis.Y});
        final private Direction[] facingArray;
        final private Axis[] axisArray;
        final static private Type[] field_11063;
