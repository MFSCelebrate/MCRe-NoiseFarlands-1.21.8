...
extends FloatProvider {
    final static public MapCodec<UniformFloatProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.FLOAT.fieldOf("min_inclusive").forGetter(provider -> Float.valueOf(provider.min)), (App)Codec.FLOAT.fieldOf("max_exclusive").forGetter(provider -> Float.valueOf(provider.max))).apply((Applicative)instance, UniformFloatProvider::new)).validate(provider -> {
