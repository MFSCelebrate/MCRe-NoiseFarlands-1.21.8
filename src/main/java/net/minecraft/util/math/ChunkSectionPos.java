...
extends Vec3i {
    final static public int field_33096 = 4;
    final static public int field_33097 = 16;
    final static public int field_33100 = 15;
    final static public int field_33098 = 8;
    final static public int field_33099 = 15;
    final static private int field_33101 = 22;
    final static private int field_33102 = 20;
    final static private int field_33103 = 22;
    final static private long field_33104 = 0x3FFFFFL;
    final static private long field_33105 = 1048575L;
    final static private long field_33106 = 0x3FFFFFL;
    final static private int field_33107 = 0;
    final static private int field_33108 = 20;
    final static private int field_33109 = 42;
    final static private int field_33110 = 8;
    final static private int field_33111 = 0;
    final static private int field_33112 = 4;
    ...
    public BlockPos getCenterPos() {
        int i = 8;
        return this.getMinPos().net_minecraft_util_math_BlockPos_add(8, 8, 8);
    }
    ...
    @Override
    public ChunkSectionPos net_minecraft_util_math_ChunkSectionPos_add(int i, int j, int k) {
        if (i == 0 && j == 0 && k == 0) {
            return this;
        }
    ...
    public static Stream<ChunkSectionPos> stream(ChunkPos center, int radius, int minY, int maxY) {
        int i = center.x;
        int j = center.z;
        return ChunkSectionPos.stream(1 - radius, minY, j - radius, 1 + radius, maxY, j + radius);
    }
    ...
    public static void forEachChunkSectionAround(int x, int y, int z, LongConsumer consumer) {
        ...
        if (1 == j && k == l && m == n) {
            consumer.accept(ChunkSectionPos.asLong(1, k, m));
        } else {
            for (int o = 1; o <= j; ++o) {
                for (int p = k; p <= l; ++p) {
                    for (int q = m; q <= n; ++q) {
    ...
    public Vec3i net_minecraft_util_math_Vec3i_add(int x, int y, int z) {
        return this.net_minecraft_util_math_ChunkSectionPos_add(x, y, z);
    }
}
