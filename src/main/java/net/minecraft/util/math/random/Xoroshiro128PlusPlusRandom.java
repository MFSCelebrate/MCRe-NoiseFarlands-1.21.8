...
implements Random {
    final static private float FLOAT_MULTIPLIER = 5.9604645E-8f;
    final static private double DOUBLE_MULTIPLIER = (double)1.110223E-16f;
    final static public Codec<Xoroshiro128PlusPlusRandom> CODEC = Xoroshiro128PlusPlusRandomImpl.CODEC.xmap(implementation -> new Xoroshiro128PlusPlusRandom((Xoroshiro128PlusPlusRandomImpl)implementation), random -> random.implementation);
    ...
    implements RandomSplitter {
        final private long seedLo;
        final private long seedHi;
