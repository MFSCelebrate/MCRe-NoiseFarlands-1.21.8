...
extends CheckedRandom {
    final private Random baseRandom;
    ...
    extends Enum<RandomProvider> {
        final static public RandomProvider LEGACY = new RandomProvider(CheckedRandom::new);
        final static public RandomProvider XOROSHIRO = new RandomProvider(Xoroshiro128PlusPlusRandom::new);
        final private LongFunction<Random> provider;
        final static private RandomProvider[] field_35145;
