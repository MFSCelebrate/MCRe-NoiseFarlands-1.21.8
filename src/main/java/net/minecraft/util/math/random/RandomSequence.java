...
public class RandomSequence {
    final static public Codec<RandomSequence> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Xoroshiro128PlusPlusRandom.CODEC.fieldOf("source").forGetter(sequence -> sequence.source)).apply((Applicative)instance, RandomSequence::new));
    final private Xoroshiro128PlusPlusRandom source;
