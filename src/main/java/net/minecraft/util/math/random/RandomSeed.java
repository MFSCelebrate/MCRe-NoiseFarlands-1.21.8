...
public final class RandomSeed {
    final static public long GOLDEN_RATIO_64 = -7046029254386353131L;
    final static public long SILVER_RATIO_64 = 7640891576956012809L;
    final static private HashFunction MD5_HASH = Hashing.md5();
    final static private AtomicLong SEED_UNIQUIFIER = new AtomicLong(8682522807148012L);
    ...
    public static XoroshiroSeed createXoroshiroSeed(String seed) {
        byte[] bs = MD5_HASH.hashString((CharSequence)seed, Charsets.UTF_8).asBytes();
