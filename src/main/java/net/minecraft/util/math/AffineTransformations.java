...
public class AffineTransformations {
    final static private Map<Direction, AffineTransformation> DIRECTION_ROTATIONS = Maps.newEnumMap(Map.of(Direction.SOUTH, AffineTransformation.identity(), Direction.EAST, new AffineTransformation(null, new Quaternionf().rotateY(1.5707964f), null, null), Direction.WEST, new AffineTransformation(null, new Quaternionf().rotateY(-1.5707964f), null, null), Direction.NORTH, new AffineTransformation(null, new Quaternionf().rotateY((float)Math.PI), null, null), Direction.UP, new AffineTransformation(null, new Quaternionf().rotateX(-1.5707964f), null, null), Direction.DOWN, new AffineTransformation(null, new Quaternionf().rotateX(1.5707964f), null, null)));
    final static private Map<Direction, AffineTransformation> INVERTED_DIRECTION_ROTATIONS = Maps.newEnumMap(Util.transformMapValues(DIRECTION_ROTATIONS, AffineTransformation::invert));
