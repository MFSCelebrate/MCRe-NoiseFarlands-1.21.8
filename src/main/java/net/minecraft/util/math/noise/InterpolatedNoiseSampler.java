...
implements DensityFunction.Base {
    final static private Codec<Double> SCALE_AND_FACTOR_RANGE = Codec.doubleRange(0.001, 1000.0);
    final static private MapCodec<InterpolatedNoiseSampler> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)SCALE_AND_FACTOR_RANGE.fieldOf("xz_scale").forGetter(interpolatedNoiseSampler -> interpolatedNoiseSampler.xzScale), (App)SCALE_AND_FACTOR_RANGE.fieldOf("y_scale").forGetter(interpolatedNoiseSampler -> interpolatedNoiseSampler.yScale), (App)SCALE_AND_FACTOR_RANGE.fieldOf("xz_factor").forGetter(interpolatedNoiseSampler -> interpolatedNoiseSampler.xzFactor), (App)SCALE_AND_FACTOR_RANGE.fieldOf("y_factor").forGetter(interpolatedNoiseSampler -> interpolatedNoiseSampler.yFactor), (App)Codec.doubleRange(1.0, 8.0).fieldOf("smear_scale_multiplier").forGetter(interpolatedNoiseSampler -> interpolatedNoiseSampler.smearScaleMultiplier)).apply((Applicative)instance, InterpolatedNoiseSampler::createBase3dNoiseFunction));
    final static public CodecHolder<InterpolatedNoiseSampler> CODEC = CodecHolder.of(MAP_CODEC);
    final private OctavePerlinNoiseSampler lowerInterpolatedNoise;
    final private OctavePerlinNoiseSampler upperInterpolatedNoise;
    final private OctavePerlinNoiseSampler interpolationNoise;
    final private double scaledXzScale;
    final private double scaledYScale;
    final private double xzFactor;
    final private double yFactor;
    final private double smearScaleMultiplier;
    final private double maxValue;
    final private double xzScale;
