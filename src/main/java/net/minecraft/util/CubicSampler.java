...
public class CubicSampler {
    final static private int FIRST_SEGMENT_OFFSET = 2;
    final static private int NUM_SEGMENTS = 6;
    final static private double[] DENSITY_CURVE = new double[]{0.0, 1.0, 4.0, 6.0, 4.0, 1.0, 0.0};
