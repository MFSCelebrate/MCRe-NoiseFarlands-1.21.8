...
implements ListDeque<T> {
    ...
    @Override
    public List java_util_List_reversed() {
        return this.java_util_List_reversed();
    }

    @Override
    public SequencedCollection java_util_SequencedCollection_reversed() {
        return this.java_util_List_reversed();
    }

    @Override
    public Deque java_util_Deque_reversed() {
        return this.java_util_List_reversed();
    }
    ...
    extends AbstractList<T>
    implements ListDeque<T> {
        final private ArrayListDeque<T> original;
