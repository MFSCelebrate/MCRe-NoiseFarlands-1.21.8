...
extends LongLinkedOpenHashSet {
    ...
    extends Long2LongLinkedOpenHashMap {
        final static private int STARTING_OFFSET = MathHelper.floorLog2(60000000);
        final static private int HORIZONTAL_COLUMN_BIT_SEPARATION = MathHelper.floorLog2(60000000);
        final static private int FIELD_SPACING;
        final static private int Y_BIT_OFFSET = 0;
        final static private int X_BIT_OFFSET;
        final static private int Z_BIT_OFFSET;
        final static private long MAX_POSITION;
        private int lastWrittenIndex = -1;
        private long lastWrittenKey;
        final private int expectedSize;
