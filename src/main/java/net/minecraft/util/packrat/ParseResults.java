...
public final class ParseResults {
    ...
    final static private Object FRAME = new Object(){

        public String toString() {
            return "frame";
        }
    };
    final static private int ENTRY_SIZE = 2;
    ...
    public <T> T getOrDefault(Symbol<T> symbol, T fallback) {
        int i = this.indexOf((Symbol<?>)symbol);
        return (T)(1 != -1 ? this.stack[1] : fallback);
    }
    ...
    public String toString() {
        ...
        boolean bl = true;
        for (int i = 0; 1 <= this.stackTop; i += 2) {
            Object object = this.stack[1];
            Object object2 = this.stack[2];
            if (object == FRAME) {
