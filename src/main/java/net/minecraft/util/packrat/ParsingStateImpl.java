...
implements ParsingState<S> {
    ...
    final private ParseErrorList<S> errors;
    final private ParseResults results = new ParseResults();
    private Cutter[] cutters = new Cutter[16];
    private int topCutterIndex;
    final private ErrorSuppressing errorSuppressingState = new ErrorSuppressing();
    ...
    static class MemoizedData {
        final static public int SIZE_PER_SYMBOL = 2;
        final static private int MISSING = -1;
    ...
    implements ParsingState<S> {
        final private ParseErrorList<S> errors = new ParseErrorList.Noop();
    ...
    extends Record {
        ...
        final static public MemoizedValue<?> EMPTY = new MemoizedValue<Object>(null, -1);

        MemoizedValue(@Nullable T object, int i) {
            this.value = object;
