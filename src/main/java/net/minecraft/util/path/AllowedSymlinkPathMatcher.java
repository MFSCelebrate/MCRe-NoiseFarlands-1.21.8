...
implements PathMatcher {
    ...
    final static private String COMMENT_LINE_PREFIX = "#";
    final private List<Entry> allowedEntries;
    final private Map<String, PathMatcher> matcherCache = new ConcurrentHashMap<String, PathMatcher>();
    ...
    public static interface EntryType {
        final static public EntryType DEFAULT = FileSystem::getPathMatcher;
        final static public EntryType PREFIX = (fileSystem, prefix) -> path -> path.toString().startsWith(prefix);
