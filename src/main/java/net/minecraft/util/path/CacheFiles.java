...
public class CacheFiles {
    ...
    extends Record {
        final Path path;
        final private FileTime modifiedTime;
        final static public Comparator<CacheFile> COMPARATOR = Comparator.comparing(CacheFile::modifiedTime).reversed();
    ...
    extends Record {
        ...
        final static public Comparator<CacheEntry> COMPARATOR = Comparator.comparing(CacheEntry::removalPriority).reversed();
