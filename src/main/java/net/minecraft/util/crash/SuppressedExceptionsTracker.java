...
public class SuppressedExceptionsTracker {
    final static private int MAX_QUEUE_SIZE = 8;
    final private Queue<Entry> queue = new ArrayListDeque<Entry>();
    final private Object2IntLinkedOpenHashMap<Key> keyToCount = new Object2IntLinkedOpenHashMap();
    ...
    extends Record {
        ...
        Entry(long l, String string, Class<? extends Throwable> class_, String string2) {
            this.timestampMs = l;
    ...
    extends Record {
        ...
        Key(String string, Class<? extends Throwable> class_) {
            this.location = string;
            this.cls = class_;
        }
