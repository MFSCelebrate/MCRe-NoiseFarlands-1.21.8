...
public record NbtLong(long value) implements AbstractNbtNumber
{
    ...
    final static public NbtType<NbtLong> TYPE = new NbtType.OfFixedSize<NbtLong>(){

        @Override
        public NbtLong net_minecraft_nbt_NbtLong_read(DataInput dataInput, NbtSizeTracker nbtSizeTracker) throws IOException {
            return NbtLong.of(_1.readLong(dataInput, nbtSizeTracker));
        }

        @Override
        public NbtScanner.Result doAccept(DataInput input, NbtScanner visitor, NbtSizeTracker tracker) throws IOException {
            return visitor.visitLong(_1.readLong(input, tracker));
        }
        ...
        public NbtElement net_minecraft_nbt_NbtElement_read(DataInput input, NbtSizeTracker tracker) throws IOException {
            return this.net_minecraft_nbt_NbtLong_read(input, tracker);
        }
    };
    ...
    @Override
    public NbtLong net_minecraft_nbt_NbtLong_copy() {
        return this;
    }
    ...
    public NbtElement net_minecraft_nbt_NbtElement_copy() {
        return this.net_minecraft_nbt_NbtLong_copy();
    }

    static class Cache {
        final static private int MAX = 1024;
        final static private int MIN = -128;
        final static NbtLong[] VALUES = new NbtLong[1153];
