...
implements AbstractNbtList {
    ...
    final static public NbtType<NbtByteArray> TYPE = new NbtType.OfVariableSize<NbtByteArray>(){

        @Override
        public NbtByteArray net_minecraft_nbt_NbtByteArray_read(DataInput dataInput, NbtSizeTracker nbtSizeTracker) throws IOException {
            return new NbtByteArray(_1.readByteArray(dataInput, nbtSizeTracker));
        }

        @Override
        public NbtScanner.Result doAccept(DataInput input, NbtScanner visitor, NbtSizeTracker tracker) throws IOException {
            return visitor.visitByteArray(_1.readByteArray(input, tracker));
        }
        ...
        public NbtElement net_minecraft_nbt_NbtElement_read(DataInput input, NbtSizeTracker tracker) throws IOException {
            return this.net_minecraft_nbt_NbtByteArray_read(input, tracker);
        }
    };
    private byte[] value;
    ...
    @Override
    public NbtByte net_minecraft_nbt_NbtByte_method_10534(int i) {
    ...
    @Override
    public NbtByte net_minecraft_nbt_NbtByte_method_10536(int i) {
        byte b = this.value[i];
    ...
    public NbtElement net_minecraft_nbt_NbtElement_method_10534(int i) {
        return this.net_minecraft_nbt_NbtByte_method_10534(i);
    }

    @Override
    public NbtElement net_minecraft_nbt_NbtElement_method_10536(int i) {
        return this.net_minecraft_nbt_NbtByte_method_10536(i);
    }
}
