...
implements NbtElement {
    ...
    final static public NbtType<NbtEnd> TYPE = new NbtType<NbtEnd>(){

        @Override
        public NbtEnd net_minecraft_nbt_NbtEnd_read(DataInput dataInput, NbtSizeTracker nbtSizeTracker) {
        ...
        public NbtElement net_minecraft_nbt_NbtElement_read(DataInput input, NbtSizeTracker tracker) throws IOException {
            return this.net_minecraft_nbt_NbtEnd_read(input, tracker);
        }
    };
    final static public NbtEnd INSTANCE = new NbtEnd();
    ...
    @Override
    public NbtEnd net_minecraft_nbt_NbtEnd_copy() {
        return this;
    }
    ...
    public NbtElement net_minecraft_nbt_NbtElement_copy() {
        return this.net_minecraft_nbt_NbtEnd_copy();
    }
}
