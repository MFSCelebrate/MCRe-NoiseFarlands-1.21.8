...
public record NbtFloat(float value) implements AbstractNbtNumber
{
    ...
    final static public NbtFloat ZERO = new NbtFloat(0.0f);
    final static public NbtType<NbtFloat> TYPE = new NbtType.OfFixedSize<NbtFloat>(){

        @Override
        public NbtFloat net_minecraft_nbt_NbtFloat_read(DataInput dataInput, NbtSizeTracker nbtSizeTracker) throws IOException {
            return NbtFloat.of(_1.readFloat(dataInput, nbtSizeTracker));
        }

        @Override
        public NbtScanner.Result doAccept(DataInput input, NbtScanner visitor, NbtSizeTracker tracker) throws IOException {
            return visitor.visitFloat(_1.readFloat(input, tracker));
        }
        ...
        public NbtElement net_minecraft_nbt_NbtElement_read(DataInput input, NbtSizeTracker tracker) throws IOException {
            return this.net_minecraft_nbt_NbtFloat_read(input, tracker);
        }
    };
    ...
    @Override
    public NbtFloat net_minecraft_nbt_NbtFloat_copy() {
        return this;
    }
    ...
    public NbtElement net_minecraft_nbt_NbtElement_copy() {
        return this.net_minecraft_nbt_NbtFloat_copy();
    }
}
