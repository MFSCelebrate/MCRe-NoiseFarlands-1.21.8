...
public class SnbtParsing {
    final static private DynamicCommandExceptionType NUMBER_PARSE_FAILURE_EXCEPTION = new DynamicCommandExceptionType(value -> Text.stringifiedTranslatable("snbt.parser.number_parse_failure", value));
    final static DynamicCommandExceptionType EXPECTED_HEX_ESCAPE_EXCEPTION = new DynamicCommandExceptionType(length -> Text.stringifiedTranslatable("snbt.parser.expected_hex_escape", length));
    final static private DynamicCommandExceptionType INVALID_CODEPOINT_EXCEPTION = new DynamicCommandExceptionType(value -> Text.stringifiedTranslatable("snbt.parser.invalid_codepoint", value));
    final static private DynamicCommandExceptionType NO_SUCH_OPERATION_EXCEPTION = new DynamicCommandExceptionType(operation -> Text.stringifiedTranslatable("snbt.parser.no_such_operation", operation));
    final static CursorExceptionType<CommandSyntaxException> EXPECTED_INTEGER_TYPE_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.expected_integer_type")));
    final static private CursorExceptionType<CommandSyntaxException> EXPECTED_FLOAT_TYPE_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.expected_float_type")));
    final static CursorExceptionType<CommandSyntaxException> EXPECTED_NON_NEGATIVE_NUMBER_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.expected_non_negative_number")));
    final static private CursorExceptionType<CommandSyntaxException> INVALID_CHARACTER_NAME_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.invalid_character_name")));
    final static CursorExceptionType<CommandSyntaxException> INVALID_ARRAY_ELEMENT_TYPE_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.invalid_array_element_type")));
    final static private CursorExceptionType<CommandSyntaxException> INVALID_UNQUOTED_START_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.invalid_unquoted_start")));
    final static private CursorExceptionType<CommandSyntaxException> EXPECTED_UNQUOTED_STRING_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.expected_unquoted_string")));
    final static private CursorExceptionType<CommandSyntaxException> INVALID_STRING_CONTENTS_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.invalid_string_contents")));
    final static private CursorExceptionType<CommandSyntaxException> EXPECTED_BINARY_NUMERAL_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.expected_binary_numeral")));
    final static private CursorExceptionType<CommandSyntaxException> UNDERSCORE_NOT_ALLOWED_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.underscore_not_allowed")));
    final static private CursorExceptionType<CommandSyntaxException> EXPECTED_DECIMAL_NUMERAL_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.expected_decimal_numeral")));
    final static private CursorExceptionType<CommandSyntaxException> EXPECTED_HEX_NUMERAL_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.expected_hex_numeral")));
    final static private CursorExceptionType<CommandSyntaxException> EMPTY_KEY_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.empty_key")));
    final static private CursorExceptionType<CommandSyntaxException> LEADING_ZERO_NOT_ALLOWED_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.leading_zero_not_allowed")));
    final static private CursorExceptionType<CommandSyntaxException> INFINITY_NOT_ALLOWED_EXCEPTION = CursorExceptionType.create(new SimpleCommandExceptionType((Message)Text.translatable("snbt.parser.infinity_not_allowed")));
    final static private HexFormat HEX_FORMAT = HexFormat.of().withUpperCase();
    final static private NumeralParsingRule BINARY_RULE = new NumeralParsingRule((CursorExceptionType)EXPECTED_BINARY_NUMERAL_EXCEPTION, (CursorExceptionType)UNDERSCORE_NOT_ALLOWED_EXCEPTION){
    ...
    final static private NumeralParsingRule DECIMAL_RULE = new NumeralParsingRule((CursorExceptionType)EXPECTED_DECIMAL_NUMERAL_EXCEPTION, (CursorExceptionType)UNDERSCORE_NOT_ALLOWED_EXCEPTION){
    ...
    final static private NumeralParsingRule HEX_RULE = new NumeralParsingRule((CursorExceptionType)EXPECTED_HEX_NUMERAL_EXCEPTION, (CursorExceptionType)UNDERSCORE_NOT_ALLOWED_EXCEPTION){
    ...
    final static private TokenParsingRule UNQUOTED_STRING_RULE = new TokenParsingRule(1, (CursorExceptionType)INVALID_STRING_CONTENTS_EXCEPTION){
    ...
    final static private Literals.CharacterLiteral DECIMAL_CHAR = new Literals.CharacterLiteral(CharList.of()){
    ...
    final static private Pattern UNICODE_NAME_PATTERN = Pattern.compile("[-a-zA-Z0-9 ]+");
    ...
    extends Enum<Sign> {
        final static public Sign PLUS = new Sign();
        final static public Sign MINUS = new Sign();
        final static private Sign[] field_58016;
    ...
    extends Record {
        ...
        SignedValue(Sign sign, T object) {
            this.sign = sign;
            this.value = object;
        }
    ...
    extends Enum<NumericType> {
        final static public NumericType FLOAT = new NumericType();
        final static public NumericType DOUBLE = new NumericType();
        final static public NumericType BYTE = new NumericType();
        final static public NumericType SHORT = new NumericType();
        final static public NumericType INT = new NumericType();
        final static public NumericType LONG = new NumericType();
        final static private NumericType[] field_58026;
    ...
    extends Record {
        ...
        final static public NumberSuffix DEFAULT = new NumberSuffix(null, null);
    ...
    extends Enum<Signedness> {
        final static public Signedness SIGNED = new Signedness();
        final static public Signedness UNSIGNED = new Signedness();
        final static private Signedness[] field_58019;
    ...
    extends Enum<ArrayType> {
        final static public ArrayType BYTE = new ArrayType(NumericType.BYTE, new NumericType[0]){
            final static private ByteBuffer EMPTY_BUFFER = ByteBuffer.wrap(new byte[0]);
        ...
        final static public ArrayType INT = new ArrayType(NumericType.INT, new NumericType[]{NumericType.BYTE, NumericType.SHORT}){
        ...
        final static public ArrayType LONG = new ArrayType(NumericType.LONG, new NumericType[]{NumericType.BYTE, NumericType.SHORT, NumericType.INT}){
        ...
        final private NumericType elementType;
        final private Set<NumericType> castableTypes;
        final static private ArrayType[] field_58007;
    ...
    extends Record {
        final private Sign sign;
        final private Radix base;
        final private String digits;
    ...
    extends Enum<Radix> {
        final static public Radix BINARY = new Radix();
        final static public Radix DECIMAL = new Radix();
        final static public Radix HEX = new Radix();
        final static private Radix[] field_58012;
