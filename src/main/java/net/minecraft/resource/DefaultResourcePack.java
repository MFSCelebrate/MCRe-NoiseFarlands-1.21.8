...
implements ResourcePack {
    ...
    final private ResourceMetadataMap metadata;
    final private Set<String> namespaces;
    final private List<Path> rootPaths;
    final private Map<ResourceType, List<Path>> namespacePaths;
    ...
    public <T> T parseMetadata(ResourceMetadataSerializer<T> metadataSerializer) {
        ...
        try {
            ...
            if (inputStream == null) return this.metadata.get(metadataSerializer);
            inputStream.close();
