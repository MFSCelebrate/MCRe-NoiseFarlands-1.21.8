...
extends FileSystem {
    final static private Set<String> SUPPORTED_FILE_ATTRIBUTE_VIEWS = Set.of("basic");
    final static public String SEPARATOR = "/";
    final static private Splitter SEPARATOR_SPLITTER = Splitter.on((char)'/');
    final private FileStore store;
    final private FileSystemProvider fileSystemProvider = new ResourceFileSystemProvider();
    final private ResourcePath root;
    ...
    extends Record {
        ...
        private Directory(Map<String, Directory> map, Map<String, Path> map2) {
            this.children = map;
            this.files = map2;
        }
    ...
    public static class Builder {
        final private Directory root = new Directory();
        ...
        public Builder withFile(List<String> directories, Path path) {
            ...
            return this.withFile(directories.subList(0, 1), directories.get(1), path);
        }
