...
class ResourcePath
implements Path {
    final static private BasicFileAttributes DIRECTORY_ATTRIBUTES = new ResourceFileAttributes(){
    ...
    final static private BasicFileAttributes FILE_ATTRIBUTES = new ResourceFileAttributes(){
    ...
    final static private Comparator<ResourcePath> COMPARATOR = Comparator.comparing(ResourcePath::getPathString);
    final private String name;
    final private ResourceFileSystem fileSystem;
    @Nullable
    final private ResourcePath parent;
    @Nullable
    private List<String> names;
    @Nullable
    private String pathString;
    final private ResourceFile file;
    ...
    @Override
    public ResourceFileSystem net_minecraft_resource_fs_ResourceFileSystem_getFileSystem() {
    ...
    @Override
    @Nullable
    public ResourcePath net_minecraft_resource_fs_ResourcePath_getRoot() {
        if (this.isAbsolute()) {
    ...
    @Override
    public ResourcePath net_minecraft_resource_fs_ResourcePath_getFileName() {
        return this.relativize(null, this.name);
    }

    @Override
    @Nullable
    public ResourcePath net_minecraft_resource_fs_ResourcePath_getParent() {
        return this.parent;
    }
    ...
    @Override
    public ResourcePath net_minecraft_resource_fs_ResourcePath_getName(int i) {
    ...
    @Override
    public ResourcePath net_minecraft_resource_fs_ResourcePath_subpath(int i, int j) {
        List<String> list = this.getNames();
    ...
    @Override
    public ResourcePath net_minecraft_resource_fs_ResourcePath_normalize() {
        return this;
    }

    @Override
    public ResourcePath net_minecraft_resource_fs_ResourcePath_resolve(Path path) {
    ...
    @Override
    public ResourcePath net_minecraft_resource_fs_ResourcePath_relativize(Path path) {
        ResourcePath resourcePath = this.toResourcePath(path);
        ...
        return resourcePath.net_minecraft_resource_fs_ResourcePath_subpath(list.size(), list2.size());
    }
    ...
    @Override
    public ResourcePath net_minecraft_resource_fs_ResourcePath_toAbsolutePath() {
        if (this.isAbsolute()) {
            return this;
        }
        return this.fileSystem.getRoot().net_minecraft_resource_fs_ResourcePath_resolve(this);
    }

    @Override
    public ResourcePath net_minecraft_resource_fs_ResourcePath_toRealPath(LinkOption ... linkOptions) {
        return this.net_minecraft_resource_fs_ResourcePath_toAbsolutePath();
    }
    ...
    @Override
    public Path java_nio_file_Path_toRealPath(LinkOption[] options) throws IOException {
        return this.net_minecraft_resource_fs_ResourcePath_toRealPath(options);
    }

    @Override
    public Path java_nio_file_Path_toAbsolutePath() {
        return this.net_minecraft_resource_fs_ResourcePath_toAbsolutePath();
    }

    @Override
    public Path java_nio_file_Path_relativize(Path other) {
        return this.net_minecraft_resource_fs_ResourcePath_relativize(other);
    }

    @Override
    public Path java_nio_file_Path_resolve(Path other) {
        return this.net_minecraft_resource_fs_ResourcePath_resolve(other);
    }

    @Override
    public Path java_nio_file_Path_normalize() {
        return this.net_minecraft_resource_fs_ResourcePath_normalize();
    }

    @Override
    public Path java_nio_file_Path_subpath(int beginIndex, int endIndex) {
        return this.net_minecraft_resource_fs_ResourcePath_subpath(beginIndex, endIndex);
    }

    @Override
    public Path java_nio_file_Path_getName(int index) {
        return this.net_minecraft_resource_fs_ResourcePath_getName(index);
    }

    @Override
    @Nullable
    public Path java_nio_file_Path_getParent() {
        return this.net_minecraft_resource_fs_ResourcePath_getParent();
    }

    @Override
    public Path java_nio_file_Path_getFileName() {
        return this.net_minecraft_resource_fs_ResourcePath_getFileName();
    }

    @Override
    @Nullable
    public Path java_nio_file_Path_getRoot() {
        return this.net_minecraft_resource_fs_ResourcePath_getRoot();
    }

    @Override
    public FileSystem java_nio_file_FileSystem_getFileSystem() {
        return this.net_minecraft_resource_fs_ResourceFileSystem_getFileSystem();
    }
}
