...
implements ReadView {
    ...
    final private ReadContext context;
    ...
    implements ReadView.ListReadView {
        final private ErrorReporter reporter;
        final private ReadContext context;
        final private List<NbtCompound> nbts;
        ...
        public Iterator<ReadView> iterator() {
            ...
            return new AbstractIterator<ReadView>(){
                ...
                @Nullable
                protected ReadView net_minecraft_storage_ReadView_computeNext() {
                ...
                protected Object java_lang_Object_computeNext() {
                    return this.net_minecraft_storage_ReadView_computeNext();
                }
            };
        }
    }
