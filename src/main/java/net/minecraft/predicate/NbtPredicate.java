...
public record NbtPredicate(NbtCompound nbt) {
    ...
    final static public Codec<NbtPredicate> CODEC = StringNbtReader.NBT_COMPOUND_CODEC.xmap(NbtPredicate::new, NbtPredicate::nbt);
    final static public PacketCodec<ByteBuf, NbtPredicate> PACKET_CODEC = PacketCodecs.NBT_COMPOUND.xmap(NbtPredicate::new, NbtPredicate::nbt);
    final static public String SELECTED_ITEM_KEY = "SelectedItem";
