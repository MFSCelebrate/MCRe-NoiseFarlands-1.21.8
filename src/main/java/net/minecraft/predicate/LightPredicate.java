...
public record LightPredicate(NumberRange.IntRange range) {
    final static public Codec<LightPredicate> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)NumberRange.IntRange.CODEC.optionalFieldOf("light", (Object)NumberRange.IntRange.ANY).forGetter(LightPredicate::range)).apply((Applicative)instance, LightPredicate::new));
