...
public record EntityEffectPredicate(Map<RegistryEntry<StatusEffect>, EffectData> effects) {
    final static public Codec<EntityEffectPredicate> CODEC = Codec.unboundedMap(StatusEffect.ENTRY_CODEC, EffectData.CODEC).xmap(EntityEffectPredicate::new, EntityEffectPredicate::effects);
    ...
    public static class Builder {
        final private ImmutableMap.Builder<RegistryEntry<StatusEffect>, EffectData> effects = ImmutableMap.builder();
