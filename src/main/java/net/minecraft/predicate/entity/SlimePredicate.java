...
{
    final static public MapCodec<SlimePredicate> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)NumberRange.IntRange.CODEC.optionalFieldOf("size", (Object)NumberRange.IntRange.ANY).forGetter(SlimePredicate::size)).apply((Applicative)instance, SlimePredicate::new));
