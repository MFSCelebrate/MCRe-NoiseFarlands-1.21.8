...
{
    final static public FishingHookPredicate ALL = new FishingHookPredicate(Optional.empty());
    final static public MapCodec<FishingHookPredicate> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.BOOL.optionalFieldOf("in_open_water").forGetter(FishingHookPredicate::inOpenWater)).apply((Applicative)instance, FishingHookPredicate::new));
