...
public record EntityTypePredicate(RegistryEntryList<EntityType<?>> types) {
    final static public Codec<EntityTypePredicate> CODEC = RegistryCodecs.entryList(RegistryKeys.ENTITY_TYPE).xmap(EntityTypePredicate::new, EntityTypePredicate::types);
