...
public final class EntityPredicates {
    final static public Predicate<Entity> VALID_ENTITY = Entity::isAlive;
    final static public Predicate<Entity> VALID_LIVING_ENTITY = entity -> entity.isAlive() && entity instanceof LivingEntity;
    final static public Predicate<Entity> NOT_MOUNTED = entity -> entity.isAlive() && !entity.hasPassengers() && !entity.hasVehicle();
    final static public Predicate<Entity> VALID_INVENTORIES = entity -> entity instanceof Inventory && entity.isAlive();
    final static public Predicate<Entity> EXCEPT_CREATIVE_OR_SPECTATOR = entity -> {
    ...
    final static public Predicate<Entity> EXCEPT_SPECTATOR = entity -> !entity.isSpectator();
    final static public Predicate<Entity> CAN_COLLIDE = EXCEPT_SPECTATOR.and(entity -> entity.isCollidable(null));
    final static public Predicate<Entity> CAN_HIT = EXCEPT_SPECTATOR.and(Entity::canHit);
    ...
    public static Predicate<Entity> canBePushedBy(Entity entity) {
        ...
        return EXCEPT_SPECTATOR.and(entityx -> {
            ...
            if (!(!entity.net_minecraft_world_World_getWorld().isClient || entityx instanceof PlayerEntity && (playerEntity = (PlayerEntity)entityx).isMainPlayer())) {
                return false;
            }
