...
public class LootContextPredicate {
    final static public Codec<LootContextPredicate> CODEC = LootCondition.CODEC.listOf().xmap(LootContextPredicate::new, lootContextPredicate -> lootContextPredicate.conditions);
    final private List<LootCondition> conditions;
    final private Predicate<LootContext> combinedCondition;
