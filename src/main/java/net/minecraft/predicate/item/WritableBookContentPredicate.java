...
{
    final static public Codec<WritableBookContentPredicate> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)CollectionPredicate.createCodec(RawStringPredicate.CODEC).optionalFieldOf("pages").forGetter(WritableBookContentPredicate::pages)).apply((Applicative)instance, WritableBookContentPredicate::new));
    ...
    {
        final static public Codec<RawStringPredicate> CODEC = Codec.STRING.xmap(RawStringPredicate::new, RawStringPredicate::contents);
