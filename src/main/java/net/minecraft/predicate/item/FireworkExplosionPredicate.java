...
{
    final static public Codec<FireworkExplosionPredicate> CODEC = Predicate.CODEC.xmap(FireworkExplosionPredicate::new, FireworkExplosionPredicate::predicate);
    ...
    public record Predicate(Optional<FireworkExplosionComponent.Type> shape, Optional<Boolean> twinkle, Optional<Boolean> trail) implements java.util.function.Predicate<FireworkExplosionComponent>
    {
        ...
        @Override
        public boolean test(Object fireworkExplosionComponent) {
