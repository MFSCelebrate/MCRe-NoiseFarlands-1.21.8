...
implements ToggleableFeature {
    final static public Codec<RegistryEntry<Potion>> CODEC = Registries.POTION.getEntryCodec();
    final static public PacketCodec<RegistryByteBuf, RegistryEntry<Potion>> PACKET_CODEC = PacketCodecs.registryEntry(RegistryKeys.POTION);
    final private String baseName;
    final private List<StatusEffectInstance> effects;
