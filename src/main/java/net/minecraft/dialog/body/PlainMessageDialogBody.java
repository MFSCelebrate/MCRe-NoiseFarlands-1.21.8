...
{
    final static public int DEFAULT_WIDTH = 200;
    final static public MapCodec<PlainMessageDialogBody> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)TextCodecs.CODEC.fieldOf("contents").forGetter(PlainMessageDialogBody::contents), (App)Dialog.WIDTH_CODEC.optionalFieldOf("width", (Object)200).forGetter(PlainMessageDialogBody::width)).apply((Applicative)instance, PlainMessageDialogBody::new));
    final static public Codec<PlainMessageDialogBody> ALTERNATIVE_CODEC = Codec.withAlternative((Codec)CODEC.codec(), TextCodecs.CODEC, contents -> new PlainMessageDialogBody((Text)contents, 200));
