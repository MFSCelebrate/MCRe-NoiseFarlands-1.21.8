...
{
    final static public MapCodec<DynamicRunCommandDialogAction> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)ParsedTemplate.CODEC.fieldOf("template").forGetter(DynamicRunCommandDialogAction::template)).apply((Applicative)instance, DynamicRunCommandDialogAction::new));
