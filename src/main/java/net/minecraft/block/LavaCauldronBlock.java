...
extends AbstractCauldronBlock {
    final static public MapCodec<LavaCauldronBlock> CODEC = LavaCauldronBlock.createCodec(LavaCauldronBlock::new);
    final static private VoxelShape LAVA_SHAPE = Block.createColumnShape(12.0, 4.0, 15.0);
    final static private VoxelShape INSIDE_COLLISION_SHAPE = VoxelShapes.union(AbstractCauldronBlock.OUTLINE_SHAPE, LAVA_SHAPE);
