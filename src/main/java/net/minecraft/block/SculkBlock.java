...
implements SculkSpreadable {
    final static public MapCodec<SculkBlock> CODEC = SculkBlock.createCodec(SculkBlock::new);
    ...
    private static boolean shouldNotDecay(WorldAccess world, BlockPos pos) {
        ...
        int i = 0;
        for (BlockPos blockPos : BlockPos.iterate(pos.net_minecraft_util_math_BlockPos_add(-4, 0, -4), pos.net_minecraft_util_math_BlockPos_add(4, 2, 4))) {
