...
extends DeadCoralFanBlock {
    final static public MapCodec<DeadCoralWallFanBlock> CODEC = DeadCoralWallFanBlock.createCodec(DeadCoralWallFanBlock::new);
    final static public EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    final static private Map<Direction, VoxelShape> SHAPES_BY_DIRECTION = VoxelShapes.createHorizontalFacingShapeMap(Block.createCuboidZShape(16.0, 8.0, 5.0, 16.0));
