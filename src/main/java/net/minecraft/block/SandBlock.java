...
extends ColoredFallingBlock {
    final static public MapCodec<SandBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)ColorCode.CODEC.fieldOf("falling_dust_color").forGetter(block -> block.color), SandBlock.createSettingsCodec()).apply((Applicative)instance, SandBlock::new));
