...
implements Fertilizable {
    final static public MapCodec<GlowLichenBlock> CODEC = GlowLichenBlock.createCodec(GlowLichenBlock::new);
    final private MultifaceGrower grower = new MultifaceGrower(this);
