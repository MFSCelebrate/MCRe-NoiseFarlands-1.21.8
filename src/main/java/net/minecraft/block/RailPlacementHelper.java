...
public class RailPlacementHelper {
    ...
    final private AbstractRailBlock block;
    private BlockState state;
    final private boolean forbidCurves;
    final private List<BlockPos> neighbors = Lists.newArrayList();
    ...
    private void computeNeighbors(RailShape shape) {
        ...
        switch (shape) {
            case NORTH_SOUTH: {
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_north());
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_south());
                break;
            }
            case EAST_WEST: {
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_west());
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_east());
                break;
            }
            case ASCENDING_EAST: {
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_west());
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_east().net_minecraft_util_math_BlockPos_up());
                break;
            }
            case ASCENDING_WEST: {
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_west().net_minecraft_util_math_BlockPos_up());
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_east());
                break;
            }
            case ASCENDING_NORTH: {
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_north().net_minecraft_util_math_BlockPos_up());
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_south());
                break;
            }
            case ASCENDING_SOUTH: {
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_north());
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_south().net_minecraft_util_math_BlockPos_up());
                break;
            }
            case SOUTH_EAST: {
                this.neighbors.add(this.pos.net_minecraft_util_math_BlockPos_east());
    ...
    private boolean isVerticallyNearRail(BlockPos pos) {
        return AbstractRailBlock.isRail(this.world, pos) || AbstractRailBlock.isRail(this.world, pos.net_minecraft_util_math_BlockPos_up()) || AbstractRailBlock.isRail(this.world, pos.net_minecraft_util_math_BlockPos_down());
    }
    ...
    private RailPlacementHelper getNeighboringRail(BlockPos pos) {
        ...
        blockPos = pos.net_minecraft_util_math_BlockPos_up();
    ...
    protected int getNeighborCount() {
        ...
        for (Direction direction : Direction.Type.HORIZONTAL) {
            if (!this.isVerticallyNearRail(this.pos.net_minecraft_util_math_BlockPos_offset(direction))) continue;
            ++i;
        }
        return i;
    }
    ...
    private void computeRailShape(RailPlacementHelper placementHelper) {
        ...
        BlockPos blockPos = this.pos.net_minecraft_util_math_BlockPos_north();
        BlockPos blockPos2 = this.pos.net_minecraft_util_math_BlockPos_south();
        BlockPos blockPos3 = this.pos.net_minecraft_util_math_BlockPos_west();
        BlockPos blockPos4 = this.pos.net_minecraft_util_math_BlockPos_east();
        ...
        if (railShape == RailShape.NORTH_SOUTH) {
            if (AbstractRailBlock.isRail(this.world, blockPos.net_minecraft_util_math_BlockPos_up())) {
                railShape = RailShape.ASCENDING_NORTH;
            }
            if (AbstractRailBlock.isRail(this.world, blockPos2.net_minecraft_util_math_BlockPos_up())) {
                railShape = RailShape.ASCENDING_SOUTH;
            }
        }
        if (railShape == RailShape.EAST_WEST) {
            if (AbstractRailBlock.isRail(this.world, blockPos4.net_minecraft_util_math_BlockPos_up())) {
                railShape = RailShape.ASCENDING_EAST;
            }
            if (AbstractRailBlock.isRail(this.world, blockPos3.net_minecraft_util_math_BlockPos_up())) {
