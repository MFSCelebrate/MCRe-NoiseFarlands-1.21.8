...
extends DispenserBlock {
    ...
    final static public MapCodec<DropperBlock> CODEC = DropperBlock.createCodec(DropperBlock::new);
    final static private DispenserBehavior BEHAVIOR = new ItemDispenserBehavior();
    ...
    protected void dispense(ServerWorld world, BlockState state, BlockPos pos) {
        ...
        if (inventory == null) {
            itemStack2 = BEHAVIOR.net_minecraft_item_ItemStack_dispense(blockPointer, itemStack);
        } else {
