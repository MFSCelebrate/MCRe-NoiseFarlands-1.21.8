...
implements Fertilizable {
    final static public MapCodec<NyliumBlock> CODEC = NyliumBlock.createCodec(NyliumBlock::new);
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ...
        RegistryWrapper.Impl registry = world.getRegistryManager().net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.CONFIGURED_FEATURE);
