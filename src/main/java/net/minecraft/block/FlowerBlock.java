...
implements SuspiciousStewIngredient {
    final static protected MapCodec<SuspiciousStewEffectsComponent> STEW_EFFECT_CODEC = SuspiciousStewEffectsComponent.CODEC.fieldOf("suspicious_stew_effects");
    final static public MapCodec<FlowerBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)STEW_EFFECT_CODEC.forGetter(FlowerBlock::getStewEffects), FlowerBlock.createSettingsCodec()).apply((Applicative)instance, FlowerBlock::new));
    final static private VoxelShape SHAPE = Block.createColumnShape(6.0, 0.0, 10.0);
