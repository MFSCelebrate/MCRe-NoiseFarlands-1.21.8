...
extends AbstractFireBlock {
    final static public MapCodec<SoulFireBlock> CODEC = SoulFireBlock.createCodec(SoulFireBlock::new);
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        return SoulFireBlock.isSoulBase(world.getBlockState(pos.net_minecraft_util_math_BlockPos_down()));
    }
