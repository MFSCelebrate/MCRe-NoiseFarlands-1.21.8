...
extends AbstractBannerBlock {
    final static public MapCodec<BannerBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)DyeColor.CODEC.fieldOf("color").forGetter(AbstractBannerBlock::getColor), BannerBlock.createSettingsCodec()).apply((Applicative)instance, BannerBlock::new));
    final static public IntProperty ROTATION = Properties.ROTATION;
    final static private Map<DyeColor, Block> COLORED_BANNERS = Maps.newHashMap();
