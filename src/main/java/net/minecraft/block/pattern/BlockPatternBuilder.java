...
public class BlockPatternBuilder {
    final static private Joiner JOINER = Joiner.on((String)",");
    final private List<String[]> aisles = Lists.newArrayList();
    final private Map<Character, Predicate<CachedBlockPosition>> charMap = Maps.newHashMap();
    private int height;
    private int width;
