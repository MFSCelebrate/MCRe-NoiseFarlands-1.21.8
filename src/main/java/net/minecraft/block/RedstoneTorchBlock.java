...
extends AbstractTorchBlock {
    final static public MapCodec<RedstoneTorchBlock> CODEC = RedstoneTorchBlock.createCodec(RedstoneTorchBlock::new);
    final static public BooleanProperty LIT = Properties.LIT;
    final static private Map<BlockView, List<BurnoutEntry>> BURNOUT_MAP = new WeakHashMap<BlockView, List<BurnoutEntry>>();
    final static public int field_31227 = 60;
    final static public int field_31228 = 8;
    final static public int field_31229 = 160;
    ...
    private void update(World world, BlockPos pos, BlockState state) {
        ...
        for (Direction direction : Direction.values()) {
            world.updateNeighborsAlways(pos.net_minecraft_util_math_BlockPos_offset(direction), this, OrientationHelper.withFrontNullable(wireOrientation, direction));
        }
    }
    ...
    protected boolean shouldUnpower(World world, BlockPos pos, BlockState state) {
        return world.isEmittingRedstonePower(pos.net_minecraft_util_math_BlockPos_down(), Direction.DOWN);
    }
