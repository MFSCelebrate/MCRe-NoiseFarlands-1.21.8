...
implements InventoryProvider {
    final static public MapCodec<ComposterBlock> CODEC = ComposterBlock.createCodec(ComposterBlock::new);
    final static public int NUM_LEVELS = 8;
    final static public int MIN_LEVEL = 0;
    final static public int MAX_LEVEL = 7;
    final static public IntProperty LEVEL = Properties.LEVEL_8;
    final static public Object2FloatMap<ItemConvertible> ITEM_TO_LEVEL_INCREASE_CHANCE = new Object2FloatOpenHashMap();
    final static private int field_55750 = 12;
    final static private VoxelShape[] COLLISION_SHAPES_BY_LEVEL = Util.make(() -> {
    ...
    implements SidedInventory {
        ...
        final private WorldAccess world;
