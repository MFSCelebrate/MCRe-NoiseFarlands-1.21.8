...
public interface Segmented {
    final static public int SEGMENTS_PER_PLACEMENT = 1;
    final static public int MAX_SEGMENTS = 4;
    final static public IntProperty SEGMENT_AMOUNT = Properties.SEGMENT_AMOUNT;
