...
extends Block {
    final static public MapCodec<TargetBlock> CODEC = TargetBlock.createCodec(TargetBlock::new);
    final static private IntProperty POWER = Properties.POWER;
    final static private int RECOVERABLE_POWER_DELAY = 20;
    final static private int REGULAR_POWER_DELAY = 8;
