...
extends BlockWithEntity {
    final static public MapCodec<BellBlock> CODEC = BellBlock.createCodec(BellBlock::new);
    final static public EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    final static public EnumProperty<Attachment> ATTACHMENT = Properties.ATTACHMENT;
    final static public BooleanProperty POWERED = Properties.POWERED;
    final static private VoxelShape BELL_SHAPE = VoxelShapes.union(Block.createColumnShape(6.0, 6.0, 13.0), Block.createColumnShape(8.0, 4.0, 6.0));
    final static private VoxelShape CEILING_SHAPE = VoxelShapes.union(BELL_SHAPE, Block.createColumnShape(2.0, 13.0, 16.0));
    final static private Map<Direction.Axis, VoxelShape> FLOOR_SHAPES = VoxelShapes.createHorizontalAxisShapeMap(Block.createCuboidShape(16.0, 16.0, 8.0));
    final static private Map<Direction.Axis, VoxelShape> DOUBLE_WALL_SHAPES = VoxelShapes.createHorizontalAxisShapeMap(VoxelShapes.union(BELL_SHAPE, Block.createColumnShape(2.0, 16.0, 13.0, 15.0)));
    final static private Map<Direction, VoxelShape> SINGLE_WALL_SHAPES = VoxelShapes.createHorizontalFacingShapeMap(VoxelShapes.union(BELL_SHAPE, Block.createCuboidZShape(2.0, 13.0, 15.0, 0.0, 13.0)));
    final static public int field_31014 = 1;
    ...
    protected void onProjectileHit(World world, BlockState state, BlockHitResult hit, ProjectileEntity projectile) {
        ...
        Entity entity = projectile.net_minecraft_entity_Entity_getOwner();
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        if (axis == Direction.Axis.Y) {
            ...
            boolean bl = axis == Direction.Axis.X && world.getBlockState(blockPos.net_minecraft_util_math_BlockPos_west()).isSideSolidFullSquare(world, blockPos.net_minecraft_util_math_BlockPos_west(), Direction.EAST) && world.getBlockState(blockPos.net_minecraft_util_math_BlockPos_east()).isSideSolidFullSquare(world, blockPos.net_minecraft_util_math_BlockPos_east(), Direction.WEST) || axis == Direction.Axis.Z && world.getBlockState(blockPos.net_minecraft_util_math_BlockPos_north()).isSideSolidFullSquare(world, blockPos.net_minecraft_util_math_BlockPos_north(), Direction.SOUTH) && world.getBlockState(blockPos.net_minecraft_util_math_BlockPos_south()).isSideSolidFullSquare(world, blockPos.net_minecraft_util_math_BlockPos_south(), Direction.NORTH);
            ...
            boolean bl2 = world.getBlockState(blockPos.net_minecraft_util_math_BlockPos_down()).isSideSolidFullSquare(world, blockPos.net_minecraft_util_math_BlockPos_down(), Direction.UP);
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        if (direction == Direction.UP) {
            return Block.sideCoversSmallSquare(world, pos.net_minecraft_util_math_BlockPos_up(), Direction.DOWN);
        }
