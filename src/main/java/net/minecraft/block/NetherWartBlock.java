...
extends PlantBlock {
    final static public MapCodec<NetherWartBlock> CODEC = NetherWartBlock.createCodec(NetherWartBlock::new);
    final static public int MAX_AGE = 3;
    final static public IntProperty AGE = Properties.AGE_3;
    final static private VoxelShape[] SHAPES_BY_AGE = Block.createShapeArray(3, age -> Block.createColumnShape(16.0, 0.0, 5 + age * 3));
