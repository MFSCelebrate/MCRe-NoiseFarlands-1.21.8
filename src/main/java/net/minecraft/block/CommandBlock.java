...
implements OperatorBlock {
    final static public MapCodec<CommandBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.BOOL.fieldOf("automatic").forGetter(block -> block.auto), CommandBlock.createSettingsCodec()).apply((Applicative)instance, CommandBlock::new));
    final static private Logger LOGGER = LogUtils.getLogger();
    final static public EnumProperty<Direction> FACING = FacingBlock.FACING;
    final static public BooleanProperty CONDITIONAL = Properties.CONDITIONAL;
    final private boolean auto;
