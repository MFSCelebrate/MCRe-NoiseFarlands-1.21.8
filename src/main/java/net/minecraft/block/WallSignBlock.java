...
extends AbstractSignBlock {
    final static public MapCodec<WallSignBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)WoodType.CODEC.fieldOf("wood_type").forGetter(AbstractSignBlock::getWoodType), WallSignBlock.createSettingsCodec()).apply((Applicative)instance, WallSignBlock::new));
    final static public EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    final static private Map<Direction, VoxelShape> SHAPES_BY_DIRECTION = VoxelShapes.createHorizontalFacingShapeMap(Block.createCuboidZShape(16.0, 4.5, 12.5, 14.0, 16.0));
