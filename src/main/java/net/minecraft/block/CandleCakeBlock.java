...
extends AbstractCandleBlock {
    final static public MapCodec<CandleCakeBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Registries.BLOCK.getCodec().fieldOf("candle").forGetter(block -> block.candle), CandleCakeBlock.createSettingsCodec()).apply((Applicative)instance, CandleCakeBlock::new));
    final static public BooleanProperty LIT = AbstractCandleBlock.LIT;
    final static private VoxelShape SHAPE = VoxelShapes.union(Block.createColumnShape(2.0, 8.0, 14.0), Block.createColumnShape(14.0, 0.0, 8.0));
    final static private Map<CandleBlock, CandleCakeBlock> CANDLES_TO_CANDLE_CAKES = Maps.newHashMap();
    final static private Iterable<Vec3d> PARTICLE_OFFSETS = List.of(new Vec3d(8.0, 16.0, 8.0).multiply(0.0625));
    final private CandleBlock candle;
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        return world.getBlockState(pos.net_minecraft_util_math_BlockPos_down()).isSolid();
    }
