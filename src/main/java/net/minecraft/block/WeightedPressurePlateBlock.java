...
extends AbstractPressurePlateBlock {
    final static public MapCodec<WeightedPressurePlateBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.intRange(1, 1024).fieldOf("max_weight").forGetter(block -> block.weight), (App)BlockSetType.CODEC.fieldOf("block_set_type").forGetter(block -> block.blockSetType), WeightedPressurePlateBlock.createSettingsCodec()).apply((Applicative)instance, WeightedPressurePlateBlock::new));
