...
extends AbstractTorchBlock {
    final static protected MapCodec<SimpleParticleType> PARTICLE_TYPE_CODEC = Registries.PARTICLE_TYPE.getCodec().comapFlatMap(particleType -> {
    ...
    final static public MapCodec<TorchBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)PARTICLE_TYPE_CODEC.forGetter(block -> block.particle), TorchBlock.createSettingsCodec()).apply((Applicative)instance, TorchBlock::new));
    final protected SimpleParticleType particle;
