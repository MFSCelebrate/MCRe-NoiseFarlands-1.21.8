...
extends FallingBlock {
    final static public MapCodec<ConcretePowderBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Registries.BLOCK.getCodec().fieldOf("concrete").forGetter(block -> block.hardenedState), ConcretePowderBlock.createSettingsCodec()).apply((Applicative)instance, ConcretePowderBlock::new));
    final private Block hardenedState;
