...
FabricBlock {
    final static public MapCodec<Block> CODEC = Block.createCodec(Block::new);
    final static private Logger LOGGER = LogUtils.getLogger();
    final private RegistryEntry.Reference<Block> registryEntry = Registries.BLOCK.createEntry(this);
    final static public IdList<BlockState> STATE_IDS = new IdList();
    final static private LoadingCache<VoxelShape, Boolean> FULL_CUBE_SHAPE_CACHE = CacheBuilder.newBuilder().maximumSize(512L).weakKeys().build((CacheLoader)new CacheLoader<VoxelShape, Boolean>(){
    ...
    final static public int NOTIFY_NEIGHBORS = 1;
    final static public int NOTIFY_LISTENERS = 2;
    final static public int NO_REDRAW = 4;
    final static public int REDRAW_ON_MAIN_THREAD = 8;
    final static public int FORCE_STATE = 16;
    final static public int SKIP_DROPS = 32;
    final static public int MOVED = 64;
    final static public int SKIP_REDSTONE_WIRE_STATE_REPLACEMENT = 128;
    final static public int SKIP_BLOCK_ENTITY_REPLACED_CALLBACK = 256;
    final static public int SKIP_BLOCK_ADDED_CALLBACK = 512;
    final static public int SKIP_REDRAW_AND_BLOCK_ENTITY_REPLACED_CALLBACK = 260;
    final static public int NOTIFY_ALL = 3;
    final static public int NOTIFY_ALL_AND_REDRAW = 11;
    final static public int FORCE_STATE_AND_SKIP_CALLBACKS_AND_DROPS = 816;
    final static public float field_31023 = -1.0f;
    final static public float field_31024 = 0.0f;
    final static public int field_31025 = 512;
    final protected StateManager<Block, BlockState> stateManager;
    private BlockState defaultState;
    @Nullable
    private Item cachedItem;
    final static private int FACE_CULL_MAP_SIZE = 256;
    final static private ThreadLocal<Object2ByteLinkedOpenHashMap<VoxelShapePair>> FACE_CULL_MAP = ThreadLocal.withInitial(() -> {
    ...
    private static void dropStack(World world, Supplier<ItemEntity> itemEntitySupplier, ItemStack stack) {
        block3: {
            block2: {
                ...
                if (!stack.isEmpty() && serverWorld.getGameRules().getBoolean(GameRules.DO_TILE_DROPS)) break block3;
            }
            return;
        }
