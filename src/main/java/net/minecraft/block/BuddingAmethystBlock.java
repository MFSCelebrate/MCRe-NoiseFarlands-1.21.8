...
extends AmethystBlock {
    final static public MapCodec<BuddingAmethystBlock> CODEC = BuddingAmethystBlock.createCodec(BuddingAmethystBlock::new);
    final static public int GROW_CHANCE = 5;
