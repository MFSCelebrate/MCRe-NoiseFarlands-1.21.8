...
implements Waterloggable {
    final static public MapCodec<WallBlock> CODEC = WallBlock.createCodec(WallBlock::new);
    final static public BooleanProperty UP = Properties.UP;
    final static public EnumProperty<WallShape> EAST_WALL_SHAPE = Properties.EAST_WALL_SHAPE;
    final static public EnumProperty<WallShape> NORTH_WALL_SHAPE = Properties.NORTH_WALL_SHAPE;
    final static public EnumProperty<WallShape> SOUTH_WALL_SHAPE = Properties.SOUTH_WALL_SHAPE;
    final static public EnumProperty<WallShape> WEST_WALL_SHAPE = Properties.WEST_WALL_SHAPE;
    final static public Map<Direction, EnumProperty<WallShape>> WALL_SHAPE_PROPERTIES_BY_DIRECTION = ImmutableMap.copyOf((Map)Maps.newEnumMap(Map.of(Direction.NORTH, NORTH_WALL_SHAPE, Direction.EAST, EAST_WALL_SHAPE, Direction.SOUTH, SOUTH_WALL_SHAPE, Direction.WEST, WEST_WALL_SHAPE)));
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final private Function<BlockState, VoxelShape> outlineShapeFunction;
    final private Function<BlockState, VoxelShape> collisionShapeFunction;
    final static private VoxelShape POST_SHAPE_FOR_TALL_TEST = Block.createColumnShape(2.0, 0.0, 16.0);
    final static private Map<Direction, VoxelShape> WALL_SHAPES_FOR_TALL_TEST_BY_DIRECTION = VoxelShapes.createHorizontalFacingShapeMap(Block.createCuboidZShape(2.0, 16.0, 0.0, 9.0));
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        BlockPos blockPos2 = blockPos.net_minecraft_util_math_BlockPos_north();
        BlockPos blockPos3 = blockPos.net_minecraft_util_math_BlockPos_east();
        BlockPos blockPos4 = blockPos.net_minecraft_util_math_BlockPos_south();
        BlockPos blockPos5 = blockPos.net_minecraft_util_math_BlockPos_west();
        BlockPos blockPos6 = blockPos.net_minecraft_util_math_BlockPos_up();
