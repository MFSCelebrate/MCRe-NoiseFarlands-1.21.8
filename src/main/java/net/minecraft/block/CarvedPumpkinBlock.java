...
extends HorizontalFacingBlock {
    final static public MapCodec<CarvedPumpkinBlock> CODEC = CarvedPumpkinBlock.createCodec(CarvedPumpkinBlock::new);
    ...
    final static private Predicate<BlockState> IS_GOLEM_HEAD_PREDICATE = state -> state != null && (state.isOf(Blocks.CARVED_PUMPKIN) || state.isOf(Blocks.JACK_O_LANTERN));
