...
extends TorchBlock {
    final static public MapCodec<WallTorchBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)PARTICLE_TYPE_CODEC.forGetter(block -> block.particle), WallTorchBlock.createSettingsCodec()).apply((Applicative)instance, WallTorchBlock::new));
    final static public EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    final static private Map<Direction, VoxelShape> SHAPES_BY_DIRECTION = VoxelShapes.createHorizontalFacingShapeMap(Block.createCuboidZShape(5.0, 3.0, 13.0, 11.0, 16.0));
