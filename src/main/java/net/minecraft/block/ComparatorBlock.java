...
implements BlockEntityProvider {
    final static public MapCodec<ComparatorBlock> CODEC = ComparatorBlock.createCodec(ComparatorBlock::new);
    final static public EnumProperty<ComparatorMode> MODE = Properties.COMPARATOR_MODE;
    ...
    protected int getPower(World world, BlockPos pos, BlockState state) {
        ...
        if (blockState.hasComparatorOutput()) {
            ...
            blockPos = blockPos.net_minecraft_util_math_BlockPos_offset(direction);
