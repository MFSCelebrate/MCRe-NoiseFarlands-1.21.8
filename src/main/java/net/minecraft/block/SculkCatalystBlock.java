...
extends BlockWithEntity {
    final static public MapCodec<SculkCatalystBlock> CODEC = SculkCatalystBlock.createCodec(SculkCatalystBlock::new);
    final static public BooleanProperty BLOOM = Properties.BLOOM;
    final private IntProvider experience = ConstantIntProvider.create(5);
