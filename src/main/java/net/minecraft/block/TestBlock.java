...
implements OperatorBlock {
    final static public MapCodec<TestBlock> CODEC = TestBlock.createCodec(TestBlock::new);
    final static public EnumProperty<TestBlockMode> MODE = Properties.TEST_BLOCK_MODE;
