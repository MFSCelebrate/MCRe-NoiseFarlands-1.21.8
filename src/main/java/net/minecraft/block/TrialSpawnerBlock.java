...
extends BlockWithEntity {
    final static public MapCodec<TrialSpawnerBlock> CODEC = TrialSpawnerBlock.createCodec(TrialSpawnerBlock::new);
    final static public EnumProperty<TrialSpawnerState> TRIAL_SPAWNER_STATE = Properties.TRIAL_SPAWNER_STATE;
    final static public BooleanProperty OMINOUS = Properties.OMINOUS;
