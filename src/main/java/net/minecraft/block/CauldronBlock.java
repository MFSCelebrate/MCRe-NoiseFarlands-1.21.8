...
extends AbstractCauldronBlock {
    final static public MapCodec<CauldronBlock> CODEC = CauldronBlock.createCodec(CauldronBlock::new);
    final static private float FILL_WITH_RAIN_CHANCE = 0.05f;
    final static private float FILL_WITH_SNOW_CHANCE = 0.1f;
