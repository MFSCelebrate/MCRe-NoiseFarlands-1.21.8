...
extends DeadCoralFanBlock {
    final static public MapCodec<CoralFanBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)CoralBlockBlock.DEAD_FIELD.forGetter(block -> block.deadCoralBlock), CoralFanBlock.createSettingsCodec()).apply((Applicative)instance, CoralFanBlock::new));
