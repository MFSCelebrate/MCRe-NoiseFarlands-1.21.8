...
implements Waterloggable {
    final static public MapCodec<EnderChestBlock> CODEC = EnderChestBlock.createCodec(EnderChestBlock::new);
    ...
    final static private VoxelShape SHAPE = Block.createColumnShape(14.0, 0.0, 14.0);
    final static private Text CONTAINER_NAME = Text.translatable("container.enderchest");
