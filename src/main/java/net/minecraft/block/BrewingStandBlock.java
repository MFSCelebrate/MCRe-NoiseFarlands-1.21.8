...
extends BlockWithEntity {
    final static public MapCodec<BrewingStandBlock> CODEC = BrewingStandBlock.createCodec(BrewingStandBlock::new);
    final static public BooleanProperty[] BOTTLE_PROPERTIES = new BooleanProperty[]{Properties.HAS_BOTTLE_0, Properties.HAS_BOTTLE_1, Properties.HAS_BOTTLE_2};
    final static private VoxelShape SHAPE = VoxelShapes.union(Block.createColumnShape(2.0, 2.0, 14.0), Block.createColumnShape(14.0, 0.0, 2.0));
