...
Waterloggable {
    final static public MapCodec<SmallDripleafBlock> CODEC = SmallDripleafBlock.createCodec(SmallDripleafBlock::new);
    ...
    final static private VoxelShape SHAPE = Block.createColumnShape(12.0, 0.0, 13.0);
    ...
    protected boolean canPlantOnTop(BlockState floor, BlockView world, BlockPos pos) {
        return floor.isIn(BlockTags.SMALL_DRIPLEAF_PLACEABLE) || world.getFluidState(pos.net_minecraft_util_math_BlockPos_up()).isEqualAndStill(Fluids.WATER) && super.canPlantOnTop(floor, world, pos);
    }
