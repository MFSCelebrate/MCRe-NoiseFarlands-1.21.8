...
implements Waterloggable {
    final static public MapCodec<LightningRodBlock> CODEC = LightningRodBlock.createCodec(LightningRodBlock::new);
    ...
    final static private int SCHEDULED_TICK_DELAY = 8;
    final static public int MAX_REDIRECT_DISTANCE = 128;
    final static private int field_31191 = 200;
    ...
    private void updateNeighbors(BlockState state, World world, BlockPos pos) {
        ...
        world.updateNeighborsAlways(pos.net_minecraft_util_math_BlockPos_offset(direction), this, OrientationHelper.getEmissionOrientation(world, direction, null));
    }
