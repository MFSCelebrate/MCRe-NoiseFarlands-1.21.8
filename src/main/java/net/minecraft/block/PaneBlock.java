...
extends HorizontalConnectingBlock {
    final static public MapCodec<PaneBlock> CODEC = PaneBlock.createCodec(PaneBlock::new);
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        BlockPos blockPos3 = blockPos.net_minecraft_util_math_BlockPos_south();
        BlockPos blockPos4 = blockPos.net_minecraft_util_math_BlockPos_west();
        BlockPos blockPos5 = blockPos.net_minecraft_util_math_BlockPos_east();
