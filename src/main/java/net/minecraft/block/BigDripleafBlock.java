...
Waterloggable {
    final static public MapCodec<BigDripleafBlock> CODEC = BigDripleafBlock.createCodec(BigDripleafBlock::new);
    final static private BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static private EnumProperty<Tilt> TILT = Properties.TILT;
    final static private int field_31015 = -1;
    final static private Object2IntMap<Tilt> NEXT_TILT_DELAYS = (Object2IntMap)Util.make(new Object2IntArrayMap(), delays -> {
    ...
    final static private int field_31016 = 5;
    final static private int field_31018 = 11;
    final static private int field_31019 = 13;
    final static private Map<Tilt, VoxelShape> SHAPES_BY_TILT = Maps.newEnumMap(Map.of(Tilt.NONE, Block.createColumnShape(16.0, 11.0, 15.0), Tilt.UNSTABLE, Block.createColumnShape(16.0, 11.0, 15.0), Tilt.PARTIAL, Block.createColumnShape(16.0, 11.0, 13.0), Tilt.FULL, VoxelShapes.empty()));
    ...
    public static void grow(WorldAccess world, Random random, BlockPos pos, Direction direction) {
        ...
        int k = pos.getY() + j - 1;
        mutable.net_minecraft_util_math_BlockPos$Mutable_setY(pos.getY());
