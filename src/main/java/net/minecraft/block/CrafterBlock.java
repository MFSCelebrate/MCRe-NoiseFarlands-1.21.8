...
extends BlockWithEntity {
    final static public MapCodec<CrafterBlock> CODEC = CrafterBlock.createCodec(CrafterBlock::new);
    final static public BooleanProperty CRAFTING = Properties.CRAFTING;
    final static public BooleanProperty TRIGGERED = Properties.TRIGGERED;
    final static private EnumProperty<Orientation> ORIENTATION = Properties.ORIENTATION;
    final static private int field_46802 = 6;
    final static private int TRIGGER_DELAY = 4;
    final static private RecipeCache RECIPE_CACHE = new RecipeCache(10);
    final static private int field_50015 = 17;
    ...
    private void transferOrSpawnStack(ServerWorld world, BlockPos pos, CrafterBlockEntity blockEntity, ItemStack stack, BlockState state, RecipeEntry<?> recipe) {
        ...
        Inventory inventory = HopperBlockEntity.getInventoryAt(world, pos.net_minecraft_util_math_BlockPos_offset(direction));
