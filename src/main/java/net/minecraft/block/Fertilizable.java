...
public interface Fertilizable {
    ...
    default public BlockPos getFertilizeParticlePos(BlockPos pos) {
        return switch (this.getFertilizableType().ordinal()) {
            ...
            case 0 -> pos.net_minecraft_util_math_BlockPos_up();
            case 1 -> pos;
        };
    }
    ...
    extends Enum<FertilizableType> {
        final static public FertilizableType NEIGHBOR_SPREADER = new FertilizableType();
        final static public FertilizableType GROWER = new FertilizableType();
        final static private FertilizableType[] field_47836;
