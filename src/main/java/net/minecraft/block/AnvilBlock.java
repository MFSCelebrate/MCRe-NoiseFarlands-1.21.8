...
extends FallingBlock {
    final static public MapCodec<AnvilBlock> CODEC = AnvilBlock.createCodec(AnvilBlock::new);
    final static public EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    final static private Map<Direction.Axis, VoxelShape> SHAPES_BY_AXIS = VoxelShapes.createHorizontalAxisShapeMap(VoxelShapes.union(Block.createColumnShape(12.0, 0.0, 4.0), Block.createColumnShape(8.0, 10.0, 4.0, 5.0), Block.createColumnShape(4.0, 8.0, 5.0, 10.0), Block.createColumnShape(10.0, 16.0, 10.0, 16.0)));
    final static private Text TITLE = Text.translatable("container.repair");
    final static private float FALLING_BLOCK_ENTITY_DAMAGE_MULTIPLIER = 2.0f;
    final static private int FALLING_BLOCK_ENTITY_MAX_DAMAGE = 40;
