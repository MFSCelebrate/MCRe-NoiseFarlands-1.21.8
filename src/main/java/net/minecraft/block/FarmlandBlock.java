...
extends Block {
    final static public MapCodec<FarmlandBlock> CODEC = FarmlandBlock.createCodec(FarmlandBlock::new);
    final static public IntProperty MOISTURE = Properties.MOISTURE;
    final static private VoxelShape SHAPE = Block.createColumnShape(16.0, 0.0, 15.0);
    final static public int MAX_MOISTURE = 7;
    ...
    protected void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (FarmlandBlock.isWaterNearby(world, pos) || world.hasRain(pos.net_minecraft_util_math_BlockPos_up())) {
            if (i < 7) {
    ...
    private static boolean hasCrop(BlockView world, BlockPos pos) {
        return world.getBlockState(pos.net_minecraft_util_math_BlockPos_up()).isIn(BlockTags.MAINTAINS_FARMLAND);
    }

    private static boolean isWaterNearby(WorldView world, BlockPos pos) {
        for (BlockPos blockPos : BlockPos.iterate(pos.net_minecraft_util_math_BlockPos_add(-4, 0, -4), pos.net_minecraft_util_math_BlockPos_add(4, 1, 4))) {
