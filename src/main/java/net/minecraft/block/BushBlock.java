...
implements Fertilizable {
    final static public MapCodec<BushBlock> CODEC = BushBlock.createCodec(BushBlock::new);
    final static private VoxelShape SHAPE = Block.createColumnShape(16.0, 0.0, 13.0);
