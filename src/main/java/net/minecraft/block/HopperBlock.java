...
extends BlockWithEntity {
    final static public MapCodec<HopperBlock> CODEC = HopperBlock.createCodec(HopperBlock::new);
    final static public EnumProperty<Direction> FACING = Properties.HOPPER_FACING;
    final static public BooleanProperty ENABLED = Properties.ENABLED;
    final private Function<BlockState, VoxelShape> shapeFunction;
    final private Map<Direction, VoxelShape> shapesByDirection;
    ...
    public HopperBlock(AbstractBlock.Settings settings) {
        ...
        this.shapesByDirection = ImmutableMap.builderWithExpectedSize(5).putAll(VoxelShapes.createHorizontalFacingShapeMap(VoxelShapes.union(voxelShape, Block.createCuboidZShape(4.0, 8.0, 10.0, 0.0, 4.0)))).put((Object)Direction.DOWN, (Object)voxelShape).build();
    }
