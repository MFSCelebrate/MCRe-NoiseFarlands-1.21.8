...
implements Waterloggable {
    final static public MapCodec<TrapdoorBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)BlockSetType.CODEC.fieldOf("block_set_type").forGetter(block -> block.blockSetType), TrapdoorBlock.createSettingsCodec()).apply((Applicative)instance, TrapdoorBlock::new));
    ...
    final static private Map<Direction, VoxelShape> shapeByDirection = VoxelShapes.createFacingShapeMap(Block.createCuboidZShape(16.0, 13.0, 16.0));
