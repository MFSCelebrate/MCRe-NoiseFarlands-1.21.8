...
extends BlockWithEntity {
    final static public MapCodec<VaultBlock> CODEC = VaultBlock.createCodec(VaultBlock::new);
    final static public Property<VaultState> VAULT_STATE = Properties.VAULT_STATE;
