...
implements CaveVines {
    final static public MapCodec<CaveVinesHeadBlock> CODEC = CaveVinesHeadBlock.createCodec(CaveVinesHeadBlock::new);
    final static private float GROW_CHANCE = 0.11f;
