...
implements Waterloggable {
    final static public MapCodec<LightBlock> CODEC = LightBlock.createCodec(LightBlock::new);
    final static public int field_33722 = 15;
    final static public IntProperty LEVEL_15 = Properties.LEVEL_15;
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static public ToIntFunction<BlockState> STATE_TO_LUMINANCE = state -> state.get(LEVEL_15);
