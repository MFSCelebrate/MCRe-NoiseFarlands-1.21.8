...
extends AbstractRedstoneGateBlock {
    final static public MapCodec<RepeaterBlock> CODEC = RepeaterBlock.createCodec(RepeaterBlock::new);
    final static public BooleanProperty LOCKED = Properties.LOCKED;
    final static public IntProperty DELAY = Properties.DELAY;
