...
extends AbstractSignBlock {
    final static public MapCodec<SignBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)WoodType.CODEC.fieldOf("wood_type").forGetter(AbstractSignBlock::getWoodType), SignBlock.createSettingsCodec()).apply((Applicative)instance, SignBlock::new));
