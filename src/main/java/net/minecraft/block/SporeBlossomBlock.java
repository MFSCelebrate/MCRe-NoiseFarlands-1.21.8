...
extends Block {
    final static public MapCodec<SporeBlossomBlock> CODEC = SporeBlossomBlock.createCodec(SporeBlossomBlock::new);
    final static private VoxelShape SHAPE = Block.createColumnShape(12.0, 13.0, 16.0);
    final static private int field_31252 = 14;
    final static private int field_31253 = 10;
    final static private int field_31254 = 10;
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        return Block.sideCoversSmallSquare(world, pos.net_minecraft_util_math_BlockPos_up(), Direction.DOWN) && !world.isWater(pos);
    }
