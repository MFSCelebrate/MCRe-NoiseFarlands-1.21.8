...
implements Waterloggable {
    final static public MapCodec<DriedGhastBlock> CODEC = DriedGhastBlock.createCodec(DriedGhastBlock::new);
    final static public int MAX_HYDRATION = 3;
    final static public IntProperty HYDRATION = Properties.HYDRATION;
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static public int HYDRATION_TICK_TIME = 5000;
    final static private VoxelShape SHAPE = Block.createColumnShape(10.0, 10.0, 0.0, 10.0);
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        ...
        if (!state.get(WATERLOGGED).booleanValue()) {
            if (random.nextInt(40) == 0 && world.getBlockState(pos.net_minecraft_util_math_BlockPos_down()).isIn(BlockTags.TRIGGERS_AMBIENT_DRIED_GHAST_BLOCK_SOUNDS)) {
