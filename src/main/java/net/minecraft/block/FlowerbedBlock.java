...
Segmented {
    final static public MapCodec<FlowerbedBlock> CODEC = FlowerbedBlock.createCodec(FlowerbedBlock::new);
    final static public EnumProperty<Direction> HORIZONTAL_FACING = Properties.HORIZONTAL_FACING;
    final static public IntProperty FLOWER_AMOUNT = Properties.FLOWER_AMOUNT;
