...
OperatorBlock {
    final static public MapCodec<JigsawBlock> CODEC = JigsawBlock.createCodec(JigsawBlock::new);
    final static public EnumProperty<Orientation> ORIENTATION = Properties.ORIENTATION;
