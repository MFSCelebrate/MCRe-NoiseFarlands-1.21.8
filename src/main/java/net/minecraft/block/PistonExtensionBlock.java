...
extends BlockWithEntity {
    final static public MapCodec<PistonExtensionBlock> CODEC = PistonExtensionBlock.createCodec(PistonExtensionBlock::new);
    final static public EnumProperty<Direction> FACING = PistonHeadBlock.FACING;
    final static public EnumProperty<PistonType> TYPE = PistonHeadBlock.TYPE;
    ...
    public void onBroken(WorldAccess world, BlockPos pos, BlockState state) {
        BlockPos blockPos = pos.net_minecraft_util_math_BlockPos_offset(state.get(FACING).getOpposite());
