...
extends RedstoneTorchBlock {
    final static public MapCodec<WallRedstoneTorchBlock> CODEC = WallRedstoneTorchBlock.createCodec(WallRedstoneTorchBlock::new);
    final static public EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    final static public BooleanProperty LIT = RedstoneTorchBlock.LIT;
    ...
    protected boolean shouldUnpower(World world, BlockPos pos, BlockState state) {
        Direction direction = state.get(FACING).getOpposite();
        return world.isEmittingRedstonePower(pos.net_minecraft_util_math_BlockPos_offset(direction), direction);
    }
