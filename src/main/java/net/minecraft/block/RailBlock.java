...
extends AbstractRailBlock {
    final static public MapCodec<RailBlock> CODEC = RailBlock.createCodec(RailBlock::new);
    final static public EnumProperty<RailShape> SHAPE = Properties.RAIL_SHAPE;
