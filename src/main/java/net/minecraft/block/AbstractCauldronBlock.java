...
extends Block {
    final static protected int field_30988 = 4;
    final static private VoxelShape RAYCAST_SHAPE = Block.createColumnShape(12.0, 4.0, 16.0);
    final static protected VoxelShape OUTLINE_SHAPE = Util.make(() -> {
        int i = 4;
        int j = 3;
        int k = 2;
    ...
    final protected CauldronBehavior.CauldronBehaviorMap behaviorMap;
