...
extends Block {
    final static public MapCodec<RespawnAnchorBlock> CODEC = RespawnAnchorBlock.createCodec(RespawnAnchorBlock::new);
    final static public int NO_CHARGES = 0;
    final static public int MAX_CHARGES = 4;
    final static public IntProperty CHARGES = Properties.CHARGES;
    final static private ImmutableList<Vec3i> VALID_HORIZONTAL_SPAWN_OFFSETS = ImmutableList.of((Object)new Vec3i(0, 0, -1), (Object)new Vec3i(-1, 0, 0), (Object)new Vec3i(0, 0, 1), (Object)new Vec3i(1, 0, 0), (Object)new Vec3i(-1, 0, -1), (Object)new Vec3i(1, 0, -1), (Object)new Vec3i(-1, 0, 1), (Object)new Vec3i(1, 0, 1));
    final static private ImmutableList<Vec3i> VALID_SPAWN_OFFSETS = new ImmutableList.Builder().addAll(VALID_HORIZONTAL_SPAWN_OFFSETS).addAll(VALID_HORIZONTAL_SPAWN_OFFSETS.stream().map(Vec3i::down).iterator()).addAll(VALID_HORIZONTAL_SPAWN_OFFSETS.stream().map(Vec3i::up).iterator()).add((Object)new Vec3i(0, 1, 0)).build();
    ...
    private static boolean hasStillWater(BlockPos pos, World world) {
        ...
        FluidState fluidState2 = world.getFluidState(pos.net_minecraft_util_math_BlockPos_down());
    ...
    private void explode(BlockState state, World world, final BlockPos explodedPos) {
        ...
        final boolean bl2 = bl || world.getFluidState(explodedPos.net_minecraft_util_math_BlockPos_up()).isIn(FluidTags.WATER);
