...
FluidFillable {
    final static public MapCodec<SeagrassBlock> CODEC = SeagrassBlock.createCodec(SeagrassBlock::new);
    ...
    public boolean isFertilizable(WorldView world, BlockPos pos, BlockState state) {
        return world.getBlockState(pos.net_minecraft_util_math_BlockPos_up()).isOf(Blocks.WATER);
    }
