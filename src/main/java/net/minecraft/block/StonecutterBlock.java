...
extends Block {
    final static public MapCodec<StonecutterBlock> CODEC = StonecutterBlock.createCodec(StonecutterBlock::new);
    final static private Text TITLE = Text.translatable("container.stonecutter");
    final static public EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    final static private VoxelShape SHAPE = Block.createColumnShape(16.0, 0.0, 9.0);
