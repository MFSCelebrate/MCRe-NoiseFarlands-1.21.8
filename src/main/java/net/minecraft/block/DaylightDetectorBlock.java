...
extends BlockWithEntity {
    final static public MapCodec<DaylightDetectorBlock> CODEC = DaylightDetectorBlock.createCodec(DaylightDetectorBlock::new);
    final static public IntProperty POWER = Properties.POWER;
    final static public BooleanProperty INVERTED = Properties.INVERTED;
    final static private VoxelShape SHAPE = Block.createColumnShape(16.0, 0.0, 6.0);
