...
implements Fertilizable {
    final static public MapCodec<ShortDryGrassBlock> CODEC = ShortDryGrassBlock.createCodec(ShortDryGrassBlock::new);
    final static private VoxelShape SHAPE = Block.createColumnShape(12.0, 0.0, 10.0);
