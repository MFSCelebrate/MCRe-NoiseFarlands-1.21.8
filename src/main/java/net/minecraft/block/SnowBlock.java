...
extends Block {
    final static public MapCodec<SnowBlock> CODEC = SnowBlock.createCodec(SnowBlock::new);
    final static public int MAX_LAYERS = 8;
    final static public IntProperty LAYERS = Properties.LAYERS;
    final static private VoxelShape[] SHAPES_BY_LAYERS = Block.createShapeArray(8, layers -> Block.createColumnShape(16.0, 0.0, layers * 2));
    final static public int field_31248 = 5;
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return Block.isFaceFullSquare(blockState.getCollisionShape(world, pos.net_minecraft_util_math_BlockPos_down()), Direction.UP) || blockState.isOf(this) && blockState.get(LAYERS) == 8;
    }
