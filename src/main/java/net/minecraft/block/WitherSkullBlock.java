...
extends SkullBlock {
    final static public MapCodec<WitherSkullBlock> CODEC = WitherSkullBlock.createCodec(WitherSkullBlock::new);
    @Nullable
    static private BlockPattern witherBossPattern;
    @Nullable
    static private BlockPattern witherDispenserPattern;
