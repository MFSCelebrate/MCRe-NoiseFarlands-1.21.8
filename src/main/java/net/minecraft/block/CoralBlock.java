...
extends AbstractCoralBlock {
    final static public MapCodec<CoralBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)CoralBlockBlock.DEAD_FIELD.forGetter(block -> block.deadCoralBlock), CoralBlock.createSettingsCodec()).apply((Applicative)instance, CoralBlock::new));
    final private Block deadCoralBlock;
    final static private VoxelShape SHAPE = Block.createColumnShape(12.0, 0.0, 15.0);
