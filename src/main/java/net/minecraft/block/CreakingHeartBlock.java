...
extends BlockWithEntity {
    final static public MapCodec<CreakingHeartBlock> CODEC = CreakingHeartBlock.createCodec(CreakingHeartBlock::new);
    final static public EnumProperty<Direction.Axis> AXIS = Properties.AXIS;
    final static public EnumProperty<CreakingHeartState> ACTIVE = Properties.CREAKING_HEART_STATE;
    final static public BooleanProperty NATURAL = Properties.NATURAL;
    ...
    private static BlockState enableIfValid(BlockState state, World world, BlockPos pos) {
        ...
        if (bl && bl2) {
            return (BlockState)state.with(ACTIVE, CreakingHeartBlock.isNightAndNatural(world) ? CreakingHeartState.AWAKE : CreakingHeartState.DORMANT);
        }
        return state;
    }
