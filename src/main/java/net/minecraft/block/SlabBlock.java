...
implements Waterloggable {
    final static public MapCodec<SlabBlock> CODEC = SlabBlock.createCodec(SlabBlock::new);
    final static public EnumProperty<SlabType> TYPE = Properties.SLAB_TYPE;
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static private VoxelShape BOTTOM_SHAPE = Block.createColumnShape(16.0, 0.0, 8.0);
    final static private VoxelShape TOP_SHAPE = Block.createColumnShape(16.0, 8.0, 16.0);
