...
implements Waterloggable {
    final static public MapCodec<DecoratedPotBlock> CODEC = DecoratedPotBlock.createCodec(DecoratedPotBlock::new);
    final static public Identifier SHERDS_DYNAMIC_DROP_ID = Identifier.ofVanilla("sherds");
    final static public EnumProperty<Direction> FACING = Properties.HORIZONTAL_FACING;
    final static public BooleanProperty CRACKED = Properties.CRACKED;
    ...
    protected void onProjectileHit(World world, BlockState state, BlockHitResult hit, ProjectileEntity projectile) {
        ...
        if (world instanceof ServerWorld && projectile.canModifyAt(serverWorld = (ServerWorld)world, blockPos) && projectile.canBreakBlocks(serverWorld)) {
            world.setBlockState(blockPos, (BlockState)state.with(CRACKED, true), Block.SKIP_REDRAW_AND_BLOCK_ENTITY_REPLACED_CALLBACK);
