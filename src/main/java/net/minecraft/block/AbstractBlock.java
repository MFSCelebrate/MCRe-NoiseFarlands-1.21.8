...
implements ToggleableFeature {
    final static protected Direction[] DIRECTIONS = new Direction[]{Direction.WEST, Direction.EAST, Direction.NORTH, Direction.SOUTH, Direction.DOWN, Direction.UP};
    final protected boolean collidable;
    final protected float resistance;
    final protected boolean randomTicks;
    final protected BlockSoundGroup soundGroup;
    final protected float slipperiness;
    final protected float velocityMultiplier;
    final protected float jumpVelocityMultiplier;
    final protected boolean dynamicBounds;
    final protected FeatureSet requiredFeatures;
    final protected Settings settings;
    final protected Optional<RegistryKey<LootTable>> lootTableKey;
    final protected String translationKey;
    ...
    public static class Settings {
        final static public Codec<Settings> CODEC = Codec.unit(() -> Settings.create());
    ...
    extends State<Block, BlockState> {
        ...
        final static private VoxelShape[] EMPTY_CULLING_FACES = Util.make(new VoxelShape[DIRECTIONS.length], direction -> Arrays.fill(direction, VoxelShapes.empty()));
        final static private VoxelShape[] FULL_CULLING_FACES = Util.make(new VoxelShape[DIRECTIONS.length], direction -> Arrays.fill(direction, VoxelShapes.fullCube()));
        final private int luminance;
        final private boolean hasSidedTransparency;
        final private boolean isAir;
        final private boolean burnable;
        @Deprecated
        final private boolean liquid;
        @Deprecated
        private boolean solid;
        final private PistonBehavior pistonBehavior;
        final private MapColor mapColor;
        final private float hardness;
        final private boolean toolRequired;
        final private boolean opaque;
        final private ContextPredicate solidBlockPredicate;
        final private ContextPredicate suffocationPredicate;
        final private ContextPredicate blockVisionPredicate;
        final private ContextPredicate postProcessPredicate;
        final private ContextPredicate emissiveLightingPredicate;
        @Nullable
        final private Offsetter offsetter;
        final private boolean blockBreakParticles;
        final private NoteBlockInstrument instrument;
        final private boolean replaceable;
        @Nullable
        ...
        static final class ShapeCache {
            final static private Direction[] DIRECTIONS = Direction.values();
            final static private int SHAPE_TYPE_LENGTH = SideShapeType.values().length;
            final protected VoxelShape collisionShape;
            final protected boolean exceedsCube;
            final private boolean[] solidSides;
            final protected boolean isFullCube;
    ...
    extends Enum<OffsetType> {
        final static public OffsetType NONE = new OffsetType();
        final static public OffsetType XZ = new OffsetType();
        final static public OffsetType XYZ = new OffsetType();
        final static private OffsetType[] field_10658;
