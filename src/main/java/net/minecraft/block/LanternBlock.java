...
implements Waterloggable {
    final static public MapCodec<LanternBlock> CODEC = LanternBlock.createCodec(LanternBlock::new);
    ...
    final static private VoxelShape STANDING_SHAPE = VoxelShapes.union(Block.createColumnShape(4.0, 7.0, 9.0), Block.createColumnShape(6.0, 0.0, 7.0));
    final static private VoxelShape HANGING_SHAPE = STANDING_SHAPE.offset(0.0, 0.0625, 0.0).simplify();
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return Block.sideCoversSmallSquare(world, pos.net_minecraft_util_math_BlockPos_offset(direction), direction.getOpposite());
    }
