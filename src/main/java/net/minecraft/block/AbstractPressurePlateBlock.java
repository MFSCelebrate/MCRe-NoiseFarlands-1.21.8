...
extends Block {
    final static private VoxelShape PRESSED_SHAPE = Block.createColumnShape(14.0, 0.0, 0.5);
    final static private VoxelShape DEFAULT_SHAPE = Block.createColumnShape(14.0, 0.0, 1.0);
    final static protected Box BOX = Block.createColumnShape(14.0, 0.0, 4.0).getBoundingBoxes().getFirst();
    final protected BlockSetType blockSetType;
