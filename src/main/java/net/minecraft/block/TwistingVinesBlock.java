...
extends AbstractPlantStemBlock {
    final static public MapCodec<TwistingVinesBlock> CODEC = TwistingVinesBlock.createCodec(TwistingVinesBlock::new);
    final static private VoxelShape SHAPE = Block.createColumnShape(8.0, 0.0, 15.0);
