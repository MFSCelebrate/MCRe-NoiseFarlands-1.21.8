...
extends HorizontalFacingBlock {
    ...
    final static private VoxelShape SHAPE = Block.createColumnShape(16.0, 0.0, 2.0);
    ...
    protected int getMaxInputLevelSides(RedstoneView world, BlockPos pos, BlockState state) {
        ...
        return Math.max(world.getEmittedRedstonePower(pos.net_minecraft_util_math_BlockPos_offset(direction2), direction2, bl), world.getEmittedRedstonePower(pos.net_minecraft_util_math_BlockPos_offset(direction3), direction3, bl));
    }
