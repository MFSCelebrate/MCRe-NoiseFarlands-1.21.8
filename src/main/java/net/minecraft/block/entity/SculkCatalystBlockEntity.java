...
implements GameEventListener.Holder<Listener> {
    final private Listener eventListener;
    ...
    @Override
    public Listener net_minecraft_block_entity_SculkCatalystBlockEntity$Listener_getEventListener() {
        return this.eventListener;
    }

    @Override
    public GameEventListener net_minecraft_world_event_listener_GameEventListener_getEventListener() {
        return this.net_minecraft_block_entity_SculkCatalystBlockEntity$Listener_getEventListener();
    }
