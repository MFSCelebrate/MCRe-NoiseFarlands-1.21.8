...
extends BlockEntity {
    final static private int field_54776 = 32;
    final static public int field_54775 = 32;
    final static private int field_54777 = 34;
    final static private int field_54778 = 16;
    final static private int field_54779 = 8;
    final static private int field_54780 = 5;
    final static private int field_54781 = 20;
    final static private int field_55498 = 5;
    final static private int field_54782 = 100;
    final static private int field_54783 = 10;
    final static private int field_54784 = 10;
    final static private int field_54785 = 50;
    final static private int field_55085 = 2;
    final static private int field_55086 = 64;
    final static private int field_55499 = 30;
    final static private Optional<CreakingEntity> DEFAULT_CREAKING_PUPPET = Optional.empty();
    @Nullable
    ...
    private static CreakingEntity spawnCreakingPuppet(ServerWorld world, CreakingHeartBlockEntity blockEntity) {
        ...
        world.emitGameEvent((Entity)creakingEntity, GameEvent.ENTITY_PLACE, creakingEntity.getPos());
    ...
    private Optional<BlockPos> findResinGenerationPos() {
        ...
        BlockPos.iterateRecursively(this.pos, 2, 64, (pos, consumer) -> {
            for (Direction direction : Util.copyShuffled(Direction.values(), this.world.random)) {
                ...
                if (!this.world.getBlockState(blockPos).isIn(BlockTags.PALE_OAK_LOGS)) continue;
                consumer.accept(blockPos);
            }
        }, arg_0 -> this.method_65169((Mutable)mutable, arg_0));
    ...
    private BlockPos.IterationState method_65169(Mutable mutable, BlockPos pos) {
        ...
        for (Direction direction : Util.copyShuffled(Direction.values(), this.world.random)) {
            ...
            this.world.setBlockState(blockPos, (BlockState)blockState.with(MultifaceBlock.getProperty(direction2), true), Block.NOTIFY_ALL);
