...
RecipeUnlocker,
RecipeInputProvider {
    final static protected int INPUT_SLOT_INDEX = 0;
    final static protected int FUEL_SLOT_INDEX = 1;
    final static protected int OUTPUT_SLOT_INDEX = 2;
    final static public int BURN_TIME_PROPERTY_INDEX = 0;
    final static private int[] TOP_SLOTS = new int[]{0};
    final static private int[] BOTTOM_SLOTS = new int[]{2, 1};
    final static private int[] SIDE_SLOTS = new int[]{1};
    final static public int FUEL_TIME_PROPERTY_INDEX = 1;
    final static public int COOK_TIME_PROPERTY_INDEX = 2;
    final static public int COOK_TIME_TOTAL_PROPERTY_INDEX = 3;
    final static public int PROPERTY_COUNT = 4;
    final static public int DEFAULT_COOK_TIME = 200;
    final static public int field_31295 = 2;
    final static private Codec<Map<RegistryKey<Recipe<?>>, Integer>> CODEC = Codec.unboundedMap(Recipe.KEY_CODEC, (Codec)Codec.INT);
    final static private short DEFAULT_LIT_TIME_REMAINING = 0;
    final static private short DEFAULT_LIT_TOTAL_TIME = 0;
    final static private short DEFAULT_COOKING_TIME_SPENT = 0;
    final static private short DEFAULT_COOKING_TOTAL_TIME = 0;
    protected DefaultedList<ItemStack> inventory = DefaultedList.ofSize(3, ItemStack.EMPTY);
    int litTimeRemaining;
    int litTotalTime;
    int cookingTimeSpent;
    int cookingTotalTime;
    final protected PropertyDelegate propertyDelegate = new PropertyDelegate(){
    ...
    final private Reference2IntOpenHashMap<RegistryKey<Recipe<?>>> recipesUsed = new Reference2IntOpenHashMap();
    final private ServerRecipeManager.MatchGetter<SingleStackRecipeInput, ? extends AbstractCookingRecipe> matchGetter;
    ...
    protected void readData(ReadView view) {
        ...
        this.cookingTimeSpent = view.getShort("cooking_time_spent", 0);
        this.cookingTotalTime = view.getShort("cooking_total_time", 0);
        this.litTimeRemaining = view.getShort("lit_time_remaining", 0);
        this.litTotalTime = view.getShort("lit_total_time", 0);
    ...
    public void dropExperienceForRecipesUsed(ServerPlayerEntity player) {
        List<RecipeEntry<?>> list = this.getRecipesUsedAndDropExperience(player.net_minecraft_server_world_ServerWorld_getWorld(), player.getPos());
    ...
    public List<RecipeEntry<?>> getRecipesUsedAndDropExperience(ServerWorld world, Vec3d pos) {
        ...
        for (Reference2IntMap.Entry entry : this.recipesUsed.reference2IntEntrySet()) {
            world.net_minecraft_recipe_ServerRecipeManager_getRecipeManager().get((RegistryKey)entry.getKey()).ifPresent(recipe -> {
                list.add(recipe);
