...
extends BlockEntity {
    final static private int field_31382 = 2;
    final static private double field_31383 = 0.01;
    final static public double field_31381 = 0.51;
    final static private BlockState DEFAULT_PUSHED_BLOCK_STATE = Blocks.AIR.getDefaultState();
    final static private float DEFAULT_PROGRESS = 0.0f;
    final static private boolean DEFAULT_EXTENDING = false;
    final static private boolean DEFAULT_SOURCE = false;
    private BlockState pushedBlockState = DEFAULT_PUSHED_BLOCK_STATE;
    private Direction facing;
    private boolean extending = false;
    private boolean source = false;
    final static private ThreadLocal<Direction> ENTITY_MOVEMENT_DIRECTION = ThreadLocal.withInitial(() -> null);
