...
extends BlockEntity {
    ...
    final static private boolean DEFAULT_AUTO = false;
    final static private boolean DEFAULT_CONDITION_MET = false;
    private boolean powered = false;
    private boolean auto = false;
    private boolean conditionMet = false;
    final private CommandBlockExecutor commandExecutor = new CommandBlockExecutor(){
        ...
        public ServerCommandSource getSource() {
            ...
            return new ServerCommandSource(this, Vec3d.ofCenter(CommandBlockBlockEntity.this.pos), new Vec2f(0.0f, direction.getPositiveHorizontalDegrees()), this.getWorld(), 2, this.getName().getString(), this.getName(), this.getWorld().getServer(), null);
        }
    ...
    public boolean updateConditionMet() {
        ...
        if (this.isConditionalCommandBlock()) {
            ...
            BlockPos blockPos = this.pos.net_minecraft_util_math_BlockPos_offset(this.world.getBlockState(this.pos).get(CommandBlock.FACING).getOpposite());
    ...
    extends Enum<Type> {
        final static public Type SEQUENCE = new Type();
        final static public Type AUTO = new Type();
        final static public Type REDSTONE = new Type();
        final static private Type[] field_11925;
