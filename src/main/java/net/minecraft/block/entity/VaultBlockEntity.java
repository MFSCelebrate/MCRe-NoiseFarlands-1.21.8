...
extends BlockEntity {
    final private VaultServerData serverData = new VaultServerData();
    final private VaultSharedData sharedData = new VaultSharedData();
    final private VaultClientData clientData = new VaultClientData();
    ...
    public static final class Client {
        final static private int field_48870 = 20;
        final static private float field_48871 = 0.5f;
        final static private float field_48872 = 0.02f;
        final static private int field_48873 = 20;
        final static private int field_48874 = 20;
    ...
    public static final class Server {
        final static private int UNLOCK_TIME = 14;
        final static private int DISPLAY_UPDATE_INTERVAL = 20;
        final static private int FAILED_UNLOCK_COOLDOWN = 15;
