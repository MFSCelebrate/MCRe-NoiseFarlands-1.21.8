...
implements SidedInventory {
    final static private int INPUT_SLOT_INDEX = 3;
    final static private int FUEL_SLOT_INDEX = 4;
    final static private int[] TOP_SLOTS = new int[]{3};
    final static private int[] BOTTOM_SLOTS = new int[]{0, 1, 2, 3};
    final static private int[] SIDE_SLOTS = new int[]{0, 1, 2, 4};
    final static public int MAX_FUEL_USES = 20;
    final static public int BREW_TIME_PROPERTY_INDEX = 0;
    final static public int FUEL_PROPERTY_INDEX = 1;
    final static public int PROPERTY_COUNT = 2;
    final static private short DEFAULT_BREW_TIME = 0;
    final static private byte DEFAULT_FUEL = 0;
    ...
    protected void readData(ReadView view) {
        ...
        this.brewTime = view.getShort("BrewTime", 0);
        if (this.brewTime > 0) {
            this.itemBrewing = this.inventory.get(3).getItem();
        }
        this.fuel = view.getByte("Fuel", 0);
    }
