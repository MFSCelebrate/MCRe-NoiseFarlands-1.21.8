...
extends BlockEntity {
    ...
    final static private int MAX_TEXT_WIDTH = 90;
    final static private int TEXT_LINE_HEIGHT = 10;
    final static private boolean DEFAULT_WAXED = false;
    @Nullable
    private UUID editor;
        ...
        block5: for (Text text : this.getText(front).getMessages(player.shouldFilterText())) {
            ...
            switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{ClickEvent.RunCommand.class, ClickEvent.ShowDialog.class, ClickEvent.Custom.class}, (Object)clickEvent2, n)) {
                case 0: {
                    ...
                    world.getServer().getCommandManager().executeWithPrefix(SignBlockEntity.createCommandSource(player, world, pos), runCommand.command());
                    bl = true;
                    continue block5;
                }
                case 1: {
    ...
    public Packet net_minecraft_network_packet_s2c_play_BlockEntityUpdateS2CPacket_toUpdatePacket() {
