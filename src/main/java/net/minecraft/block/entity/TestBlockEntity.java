...
extends BlockEntity {
    ...
    final static private String DEFAULT_MESSAGE = "";
    ...
    private void update() {
        ...
        if (blockState.isOf(Blocks.TEST_BLOCK)) {
            this.world.setBlockState(blockPos, (BlockState)blockState.with(TestBlock.MODE, this.mode), Block.NOTIFY_LISTENERS);
        }
    }
