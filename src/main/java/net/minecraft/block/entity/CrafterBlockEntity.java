...
implements RecipeInputInventory {
    final static public int GRID_WIDTH = 3;
    final static public int GRID_HEIGHT = 3;
    final static public int GRID_SIZE = 9;
    final static public int SLOT_DISABLED = 1;
    final static public int SLOT_ENABLED = 0;
    final static public int TRIGGERED_PROPERTY = 9;
    final static public int PROPERTIES_COUNT = 10;
    final static private int DEFAULT_CRAFTING_TICKS_REMAINING = 0;
    final static private int DEFAULT_TRIGGERED = 0;
    private DefaultedList<ItemStack> inputStacks = DefaultedList.ofSize(9, ItemStack.EMPTY);
    private int craftingTicksRemaining = 0;
    final protected PropertyDelegate propertyDelegate = new PropertyDelegate(this){
        final private int[] disabledSlots = new int[9];
