...
implements Inventory {
    final static public int MAX_BOOKS = 6;
    final static private Logger LOGGER = LogUtils.getLogger();
    final static private int DEFAULT_LAST_INTERACTED_SLOT = -1;
    final private DefaultedList<ItemStack> inventory = DefaultedList.ofSize(6, ItemStack.EMPTY);
