...
implements SingleStackInventory.SingleStackBlockEntityInventory {
    final static public String RECORD_ITEM_NBT_KEY = "RecordItem";
    final static public String TICKS_SINCE_SONG_STARTED_NBT_KEY = "ticks_since_song_started";
    private ItemStack recordStack = ItemStack.EMPTY;
    final private JukeboxManager manager = new JukeboxManager(this::onManagerChange, this.getPos());
