...
implements LidOpenable {
    final static private int VIEWER_COUNT_UPDATE_EVENT_TYPE = 1;
    private DefaultedList<ItemStack> inventory = DefaultedList.ofSize(27, ItemStack.EMPTY);
    final private ViewerCountManager stateManager = new ViewerCountManager(){
    ...
    final private ChestLidAnimator lidAnimator = new ChestLidAnimator();
