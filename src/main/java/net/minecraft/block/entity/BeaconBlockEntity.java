...
Nameable,
BeamEmitter {
    final static private int field_31304 = 4;
    final static public List<List<RegistryEntry<StatusEffect>>> EFFECTS_BY_LEVEL = List.of(List.of(StatusEffects.SPEED, StatusEffects.HASTE), List.of(StatusEffects.RESISTANCE, StatusEffects.JUMP_BOOST), List.of(StatusEffects.STRENGTH), List.of(StatusEffects.REGENERATION));
    final static private Set<RegistryEntry<StatusEffect>> EFFECTS = EFFECTS_BY_LEVEL.stream().flatMap(Collection::stream).collect(Collectors.toSet());
    final static public int LEVEL_PROPERTY_INDEX = 0;
    final static public int PRIMARY_PROPERTY_INDEX = 1;
    final static public int SECONDARY_PROPERTY_INDEX = 2;
    final static public int PROPERTY_COUNT = 3;
    final static private int field_31305 = 10;
    final static private Text CONTAINER_NAME_TEXT = Text.translatable("container.beacon");
    final static private String PRIMARY_EFFECT_NBT_KEY = "primary_effect";
    final static private String SECONDARY_EFFECT_NBT_KEY = "secondary_effect";
    ...
    final private PropertyDelegate propertyDelegate = new PropertyDelegate(){
