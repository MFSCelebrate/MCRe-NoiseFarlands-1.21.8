...
implements Hopper {
    final static public int TRANSFER_COOLDOWN = 8;
    final static public int INVENTORY_SIZE = 5;
    final static private int[][] AVAILABLE_SLOTS_CACHE = new int[54][];
    final static private int DEFAULT_TRANSFER_COOLDOWN = -1;
    ...
    private static Inventory getOutputInventory(World world, BlockPos pos, HopperBlockEntity blockEntity) {
        return HopperBlockEntity.getInventoryAt(world, pos.net_minecraft_util_math_BlockPos_offset(blockEntity.facing));
    }
