...
implements SidedInventory {
    final static public int field_31354 = 9;
    final static public int field_31355 = 3;
    final static public int INVENTORY_SIZE = 27;
    final static public int field_31357 = 1;
    final static public int field_31358 = 10;
    final static public float field_31359 = 0.5f;
    final static public float field_31360 = 270.0f;
    final static private int[] AVAILABLE_SLOTS = IntStream.range(0, 27).toArray();
    ...
    @Nullable
    final private DyeColor cachedColor;
    ...
    extends Enum<AnimationStage> {
        final static public AnimationStage CLOSED = new AnimationStage();
        final static public AnimationStage OPENING = new AnimationStage();
        final static public AnimationStage OPENED = new AnimationStage();
        final static public AnimationStage CLOSING = new AnimationStage();
        final static private AnimationStage[] field_12067;
