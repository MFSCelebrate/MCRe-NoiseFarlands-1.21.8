...
extends BlockEntity {
    ...
    final static private String LOOT_TABLE_NBT_KEY = "LootTable";
    final static private String LOOT_TABLE_SEED_NBT_KEY = "LootTableSeed";
    final static private String HIT_DIRECTION_NBT_KEY = "hit_direction";
    final static private String ITEM_NBT_KEY = "item";
    final static private int field_42806 = 10;
    final static private int field_42807 = 40;
    final static private int field_42808 = 10;
    ...
    private void spawnItem(ServerWorld world, LivingEntity brusher, ItemStack brush) {
        ...
        if (!this.item.isEmpty()) {
            ...
            BlockPos blockPos = this.pos.net_minecraft_util_math_BlockPos_offset(direction, 1);
