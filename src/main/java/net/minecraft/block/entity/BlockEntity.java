...
AttachmentTarget {
    final static private Codec<BlockEntityType<?>> TYPE_CODEC = Registries.BLOCK_ENTITY_TYPE.getCodec();
    final static private Logger LOGGER = LogUtils.getLogger();
    final private BlockEntityType<?> type;
    @Nullable
    ...
    public final void readComponents(ComponentMap defaultComponents, ComponentChanges components) {
        final HashSet<ComponentType<Object>> set = new HashSet<ComponentType<Object>>();
