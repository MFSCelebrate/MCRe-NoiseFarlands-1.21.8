...
implements StructureBoxRendering {
    final static private int field_31367 = 5;
    final static public int field_31364 = 48;
    final static public int field_31365 = 48;
    final static public String AUTHOR_KEY = "author";
    final static private String DEFAULT_AUTHOR = "";
    final static private String DEFAULT_METADATA = "";
    final static private BlockPos DEFAULT_OFFSET = new BlockPos(0, 1, 0);
    final static private Vec3i DEFAULT_SIZE = Vec3i.ZERO;
    final static private BlockRotation DEFAULT_ROTATION = BlockRotation.NONE;
    final static private BlockMirror DEFAULT_MIRROR = BlockMirror.NONE;
    final static private boolean DEFAULT_IGNORE_ENTITIES = true;
    final static private boolean DEFAULT_STRICT = false;
    final static private boolean DEFAULT_POWERED = false;
    final static private boolean DEFAULT_SHOW_AIR = false;
    final static private boolean DEFAULT_SHOW_BOUNDING_BOX = true;
    final static private float DEFAULT_INTEGRITY = 1.0f;
    final static private long DEFAULT_SEED = 0L;
    @Nullable
    ...
    public boolean saveStructure(boolean toDisk) {
        ...
        BlockPos blockPos = this.getPos().net_minecraft_util_math_BlockPos_add(this.offset);
    ...
    private void loadAndPlaceStructure(ServerWorld world, StructureTemplate template) {
        ...
        BlockPos blockPos = this.getPos().net_minecraft_util_math_BlockPos_add(this.offset);
        template.place(world, blockPos, blockPos, structurePlacementData, StructureBlockBlockEntity.createRandom(this.seed), Block.NOTIFY_LISTENERS | (this.strict ? Block.FORCE_STATE_AND_SKIP_CALLBACKS_AND_DROPS : 0));
    }
    ...
    extends Enum<Action> {
        final static public Action UPDATE_DATA = new Action();
        final static public Action SAVE_AREA = new Action();
        final static public Action LOAD_AREA = new Action();
        final static public Action SCAN_AREA = new Action();
        final static private Action[] field_12107;
