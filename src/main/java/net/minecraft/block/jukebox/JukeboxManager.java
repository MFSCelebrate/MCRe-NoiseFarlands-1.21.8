...
public class JukeboxManager {
    ...
    final private ChangeNotifier changeNotifier;
    ...
    public void startPlaying(WorldAccess world, RegistryEntry<JukeboxSong> song) {
        ...
        int i = world.getRegistryManager().net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.JUKEBOX_SONG).getRawId(this.song.value());
