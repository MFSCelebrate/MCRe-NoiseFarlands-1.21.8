...
implements Falling {
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (!FallingBlock.canFallThrough(world.getBlockState(pos.net_minecraft_util_math_BlockPos_down())) || pos.getY() < world.getBottomY()) {
            return;
        }
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        BlockPos blockPos;
        if (random.nextInt(16) == 0 && FallingBlock.canFallThrough(world.getBlockState(blockPos = pos.net_minecraft_util_math_BlockPos_down()))) {
