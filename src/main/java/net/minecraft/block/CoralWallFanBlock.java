...
extends DeadCoralWallFanBlock {
    final static public MapCodec<CoralWallFanBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)CoralBlockBlock.DEAD_FIELD.forGetter(block -> block.deadCoralBlock), CoralWallFanBlock.createSettingsCodec()).apply((Applicative)instance, CoralWallFanBlock::new));
