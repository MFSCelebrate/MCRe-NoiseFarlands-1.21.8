...
implements Waterloggable {
    final static public MapCodec<SculkShriekerBlock> CODEC = SculkShriekerBlock.createCodec(SculkShriekerBlock::new);
    final static public BooleanProperty SHRIEKING = Properties.SHRIEKING;
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static public BooleanProperty CAN_SUMMON = Properties.CAN_SUMMON;
    final static private VoxelShape SHAPE = Block.createColumnShape(16.0, 0.0, 8.0);
    final static public double TOP = SHAPE.getMax(Direction.Axis.Y);
