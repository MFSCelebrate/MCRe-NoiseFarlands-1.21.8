...
extends FlowerBlock {
    final static public MapCodec<WitherRoseBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)STEW_EFFECT_CODEC.forGetter(FlowerBlock::getStewEffects), WitherRoseBlock.createSettingsCodec()).apply((Applicative)instance, WitherRoseBlock::new));
