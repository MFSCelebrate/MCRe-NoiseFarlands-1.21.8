...
implements Fertilizable {
    final static private double FIREFLY_CHANCE = 0.7;
    final static private double FIREFLY_HORIZONTAL_RADIUS = 10.0;
    final static private double FIREFLY_VERTICAL_RADIUS = 5.0;
    final static private int LIGHT_LEVEL_THRESHOLD = 13;
    final static private int IDLE_SOUND_CHANCE = 30;
    final static public MapCodec<FireflyBushBlock> CODEC = FireflyBushBlock.createCodec(FireflyBushBlock::new);
