...
extends BlockWithEntity {
    final static public MapCodec<JukeboxBlock> CODEC = JukeboxBlock.createCodec(JukeboxBlock::new);
    final static public BooleanProperty HAS_RECORD = Properties.HAS_RECORD;
