...
extends InfestedBlock {
    final static public MapCodec<RotatedInfestedBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Registries.BLOCK.getCodec().fieldOf("host").forGetter(InfestedBlock::getRegularBlock), RotatedInfestedBlock.createSettingsCodec()).apply((Applicative)instance, RotatedInfestedBlock::new));
