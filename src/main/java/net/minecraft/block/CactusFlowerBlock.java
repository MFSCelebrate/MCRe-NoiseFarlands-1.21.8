...
extends PlantBlock {
    final static public MapCodec<CactusFlowerBlock> CODEC = CactusFlowerBlock.createCodec(CactusFlowerBlock::new);
    final static private VoxelShape SHAPE = Block.createColumnShape(14.0, 0.0, 12.0);
