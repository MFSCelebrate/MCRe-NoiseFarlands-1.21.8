...
implements Waterloggable {
    ...
    final static private VoxelShape SHAPE = Block.createColumnShape(12.0, 0.0, 4.0);
    ...
    protected static boolean isInWater(BlockState state, BlockView world, BlockPos pos) {
        ...
        for (Direction direction : Direction.values()) {
            if (!world.getFluidState(pos.net_minecraft_util_math_BlockPos_offset(direction)).isIn(FluidTags.WATER)) continue;
            return true;
        }
        return false;
    }
