...
public class TrialSpawnerData {
    final static private String SPAWN_DATA_KEY = "spawn_data";
    final static private String NEXT_MOB_SPAWNS_AT_KEY = "next_mob_spawns_at";
    final static private int field_50190 = 20;
    final static private int field_50191 = 18000;
    ...
    extends Record {
        ...
        final static public MapCodec<Packed> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Uuids.SET_CODEC.lenientOptionalFieldOf("registered_players", Set.of()).forGetter(Packed::detectedPlayers), (App)Uuids.SET_CODEC.lenientOptionalFieldOf("current_mobs", Set.of()).forGetter(Packed::currentMobs), (App)Codec.LONG.lenientOptionalFieldOf("cooldown_ends_at", (Object)0L).forGetter(Packed::cooldownEndsAt), (App)Codec.LONG.lenientOptionalFieldOf(TrialSpawnerData.NEXT_MOB_SPAWNS_AT_KEY, (Object)0L).forGetter(Packed::nextMobSpawnsAt), (App)Codec.intRange(0, Integer.MAX_VALUE).lenientOptionalFieldOf("total_mobs_spawned", (Object)0).forGetter(Packed::totalMobsSpawned), (App)MobSpawnerEntry.CODEC.lenientOptionalFieldOf(TrialSpawnerData.SPAWN_DATA_KEY).forGetter(Packed::nextSpawnData), (App)LootTable.TABLE_KEY.lenientOptionalFieldOf("ejecting_loot_table").forGetter(Packed::ejectingLootTable)).apply((Applicative)instance, Packed::new));

        public Packed(Set<UUID> set, Set<UUID> set2, long l, long m, int i, Optional<MobSpawnerEntry> optional, Optional<RegistryKey<LootTable>> optional2) {
