...
public class TrialSpawnerConfigs {
    final static private ConfigKeyPair BREEZE = ConfigKeyPair.of("trial_chamber/breeze");
    final static private ConfigKeyPair MELEE_HUSK = ConfigKeyPair.of("trial_chamber/melee/husk");
    final static private ConfigKeyPair MELEE_SPIDER = ConfigKeyPair.of("trial_chamber/melee/spider");
    final static private ConfigKeyPair MELEE_ZOMBIE = ConfigKeyPair.of("trial_chamber/melee/zombie");
    final static private ConfigKeyPair RANGED_POISON_SKELETON = ConfigKeyPair.of("trial_chamber/ranged/poison_skeleton");
    final static private ConfigKeyPair RANGED_SKELETON = ConfigKeyPair.of("trial_chamber/ranged/skeleton");
    final static private ConfigKeyPair RANGED_STRAY = ConfigKeyPair.of("trial_chamber/ranged/stray");
    final static private ConfigKeyPair SLOW_RANGED_POISON_SKELETON = ConfigKeyPair.of("trial_chamber/slow_ranged/poison_skeleton");
    final static private ConfigKeyPair SLOW_RANGED_SKELETON = ConfigKeyPair.of("trial_chamber/slow_ranged/skeleton");
    final static private ConfigKeyPair SLOW_RANGED_STRAY = ConfigKeyPair.of("trial_chamber/slow_ranged/stray");
    final static private ConfigKeyPair SMALL_MELEE_BABY_ZOMBIE = ConfigKeyPair.of("trial_chamber/small_melee/baby_zombie");
    final static private ConfigKeyPair SMALL_MELEE_CAVE_SPIDER = ConfigKeyPair.of("trial_chamber/small_melee/cave_spider");
    final static private ConfigKeyPair SMALL_MELEE_SILVERFISH = ConfigKeyPair.of("trial_chamber/small_melee/silverfish");
    final static private ConfigKeyPair SMALL_MELEE_SLIME = ConfigKeyPair.of("trial_chamber/small_melee/slime");
    ...
    public static void bootstrap(Registerable<TrialSpawnerConfig> registry) {
        ...
        TrialSpawnerConfigs.register(registry, SMALL_MELEE_SLIME, TrialSpawnerConfigs.genericBuilder().spawnPotentials(Pool.builder().add(TrialSpawnerConfigs.createEntry(EntityType.SLIME, (NbtCompound nbt) -> nbt.putByte("Size", 1)), 3).add(TrialSpawnerConfigs.createEntry(EntityType.SLIME, (NbtCompound nbt) -> nbt.putByte("Size", 2)), 1).build()).build(), TrialSpawnerConfigs.ominousMeleeBuilder().lootTablesToEject(Pool.builder().add(LootTables.OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER, 3).add(LootTables.OMINOUS_TRIAL_CHAMBER_CONSUMABLES_SPAWNER, 7).build()).spawnPotentials(Pool.builder().add(TrialSpawnerConfigs.createEntry(EntityType.SLIME, (NbtCompound nbt) -> nbt.putByte("Size", 1)), 3).add(TrialSpawnerConfigs.createEntry(EntityType.SLIME, (NbtCompound nbt) -> nbt.putByte("Size", 2)), 1).build()).build());
    }
