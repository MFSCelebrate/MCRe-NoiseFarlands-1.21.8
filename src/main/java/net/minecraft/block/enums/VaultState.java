...
implements StringIdentifiable {
    final static public VaultState INACTIVE = new VaultState("inactive", Light.HALF_LIT){
    ...
    final static public VaultState ACTIVE = new VaultState("active", Light.LIT){
    ...
    final static public VaultState UNLOCKING = new VaultState("unlocking", Light.LIT){
    ...
    final static public VaultState EJECTING = new VaultState("ejecting", Light.LIT){
    ...
    final static private int field_48903 = 20;
    final static private int field_48904 = 20;
    final static private int field_48905 = 20;
    final static private int field_48906 = 20;
    final private String id;
    final private Light light;
    final static private VaultState[] field_48909;
    ...
    extends Enum<Light> {
        final static public Light HALF_LIT = new Light(6);
        final static public Light LIT = new Light(12);
        final int luminance;
        final static private Light[] field_48914;
