...
implements Waterloggable {
    final static public MapCodec<CandleBlock> CODEC = CandleBlock.createCodec(CandleBlock::new);
    final static public int field_31050 = 1;
    final static public int MAX_CANDLE_AMOUNT = 4;
    final static public IntProperty CANDLES = Properties.CANDLES;
    final static public BooleanProperty LIT = AbstractCandleBlock.LIT;
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static public ToIntFunction<BlockState> STATE_TO_LUMINANCE = state -> state.get(LIT) != false ? 3 * state.get(CANDLES) : 0;
    final static private Int2ObjectMap<List<Vec3d>> CANDLES_TO_PARTICLE_OFFSETS = (Int2ObjectMap)Util.make(new Int2ObjectOpenHashMap(4), int2ObjectOpenHashMap -> {
        float f = 0.0625f;
    ...
    final static private VoxelShape[] SHAPES_BY_CANDLES = new VoxelShape[]{Block.createColumnShape(2.0, 0.0, 6.0), Block.createCuboidShape(5.0, 0.0, 6.0, 11.0, 6.0, 9.0), Block.createCuboidShape(5.0, 0.0, 6.0, 10.0, 6.0, 11.0), Block.createCuboidShape(5.0, 0.0, 5.0, 11.0, 6.0, 10.0)};
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        return Block.sideCoversSmallSquare(world, pos.net_minecraft_util_math_BlockPos_down(), Direction.UP);
    }
}
