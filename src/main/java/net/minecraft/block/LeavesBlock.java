...
implements Waterloggable {
    ...
    final static public IntProperty DISTANCE = Properties.DISTANCE_1_7;
    final static public BooleanProperty PERSISTENT = Properties.PERSISTENT;
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final protected float leafParticleChance;
    final static private int field_31112 = 1;
    ...
    private static void spawnWaterParticle(World world, BlockPos pos, Random random, BlockState state, BlockPos posBelow) {
        if (!world.hasRain(pos.net_minecraft_util_math_BlockPos_up())) {
            return;
        }
