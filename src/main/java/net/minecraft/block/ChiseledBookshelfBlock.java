...
extends BlockWithEntity {
    final static public MapCodec<ChiseledBookshelfBlock> CODEC = ChiseledBookshelfBlock.createCodec(ChiseledBookshelfBlock::new);
    final static private int MAX_BOOK_COUNT = 6;
    final static public int BOOK_HEIGHT = 3;
    final static public List<BooleanProperty> SLOT_OCCUPIED_PROPERTIES = List.of(Properties.SLOT_0_OCCUPIED, Properties.SLOT_1_OCCUPIED, Properties.SLOT_2_OCCUPIED, Properties.SLOT_3_OCCUPIED, Properties.SLOT_4_OCCUPIED, Properties.SLOT_5_OCCUPIED);
    ...
    private static Optional<Vec2f> getHitPos(BlockHitResult hit, Direction facing) {
        ...
        BlockPos blockPos = hit.getBlockPos().net_minecraft_util_math_BlockPos_offset(direction);
