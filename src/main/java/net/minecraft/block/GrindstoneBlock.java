...
extends WallMountedBlock {
    final static public MapCodec<GrindstoneBlock> CODEC = GrindstoneBlock.createCodec(GrindstoneBlock::new);
    final static private Text TITLE = Text.translatable("container.grindstone_title");
