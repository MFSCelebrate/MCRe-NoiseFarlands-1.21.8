...
extends PlantBlock {
    final static public MapCodec<TallPlantBlock> CODEC = TallPlantBlock.createCodec(TallPlantBlock::new);
    ...
    protected static void onBreakInCreative(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        DoubleBlockHalf doubleBlockHalf = state.get(HALF);
        if (doubleBlockHalf == DoubleBlockHalf.UPPER && (blockState = world.getBlockState(blockPos = pos.net_minecraft_util_math_BlockPos_down())).isOf(state.getBlock()) && blockState.get(HALF) == DoubleBlockHalf.LOWER) {
