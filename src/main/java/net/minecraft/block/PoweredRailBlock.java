...
extends AbstractRailBlock {
    final static public MapCodec<PoweredRailBlock> CODEC = PoweredRailBlock.createCodec(PoweredRailBlock::new);
    final static public EnumProperty<RailShape> SHAPE = Properties.STRAIGHT_RAIL_SHAPE;
