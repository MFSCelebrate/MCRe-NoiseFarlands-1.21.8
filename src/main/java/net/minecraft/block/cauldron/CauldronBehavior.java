...
public interface CauldronBehavior {
    final static public Map<String, CauldronBehaviorMap> BEHAVIOR_MAPS = new Object2ObjectArrayMap();
    final static public Codec<CauldronBehaviorMap> CODEC = Codec.stringResolver(CauldronBehaviorMap::name, BEHAVIOR_MAPS::get);
    final static public CauldronBehaviorMap EMPTY_CAULDRON_BEHAVIOR = CauldronBehavior.createMap("empty");
    final static public CauldronBehaviorMap WATER_CAULDRON_BEHAVIOR = CauldronBehavior.createMap("water");
    final static public CauldronBehaviorMap LAVA_CAULDRON_BEHAVIOR = CauldronBehavior.createMap("lava");
    final static public CauldronBehaviorMap POWDER_SNOW_CAULDRON_BEHAVIOR = CauldronBehavior.createMap("powder_snow");
    ...
    private static boolean isUnderwater(World world, BlockPos pos) {
        FluidState fluidState = world.getFluidState(pos.net_minecraft_util_math_BlockPos_up());
