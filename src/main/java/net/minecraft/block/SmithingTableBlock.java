...
extends CraftingTableBlock {
    final static public MapCodec<SmithingTableBlock> CODEC = SmithingTableBlock.createCodec(SmithingTableBlock::new);
    final static private Text SCREEN_TITLE = Text.translatable("container.upgrade");
