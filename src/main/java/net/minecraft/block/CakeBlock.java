...
extends Block {
    final static public MapCodec<CakeBlock> CODEC = CakeBlock.createCodec(CakeBlock::new);
    final static public int MAX_BITES = 6;
    final static public IntProperty BITES = Properties.BITES;
    final static public int DEFAULT_COMPARATOR_OUTPUT = CakeBlock.getComparatorOutput(0);
    final static private VoxelShape[] SHAPES_BY_BITES = Block.createShapeArray(6, bites -> Block.createCuboidShape(1 + bites * 2, 0.0, 1.0, 15.0, 8.0, 15.0));
