...
public interface DispenserBehavior {
    ...
    final static public DispenserBehavior NOOP = (pointer, stack) -> stack;

    public ItemStack net_minecraft_item_ItemStack_dispense(BlockPointer var1, ItemStack var2);
    ...
    public static void registerDefaults() {
        ...
        ItemDispenserBehavior itemDispenserBehavior = new ItemDispenserBehavior(){
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                try {
                    entityType.spawnFromItemStack(pointer.world(), stack, null, pointer.pos().net_minecraft_util_math_BlockPos_offset(direction), SpawnReason.DISPENSER, direction != Direction.UP, false);
                }
        ...
        DispenserBlock.registerBehavior(Items.CHEST, new FallibleItemDispenserBehavior(){
            ...
            @Override
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                BlockPos blockPos = pointer.pos().net_minecraft_util_math_BlockPos_offset(pointer.state().get(DispenserBlock.FACING));
        ...
        ItemDispenserBehavior dispenserBehavior = new ItemDispenserBehavior(){
            final private ItemDispenserBehavior fallback = new ItemDispenserBehavior();
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                return this.fallback.net_minecraft_item_ItemStack_dispense(pointer, stack);
            }
        };
        ...
        DispenserBlock.registerBehavior(Items.BUCKET, new ItemDispenserBehavior(){
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                BlockState blockState = worldAccess.getBlockState(blockPos = pointer.pos().net_minecraft_util_math_BlockPos_offset(pointer.state().get(DispenserBlock.FACING)));
        ...
        DispenserBlock.registerBehavior(Items.WITHER_SKELETON_SKULL, new FallibleItemDispenserBehavior(){
            ...
            protected ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                if (world.isAir(blockPos) && WitherSkullBlock.canDispense(world, blockPos, stack)) {
                    ...
                    this.setSuccess(EquippableDispenserBehavior.boolean_dispense(pointer, stack));
                }
                return stack;
            }
        });
        ...
        DispenserBlock.registerBehavior(Items.BRUSH.asItem(), new FallibleItemDispenserBehavior(){
            ...
            protected ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                BlockPos blockPos;
                ServerWorld serverWorld = pointer.world();
                List<Entity> list = serverWorld.getEntitiesByClass(ArmadilloEntity.class, new Box(blockPos = pointer.pos().net_minecraft_util_math_BlockPos_offset(pointer.state().get(DispenserBlock.FACING))), EntityPredicates.EXCEPT_SPECTATOR);
                if (list.isEmpty()) {
                    this.setSuccess(false);
                    return stack;
                }
        ...
        DispenserBlock.registerBehavior(Items.POTION, new ItemDispenserBehavior(){
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                BlockPos blockPos2 = pointer.pos().net_minecraft_util_math_BlockPos_offset(pointer.state().get(DispenserBlock.FACING));
