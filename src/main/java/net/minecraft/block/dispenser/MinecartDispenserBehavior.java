...
extends ItemDispenserBehavior {
    ...
    final private EntityType<? extends AbstractMinecartEntity> minecartEntityType;
    ...
    public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
        ...
        if (blockState.isIn(BlockTags.RAILS)) {
            ...
            if (!blockState.isAir()) return this.fallbackBehavior.net_minecraft_item_ItemStack_dispense(pointer, stack);
            BlockState blockState2 = serverWorld.getBlockState(blockPos.net_minecraft_util_math_BlockPos_down());
            if (!blockState2.isIn(BlockTags.RAILS)) return this.fallbackBehavior.net_minecraft_item_ItemStack_dispense(pointer, stack);
