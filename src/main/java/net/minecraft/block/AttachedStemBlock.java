...
extends PlantBlock {
    ...
    protected BlockState getStateForNeighborUpdate(BlockState state, WorldView world, ScheduledTickView tickView, BlockPos pos, Direction direction, BlockPos neighborPos, BlockState neighborState, Random random) {
        ...
        if (!neighborState.matchesKey(this.gourdBlock) && direction == state.get(FACING) && (optional = world.getRegistryManager().net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.BLOCK).getOptionalValue(this.stemBlock)).isPresent()) {
