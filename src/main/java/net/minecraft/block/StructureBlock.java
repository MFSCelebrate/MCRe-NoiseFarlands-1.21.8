...
implements OperatorBlock {
    final static public MapCodec<StructureBlock> CODEC = StructureBlock.createCodec(StructureBlock::new);
    final static public EnumProperty<StructureBlockMode> MODE = Properties.STRUCTURE_BLOCK_MODE;
