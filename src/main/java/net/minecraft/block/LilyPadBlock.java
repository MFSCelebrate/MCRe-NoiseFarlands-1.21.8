...
extends PlantBlock {
    final static public MapCodec<LilyPadBlock> CODEC = LilyPadBlock.createCodec(LilyPadBlock::new);
    final static private VoxelShape SHAPE = Block.createColumnShape(14.0, 0.0, 1.5);
