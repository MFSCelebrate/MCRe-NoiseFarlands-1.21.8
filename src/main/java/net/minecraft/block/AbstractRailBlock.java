...
implements Waterloggable {
    ...
    final static private VoxelShape STRAIGHT_SHAPE = Block.createColumnShape(16.0, 0.0, 2.0);
    final static private VoxelShape ASCENDING_SHAPE = Block.createColumnShape(16.0, 0.0, 8.0);
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        return AbstractRailBlock.hasTopRim(world, pos.net_minecraft_util_math_BlockPos_down());
    }
    ...
    private static boolean shouldDropRail(BlockPos pos, World world, RailShape shape) {
        if (!AbstractRailBlock.hasTopRim(world, pos.net_minecraft_util_math_BlockPos_down())) {
            return true;
        }
        switch (shape) {
            case ASCENDING_EAST: {
                return !AbstractRailBlock.hasTopRim(world, pos.net_minecraft_util_math_BlockPos_east());
            }
            case ASCENDING_WEST: {
                return !AbstractRailBlock.hasTopRim(world, pos.net_minecraft_util_math_BlockPos_west());
            }
            case ASCENDING_NORTH: {
                return !AbstractRailBlock.hasTopRim(world, pos.net_minecraft_util_math_BlockPos_north());
            }
            case ASCENDING_SOUTH: {
                return !AbstractRailBlock.hasTopRim(world, pos.net_minecraft_util_math_BlockPos_south());
            }
        }
        return false;
    }
    ...
    protected void onStateReplaced(BlockState state, ServerWorld world, BlockPos pos, boolean moved) {
        ...
        if (state.get(this.getShapeProperty()).isAscending()) {
            world.updateNeighbors(pos.net_minecraft_util_math_BlockPos_up(), this);
        }
        if (this.forbidCurves) {
            world.updateNeighbors(pos, this);
            world.updateNeighbors(pos.net_minecraft_util_math_BlockPos_down(), this);
        }
    }
