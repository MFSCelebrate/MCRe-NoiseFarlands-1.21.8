...
public class VaultServerData {
    final static String SERVER_DATA_KEY = "server_data";
    ...
    final static private int MAX_STORED_REWARDED_PLAYERS = 128;
    final private Set<UUID> rewardedPlayers = new ObjectLinkedOpenHashSet();
    private long stateUpdatingResumesAt;
    final private List<ItemStack> itemsToEject = new ObjectArrayList();
