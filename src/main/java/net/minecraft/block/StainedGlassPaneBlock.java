...
implements Stainable {
    final static public MapCodec<StainedGlassPaneBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)DyeColor.CODEC.fieldOf("color").forGetter(StainedGlassPaneBlock::getColor), StainedGlassPaneBlock.createSettingsCodec()).apply((Applicative)instance, StainedGlassPaneBlock::new));
