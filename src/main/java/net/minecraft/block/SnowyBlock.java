...
extends Block {
    final static public MapCodec<SnowyBlock> CODEC = SnowyBlock.createCodec(SnowyBlock::new);
    final static public BooleanProperty SNOWY = Properties.SNOWY;
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        BlockState blockState = ctx.getWorld().getBlockState(ctx.getBlockPos().net_minecraft_util_math_BlockPos_up());
