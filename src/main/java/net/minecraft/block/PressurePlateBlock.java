...
extends AbstractPressurePlateBlock {
    final static public MapCodec<PressurePlateBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)BlockSetType.CODEC.fieldOf("block_set_type").forGetter(block -> block.blockSetType), PressurePlateBlock.createSettingsCodec()).apply((Applicative)instance, PressurePlateBlock::new));
