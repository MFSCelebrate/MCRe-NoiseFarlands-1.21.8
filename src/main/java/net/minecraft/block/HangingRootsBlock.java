...
implements Waterloggable {
    final static public MapCodec<HangingRootsBlock> CODEC = HangingRootsBlock.createCodec(HangingRootsBlock::new);
    final static private BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static private VoxelShape SHAPE = Block.createColumnShape(12.0, 10.0, 16.0);
