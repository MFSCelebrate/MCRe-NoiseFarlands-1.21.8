...
extends IceBlock {
    final static public MapCodec<FrostedIceBlock> CODEC = FrostedIceBlock.createCodec(FrostedIceBlock::new);
    final static public int MAX_AGE = 3;
    final static public IntProperty AGE = Properties.AGE_3;
    final static private int NEIGHBORS_CHECKED_ON_SCHEDULED_TICK = 4;
    final static private int NEIGHBORS_CHECKED_ON_NEIGHBOR_UPDATE = 2;
