...
extends Block {
    final static public MapCodec<CraftingTableBlock> CODEC = CraftingTableBlock.createCodec(CraftingTableBlock::new);
    final static private Text TITLE = Text.translatable("container.crafting");
