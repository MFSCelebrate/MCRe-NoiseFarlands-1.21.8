...
implements Fertilizable {
    final static public MapCodec<NetherrackBlock> CODEC = NetherrackBlock.createCodec(NetherrackBlock::new);
    ...
    public boolean isFertilizable(WorldView world, BlockPos pos, BlockState state) {
        if (!world.getBlockState(pos.net_minecraft_util_math_BlockPos_up()).isTransparent()) {
            return false;
        }
        for (BlockPos blockPos : BlockPos.iterate(pos.net_minecraft_util_math_BlockPos_add(-1, -1, -1), pos.net_minecraft_util_math_BlockPos_add(1, 1, 1))) {
