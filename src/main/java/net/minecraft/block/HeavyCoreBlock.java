...
implements Waterloggable {
    final static public MapCodec<HeavyCoreBlock> CODEC = HeavyCoreBlock.createCodec(HeavyCoreBlock::new);
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static private VoxelShape OUTLINE_SHAPE = Block.createColumnShape(8.0, 0.0, 8.0);
