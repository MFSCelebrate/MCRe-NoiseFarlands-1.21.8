...
extends PlantBlock {
    final static public MapCodec<SproutsBlock> CODEC = SproutsBlock.createCodec(SproutsBlock::new);
    final static private VoxelShape SHAPE = Block.createColumnShape(12.0, 0.0, 3.0);
