...
Waterloggable {
    final static public MapCodec<BigDripleafStemBlock> CODEC = BigDripleafStemBlock.createCodec(BigDripleafStemBlock::new);
    final static private BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static private Map<Direction, VoxelShape> SHAPES_BY_DIRECTION = VoxelShapes.createHorizontalFacingShapeMap(Block.createColumnShape(6.0, 0.0, 16.0).offset(0.0, 0.0, 0.25).simplify());
    ...
    public boolean isFertilizable(WorldView world, BlockPos pos, BlockState state) {
        ...
        BlockPos blockPos = optional.get().net_minecraft_util_math_BlockPos_up();
        BlockState blockState = world.getBlockState(blockPos);
