...
extends Block {
    final static public MapCodec<FlowerPotBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Registries.BLOCK.getCodec().fieldOf("potted").forGetter(block -> block.content), FlowerPotBlock.createSettingsCodec()).apply((Applicative)instance, FlowerPotBlock::new));
    final static private Map<Block, Block> CONTENT_TO_POTTED = Maps.newHashMap();
    final static private VoxelShape SHAPE = Block.createColumnShape(6.0, 0.0, 6.0);
    final private Block content;
