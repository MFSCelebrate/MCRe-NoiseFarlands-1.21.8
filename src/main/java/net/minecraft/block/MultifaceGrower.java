...
public class MultifaceGrower {
    final static public GrowType[] GROW_TYPES = new GrowType[]{GrowType.SAME_POSITION, GrowType.SAME_PLANE, GrowType.WRAP_AROUND};
    final private GrowChecker growChecker;
    ...
    extends Enum<GrowType> {
        final static public GrowType SAME_POSITION = new GrowType(){
        ...
        final static public GrowType SAME_PLANE = new GrowType(){

            @Override
            public GrowPos getGrowPos(BlockPos pos, Direction newDirection, Direction oldDirection) {
                return new GrowPos(pos.net_minecraft_util_math_BlockPos_offset(newDirection), oldDirection);
            }
        };
        final static public GrowType WRAP_AROUND = new GrowType(){

            @Override
            public GrowPos getGrowPos(BlockPos pos, Direction newDirection, Direction oldDirection) {
                return new GrowPos(pos.net_minecraft_util_math_BlockPos_offset(newDirection).net_minecraft_util_math_BlockPos_offset(oldDirection), newDirection.getOpposite());
            }
        };
        final static private GrowType[] field_37601;
