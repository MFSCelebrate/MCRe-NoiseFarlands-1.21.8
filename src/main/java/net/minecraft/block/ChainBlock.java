...
implements Waterloggable {
    final static public MapCodec<ChainBlock> CODEC = ChainBlock.createCodec(ChainBlock::new);
    final static public BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    final static private Map<Direction.Axis, VoxelShape> SHAPES_BY_AXIS = VoxelShapes.createAxisShapeMap(Block.createCuboidShape(3.0, 3.0, 16.0));
