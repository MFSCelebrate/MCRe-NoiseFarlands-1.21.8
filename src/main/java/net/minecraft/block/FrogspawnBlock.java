...
extends Block {
    final static public MapCodec<FrogspawnBlock> CODEC = FrogspawnBlock.createCodec(FrogspawnBlock::new);
    final static private int MIN_TADPOLES = 2;
    final static private int MAX_TADPOLES = 5;
    final static private int MIN_HATCH_TIME = 3600;
    final static private int MAX_HATCH_TIME = 12000;
    final static private VoxelShape SHAPE = Block.createColumnShape(16.0, 0.0, 1.5);
    static private int minHatchTime = 3600;
    static private int maxHatchTime = 12000;
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        return FrogspawnBlock.canLayAt(world, pos.net_minecraft_util_math_BlockPos_down());
    }
    ...
    private static boolean canLayAt(BlockView world, BlockPos pos) {
        ...
        FluidState fluidState2 = world.getFluidState(pos.net_minecraft_util_math_BlockPos_up());
