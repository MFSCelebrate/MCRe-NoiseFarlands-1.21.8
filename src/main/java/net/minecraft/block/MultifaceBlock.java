...
implements Waterloggable {
    final static public MapCodec<MultifaceBlock> CODEC = MultifaceBlock.createCodec(MultifaceBlock::new);
    ...
    final private boolean hasAllHorizontalDirections;
    final private boolean canMirrorX;
    final private boolean canMirrorZ;
