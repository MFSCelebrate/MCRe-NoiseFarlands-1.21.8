...
extends Block {
    final static public MapCodec<EndPortalFrameBlock> CODEC = EndPortalFrameBlock.createCodec(EndPortalFrameBlock::new);
    final static public EnumProperty<Direction> FACING = HorizontalFacingBlock.FACING;
    final static public BooleanProperty EYE = Properties.EYE;
    final static private VoxelShape FRAME_SHAPE = Block.createColumnShape(16.0, 0.0, 13.0);
    final static private VoxelShape FRAME_WITH_EYE_SHAPE = VoxelShapes.union(FRAME_SHAPE, Block.createColumnShape(8.0, 13.0, 16.0));
    static private BlockPattern COMPLETED_FRAME;
