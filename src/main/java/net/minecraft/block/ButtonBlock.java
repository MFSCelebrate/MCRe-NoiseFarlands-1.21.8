...
extends WallMountedBlock {
    final static public MapCodec<ButtonBlock> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)BlockSetType.CODEC.fieldOf("block_set_type").forGetter(block -> block.blockSetType), (App)Codec.intRange(1, 1024).fieldOf("ticks_to_stay_pressed").forGetter(block -> block.pressTicks), ButtonBlock.createSettingsCodec()).apply((Applicative)instance, ButtonBlock::new));
    final static public BooleanProperty POWERED = Properties.POWERED;
    final private BlockSetType blockSetType;
    final private int pressTicks;
    ...
    private void updateNeighbors(BlockState state, World world, BlockPos pos) {
        ...
        world.updateNeighborsAlways(pos.net_minecraft_util_math_BlockPos_offset(direction), this, wireOrientation);
    }
