...
implements DataCommandObject {
    ...
    final static private SimpleCommandExceptionType INVALID_ENTITY_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.data.entity.invalid"));
