...
public interface CommandSource {
    final static public CharMatcher SUGGESTION_MATCH_PREFIX = CharMatcher.anyOf((CharSequence)"._/");
    ...
    public static class RelativePosition {
        final static public RelativePosition ZERO_LOCAL = new RelativePosition("^", "^", "^");
        final static public RelativePosition ZERO_WORLD = new RelativePosition("~", "~", "~");
        final public String x;
        final public String y;
        final public String z;
    ...
    extends Enum<SuggestedIdType> {
        final static public SuggestedIdType TAGS = new SuggestedIdType();
        final static public SuggestedIdType ELEMENTS = new SuggestedIdType();
        final static public SuggestedIdType ALL = new SuggestedIdType();
        final static private SuggestedIdType[] field_37265;
