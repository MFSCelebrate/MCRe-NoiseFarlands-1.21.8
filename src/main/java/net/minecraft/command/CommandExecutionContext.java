...
implements AutoCloseable {
    final static private int MAX_COMMAND_QUEUE_LENGTH = 10000000;
    final static private Logger LOGGER = LogUtils.getLogger();
    final private int maxCommandChainLength;
    final private int forkLimit;
    final private Profiler profiler;
    @Nullable
    private Tracer tracer;
    private int commandsRemaining;
    private boolean queueOverflowed;
    final private Deque<CommandQueueEntry<T>> commandQueue = Queues.newArrayDeque();
    final private List<CommandQueueEntry<T>> pendingCommands = new ObjectArrayList();
