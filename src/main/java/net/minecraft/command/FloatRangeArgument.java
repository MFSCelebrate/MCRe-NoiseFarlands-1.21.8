...
public record FloatRangeArgument(@Nullable Float min, @Nullable Float max) {
    final static public FloatRangeArgument ANY = new FloatRangeArgument(null, null);
    final static public SimpleCommandExceptionType ONLY_INTS_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.range.ints"));
