...
implements ArgumentType<Formatting> {
    final static private Collection<String> EXAMPLES = Arrays.asList("red", "green");
    final static public DynamicCommandExceptionType INVALID_COLOR_EXCEPTION = new DynamicCommandExceptionType(color -> Text.stringifiedTranslatable("argument.color.invalid", color));
    ...
    public Formatting net_minecraft_util_Formatting_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader reader) throws CommandSyntaxException {
        return this.net_minecraft_util_Formatting_parse(reader);
    }
}
