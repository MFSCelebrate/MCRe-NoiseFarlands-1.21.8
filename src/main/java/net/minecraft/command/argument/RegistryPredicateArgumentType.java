...
implements ArgumentType<RegistryPredicate<T>> {
    ...
    implements ArgumentSerializer<RegistryPredicateArgumentType<T>, Properties> {
        ...
        @Override
        public Properties net_minecraft_command_argument_RegistryPredicateArgumentType$Serializer$Properties_fromPacket(PacketByteBuf packetByteBuf) {
        ...
        public ArgumentSerializer.ArgumentTypeProperties net_minecraft_command_argument_serialize_ArgumentSerializer$ArgumentTypeProperties_fromPacket(PacketByteBuf buf) {
            return this.net_minecraft_command_argument_RegistryPredicateArgumentType$Serializer$Properties_fromPacket(buf);
        }
