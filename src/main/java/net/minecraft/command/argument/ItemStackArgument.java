...
public class ItemStackArgument {
    final static private Dynamic2CommandExceptionType OVERSTACKED_EXCEPTION = new Dynamic2CommandExceptionType((item, maxCount) -> Text.stringifiedTranslatable("arguments.item.overstacked", item, maxCount));
    final private RegistryEntry<Item> item;
    final private ComponentChanges components;
