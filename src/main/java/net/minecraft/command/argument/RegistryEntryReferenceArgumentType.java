...
implements ArgumentType<RegistryEntry.Reference<T>> {
    ...
    final static private DynamicCommandExceptionType NOT_SUMMONABLE_EXCEPTION = new DynamicCommandExceptionType(id -> Text.stringifiedTranslatable("entity.not_summonable", id));
    final static public Dynamic2CommandExceptionType NOT_FOUND_EXCEPTION = new Dynamic2CommandExceptionType((element, type) -> Text.stringifiedTranslatable("argument.resource.not_found", element, type));
    final static public Dynamic3CommandExceptionType INVALID_TYPE_EXCEPTION = new Dynamic3CommandExceptionType((element, type, expectedType) -> Text.stringifiedTranslatable("argument.resource.invalid_type", element, type, expectedType));
    final RegistryKey<? extends Registry<T>> registryRef;
    final private RegistryWrapper<T> registryWrapper;
    ...
    public RegistryEntryReferenceArgumentType(CommandRegistryAccess registryAccess, RegistryKey<? extends Registry<T>> registryRef) {
        ...
        this.registryWrapper = registryAccess.net_minecraft_registry_RegistryEntryLookup_getOrThrow(registryRef);
    }
    ...
    implements ArgumentSerializer<RegistryEntryReferenceArgumentType<T>, Properties> {
        ...
        @Override
        public Properties net_minecraft_command_argument_RegistryEntryReferenceArgumentType$Serializer$Properties_fromPacket(PacketByteBuf packetByteBuf) {
        ...
        public ArgumentSerializer.ArgumentTypeProperties net_minecraft_command_argument_serialize_ArgumentSerializer$ArgumentTypeProperties_fromPacket(PacketByteBuf buf) {
            return this.net_minecraft_command_argument_RegistryEntryReferenceArgumentType$Serializer$Properties_fromPacket(buf);
        }
