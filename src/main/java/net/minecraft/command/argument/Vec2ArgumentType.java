...
implements ArgumentType<PosArgument> {
    final static private Collection<String> EXAMPLES = Arrays.asList("0 0", "~ ~", "0.1 -0.5", "~1 ~-2");
    final static public SimpleCommandExceptionType INCOMPLETE_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.pos2d.incomplete"));
