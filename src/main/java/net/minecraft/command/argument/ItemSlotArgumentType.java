...
implements ArgumentType<Integer> {
    final static private Collection<String> EXAMPLES = Arrays.asList("container.5", "weapon");
    final static private DynamicCommandExceptionType UNKNOWN_SLOT_EXCEPTION = new DynamicCommandExceptionType(name -> Text.stringifiedTranslatable("slot.unknown", name));
    final static private DynamicCommandExceptionType ONLY_SINGLE_ALLOWED_EXCEPTION = new DynamicCommandExceptionType(name -> Text.stringifiedTranslatable("slot.only_single_allowed", name));
