...
implements ArgumentType<EnumSet<Direction.Axis>> {
    final static private Collection<String> EXAMPLES = Arrays.asList("xyz", "x");
    final static private SimpleCommandExceptionType INVALID_SWIZZLE_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("arguments.swizzle.invalid"));
