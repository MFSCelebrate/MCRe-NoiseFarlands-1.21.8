...
implements ArgumentType<SlotRange> {
    final static private Collection<String> EXAMPLES = List.of("container.*", "container.5", "weapon");
    final static private DynamicCommandExceptionType UNKNOWN_SLOT_EXCEPTION = new DynamicCommandExceptionType(slotRange -> Text.stringifiedTranslatable("slot.unknown", slotRange));
    ...
    public SlotRange net_minecraft_inventory_SlotRange_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader stringReader) throws CommandSyntaxException {
        return this.net_minecraft_inventory_SlotRange_parse(stringReader);
    }
}
