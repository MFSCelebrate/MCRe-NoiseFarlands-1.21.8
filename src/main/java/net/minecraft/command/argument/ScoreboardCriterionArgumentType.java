...
implements ArgumentType<ScoreboardCriterion> {
    final static private Collection<String> EXAMPLES = Arrays.asList("foo", "foo.bar.baz", "minecraft:foo");
    final static public DynamicCommandExceptionType INVALID_CRITERION_EXCEPTION = new DynamicCommandExceptionType(name -> Text.stringifiedTranslatable("argument.criteria.invalid", name));
    ...
    public ScoreboardCriterion net_minecraft_scoreboard_ScoreboardCriterion_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader reader) throws CommandSyntaxException {
        return this.net_minecraft_scoreboard_ScoreboardCriterion_parse(reader);
    }
}
