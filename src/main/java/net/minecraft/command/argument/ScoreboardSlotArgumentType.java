...
implements ArgumentType<ScoreboardDisplaySlot> {
    final static private Collection<String> EXAMPLES = Arrays.asList("sidebar", "foo.bar");
    final static public DynamicCommandExceptionType INVALID_SLOT_EXCEPTION = new DynamicCommandExceptionType(name -> Text.stringifiedTranslatable("argument.scoreboardDisplaySlot.invalid", name));
    ...
    public ScoreboardDisplaySlot net_minecraft_scoreboard_ScoreboardDisplaySlot_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader reader) throws CommandSyntaxException {
        return this.net_minecraft_scoreboard_ScoreboardDisplaySlot_parse(reader);
    }
}
