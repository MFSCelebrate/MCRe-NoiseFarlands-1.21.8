...
extends ParserBackedArgumentType<Style> {
    final static private Collection<String> EXAMPLES = List.of("{bold: true}", "{color: 'red'}", "{}");
    final static public DynamicCommandExceptionType INVALID_STYLE_EXCEPTION = new DynamicCommandExceptionType(style -> Text.stringifiedTranslatable("argument.style.invalid", style));
