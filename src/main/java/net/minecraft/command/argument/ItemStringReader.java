...
public class ItemStringReader {
    ...
    final static DynamicCommandExceptionType UNKNOWN_COMPONENT_EXCEPTION = new DynamicCommandExceptionType(id -> Text.stringifiedTranslatable("arguments.item.component.unknown", id));
    final static Dynamic2CommandExceptionType MALFORMED_COMPONENT_EXCEPTION = new Dynamic2CommandExceptionType((type, error) -> Text.stringifiedTranslatable("arguments.item.component.malformed", type, error));
    final static SimpleCommandExceptionType COMPONENT_EXPECTED_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("arguments.item.component.expected"));
    final static DynamicCommandExceptionType REPEATED_COMPONENT_EXCEPTION = new DynamicCommandExceptionType(type -> Text.stringifiedTranslatable("arguments.item.component.repeated", type));
    final static private DynamicCommandExceptionType MALFORMED_ITEM_EXCEPTION = new DynamicCommandExceptionType(error -> Text.stringifiedTranslatable("arguments.item.malformed", error));
    final static public char OPEN_SQUARE_BRACKET = '[';
    final static public char CLOSED_SQUARE_BRACKET = ']';
    final static public char COMMA = ',';
    final static public char EQUAL_SIGN = '=';
    final static public char EXCLAMATION_MARK = '!';
    final static Function<SuggestionsBuilder, CompletableFuture<Suggestions>> SUGGEST_DEFAULT = SuggestionsBuilder::buildFuture;
    ...
    public ItemStringReader(RegistryWrapper.WrapperLookup registries) {
        this.itemRegistry = registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.ITEM);
