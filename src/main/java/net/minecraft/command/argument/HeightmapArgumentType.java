...
extends EnumArgumentType<Heightmap.Type> {
    final static private Codec<Heightmap.Type> HEIGHTMAP_CODEC = StringIdentifiable.createCodec(HeightmapArgumentType::getHeightmapTypes, name -> name.toLowerCase(Locale.ROOT));
