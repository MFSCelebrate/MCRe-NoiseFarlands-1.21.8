...
implements ArgumentType<BlockPredicate> {
    final static private Collection<String> EXAMPLES = Arrays.asList("stone", "minecraft:stone", "stone[foo=bar]", "#stone", "#stone[foo=bar]{baz=nbt}");
    ...
    public BlockPredicate net_minecraft_command_argument_BlockPredicateArgumentType$BlockPredicate_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader reader) throws CommandSyntaxException {
        return this.net_minecraft_command_argument_BlockPredicateArgumentType$BlockPredicate_parse(reader);
    }
    ...
    implements BlockPredicate {
        final private RegistryEntryList<Block> tag;
        @Nullable
