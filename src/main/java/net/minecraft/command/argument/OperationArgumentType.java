...
implements ArgumentType<Operation> {
    final static private Collection<String> EXAMPLES = Arrays.asList("=", ">", "<");
    final static private SimpleCommandExceptionType INVALID_OPERATION = new SimpleCommandExceptionType((Message)Text.translatable("arguments.operation.invalid"));
    final static private SimpleCommandExceptionType DIVISION_ZERO_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("arguments.operation.div0"));
    ...
    public Operation net_minecraft_command_argument_OperationArgumentType$Operation_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader reader) throws CommandSyntaxException {
        return this.net_minecraft_command_argument_OperationArgumentType$Operation_parse(reader);
    }
