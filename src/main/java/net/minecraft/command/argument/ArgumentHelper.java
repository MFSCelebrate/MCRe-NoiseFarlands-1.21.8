...
public class ArgumentHelper {
    ...
    final static private byte MIN_FLAG = 1;
    final static private byte MAX_FLAG = 2;
    ...
    public static <S> JsonObject toJson(CommandDispatcher<S> dispatcher, CommandNode<S> node) {
        ...
        if ((rootCommandNode = node.getRequirement()) instanceof PermissionLevelPredicate) {
            PermissionLevelPredicate permissionLevelPredicate = (PermissionLevelPredicate)rootCommandNode;
            jsonObject.addProperty("required_level", (Number)permissionLevelPredicate.requiredLevel());
        }
