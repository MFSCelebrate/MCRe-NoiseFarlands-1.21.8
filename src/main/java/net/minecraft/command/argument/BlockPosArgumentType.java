...
implements ArgumentType<PosArgument> {
    final static private Collection<String> EXAMPLES = Arrays.asList("0 0 0", "~ ~ ~", "^ ^ ^", "^1 ^ ^-5", "~0.5 ~1 ~-5");
    ...
    final static public SimpleCommandExceptionType OUT_OF_WORLD_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.pos.outofworld"));
    final static public SimpleCommandExceptionType OUT_OF_BOUNDS_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.pos.outofbounds"));
    ...
    public PosArgument net_minecraft_command_argument_PosArgument_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader reader) throws CommandSyntaxException {
        return this.net_minecraft_command_argument_PosArgument_parse(reader);
    }
}
