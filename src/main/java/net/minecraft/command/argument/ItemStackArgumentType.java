...
implements ArgumentType<ItemStackArgument> {
    final static private Collection<String> EXAMPLES = Arrays.asList("stick", "minecraft:stick", "stick{foo=bar}");
    final private ItemStringReader reader;
    ...
    public ItemStackArgument net_minecraft_command_argument_ItemStackArgument_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader reader) throws CommandSyntaxException {
        return this.net_minecraft_command_argument_ItemStackArgument_parse(reader);
    }
}
