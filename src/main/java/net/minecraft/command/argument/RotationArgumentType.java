...
implements ArgumentType<PosArgument> {
    final static private Collection<String> EXAMPLES = Arrays.asList("0 0", "~ ~", "~-5 ~5");
    final static public SimpleCommandExceptionType INCOMPLETE_ROTATION_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.rotation.incomplete"));
