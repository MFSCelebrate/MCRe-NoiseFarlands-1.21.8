...
implements ArgumentType<T> {
    final static private DynamicCommandExceptionType INVALID_ENUM_EXCEPTION = new DynamicCommandExceptionType(value -> Text.stringifiedTranslatable("argument.enum.invalid", value));
    final private Codec<T> codec;
    final private Supplier<T[]> valuesSupplier;
