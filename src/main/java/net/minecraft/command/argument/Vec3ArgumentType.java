...
implements ArgumentType<PosArgument> {
    final static private Collection<String> EXAMPLES = Arrays.asList("0 0 0", "~ ~ ~", "^ ^ ^", "^1 ^ ^-5", "0.1 -0.5 .9", "~0.5 ~1 ~-5");
    final static public SimpleCommandExceptionType INCOMPLETE_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.pos3d.incomplete"));
    final static public SimpleCommandExceptionType MIXED_COORDINATE_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.pos.mixed"));
    final private boolean centerIntegers;
