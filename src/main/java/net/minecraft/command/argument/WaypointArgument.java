...
public class WaypointArgument {
    final static public SimpleCommandExceptionType INVALID_WAYPOINT_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.waypoint.invalid"));
