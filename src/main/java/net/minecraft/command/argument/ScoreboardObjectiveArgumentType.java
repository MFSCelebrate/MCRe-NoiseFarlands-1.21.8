...
implements ArgumentType<String> {
    final static private Collection<String> EXAMPLES = Arrays.asList("foo", "*", "012");
    final static private DynamicCommandExceptionType UNKNOWN_OBJECTIVE_EXCEPTION = new DynamicCommandExceptionType(name -> Text.stringifiedTranslatable("arguments.objective.notFound", name));
    final static private DynamicCommandExceptionType READONLY_OBJECTIVE_EXCEPTION = new DynamicCommandExceptionType(name -> Text.stringifiedTranslatable("arguments.objective.readonly", name));
    ...
    public String java_lang_String_parse(StringReader stringReader) throws CommandSyntaxException {
    ...
    public Object java_lang_Object_parse(StringReader reader) throws CommandSyntaxException {
        return this.java_lang_String_parse(reader);
    }
}
