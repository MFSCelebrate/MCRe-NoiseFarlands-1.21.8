...
implements ArgumentType<String> {
    final static private Collection<String> EXAMPLES = Arrays.asList("foo", "123");
    final static private DynamicCommandExceptionType UNKNOWN_TEAM_EXCEPTION = new DynamicCommandExceptionType(name -> Text.stringifiedTranslatable("team.notFound", name));
