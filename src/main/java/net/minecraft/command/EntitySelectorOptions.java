...
public class EntitySelectorOptions {
    ...
    final static private Map<String, SelectorOption> OPTIONS = Maps.newHashMap();
    final static public DynamicCommandExceptionType UNKNOWN_OPTION_EXCEPTION = new DynamicCommandExceptionType(option -> Text.stringifiedTranslatable("argument.entity.options.unknown", option));
    final static public DynamicCommandExceptionType INAPPLICABLE_OPTION_EXCEPTION = new DynamicCommandExceptionType(option -> Text.stringifiedTranslatable("argument.entity.options.inapplicable", option));
    final static public SimpleCommandExceptionType NEGATIVE_DISTANCE_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.entity.options.distance.negative"));
    final static public SimpleCommandExceptionType NEGATIVE_LEVEL_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.entity.options.level.negative"));
    final static public SimpleCommandExceptionType TOO_SMALL_LEVEL_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("argument.entity.options.limit.toosmall"));
    final static public DynamicCommandExceptionType IRREVERSIBLE_SORT_EXCEPTION = new DynamicCommandExceptionType(sortType -> Text.stringifiedTranslatable("argument.entity.options.sort.irreversible", sortType));
    final static public DynamicCommandExceptionType INVALID_MODE_EXCEPTION = new DynamicCommandExceptionType(gameMode -> Text.stringifiedTranslatable("argument.entity.options.mode.invalid", gameMode));
    final static public DynamicCommandExceptionType INVALID_TYPE_EXCEPTION = new DynamicCommandExceptionType(entity -> Text.stringifiedTranslatable("argument.entity.options.type.invalid", entity));
    ...
    public static void register() {
        ...
        EntitySelectorOptions.putOption("predicate", reader -> {
            ...
            reader.addPredicate(entity -> {
                if (!(entity.net_minecraft_world_World_getWorld() instanceof ServerWorld)) {
                    return false;
                }
                ServerWorld serverWorld = (ServerWorld)entity.net_minecraft_world_World_getWorld();
