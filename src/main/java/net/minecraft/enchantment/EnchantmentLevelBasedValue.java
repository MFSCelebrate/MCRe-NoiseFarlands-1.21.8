...
public interface EnchantmentLevelBasedValue {
    final static public Codec<EnchantmentLevelBasedValue> BASE_CODEC = Registries.ENCHANTMENT_LEVEL_BASED_VALUE_TYPE.getCodec().dispatch(EnchantmentLevelBasedValue::getCodec, codec -> codec);
    final static public Codec<EnchantmentLevelBasedValue> CODEC = Codec.either(Constant.CODEC, BASE_CODEC).xmap(either -> (EnchantmentLevelBasedValue)either.map(type -> type, type -> type), type -> {
        Either either;
    ...
    {
        final static public MapCodec<Clamped> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)CODEC.fieldOf("value").forGetter(Clamped::value), (App)Codec.FLOAT.fieldOf("min").forGetter(Clamped::min), (App)Codec.FLOAT.fieldOf("max").forGetter(Clamped::max)).apply((Applicative)instance, Clamped::new)).validate(type -> {
    ...
    {
        final static public MapCodec<Fraction> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)CODEC.fieldOf("numerator").forGetter(Fraction::numerator), (App)CODEC.fieldOf("denominator").forGetter(Fraction::denominator)).apply((Applicative)instance, Fraction::new));
    ...
    {
        final static public MapCodec<LevelsSquared> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.FLOAT.fieldOf("added").forGetter(LevelsSquared::added)).apply((Applicative)instance, LevelsSquared::new));
    ...
    {
        final static public MapCodec<Linear> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.FLOAT.fieldOf("base").forGetter(Linear::base), (App)Codec.FLOAT.fieldOf("per_level_above_first").forGetter(Linear::perLevelAboveFirst)).apply((Applicative)instance, Linear::new));
    ...
    {
        final static public MapCodec<Lookup> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.FLOAT.listOf().fieldOf("values").forGetter(Lookup::values), (App)CODEC.fieldOf("fallback").forGetter(Lookup::fallback)).apply((Applicative)instance, Lookup::new));
    ...
    {
        final static public Codec<Constant> CODEC = Codec.FLOAT.xmap(Constant::new, Constant::value);
        final static public MapCodec<Constant> TYPE_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.FLOAT.fieldOf("value").forGetter(Constant::value)).apply((Applicative)instance, Constant::new));
