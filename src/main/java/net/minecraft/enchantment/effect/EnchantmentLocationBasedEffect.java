...
public interface EnchantmentLocationBasedEffect {
    final static public Codec<EnchantmentLocationBasedEffect> CODEC = Registries.ENCHANTMENT_LOCATION_BASED_EFFECT_TYPE.getCodec().dispatch(EnchantmentLocationBasedEffect::getCodec, Function.identity());
