...
public record SpawnParticlesEnchantmentEffect(ParticleEffect particle, PositionSource horizontalPosition, PositionSource verticalPosition, VelocitySource horizontalVelocity, VelocitySource verticalVelocity, FloatProvider speed) implements EnchantmentEntityEffect
{
    ...
    implements StringIdentifiable {
        final static public PositionSourceType ENTITY_POSITION = new PositionSourceType("entity_position", (entityPosition, boundingBoxCenter, boundingBoxSize, random) -> entityPosition);
        final static public PositionSourceType BOUNDING_BOX = new PositionSourceType("in_bounding_box", (entityPosition, boundingBoxCenter, boundingBoxSize, random) -> boundingBoxCenter + (random.nextDouble() - 0.5) * (double)boundingBoxSize);
        final static public Codec<PositionSourceType> CODEC;
        final private String id;
        final private CoordinateSource coordinateSource;
        final static private PositionSourceType[] field_51728;
