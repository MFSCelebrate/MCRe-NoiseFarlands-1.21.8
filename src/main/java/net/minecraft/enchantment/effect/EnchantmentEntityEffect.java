...
extends EnchantmentLocationBasedEffect {
    final static public Codec<EnchantmentEntityEffect> CODEC = Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE.getCodec().dispatch(EnchantmentEntityEffect::getCodec, Function.identity());
