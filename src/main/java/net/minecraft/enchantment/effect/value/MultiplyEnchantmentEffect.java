...
{
    final static public MapCodec<MultiplyEnchantmentEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)EnchantmentLevelBasedValue.CODEC.fieldOf("factor").forGetter(MultiplyEnchantmentEffect::factor)).apply((Applicative)instance, MultiplyEnchantmentEffect::new));
