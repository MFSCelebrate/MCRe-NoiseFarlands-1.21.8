...
{
    final static public MapCodec<SetEnchantmentEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)EnchantmentLevelBasedValue.CODEC.fieldOf("value").forGetter(SetEnchantmentEffect::value)).apply((Applicative)instance, SetEnchantmentEffect::new));
