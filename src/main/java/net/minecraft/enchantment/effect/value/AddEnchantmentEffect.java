...
{
    final static public MapCodec<AddEnchantmentEffect> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)EnchantmentLevelBasedValue.CODEC.fieldOf("value").forGetter(AddEnchantmentEffect::value)).apply((Applicative)instance, AddEnchantmentEffect::new));
