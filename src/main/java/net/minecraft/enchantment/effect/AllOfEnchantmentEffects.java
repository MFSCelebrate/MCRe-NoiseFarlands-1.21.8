...
public interface AllOfEnchantmentEffects {
    ...
    {
        final static public MapCodec<EntityEffects> CODEC = AllOfEnchantmentEffects.buildCodec(EnchantmentEntityEffect.CODEC, EntityEffects::new, EntityEffects::effects);
    ...
    {
        final static public MapCodec<LocationBasedEffects> CODEC = AllOfEnchantmentEffects.buildCodec(EnchantmentLocationBasedEffect.CODEC, LocationBasedEffects::new, LocationBasedEffects::effects);
    ...
    {
        final static public MapCodec<ValueEffects> CODEC = AllOfEnchantmentEffects.buildCodec(EnchantmentValueEffect.CODEC, ValueEffects::new, ValueEffects::effects);
