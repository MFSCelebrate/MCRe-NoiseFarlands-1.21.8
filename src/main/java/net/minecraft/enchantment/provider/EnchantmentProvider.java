...
public interface EnchantmentProvider {
    final static public Codec<EnchantmentProvider> CODEC = Registries.ENCHANTMENT_PROVIDER_TYPE.getCodec().dispatch(EnchantmentProvider::getCodec, Function.identity());
