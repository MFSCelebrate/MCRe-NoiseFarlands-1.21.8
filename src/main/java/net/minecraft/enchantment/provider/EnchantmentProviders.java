...
public interface EnchantmentProviders {
    final static public RegistryKey<EnchantmentProvider> MOB_SPAWN_EQUIPMENT = EnchantmentProviders.of("mob_spawn_equipment");
    final static public RegistryKey<EnchantmentProvider> PILLAGER_SPAWN_CROSSBOW = EnchantmentProviders.of("pillager_spawn_crossbow");
    final static public RegistryKey<EnchantmentProvider> PILLAGER_POST_WAVE_3_RAID = EnchantmentProviders.of("raid/pillager_post_wave_3");
    final static public RegistryKey<EnchantmentProvider> PILLAGER_POST_WAVE_5_RAID = EnchantmentProviders.of("raid/pillager_post_wave_5");
    final static public RegistryKey<EnchantmentProvider> VINDICATOR_RAID = EnchantmentProviders.of("raid/vindicator");
    final static public RegistryKey<EnchantmentProvider> VINDICATOR_POST_WAVE_5_RAID = EnchantmentProviders.of("raid/vindicator_post_wave_5");
    final static public RegistryKey<EnchantmentProvider> ENDERMAN_LOOT_DROP = EnchantmentProviders.of("enderman_loot_drop");
