...
public class TestSet {
    final static private char NOT_STARTED = ' ';
    final static private char RUNNING = '_';
    final static private char PASS = '+';
    final static private char OPTIONAL_FAIL = 'x';
    final static private char REQUIRED_FAIL = 'X';
    final private Collection<GameTestState> tests = Lists.newArrayList();
