...
extends TestFunctionProvider {
    final static public RegistryKey<Consumer<TestContext>> ALWAYS_PASS = BuiltinTestFunctions.of("always_pass");
    final static public Consumer<TestContext> ALWAYS_PASS_FUNCTION = TestContext::complete;
