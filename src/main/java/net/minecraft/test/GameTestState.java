...
public class GameTestState {
    final private RegistryEntry.Reference<TestInstance> instanceEntry;
    @Nullable
    private BlockPos testBlockPos;
    final private ServerWorld world;
    final private Collection<TestListener> listeners = Lists.newArrayList();
    final private int tickLimit;
    final private Collection<TimedTaskRunner> timedTaskRunners = Lists.newCopyOnWriteArrayList();
    final private Object2LongMap<Runnable> ticksByRunnables = new Object2LongOpenHashMap();
    private boolean initialized;
    private boolean tickedOnce;
    private int tick;
    private boolean started;
    final private TestAttemptConfig testAttemptConfig;
