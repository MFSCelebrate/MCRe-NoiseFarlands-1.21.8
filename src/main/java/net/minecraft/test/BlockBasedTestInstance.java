...
extends TestInstance {
    final static public MapCodec<BlockBasedTestInstance> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)TestData.CODEC.forGetter(TestInstance::getData)).apply((Applicative)instance, BlockBasedTestInstance::new));
