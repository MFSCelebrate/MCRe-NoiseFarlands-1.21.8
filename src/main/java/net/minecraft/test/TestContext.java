...
public class TestContext {
    final private GameTestState test;
    ...
    public ServerPlayerEntity createMockCreativeServerPlayerInWorld() {
        ...
        this.getWorld().getServer().net_minecraft_server_PlayerManager_getPlayerManager().onPlayerConnect(clientConnection, serverPlayerEntity, connectedClientData);
    ...
    public void expectSameStates(BlockBox checkedBlockBox, BlockPos correctStatePos) {
        BlockPos.stream(checkedBlockBox).forEach(checkedPos -> {
            BlockPos blockPos2 = correctStatePos.net_minecraft_util_math_BlockPos_add(checkedPos.getX() - checkedBlockBox.getMinX(), checkedPos.getY() - checkedBlockBox.getMinY(), checkedPos.getZ() - checkedBlockBox.getMinZ());
    ...
    public BlockPos getRelativePos(BlockPos pos) {
        ...
        return blockPos2.net_minecraft_util_math_BlockPos_subtract(blockPos);
    }
    ...
    public void useStackOnBlock(PlayerEntity player, ItemStack stack, BlockPos pos, Direction direction) {
        BlockPos blockPos = this.getAbsolutePos(pos.net_minecraft_util_math_BlockPos_offset(direction));
    ...
    public void setBiome(RegistryKey<Biome> biome) {
        ...
        Either<Integer, CommandSyntaxException> either = FillBiomeCommand.fillBiome(this.getWorld(), blockPos, blockPos2, this.getWorld().getRegistryManager().net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.BIOME).getOrThrow(biome));
