...
public abstract class TestInstance {
    final static public Codec<TestInstance> CODEC = Registries.TEST_INSTANCE_TYPE.getCodec().dispatch(TestInstance::getCodec, codec -> codec);
    final private TestData<RegistryEntry<TestEnvironmentDefinition>> data;
