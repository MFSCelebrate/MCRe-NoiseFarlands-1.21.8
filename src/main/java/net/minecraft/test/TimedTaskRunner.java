...
public class TimedTaskRunner {
    ...
    final private List<TimedTask> tasks = Lists.newArrayList();
    private int tick;
    ...
    private void runTasks(int tick) {
        ...
        while (iterator.hasNext()) {
            ...
            int j = this.tick;
            this.tick = tick;
            if (timedTask.duration == null || timedTask.duration == 1L) continue;
    ...
    public class Trigger {
        final static private int UNTRIGGERED_TICK = -1;
