...
extends Enum<ChunkLevelType> {
    final static public ChunkLevelType INACCESSIBLE = new ChunkLevelType();
    final static public ChunkLevelType FULL = new ChunkLevelType();
    final static public ChunkLevelType BLOCK_TICKING = new ChunkLevelType();
    final static public ChunkLevelType ENTITY_TICKING = new ChunkLevelType();
    final static private ChunkLevelType[] field_13878;
