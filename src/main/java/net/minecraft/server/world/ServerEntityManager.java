...
implements AutoCloseable {
    ...
    final private ChunkDataAccess<T> dataAccess;
    final private EntityIndex<T> index;
    final SectionedEntityCache<T> cache;
    final private EntityLookup<T> lookup;
    final private Long2ObjectMap<EntityTrackingStatus> trackingStatuses = new Long2ObjectOpenHashMap();
    final private Long2ObjectMap<Status> managedStatuses = new Long2ObjectOpenHashMap();
    final private LongSet pendingUnloads = new LongOpenHashSet();
    final private Queue<ChunkDataList<T>> loadingQueue = Queues.newConcurrentLinkedQueue();
    ...
    extends Enum<Status> {
        final static public Status FRESH = new Status();
        final static public Status PENDING = new Status();
        final static public Status LOADED = new Status();
        final static private Status[] field_27278;
    ...
    implements EntityChangeListener {
        ...
        final ServerEntityManager manager;
