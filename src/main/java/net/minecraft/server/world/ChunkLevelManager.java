...
public abstract class ChunkLevelManager {
    ...
    final static int NEARBY_PLAYER_TICKET_LEVEL = ChunkLevels.getLevelFromType(ChunkLevelType.ENTITY_TICKING);
    final Long2ObjectMap<ObjectSet<ServerPlayerEntity>> playersByChunkPos = new Long2ObjectOpenHashMap();
    final private TicketDistanceLevelPropagator ticketDistanceLevelPropagator;
    final private SimulationDistanceLevelPropagator simulationDistanceLevelPropagator;
    final ChunkTicketManager ticketManager;
    final private DistanceFromNearestPlayerTracker distanceFromNearestPlayerTracker = new DistanceFromNearestPlayerTracker(8);
    final private NearbyChunkTicketUpdater nearbyChunkTicketUpdater = new NearbyChunkTicketUpdater(32);
    final protected Set<ChunkHolder> chunkHoldersWithPendingUpdates = new ReferenceOpenHashSet();
    ...
    extends ChunkPosDistanceLevelPropagator {
        final protected Long2ByteMap distanceFromNearestPlayer;
        final protected int maxDistance;
    ...
    extends DistanceFromNearestPlayerTracker {
        ...
        final private Long2IntMap distances;
        final private LongSet positionsAffected;
