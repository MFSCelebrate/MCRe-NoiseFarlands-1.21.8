...
public class LevelPrioritizedQueue {
    final static public int LEVEL_COUNT = ChunkLevels.INACCESSIBLE + 2;
    final private List<Long2ObjectLinkedOpenHashMap<List<Runnable>>> values = IntStream.range(0, LEVEL_COUNT).mapToObj(level -> new Long2ObjectLinkedOpenHashMap()).toList();
