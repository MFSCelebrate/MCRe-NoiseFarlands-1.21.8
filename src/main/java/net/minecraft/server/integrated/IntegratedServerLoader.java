...
public class IntegratedServerLoader {
    ...
    final static private UUID WORLD_PACK_ID = UUID.fromString("640a6a92-b6cb-48a0-b391-831586500359");
    final private MinecraftClient client;
    final private LevelStorage storage;
    ...
    private void start(LevelStorage.Session session, Dynamic<?> levelProperties, boolean safeMode, Runnable onCancel) {
        ...
        try {
            ...
            Iterator iterator = saveLoader.combinedDynamicRegistries().getCombinedRegistryManager().net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.DIMENSION).iterator();
