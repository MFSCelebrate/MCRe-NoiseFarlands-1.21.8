...
extends TickManager {
    ...
    private void sendUpdateTickRatePacket() {
        this.server.net_minecraft_server_PlayerManager_getPlayerManager().sendToAll(UpdateTickRateS2CPacket.create(this));
    }

    private void sendStepPacket() {
        this.server.net_minecraft_server_PlayerManager_getPlayerManager().sendToAll(TickStepS2CPacket.create(this));
    }
