...
extends ServerConfigEntry<T> {
    final static public SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss Z", Locale.ROOT);
    final static public String FOREVER = "forever";
    final protected Date creationDate;
    final protected String source;
    @Nullable
    final protected Date expiryDate;
