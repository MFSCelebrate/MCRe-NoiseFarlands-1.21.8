...
implements CommandFunction<T> {
    final static private DecimalFormat DECIMAL_FORMAT = Util.make(new DecimalFormat("#"), format -> {
        format.setMaximumFractionDigits(15);
        format.setDecimalFormatSymbols(DecimalFormatSymbols.getInstance(Locale.US));
    });
    final static private int CACHE_SIZE = 8;
    final private List<String> varNames;
    final private Object2ObjectLinkedOpenHashMap<List<String>, Procedure<T>> cache = new Object2ObjectLinkedOpenHashMap(8, 0.25f);
    final private Identifier id;
    final private List<Line<T>> lines;
    ...
    implements Line<T> {
        final private MacroInvocation invocation;
        final private IntList variableIndices;
    ...
    implements Line<T> {
        final private SourcedCommandAction<T> action;
