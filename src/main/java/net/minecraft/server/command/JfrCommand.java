...
public class JfrCommand {
    final static private SimpleCommandExceptionType JFR_START_FAILED_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.jfr.start.failed"));
    final static private DynamicCommandExceptionType JFR_DUMP_FAILED_EXCEPTION = new DynamicCommandExceptionType(message -> Text.stringifiedTranslatable("commands.jfr.dump.failed", message));
