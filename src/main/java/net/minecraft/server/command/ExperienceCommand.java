...
public class ExperienceCommand {
    ...
    private static int executeQuery(ServerCommandSource source, ServerPlayerEntity player, Component component) {
        ...
        source.sendFeedback(() -> Text.translatable("commands.experience.query." + component.name, player.getDisplayName(), 1), false);
        return 1;
    }
    ...
    extends Enum<Component> {
        final static public Component POINTS = new Component("points", PlayerEntity::addExperience, (player, experience) -> {
        ...
        final static public Component LEVELS = new Component("levels", ServerPlayerEntity::addExperienceLevels, (player, level) -> {
            player.setExperienceLevel((int)level);
            return true;
        }, player -> player.experienceLevel);
        final public BiConsumer<ServerPlayerEntity, Integer> adder;
        final public BiPredicate<ServerPlayerEntity, Integer> setter;
        final public String name;
        final ToIntFunction<ServerPlayerEntity> getter;
        final static private Component[] field_13640;
