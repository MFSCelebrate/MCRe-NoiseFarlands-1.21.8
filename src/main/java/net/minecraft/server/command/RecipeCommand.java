...
public class RecipeCommand {
    final static private SimpleCommandExceptionType GIVE_FAILED_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.recipe.give.failed"));
    final static private SimpleCommandExceptionType TAKE_FAILED_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.recipe.take.failed"));
