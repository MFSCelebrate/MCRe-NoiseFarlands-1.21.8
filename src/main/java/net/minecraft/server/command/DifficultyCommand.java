...
public class DifficultyCommand {
    final static private DynamicCommandExceptionType FAILURE_EXCEPTION = new DynamicCommandExceptionType(difficulty -> Text.stringifiedTranslatable("commands.difficulty.failure", difficulty));
