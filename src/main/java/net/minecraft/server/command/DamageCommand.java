...
public class DamageCommand {
    final static private SimpleCommandExceptionType INVULNERABLE_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.damage.invulnerable"));
