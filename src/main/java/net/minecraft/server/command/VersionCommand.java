...
public class VersionCommand {
    final static private Text HEADER_TEXT = Text.translatable("commands.version.header");
    final static private Text STABLE_YES_TEXT = Text.translatable("commands.version.stable.yes");
    final static private Text STABLE_NO_TEXT = Text.translatable("commands.version.stable.no");
