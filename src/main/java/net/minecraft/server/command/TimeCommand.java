...
public class TimeCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("time").requires(CommandManager.requirePermissionLevel(2))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("set").then(CommandManager.literal("day").executes(context -> TimeCommand.executeSet((ServerCommandSource)context.getSource(), 1000)))).then(CommandManager.literal("noon").executes(context -> TimeCommand.executeSet((ServerCommandSource)context.getSource(), 6000)))).then(CommandManager.literal("night").executes(context -> TimeCommand.executeSet((ServerCommandSource)context.getSource(), 13000)))).then(CommandManager.literal("midnight").executes(context -> TimeCommand.executeSet((ServerCommandSource)context.getSource(), 18000)))).then(CommandManager.argument("time", TimeArgumentType.time()).executes(context -> TimeCommand.executeSet((ServerCommandSource)context.getSource(), IntegerArgumentType.getInteger((CommandContext)context, (String)"time")))))).then(CommandManager.literal("add").then(CommandManager.argument("time", TimeArgumentType.time()).executes(context -> TimeCommand.executeAdd((ServerCommandSource)context.getSource(), IntegerArgumentType.getInteger((CommandContext)context, (String)"time")))))).then(((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("query").then(CommandManager.literal("daytime").executes(context -> TimeCommand.executeQuery((ServerCommandSource)context.getSource(), TimeCommand.getDayTime(((ServerCommandSource)context.getSource()).getWorld()))))).then(CommandManager.literal("gametime").executes(context -> TimeCommand.executeQuery((ServerCommandSource)context.getSource(), (int)(((ServerCommandSource)context.getSource()).getWorld().getTime() % Integer.MAX_VALUE))))).then(CommandManager.literal("day").executes(context -> TimeCommand.executeQuery((ServerCommandSource)context.getSource(), (int)(((ServerCommandSource)context.getSource()).getWorld().getTimeOfDay() / 24000L % Integer.MAX_VALUE))))));
    }
