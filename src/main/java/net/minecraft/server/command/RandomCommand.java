...
public class RandomCommand {
    ...
    private static int execute(ServerCommandSource source, NumberRange.IntRange range, @Nullable Identifier sequenceId, boolean roll) throws CommandSyntaxException {
        ...
        if (roll) {
            source.getServer().net_minecraft_server_PlayerManager_getPlayerManager().broadcast(Text.translatable("commands.random.roll", source.getDisplayName(), k, i, j), false);
        } else {
