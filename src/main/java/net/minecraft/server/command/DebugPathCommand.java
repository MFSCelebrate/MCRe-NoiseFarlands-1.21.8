...
public class DebugPathCommand {
    final static private SimpleCommandExceptionType SOURCE_NOT_MOB_EXCEPTION = new SimpleCommandExceptionType((Message)Text.literal("Source is not a mob"));
    final static private SimpleCommandExceptionType PATH_NOT_FOUND_EXCEPTION = new SimpleCommandExceptionType((Message)Text.literal("Path not found"));
    final static private SimpleCommandExceptionType TARGET_NOT_REACHED_EXCEPTION = new SimpleCommandExceptionType((Message)Text.literal("Target not reached"));
