...
public class DebugCommand {
    ...
    final static private SimpleCommandExceptionType NOT_RUNNING_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.debug.notRunning"));
    final static private SimpleCommandExceptionType ALREADY_RUNNING_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.debug.alreadyRunning"));
    final static SimpleCommandExceptionType NO_RECURSION_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.debug.function.noRecursion"));
    final static SimpleCommandExceptionType NO_RETURN_RUN_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.debug.function.noReturnRun"));

    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("debug").requires(CommandManager.requirePermissionLevel(3))).then(CommandManager.literal("start").executes(context -> DebugCommand.executeStart((ServerCommandSource)context.getSource())))).then(CommandManager.literal("stop").executes(context -> DebugCommand.executeStop((ServerCommandSource)context.getSource())))).then(((LiteralArgumentBuilder)CommandManager.literal("function").requires(CommandManager.requirePermissionLevel(3))).then(CommandManager.argument("name", CommandFunctionArgumentType.commandFunction()).suggests(FunctionCommand.SUGGESTION_PROVIDER).executes((com.mojang.brigadier.Command)new Command()))));
    }
    ...
    net.minecraft.server.function.Tracer {
        final static public int MARGIN = 1;
