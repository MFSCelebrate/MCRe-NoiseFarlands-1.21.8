...
public class StopSoundCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        ...
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("stopsound").requires(CommandManager.requirePermissionLevel(2))).then((ArgumentBuilder)requiredArgumentBuilder));
    }
