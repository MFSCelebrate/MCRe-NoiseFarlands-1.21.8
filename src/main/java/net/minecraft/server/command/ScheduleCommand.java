...
public class ScheduleCommand {
    final static private SimpleCommandExceptionType SAME_TICK_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.schedule.same_tick"));
    final static private DynamicCommandExceptionType CLEARED_FAILURE_EXCEPTION = new DynamicCommandExceptionType(eventName -> Text.stringifiedTranslatable("commands.schedule.cleared.failure", eventName));
    final static private SimpleCommandExceptionType MACRO_EXCEPTION = new SimpleCommandExceptionType((Message)Text.stringifiedTranslatable("commands.schedule.macro", new Object[0]));
    final static private SuggestionProvider<ServerCommandSource> SUGGESTION_PROVIDER = (context, builder) -> CommandSource.suggestMatching(((ServerCommandSource)context.getSource()).getServer().getSaveProperties().getMainWorldProperties().getScheduledEvents().getEventNames(), builder);
