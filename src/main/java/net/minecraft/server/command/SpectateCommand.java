...
public class SpectateCommand {
    final static private SimpleCommandExceptionType SPECTATE_SELF_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.spectate.self"));
    final static private DynamicCommandExceptionType NOT_SPECTATOR_EXCEPTION = new DynamicCommandExceptionType(playerName -> Text.stringifiedTranslatable("commands.spectate.not_spectator", playerName));
