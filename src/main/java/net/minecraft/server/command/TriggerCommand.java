...
public class TriggerCommand {
    final static private SimpleCommandExceptionType FAILED_UNPRIMED_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.trigger.failed.unprimed"));
    final static private SimpleCommandExceptionType FAILED_INVALID_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.trigger.failed.invalid"));
