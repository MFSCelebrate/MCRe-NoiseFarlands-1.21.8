...
public class AdvancementCommand {
    final static private DynamicCommandExceptionType GENERIC_EXCEPTION = new DynamicCommandExceptionType(message -> (Text)message);
    final static private Dynamic2CommandExceptionType CRITERION_NOT_FOUND_EXCEPTION = new Dynamic2CommandExceptionType((advancement, criterion) -> Text.stringifiedTranslatable("commands.advancement.criterionNotFound", advancement, criterion));
    ...
    extends Enum<Operation> {
        final static public Operation GRANT = new Operation("grant"){
        ...
        final static public Operation REVOKE = new Operation("revoke"){
        ...
        final static private Operation[] field_13455;
    ...
    extends Enum<Selection> {
        final static public Selection ONLY = new Selection(false, false);
        final static public Selection THROUGH = new Selection(true, true);
        final static public Selection FROM = new Selection(false, true);
        final static public Selection UNTIL = new Selection(true, false);
        final static public Selection EVERYTHING = new Selection(true, true);
        final boolean before;
        final boolean after;
        final static private Selection[] field_13463;
