...
public record ServerLinks(List<Entry> entries) {
    final static public ServerLinks EMPTY = new ServerLinks(List.of());
    final static public PacketCodec<ByteBuf, Either<Known, Text>> TYPE_CODEC = PacketCodecs.either(Known.CODEC, TextCodecs.PACKET_CODEC);
    final static public PacketCodec<ByteBuf, List<StringifiedEntry>> LIST_CODEC = StringifiedEntry.CODEC.collect(PacketCodecs.toList());
    ...
    extends Enum<Known> {
        final static public Known BUG_REPORT = new Known(0, "report_bug");
        final static public Known COMMUNITY_GUIDELINES = new Known(1, "community_guidelines");
        final static public Known SUPPORT = new Known(2, "support");
        final static public Known STATUS = new Known(3, "status");
        final static public Known FEEDBACK = new Known(4, "feedback");
        final static public Known COMMUNITY = new Known(5, "community");
        final static public Known WEBSITE = new Known(6, "website");
        final static public Known FORUMS = new Known(7, "forums");
        final static public Known NEWS = new Known(8, "news");
        final static public Known ANNOUNCEMENTS = new Known(9, "announcements");
        final static private IntFunction<Known> FROM_ID;
        final static public PacketCodec<ByteBuf, Known> CODEC;
        final private int id;
        final private String name;
        final static private Known[] field_51986;
    ...
    public record StringifiedEntry(Either<Known, Text> type, String link) {
        final static public PacketCodec<ByteBuf, StringifiedEntry> CODEC = PacketCodec.tuple(TYPE_CODEC, StringifiedEntry::type, PacketCodecs.STRING, StringifiedEntry::link, StringifiedEntry::new);
    }
    ...
    extends Record {
        ...
        public Entry(Either<Known, Text> either, URI uRI) {
            this.type = either;
            this.link = uRI;
        }
