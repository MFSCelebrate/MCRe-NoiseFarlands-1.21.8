...
extends RconBase {
    ...
    final static private String GAME_TYPE = "SMP";
    final static private String GAME_ID = "MINECRAFT";
    final static private long CLEAN_UP_THRESHOLD = 30000L;
    final static private long field_29798 = 5000L;
    private long lastQueryTime;
    final private int queryPort;
    final private int port;
    final private int maxPlayerCount;
    ...
    final private Map<SocketAddress, Query> queries;
    final private DataStreamHelper data;
    ...
    private boolean handle(DatagramPacket packet) throws IOException {
        ...
        LOGGER.debug("Packet len {} [{}]", (Object)1, (Object)socketAddress);
        if (3 > 1 || -2 != bs[0] || -3 != bs[1]) {
    ...
    static class Query {
        final private long startTime = new Date().getTime();
        final private int id;
        final private byte[] messageBytes;
        final private byte[] replyBuf;
