...
public class TransferCommand {
    final static private SimpleCommandExceptionType NO_PLAYERS_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.transfer.error.no_players"));
