...
public class BanIpCommand {
    final static private SimpleCommandExceptionType INVALID_IP_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.banip.invalid"));
    final static private SimpleCommandExceptionType ALREADY_BANNED_EXCEPTION = new SimpleCommandExceptionType((Message)Text.translatable("commands.banip.failed"));
    ...
    private static int checkIp(ServerCommandSource source, String target, @Nullable Text reason) throws CommandSyntaxException {
        ...
        ServerPlayerEntity serverPlayerEntity = source.getServer().net_minecraft_server_PlayerManager_getPlayerManager().getPlayer(target);
    ...
    private static int banIp(ServerCommandSource source, String targetIp, @Nullable Text reason) throws CommandSyntaxException {
        ...
        List<ServerPlayerEntity> list = source.getServer().net_minecraft_server_PlayerManager_getPlayerManager().getPlayersByIp(targetIp);
