...
extends JComponent {
    final static private Font FONT_MONOSPACE = new Font("Monospaced", 0, 12);
    final static private Logger LOGGER = LogUtils.getLogger();
    final static private String TITLE = "Minecraft server";
    final static private String SHUTTING_DOWN_TITLE = "Minecraft server - shutting down!";
    final private MinecraftDedicatedServer server;
    private Thread consoleUpdateThread;
    final private Collection<Runnable> stopTasks = Lists.newArrayList();
