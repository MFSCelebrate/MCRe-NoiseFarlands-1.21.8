...
extends JComponent {
    final static private DecimalFormat AVG_TICK_FORMAT = Util.make(new DecimalFormat("########0.000"), decimalFormat -> decimalFormat.setDecimalFormatSymbols(DecimalFormatSymbols.getInstance(Locale.ROOT)));
    final private int[] memoryUsePercentage = new int[256];
    private int memoryUsePercentagePos;
    final private String[] lines = new String[11];
