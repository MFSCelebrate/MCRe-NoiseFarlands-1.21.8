...
implements WorldGenerationProgressListener {
    final private WorldGenerationProgressLogger progressLogger;
    final private Long2ObjectOpenHashMap<ChunkStatus> chunkStatuses = new Long2ObjectOpenHashMap();
    private ChunkPos spawnPos = new ChunkPos(0, 0);
    final private int centerSize;
