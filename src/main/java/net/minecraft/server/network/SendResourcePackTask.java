...
implements ServerPlayerConfigurationTask {
    final static public ServerPlayerConfigurationTask.Key KEY = new ServerPlayerConfigurationTask.Key("server_resource_pack");
    final private MinecraftServer.ServerResourcePackProperties packProperties;
