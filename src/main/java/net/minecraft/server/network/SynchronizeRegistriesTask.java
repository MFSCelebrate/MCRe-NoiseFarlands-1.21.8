...
implements ServerPlayerConfigurationTask {
    final static public ServerPlayerConfigurationTask.Key KEY = new ServerPlayerConfigurationTask.Key("synchronize_registries");
    final private List<VersionedIdentifier> knownPacks;
    final private CombinedDynamicRegistries<ServerDynamicRegistryType> registries;
