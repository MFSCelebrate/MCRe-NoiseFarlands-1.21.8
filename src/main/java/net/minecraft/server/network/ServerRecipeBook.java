...
extends RecipeBook {
    final static public String RECIPE_BOOK_KEY = "recipeBook";
    final static private Logger LOGGER = LogUtils.getLogger();
    final private DisplayCollector collector;
    @VisibleForTesting
    final protected Set<RegistryKey<Recipe<?>>> unlocked = Sets.newIdentityHashSet();
    @VisibleForTesting
    final protected Set<RegistryKey<Recipe<?>>> highlighted = Sets.newIdentityHashSet();
