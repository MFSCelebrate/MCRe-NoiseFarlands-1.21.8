...
implements WaypointHandler<ServerWaypoint> {
    final private Set<ServerWaypoint> waypoints = new HashSet<ServerWaypoint>();
    final private Set<ServerPlayerEntity> players = new HashSet<ServerPlayerEntity>();
    final private Table<ServerPlayerEntity, ServerWaypoint, ServerWaypoint.WaypointTracker> trackers = HashBasedTable.create();
    ...
    private static boolean isLocatorBarEnabled(ServerPlayerEntity player) {
        return player.net_minecraft_server_world_ServerWorld_getWorld().getServer().getGameRules().getBoolean(GameRules.LOCATOR_BAR);
    }
    ...
    @Override
    public void onUntrack(Waypoint waypoint) {
        this.onUntrack((ServerWaypoint)waypoint);
    }

    @Override
    public void onTrack(Waypoint waypoint) {
