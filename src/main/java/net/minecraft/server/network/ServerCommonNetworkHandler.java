...
implements ServerCommonPacketListener {
    ...
    final static public int KEEP_ALIVE_INTERVAL = 15000;
    final static private int TRANSITION_TIMEOUT = 15000;
    final static private Text TIMEOUT_TEXT = Text.translatable("disconnect.timeout");
    final static Text UNEXPECTED_QUERY_RESPONSE_TEXT = Text.translatable("multiplayer.disconnect.unexpected_query_response");
