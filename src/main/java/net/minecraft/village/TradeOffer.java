...
public class TradeOffer {
    final static public Codec<TradeOffer> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)TradedItem.CODEC.fieldOf("buy").forGetter(tradeOffer -> tradeOffer.firstBuyItem), (App)TradedItem.CODEC.lenientOptionalFieldOf("buyB").forGetter(tradeOffer -> tradeOffer.secondBuyItem), (App)ItemStack.CODEC.fieldOf("sell").forGetter(tradeOffer -> tradeOffer.sellItem), (App)Codec.INT.lenientOptionalFieldOf("uses", (Object)0).forGetter(tradeOffer -> tradeOffer.uses), (App)Codec.INT.lenientOptionalFieldOf("maxUses", (Object)4).forGetter(tradeOffer -> tradeOffer.maxUses), (App)Codec.BOOL.lenientOptionalFieldOf("rewardExp", (Object)true).forGetter(tradeOffer -> tradeOffer.rewardingPlayerExperience), (App)Codec.INT.lenientOptionalFieldOf("specialPrice", (Object)0).forGetter(tradeOffer -> tradeOffer.specialPrice), (App)Codec.INT.lenientOptionalFieldOf("demand", (Object)0).forGetter(tradeOffer -> tradeOffer.demandBonus), (App)Codec.FLOAT.lenientOptionalFieldOf("priceMultiplier", (Object)Float.valueOf(0.0f)).forGetter(tradeOffer -> Float.valueOf(tradeOffer.priceMultiplier)), (App)Codec.INT.lenientOptionalFieldOf("xp", (Object)1).forGetter(tradeOffer -> tradeOffer.merchantExperience)).apply((Applicative)instance, TradeOffer::new));
    final static public PacketCodec<RegistryByteBuf, TradeOffer> PACKET_CODEC = PacketCodec.ofStatic(TradeOffer::write, TradeOffer::read);
    final private TradedItem firstBuyItem;
    final private Optional<TradedItem> secondBuyItem;
    final private ItemStack sellItem;
    private int uses;
    final private int maxUses;
    final private boolean rewardingPlayerExperience;
    private int specialPrice;
    private int demandBonus;
    final private float priceMultiplier;
    final private int merchantExperience;
    ...
    private static void write(RegistryByteBuf buf, TradeOffer offer) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(offer.isDisabled());
        buf.net_minecraft_network_PacketByteBuf_writeInt(offer.getUses());
        buf.net_minecraft_network_PacketByteBuf_writeInt(offer.getMaxUses());
        buf.net_minecraft_network_PacketByteBuf_writeInt(offer.getMerchantExperience());
        buf.net_minecraft_network_PacketByteBuf_writeInt(offer.getSpecialPrice());
        buf.net_minecraft_network_PacketByteBuf_writeFloat(offer.getPriceMultiplier());
        buf.net_minecraft_network_PacketByteBuf_writeInt(offer.getDemandBonus());
    }
