...
public final class VillagerType {
    final static public RegistryKey<VillagerType> DESERT = VillagerType.of("desert");
    final static public RegistryKey<VillagerType> JUNGLE = VillagerType.of("jungle");
    final static public RegistryKey<VillagerType> PLAINS = VillagerType.of("plains");
    final static public RegistryKey<VillagerType> SAVANNA = VillagerType.of("savanna");
    final static public RegistryKey<VillagerType> SNOW = VillagerType.of("snow");
    final static public RegistryKey<VillagerType> SWAMP = VillagerType.of("swamp");
    final static public RegistryKey<VillagerType> TAIGA = VillagerType.of("taiga");
    final static public Codec<RegistryEntry<VillagerType>> CODEC = RegistryFixedCodec.of(RegistryKeys.VILLAGER_TYPE);
    final static public PacketCodec<RegistryByteBuf, RegistryEntry<VillagerType>> PACKET_CODEC = PacketCodecs.registryEntry(RegistryKeys.VILLAGER_TYPE);
    final static public Map<RegistryKey<Biome>, RegistryKey<VillagerType>> BIOME_TO_TYPE = Util.make(Maps.newHashMap(), map -> {
