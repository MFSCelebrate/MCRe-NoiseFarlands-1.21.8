...
implements SpecialSpawner {
    ...
    extends Enum<State> {
        final static public State SIEGE_CAN_ACTIVATE = new State();
        final static public State SIEGE_TONIGHT = new State();
        final static public State SIEGE_DONE = new State();
        final static private State[] field_18483;
