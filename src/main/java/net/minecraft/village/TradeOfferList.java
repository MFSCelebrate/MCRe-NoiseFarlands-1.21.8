...
extends ArrayList<TradeOffer> {
    final static public Codec<TradeOfferList> CODEC = TradeOffer.CODEC.listOf().optionalFieldOf("Recipes", List.of()).xmap(TradeOfferList::new, Function.identity()).codec();
    final static public PacketCodec<RegistryByteBuf, TradeOfferList> PACKET_CODEC = TradeOffer.PACKET_CODEC.collect(PacketCodecs.toCollection(TradeOfferList::new));
