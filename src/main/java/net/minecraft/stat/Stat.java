...
extends ScoreboardCriterion {
    final static public PacketCodec<RegistryByteBuf, Stat<?>> PACKET_CODEC = PacketCodecs.registryValue(RegistryKeys.STAT_TYPE).dispatch(Stat::getType, StatType::getPacketCodec);
    final private StatFormatter formatter;
    final private T value;
    final private StatType<T> type;
