...
public class DamageUtil {
    final static public float field_29962 = 20.0f;
    final static public float field_29963 = 25.0f;
    final static public float field_29964 = 2.0f;
    final static public float field_29965 = 0.2f;
    final static private int field_29966 = 4;
    ...
    public static float getDamageLeft(LivingEntity armorWearer, float damageAmount, DamageSource damageSource, float armor, float armorToughness) {
        ...
        if (itemStack != null && (world = armorWearer.net_minecraft_world_World_getWorld()) instanceof ServerWorld) {
