...
public record EquipmentDropChances(Map<EquipmentSlot, Float> byEquipment) {
    final static public float DEFAULT_CHANCE = 0.085f;
    final static public float UNHARMED_DROP_THRESHOLD = 1.0f;
    final static public int GUARANTEED_DROP_CHANCE = 2;
    final static public EquipmentDropChances DEFAULT = new EquipmentDropChances(Util.mapEnum(EquipmentSlot.class, slot -> Float.valueOf(0.085f)));
    final static public Codec<EquipmentDropChances> CODEC = Codec.unboundedMap(EquipmentSlot.CODEC, Codecs.NON_NEGATIVE_FLOAT).xmap(EquipmentDropChances::getWithDefaultChances, EquipmentDropChances::getWithoutDefaultChances).xmap(EquipmentDropChances::new, EquipmentDropChances::byEquipment);
