...
public class EntityAttributeInstance {
    final private RegistryEntry<EntityAttribute> type;
    final private Map<EntityAttributeModifier.Operation, Map<Identifier, EntityAttributeModifier>> operationToModifiers = Maps.newEnumMap(EntityAttributeModifier.Operation.class);
    final private Map<Identifier, EntityAttributeModifier> idToModifiers = new Object2ObjectArrayMap();
    final private Map<Identifier, EntityAttributeModifier> persistentModifiers = new Object2ObjectArrayMap();
    private double baseValue;
    private boolean dirty = true;
    private double value;
    final private Consumer<EntityAttributeInstance> updateCallback;
    ...
    extends Record {
        ...
        final static public Codec<List<Packed>> LIST_CODEC = CODEC.listOf();

        public Packed(RegistryEntry<EntityAttribute> registryEntry, double d, List<EntityAttributeModifier> list) {
