...
public record EntityAttributeModifier(Identifier id, double value, Operation operation) {
    final static public MapCodec<EntityAttributeModifier> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Identifier.CODEC.fieldOf("id").forGetter(EntityAttributeModifier::id), (App)Codec.DOUBLE.fieldOf("amount").forGetter(EntityAttributeModifier::value), (App)Operation.CODEC.fieldOf("operation").forGetter(EntityAttributeModifier::operation)).apply((Applicative)instance, EntityAttributeModifier::new));
    final static public Codec<EntityAttributeModifier> CODEC = MAP_CODEC.codec();
    final static public PacketCodec<ByteBuf, EntityAttributeModifier> PACKET_CODEC = PacketCodec.tuple(Identifier.PACKET_CODEC, EntityAttributeModifier::id, PacketCodecs.DOUBLE, EntityAttributeModifier::value, Operation.PACKET_CODEC, EntityAttributeModifier::operation, EntityAttributeModifier::new);
    ...
    implements StringIdentifiable {
        final static public Operation ADD_VALUE = new Operation("add_value", 0);
        final static public Operation ADD_MULTIPLIED_BASE = new Operation("add_multiplied_base", 1);
        final static public Operation ADD_MULTIPLIED_TOTAL = new Operation("add_multiplied_total", 2);
        final static public IntFunction<Operation> ID_TO_VALUE;
        final static public PacketCodec<ByteBuf, Operation> PACKET_CODEC;
        final static public Codec<Operation> CODEC;
        final private String name;
        final private int id;
        final static private Operation[] field_6333;
