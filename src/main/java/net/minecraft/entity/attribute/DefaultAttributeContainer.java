...
public class DefaultAttributeContainer {
    final private Map<RegistryEntry<EntityAttribute>, EntityAttributeInstance> instances;
    ...
    public static class Builder {
        final private ImmutableMap.Builder<RegistryEntry<EntityAttribute>, EntityAttributeInstance> instances = ImmutableMap.builder();
