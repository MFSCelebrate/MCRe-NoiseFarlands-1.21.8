...
public class AttributeContainer {
    final private Map<RegistryEntry<EntityAttribute>, EntityAttributeInstance> custom = new Object2ObjectOpenHashMap();
    final private Set<EntityAttributeInstance> tracked = new ObjectOpenHashSet();
    final private Set<EntityAttributeInstance> pendingUpdate = new ObjectOpenHashSet();
    final private DefaultAttributeContainer defaultAttributes;
