...
public class PositionInterpolator {
    final static public int DEFAULT_INTERPOLATION_DURATION = 3;
    final private Entity entity;
    private int lerpDuration;
    final private Data data = new Data(0, Vec3d.ZERO, 0.0f, 0.0f);
    @Nullable
    private Vec3d lastPos;
    @Nullable
    private Vec2f lastRotation;
    @Nullable
    final private Consumer<PositionInterpolator> callback;
    ...
    public void tick() {
        ...
        if (this.lastPos != null) {
            ...
            if (this.entity.net_minecraft_world_World_getWorld().isSpaceEmpty(this.entity, this.entity.calculateDefaultBoundingBox(this.data.pos.add(vec3d)))) {
