...
extends RangedAttackMob {
    ...
    default public void shoot(LivingEntity entity, float speed) {
        ...
        if (item instanceof CrossbowItem) {
            ...
            crossbowItem.shootAll(entity.net_minecraft_world_World_getWorld(), entity, hand, itemStack, speed, 14 - entity.net_minecraft_world_World_getWorld().getDifficulty().getId() * 4, this.getTarget());
        }
        this.postShoot();
    }
}
