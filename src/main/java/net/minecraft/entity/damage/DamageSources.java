...
public class DamageSources {
    final public Registry<DamageType> registry;
    final private DamageSource inFire;
    final private DamageSource campfire;
    final private DamageSource lightningBolt;
    final private DamageSource onFire;
    final private DamageSource lava;
    final private DamageSource hotFloor;
    final private DamageSource inWall;
    final private DamageSource cramming;
    final private DamageSource drown;
    final private DamageSource starve;
    final private DamageSource cactus;
    final private DamageSource fall;
    final private DamageSource enderPearl;
    final private DamageSource flyIntoWall;
    final private DamageSource outOfWorld;
    final private DamageSource generic;
    final private DamageSource magic;
    final private DamageSource wither;
    final private DamageSource dragonBreath;
    final private DamageSource dryOut;
    final private DamageSource sweetBerryBush;
    final private DamageSource freeze;
    final private DamageSource stalagmite;
    final private DamageSource outsideBorder;
    final private DamageSource genericKill;

    public DamageSources(DynamicRegistryManager registryManager) {
        this.registry = registryManager.net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.DAMAGE_TYPE);
