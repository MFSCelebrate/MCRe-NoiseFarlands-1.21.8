...
public class DamageTracker {
    final static public int DAMAGE_COOLDOWN = 100;
    final static public int ATTACK_DAMAGE_COOLDOWN = 300;
    final static private Style INTENTIONAL_GAME_DESIGN_ISSUE_LINK_STYLE = Style.EMPTY.withClickEvent(new ClickEvent.OpenUrl(Urls.INTENTIONAL_GAME_DESIGN_ISSUE)).withHoverEvent(new HoverEvent.ShowText(Text.literal("MCPE-28723")));
    final private List<DamageRecord> recentDamage = Lists.newArrayList();
