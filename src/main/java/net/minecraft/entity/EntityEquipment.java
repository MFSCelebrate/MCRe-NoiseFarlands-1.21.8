...
public class EntityEquipment {
    final static public Codec<EntityEquipment> CODEC = Codec.unboundedMap(EquipmentSlot.CODEC, ItemStack.CODEC).xmap(map -> {
    ...
    final private EnumMap<EquipmentSlot, ItemStack> map;
    ...
    public void tick(Entity entity) {
        for (Map.Entry<EquipmentSlot, ItemStack> entry : this.map.entrySet()) {
            ...
            if (itemStack.isEmpty()) continue;
            itemStack.inventoryTick(entity.net_minecraft_world_World_getWorld(), entity, entry.getKey());
        }
    }
