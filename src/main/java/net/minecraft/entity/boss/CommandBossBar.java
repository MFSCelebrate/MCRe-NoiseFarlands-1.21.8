...
extends ServerBossBar {
    final static private int DEFAULT_MAX_VALUE = 100;
    final private Identifier id;
    final private Set<UUID> playerUuids = Sets.newHashSet();
    private int value;
    ...
    extends Record {
        ...
        public Serialized(Text text, boolean bl, int i, int j, BossBar.Color color, BossBar.Style style, boolean bl2, boolean bl3, boolean bl4, Set<UUID> set) {
            this.name = text;
            this.visible = bl;
            this.value = 1;
            this.max = j;
