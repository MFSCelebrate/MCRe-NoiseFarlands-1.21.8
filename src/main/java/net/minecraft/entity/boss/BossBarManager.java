...
public class BossBarManager {
    ...
    final static private Codec<Map<Identifier, CommandBossBar.Serialized>> CODEC = Codec.unboundedMap(Identifier.CODEC, CommandBossBar.Serialized.CODEC);
    final private Map<Identifier, CommandBossBar> commandBossBars = Maps.newHashMap();
