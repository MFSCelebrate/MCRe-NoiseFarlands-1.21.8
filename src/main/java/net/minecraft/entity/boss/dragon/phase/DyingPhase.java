...
extends AbstractPhase {
    ...
    public void clientTick() {
        if (this.ticks++ % 10 == 0) {
            ...
            this.dragon.net_minecraft_world_World_getWorld().addParticleClient(ParticleTypes.EXPLOSION_EMITTER, this.dragon.getX() + (double)f, this.dragon.getY() + 2.0 + (double)g, this.dragon.getZ() + (double)h, 0.0, 0.0, 0.0);
        }
    }
