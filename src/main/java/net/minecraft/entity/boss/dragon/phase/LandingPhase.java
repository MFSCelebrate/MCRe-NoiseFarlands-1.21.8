...
extends AbstractPhase {
    ...
    public void clientTick() {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            this.dragon.net_minecraft_world_World_getWorld().addParticleClient(ParticleTypes.DRAGON_BREATH, g, h, j, -vec3d.x * (double)0.08f + vec3d2.x, -vec3d.y * (double)0.3f + vec3d2.y, -vec3d.z * (double)0.08f + vec3d2.z);
