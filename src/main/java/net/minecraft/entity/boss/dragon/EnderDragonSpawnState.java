...
extends Enum<EnderDragonSpawnState> {
    final static public EnderDragonSpawnState START = new EnderDragonSpawnState(){
    ...
    final static public EnderDragonSpawnState PREPARING_TO_SUMMON_PILLARS = new EnderDragonSpawnState(){
    ...
    final static public EnderDragonSpawnState SUMMONING_PILLARS = new EnderDragonSpawnState(){
            ...
            if (bl || bl2) {
                ...
                if (j < list.size()) {
                    ...
                    if (bl) {
                        ...
                        Feature.END_SPIKE.generateIfValid(endSpikeFeatureConfig, world, world.net_minecraft_server_world_ServerChunkManager_getChunkManager().getChunkGenerator(), Random.create(), new BlockPos(spike.getCenterX(), 45, spike.getCenterZ()));
                    }
                } else if (bl) {
    ...
    final static public EnderDragonSpawnState SUMMONING_DRAGON = new EnderDragonSpawnState(){
    ...
    final static public EnderDragonSpawnState END = new EnderDragonSpawnState(){

        @Override
        public void run(ServerWorld world, EnderDragonFight fight, List<EndCrystalEntity> crystals, int tick, BlockPos pos) {
        }
    };
    final static private EnderDragonSpawnState[] field_13096;
