...
extends AbstractSittingPhase {
    final static private int DURATION = 40;
    private int ticks;
    ...
    public void clientTick() {
        this.dragon.net_minecraft_world_World_getWorld().playSoundClient(this.dragon.getX(), this.dragon.getY(), this.dragon.getZ(), SoundEvents.ENTITY_ENDER_DRAGON_GROWL, this.dragon.getSoundCategory(), 2.5f, 0.8f + this.dragon.getRandom().nextFloat() * 0.3f, false);
    }
