...
extends BossBar {
    final private Set<ServerPlayerEntity> players = Sets.newHashSet();
    final private Set<ServerPlayerEntity> unmodifiablePlayers = Collections.unmodifiableSet(this.players);
