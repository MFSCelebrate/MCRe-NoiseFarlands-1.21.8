...
public class LargeEntitySpawnHelper {
    ...
    public static interface Requirements {
        @Deprecated
        final static public Requirements IRON_GOLEM = (world, pos, state, abovePos, aboveState) -> {
        ...
        final static public Requirements WARDEN = (world, pos, state, abovePos, aboveState) -> aboveState.getCollisionShape(world, abovePos).isEmpty() && Block.isFaceFullSquare(state.getCollisionShape(world, pos), Direction.UP);
        final static public Requirements CREAKING = (world, pos, state, abovePos, aboveState) -> aboveState.getCollisionShape(world, abovePos).isEmpty() && !state.isIn(BlockTags.LEAVES) && Block.isFaceFullSquare(state.getCollisionShape(world, pos), Direction.UP);
