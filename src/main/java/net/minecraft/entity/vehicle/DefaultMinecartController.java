...
extends MinecartController {
    final static private double field_52547 = 0.01;
    final static private double field_54466 = 0.2;
    final static private double field_54467 = 0.4;
    final static private double field_54468 = 0.4;
    final private PositionInterpolator interpolator;
        ...
        if (bl) {
            ...
            if (v > 0.01) {
                ...
                if (railShape == RailShape.EAST_WEST) {
                    if (this.minecart.willHitBlockAt(blockPos.net_minecraft_util_math_BlockPos_west())) {
                        z = 0.02;
                    } else if (this.minecart.willHitBlockAt(blockPos.net_minecraft_util_math_BlockPos_east())) {
                        z = -0.02;
                    }
                } else if (railShape == RailShape.NORTH_SOUTH) {
                    if (this.minecart.willHitBlockAt(blockPos.net_minecraft_util_math_BlockPos_north())) {
                        aa = 0.02;
                    } else if (this.minecart.willHitBlockAt(blockPos.net_minecraft_util_math_BlockPos_south())) {
                        aa = -0.02;
                    }
                } else {
                    return;
