...
extends MinecartController {
    final static public int REFRESH_FREQUENCY = 3;
    final static public double field_52528 = 0.1;
    final static public double field_53756 = 0.005;
    @Nullable
    ...
    final public List<Step> stagingLerpSteps = new LinkedList<Step>();
    final public List<Step> currentLerpSteps = new LinkedList<Step>();
    ...
    extends Record {
        ...
        final float xRot;
        final float weight;
        final static public PacketCodec<ByteBuf, Step> PACKET_CODEC = PacketCodec.tuple(Vec3d.PACKET_CODEC, Step::position, Vec3d.PACKET_CODEC, Step::movement, PacketCodecs.DEGREES, Step::yRot, PacketCodecs.DEGREES, Step::xRot, PacketCodecs.FLOAT, Step::weight, Step::new);
        static public Step ZERO = new Step(Vec3d.ZERO, Vec3d.ZERO, 0.0f, 0.0f, 0.0f);
