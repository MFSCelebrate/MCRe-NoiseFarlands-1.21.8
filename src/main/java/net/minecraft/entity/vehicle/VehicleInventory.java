...
NamedScreenHandlerFactory {
    ...
    default public void generateInventoryLoot(@Nullable PlayerEntity player) {
        MinecraftServer minecraftServer = this.net_minecraft_world_World_getWorld().getServer();
        if (this.getLootTable() != null && minecraftServer != null) {
            ...
            LootWorldContext.Builder builder = new LootWorldContext.Builder((ServerWorld)this.net_minecraft_world_World_getWorld()).add(LootContextParameters.ORIGIN, this.getPos());
            if (player != null) {
