...
extends AbstractMinecartEntity {
    final private MobSpawnerLogic logic = new MobSpawnerLogic(){
    ...
    protected void readCustomData(ReadView view) {
        ...
        this.logic.readData(this.net_minecraft_world_World_getWorld(), this.getBlockPos(), view);
    }
    ...
    public void handleStatus(byte status) {
        this.logic.handleStatus(this.net_minecraft_world_World_getWorld(), status);
    }
