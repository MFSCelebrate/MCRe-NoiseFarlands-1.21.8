...
extends AbstractMinecartEntity {
    final static private TrackedData<Boolean> LIT = DataTracker.registerData(FurnaceMinecartEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private int FUEL_PER_ITEM = 3600;
    final static private int MAX_FUEL = 32000;
    final static private short DEFAULT_FUEL = 0;
    final static private Vec3d DEFAULT_PUSH_VEC = Vec3d.ZERO;
    private int fuel = 0;
    ...
    public void tick() {
        ...
        if (this.isLit() && this.random.nextInt(4) == 0) {
            this.net_minecraft_world_World_getWorld().addParticleClient(ParticleTypes.LARGE_SMOKE, this.getX(), this.getY() + 0.8, this.getZ(), 0.0, 0.0, 0.0);
        }
    }
    ...
    protected void readCustomData(ReadView view) {
        ...
        this.fuel = view.getShort("Fuel", 0);
    }
