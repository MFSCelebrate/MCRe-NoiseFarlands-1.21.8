...
implements Tameable {
    final static public int field_52002 = 144;
    final static private int field_52003 = 2;
    final static private int field_52004 = 3;
    final static private int field_52005 = 1;
    final static private boolean DEFAULT_SITTING = false;
    final static protected TrackedData<Byte> TAMEABLE_FLAGS = DataTracker.registerData(TameableEntity.class, TrackedDataHandlerRegistry.BYTE);
    final static protected TrackedData<Optional<LazyEntityReference<LivingEntity>>> OWNER_UUID = DataTracker.registerData(TameableEntity.class, TrackedDataHandlerRegistry.LAZY_ENTITY_REFERENCE);
    ...
    protected void readCustomData(ReadView view) {
        ...
        LazyEntityReference lazyEntityReference = LazyEntityReference.fromDataOrPlayerName(view, "Owner", this.net_minecraft_world_World_getWorld());
    ...
    public void onDeath(DamageSource damageSource) {
        ...
        if (world instanceof ServerWorld && (serverWorld = (ServerWorld)world).getGameRules().getBoolean(GameRules.SHOW_DEATH_MESSAGES) && (livingEntity = this.getOwner()) instanceof ServerPlayerEntity) {
    ...
    private boolean canTeleportTo(BlockPos pos) {
        ...
        BlockPos blockPos = pos.net_minecraft_util_math_BlockPos_subtract(this.getBlockPos());
        return this.net_minecraft_world_World_getWorld().isSpaceEmpty(this, this.getBoundingBox().offset(blockPos));
    }
