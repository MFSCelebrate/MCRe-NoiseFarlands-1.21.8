...
public class AllayBrain {
    final static private float field_38406 = 1.0f;
    final static private float field_38407 = 2.25f;
    final static private float WALK_TO_ITEM_SPEED = 1.75f;
    final static private float FLEE_SPEED = 2.5f;
    final static private int field_38938 = 4;
    final static private int field_38939 = 16;
    final static private int field_38410 = 6;
    final static private int field_38411 = 30;
    final static private int field_38412 = 60;
    final static private int LIKED_NOTEBLOCK_COOLDOWN_TICKS_EXPIRY = 600;
    final static private int WALK_TO_ITEM_RADIUS = 32;
    final static private int GIVE_INVENTORY_RUN_TIME = 20;
    ...
    public static void rememberNoteBlock(LivingEntity allay, BlockPos pos) {
        ...
        GlobalPos globalPos = GlobalPos.create(allay.net_minecraft_world_World_getWorld().getRegistryKey(), pos);
    ...
    private static Optional<LookTarget> getLookTarget(LivingEntity allay) {
        ...
        if (optional.isPresent()) {
            ...
            if (AllayBrain.shouldGoTowardsNoteBlock(allay, brain, globalPos)) {
                return Optional.of(new BlockPosLookTarget(globalPos.pos().net_minecraft_util_math_BlockPos_up()));
            }
    ...
    private static boolean shouldGoTowardsNoteBlock(LivingEntity allay, Brain<?> brain, GlobalPos pos) {
        ...
        World world = allay.net_minecraft_world_World_getWorld();
    ...
    public static Optional<ServerPlayerEntity> getLikedPlayer(LivingEntity allay) {
        ...
        if (!world.isClient() && world instanceof ServerWorld) {
            ...
            if (optional.isPresent()) {
                Entity entity = serverWorld.net_minecraft_entity_Entity_getEntity(optional.get());
