...
public class AxolotlBrain {
    ...
    final static private float BREEDING_SPEED = 0.2f;
    final static private float ON_LAND_SPEED = 0.15f;
    final static private float IDLE_SPEED = 0.5f;
    final static private float TARGET_APPROACHING_SPEED = 0.6f;
    final static private float ADULT_FOLLOWING_SPEED = 0.6f;
