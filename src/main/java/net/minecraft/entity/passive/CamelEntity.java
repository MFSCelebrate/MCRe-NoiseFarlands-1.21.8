...
extends AbstractHorseEntity {
    final static public float field_45127 = 0.45f;
    final static public int field_40132 = 55;
    final static public int field_41764 = 30;
    final static private float field_40146 = 0.1f;
    final static private float field_40147 = 1.4285f;
    final static private float field_40148 = 22.2222f;
    final static private int field_43388 = 5;
    final static private int field_40149 = 40;
    final static private int field_40133 = 52;
    final static private int field_40134 = 80;
    final static private float field_40135 = 1.43f;
    final static private long DEFAULT_LAST_POSE_TICK = 0L;
    final static public TrackedData<Boolean> DASHING = DataTracker.registerData(CamelEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static public TrackedData<Long> LAST_POSE_TICK = DataTracker.registerData(CamelEntity.class, TrackedDataHandlerRegistry.LONG);
    ...
    final static private EntityDimensions SITTING_DIMENSIONS = EntityDimensions.changing(EntityType.CAMEL.getWidth(), EntityType.CAMEL.getHeight() - 1.43f).withEyeHeight(0.845f);
    ...
    public static boolean canSpawn(EntityType<CamelEntity> type, WorldAccess world, SpawnReason reason, BlockPos pos, Random random) {
        return world.getBlockState(pos.net_minecraft_util_math_BlockPos_down()).isIn(BlockTags.CAMELS_SPAWNABLE_ON) && CamelEntity.isLightLevelValidForNaturalSpawn(world, pos);
    }
    ...
    public void tick() {
        ...
        if (this.dashCooldown > 0) {
            --this.dashCooldown;
            if (this.dashCooldown == 0) {
                this.net_minecraft_world_World_getWorld().playSound(null, this.getBlockPos(), SoundEvents.ENTITY_CAMEL_DASH_READY, SoundCategory.NEUTRAL, 1.0f, 1.0f);
            }
        }
    ...
    @Override
    @Nullable
    public CamelEntity net_minecraft_entity_passive_CamelEntity_createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
    ...
    public void startSitting() {
        ...
        this.setPose(EntityPose.SITTING);
        this.emitGameEvent(GameEvent.ENTITY_ACTION);
        this.setLastPoseTick(-this.net_minecraft_world_World_getWorld().getTime());
    }
    ...
    public void setStanding() {
        this.setPose(EntityPose.STANDING);
        this.emitGameEvent(GameEvent.ENTITY_ACTION);
        this.initLastPoseTick(this.net_minecraft_world_World_getWorld().getTime());
    }
    ...
    public long getTimeSinceLastPoseTick() {
        return this.net_minecraft_world_World_getWorld().getTime() - Math.abs(this.dataTracker.get(LAST_POSE_TICK));
    }
    ...
    public PassiveEntity net_minecraft_entity_passive_PassiveEntity_createChild(ServerWorld world, PassiveEntity entity) {
        return this.net_minecraft_entity_passive_CamelEntity_createChild(world, entity);
    }
