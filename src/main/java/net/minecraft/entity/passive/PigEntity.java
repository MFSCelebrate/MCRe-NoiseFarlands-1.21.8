...
implements ItemSteerable {
    final static private TrackedData<Integer> BOOST_TIME = DataTracker.registerData(PigEntity.class, TrackedDataHandlerRegistry.INTEGER);
    final static private TrackedData<RegistryEntry<PigVariant>> VARIANT = DataTracker.registerData(PigEntity.class, TrackedDataHandlerRegistry.PIG_VARIANT);
    ...
    public Vec3d updatePassengerForDismount(LivingEntity passenger) {
        ...
        for (EntityPose entityPose : passenger.getPoses()) {
            ...
            for (int[] js : is) {
                ...
                double d = this.net_minecraft_world_World_getWorld().getDismountHeight(mutable);
    ...
    @Override
    @Nullable
    public PigEntity net_minecraft_entity_passive_PigEntity_createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
    ...
    public PassiveEntity net_minecraft_entity_passive_PassiveEntity_createChild(ServerWorld world, PassiveEntity entity) {
        return this.net_minecraft_entity_passive_PigEntity_createChild(world, entity);
    }
}
