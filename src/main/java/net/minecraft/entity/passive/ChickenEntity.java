...
extends AnimalEntity {
    final static private EntityDimensions BABY_BASE_DIMENSIONS = EntityType.CHICKEN.getDimensions().scaled(0.5f).withEyeHeight(0.2975f);
    final static private TrackedData<RegistryEntry<ChickenVariant>> VARIANT = DataTracker.registerData(ChickenEntity.class, TrackedDataHandlerRegistry.CHICKEN_VARIANT);
    final static private boolean DEFAULT_HAS_JOCKEY = false;
    ...
    @Override
    @Nullable
    public ChickenEntity net_minecraft_entity_passive_ChickenEntity_createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
    ...
    public PassiveEntity net_minecraft_entity_passive_PassiveEntity_createChild(ServerWorld world, PassiveEntity entity) {
        return this.net_minecraft_entity_passive_ChickenEntity_createChild(world, entity);
    }
}
