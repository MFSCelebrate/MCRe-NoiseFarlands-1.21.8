...
extends SchoolingFishEntity {
    ...
    final static private TrackedData<Integer> VARIANT = DataTracker.registerData(SalmonEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    implements StringIdentifiable {
        final static public Variant SMALL = new Variant("small", 0, 0.5f);
        final static public Variant MEDIUM = new Variant("medium", 1, 1.0f);
        final static public Variant LARGE = new Variant("large", 2, 1.5f);
        final static public Variant DEFAULT;
        final static public StringIdentifiable.EnumCodec<Variant> CODEC;
        final static IntFunction<Variant> FROM_INDEX;
        final static public PacketCodec<ByteBuf, Variant> PACKET_CODEC;
        final private String id;
        final int index;
        final float scale;
        final static private Variant[] field_52475;
