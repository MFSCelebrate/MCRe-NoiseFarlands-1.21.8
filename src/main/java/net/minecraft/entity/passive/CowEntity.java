...
extends AbstractCowEntity {
    final static private TrackedData<RegistryEntry<CowVariant>> VARIANT = DataTracker.registerData(CowEntity.class, TrackedDataHandlerRegistry.COW_VARIANT);
    ...
    @Override
    @Nullable
    public CowEntity net_minecraft_entity_passive_CowEntity_createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
    ...
    public PassiveEntity net_minecraft_entity_passive_PassiveEntity_createChild(ServerWorld world, PassiveEntity entity) {
        return this.net_minecraft_entity_passive_CowEntity_createChild(world, entity);
    }
}
