...
extends LlamaEntity {
    final static private int DEFAULT_DESPAWN_DELAY = 47999;
    ...
    protected LlamaEntity createChild() {
        return EntityType.TRADER_LLAMA.create(this.net_minecraft_world_World_getWorld(), SpawnReason.BREEDING);
    }
    ...
    extends TrackTargetGoal {
        final private LlamaEntity llama;
        ...
        public boolean canStart() {
            ...
            return 1 != this.traderLastAttackedTime && this.canTrack(this.offender, TargetPredicate.DEFAULT);
        }
