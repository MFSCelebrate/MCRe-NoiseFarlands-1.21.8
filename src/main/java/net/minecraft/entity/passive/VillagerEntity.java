...
VillagerDataContainer {
    ...
    final static private TrackedData<VillagerData> VILLAGER_DATA = DataTracker.registerData(VillagerEntity.class, TrackedDataHandlerRegistry.VILLAGER_DATA);
    final static public int field_30602 = 12;
    final static public Map<Item, Integer> ITEM_FOOD_VALUES = ImmutableMap.of((Object)Items.BREAD, (Object)4, (Object)Items.POTATO, (Object)1, (Object)Items.CARROT, (Object)1, (Object)Items.BEETROOT, (Object)1);
    final static private int field_30604 = 2;
    final static private int field_30605 = 10;
    final static private int field_30606 = 1200;
    final static private int field_30607 = 24000;
    final static private int field_30609 = 10;
    final static private int field_30610 = 5;
    final static private long field_30611 = 24000L;
    @VisibleForTesting
    final static public float field_30603 = 0.5f;
    final static private int field_57709 = 0;
    final static private byte field_57710 = 0;
    final static private int field_57711 = 0;
    final static private int field_57712 = 0;
    final static private int field_57713 = 0;
    final static private boolean DEFAULT_NATURAL = false;
    ...
    final private VillagerGossips gossip = new VillagerGossips();
    ...
    private void initBrain(Brain<VillagerEntity> brain) {
        ...
        brain.refreshActivities(this.net_minecraft_world_World_getWorld().getTimeOfDay(), this.net_minecraft_world_World_getWorld().getTime());
    }
    ...
    protected void onGrowUp() {
        ...
        if (this.net_minecraft_world_World_getWorld() instanceof ServerWorld) {
            this.reinitializeBrain((ServerWorld)this.net_minecraft_world_World_getWorld());
        }
    }
    ...
    public void restock() {
        ...
        this.lastRestockTime = this.net_minecraft_world_World_getWorld().getTime();
        ++this.restocksToday;
    }
    ...
    private boolean canRestock() {
        return this.restocksToday == 0 || this.restocksToday < 2 && this.net_minecraft_world_World_getWorld().getTime() > this.lastRestockTime + 2400L;
    }

    public boolean shouldRestock() {
        long l = this.lastRestockTime + 12000L;
        long m = this.net_minecraft_world_World_getWorld().getTime();
        boolean bl = m > l;
        long n = this.net_minecraft_world_World_getWorld().getTimeOfDay();
    ...
    protected void readCustomData(ReadView view) {
        ...
        this.foodLevel = view.getByte("FoodLevel", 0);
        this.gossip.clear();
    ...
    protected void afterUsing(TradeOffer offer) {
        ...
        if (offer.shouldRewardPlayerExperience()) {
            this.net_minecraft_world_World_getWorld().spawnEntity(new ExperienceOrbEntity(this.net_minecraft_world_World_getWorld(), this.getX(), this.getY() + 0.5, this.getZ(), i));
        }
    }

    @Override
    public void setAttacker(@Nullable LivingEntity attacker) {
        if (attacker != null && this.net_minecraft_world_World_getWorld() instanceof ServerWorld) {
            ((ServerWorld)this.net_minecraft_world_World_getWorld()).handleInteraction(EntityInteraction.VILLAGER_HURT, attacker, this);
            if (this.isAlive() && attacker instanceof PlayerEntity) {
                this.net_minecraft_world_World_getWorld().sendEntityStatus(this, EntityStatuses.ADD_VILLAGER_ANGRY_PARTICLES);
            }
        }
    ...
    public void releaseTicketFor(MemoryModuleType<GlobalPos> pos) {
        ...
        MinecraftServer minecraftServer = ((ServerWorld)this.net_minecraft_world_World_getWorld()).getServer();
    ...
    @Override
    @Nullable
    public VillagerEntity net_minecraft_entity_passive_VillagerEntity_createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
    ...
    public boolean canSummonGolem(long time) {
        if (!this.hasRecentlySlept(this.net_minecraft_world_World_getWorld().getTime())) {
            return false;
        }
    ...
    public void sleep(BlockPos pos) {
        super.sleep(pos);
        this.brain.remember(MemoryModuleType.LAST_SLEPT, this.net_minecraft_world_World_getWorld().getTime());
    ...
    public void wakeUp() {
        super.wakeUp();
        this.brain.remember(MemoryModuleType.LAST_WOKEN, this.net_minecraft_world_World_getWorld().getTime());
    }
    ...
    public PassiveEntity net_minecraft_entity_passive_PassiveEntity_createChild(ServerWorld world, PassiveEntity entity) {
        return this.net_minecraft_entity_passive_VillagerEntity_createChild(world, entity);
    }
}
