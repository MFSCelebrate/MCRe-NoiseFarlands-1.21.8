...
extends PathAwareEntity {
    final static private TrackedData<Boolean> CHILD = DataTracker.registerData(PassiveEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static public int BABY_AGE = -24000;
    final static private int HAPPY_TICKS = 40;
    final static protected int DEFAULT_AGE = 0;
    final static protected int DEFAULT_FORCED_AGE = 0;
    ...
    @Nullable
    public abstract PassiveEntity net_minecraft_entity_passive_LlamaEntity_createChild(ServerWorld var1, PassiveEntity var2);
    ...
    implements EntityData {
        ...
        final private boolean babyAllowed;
        final private float babyChance;
