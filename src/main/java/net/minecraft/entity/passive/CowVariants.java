...
public class CowVariants {
    final static public RegistryKey<CowVariant> TEMPERATE = CowVariants.of(AnimalTemperature.TEMPERATE);
    final static public RegistryKey<CowVariant> WARM = CowVariants.of(AnimalTemperature.WARM);
    final static public RegistryKey<CowVariant> COLD = CowVariants.of(AnimalTemperature.COLD);
    final static public RegistryKey<CowVariant> DEFAULT = TEMPERATE;
