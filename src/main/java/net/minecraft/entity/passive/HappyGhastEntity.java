...
extends AnimalEntity {
    final static public float field_59681 = 0.2375f;
    final static public int field_59682 = 16;
    final static public int field_59683 = 32;
    final static public int field_59684 = 64;
    final static public int field_59685 = 16;
    final static public int field_59686 = 20;
    final static public int field_59687 = 600;
    final static public int field_59688 = 4;
    final static private int field_61061 = 60;
    final static private int field_60551 = 10;
    final static public float field_59689 = 2.0f;
    final static public Predicate<ItemStack> FOOD_PREDICATE = stack -> stack.isIn(ItemTags.HAPPY_GHAST_FOOD);
    private int ropeRemovalTimer = 0;
    private int stillTimeout;
    final static private TrackedData<Boolean> HAS_ROPES = DataTracker.registerData(HappyGhastEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private TrackedData<Boolean> STAYING_STILL = DataTracker.registerData(HappyGhastEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private float field_60550 = 1.0f;
    ...
    private void setStillTimeout(int stillTimeout) {
        World world;
        if (this.stillTimeout <= 0 && stillTimeout > 0 && (world = this.net_minecraft_world_World_getWorld()) instanceof ServerWorld) {
            ServerWorld serverWorld = (ServerWorld)world;
            this.updateTrackedPosition(this.getX(), this.getY(), this.getZ());
            serverWorld.net_minecraft_server_world_ServerChunkManager_getChunkManager().chunkLoadingManager.sendToOtherNearbyPlayers(this, EntityPositionSyncS2CPacket.create(this));
        }
    ...
    private void initAdultHappyGhast() {
        this.moveControl = new GhastEntity.GhastMoveControl(this, true, this::method_72227);
        this.lookControl = new HappyGhastLookControl();
        this.navigation = this.createNavigation(this.net_minecraft_world_World_getWorld());
    ...
    private void initGhastling() {
        ...
        this.navigation = this.createGhastlingNavigation(this.net_minecraft_world_World_getWorld());
    ...
    public float getPathfindingFavor(BlockPos pos, WorldView world) {
        ...
        if (world.isAir(pos.net_minecraft_util_math_BlockPos_down()) && !world.isAir(pos.net_minecraft_util_math_BlockPos_down(2))) {
            return 10.0f;
        }
        return 5.0f;
    }
    ...
    protected void addPassenger(Entity passenger) {
        if (!this.hasPassengers()) {
            this.net_minecraft_world_World_getWorld().playSound(null, this.getX(), this.getY(), this.getZ(), SoundEvents.ENTITY_HAPPY_GHAST_HARNESS_GOGGLES_DOWN, this.getSoundCategory(), 1.0f, 1.0f);
        }
    ...
    protected void removePassenger(Entity passenger) {
        ...
        if (!this.hasPassengers()) {
            ...
            this.net_minecraft_world_World_getWorld().playSound(null, this.getX(), this.getY(), this.getZ(), SoundEvents.ENTITY_HAPPY_GHAST_HARNESS_GOGGLES_UP, this.getSoundCategory(), 1.0f, 1.0f);
        }
    }
    ...
    public LivingEntity getControllingPassenger() {
        ...
        if (this.isWearingBodyArmor() && !this.method_72227() && entity instanceof PlayerEntity) {
    ...
    private boolean hasPlayerOnTop() {
        ...
        for (PlayerEntity playerEntity : this.net_minecraft_world_World_getWorld().getPlayers()) {
            Entity entity;
            if (playerEntity.isSpectator() || (entity = playerEntity.getRootVehicle()) instanceof HappyGhastEntity || !box2.contains(entity.getPos())) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean isCollidable(@Nullable Entity entity) {
        ...
        if (this.net_minecraft_world_World_getWorld().isClient() && entity instanceof PlayerEntity && entity.getPos().y >= this.getBoundingBox().maxY) {
            return true;
        }
        if (this.hasPassengers() && entity instanceof HappyGhastEntity) {
            return true;
        }
        return this.method_72227();
    }
