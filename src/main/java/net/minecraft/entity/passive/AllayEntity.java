...
Vibrations {
    final static private Vec3i ITEM_PICKUP_RANGE_EXPANDER = new Vec3i(1, 1, 1);
    final static private int field_39461 = 5;
    final static private float field_39462 = 55.0f;
    final static private float field_39463 = 15.0f;
    final static private int DEFAULT_DUPLICATION_COOLDOWN = 0;
    final static private int DUPLICATION_COOLDOWN = 6000;
    final static private int field_39679 = 3;
    final static public int field_54974 = 1024;
    final static private TrackedData<Boolean> DANCING = DataTracker.registerData(AllayEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private TrackedData<Boolean> CAN_DUPLICATE = DataTracker.registerData(AllayEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static protected ImmutableList<SensorType<? extends Sensor<? super AllayEntity>>> SENSORS = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS, SensorType.HURT_BY, SensorType.NEAREST_ITEMS);
    final static protected ImmutableList<MemoryModuleType<?>> MEMORY_MODULES = ImmutableList.of(MemoryModuleType.PATH, MemoryModuleType.LOOK_TARGET, MemoryModuleType.VISIBLE_MOBS, MemoryModuleType.WALK_TARGET, MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleType.HURT_BY, MemoryModuleType.NEAREST_VISIBLE_WANTED_ITEM, MemoryModuleType.LIKED_PLAYER, MemoryModuleType.LIKED_NOTEBLOCK, MemoryModuleType.LIKED_NOTEBLOCK_COOLDOWN_TICKS, MemoryModuleType.ITEM_PICKUP_COOLDOWN_TICKS, MemoryModuleType.IS_PANICKING, (Object[])new MemoryModuleType[0]);
    final static public ImmutableList<Float> THROW_SOUND_PITCHES = ImmutableList.of((Object)Float.valueOf(0.5625f), (Object)Float.valueOf(0.625f), (Object)Float.valueOf(0.75f), (Object)Float.valueOf(0.9375f), (Object)Float.valueOf(1.0f), (Object)Float.valueOf(1.0f), (Object)Float.valueOf(1.125f), (Object)Float.valueOf(1.25f), (Object)Float.valueOf(1.5f), (Object)Float.valueOf(1.875f), (Object)Float.valueOf(2.0f), (Object)Float.valueOf(2.25f), (Object[])new Float[]{Float.valueOf(2.5f), Float.valueOf(3.0f), Float.valueOf(3.75f), Float.valueOf(4.0f)});
    final private EntityGameEventHandler<Vibrations.VibrationListener> gameEventHandler;
    private Vibrations.ListenerData vibrationListenerData;
    final private Vibrations.Callback vibrationCallback;
    final private EntityGameEventHandler<JukeboxEventListener> jukeboxEventHandler;
    final private SimpleInventory inventory = new SimpleInventory(1);
    @Nullable
    ...
    public void tickMovement() {
        super.tickMovement();
        if (!this.net_minecraft_world_World_getWorld().isClient && this.isAlive() && this.age % 10 == 0) {
            this.heal(1.0f);
        }
    ...
    public void tick() {
        ...
        if (this.net_minecraft_world_World_getWorld().isClient) {
            ...
            Vibrations.Ticker.tick(this.net_minecraft_world_World_getWorld(), this.vibrationListenerData, this.vibrationCallback);
            if (this.isPanicking()) {
                this.setDancing(false);
            }
        }
    ...
    protected ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (this.isDancing() && itemStack.isIn(ItemTags.DUPLICATES_ALLAYS) && this.canDuplicate()) {
            this.duplicate();
            this.net_minecraft_world_World_getWorld().sendEntityStatus(this, EntityStatuses.ADD_BREEDING_PARTICLES);
            this.net_minecraft_world_World_getWorld().playSoundFromEntity(player, this, SoundEvents.BLOCK_AMETHYST_BLOCK_CHIME, SoundCategory.NEUTRAL, 2.0f, 1.0f);
        ...
        if (itemStack2.isEmpty() && !itemStack.isEmpty()) {
            ...
            this.decrementStackUnlessInCreative(player, itemStack);
            this.net_minecraft_world_World_getWorld().playSoundFromEntity(player, this, SoundEvents.ENTITY_ALLAY_ITEM_GIVEN, SoundCategory.NEUTRAL, 2.0f, 1.0f);
        ...
        if (!itemStack2.isEmpty() && hand == Hand.MAIN_HAND && itemStack.isEmpty()) {
            ...
            this.net_minecraft_world_World_getWorld().playSoundFromEntity(player, this, SoundEvents.ENTITY_ALLAY_ITEM_TAKEN, SoundCategory.NEUTRAL, 2.0f, 1.0f);
    ...
    public void setDancing(boolean dancing) {
        if (this.net_minecraft_world_World_getWorld().isClient || !this.canActVoluntarily() || dancing && this.isPanicking()) {
            return;
        }
    ...
    private boolean shouldStopDancing() {
        return this.jukeboxPos == null || !this.jukeboxPos.isWithinDistance(this.getPos(), (double)GameEvent.JUKEBOX_PLAY.value().notificationRadius()) || !this.net_minecraft_world_World_getWorld().getBlockState(this.jukeboxPos).isOf(Blocks.JUKEBOX);
    }
    ...
    private void tickDuplicationCooldown() {
        if (!this.net_minecraft_world_World_getWorld().isClient() && this.duplicationCooldown > 0L) {
    ...
    private void duplicate() {
        AllayEntity allayEntity = EntityType.ALLAY.create(this.net_minecraft_world_World_getWorld(), SpawnReason.BREEDING);
        if (allayEntity != null) {
            ...
            this.net_minecraft_world_World_getWorld().spawnEntity(allayEntity);
        }
    }
    ...
    private void addHeartParticle() {
        ...
        this.net_minecraft_world_World_getWorld().addParticleClient(ParticleTypes.HEART, this.getParticleX(1.0), this.getRandomBodyY() + 0.5, this.getParticleZ(1.0), d, e, f);
    }
    ...
    implements Vibrations.Callback {
        final static private int RANGE = 16;
