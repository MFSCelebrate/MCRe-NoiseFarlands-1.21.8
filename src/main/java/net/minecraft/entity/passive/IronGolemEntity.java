...
implements Angerable {
    final static protected TrackedData<Byte> IRON_GOLEM_FLAGS = DataTracker.registerData(IronGolemEntity.class, TrackedDataHandlerRegistry.BYTE);
    final static private int HEALTH_PER_INGOT = 25;
    final static private boolean DEFAULT_PLAYER_CREATED = false;
    ...
    protected void initDataTracker(DataTracker.Builder builder) {
        ...
        builder.add(IRON_GOLEM_FLAGS, 0);
    }
    ...
    public void setLookingAtVillager(boolean lookingAtVillager) {
        if (lookingAtVillager) {
            this.lookingAtVillagerTicksLeft = 400;
            this.net_minecraft_world_World_getWorld().sendEntityStatus(this, EntityStatuses.LOOK_AT_VILLAGER);
        } else {
            this.lookingAtVillagerTicksLeft = 0;
            this.net_minecraft_world_World_getWorld().sendEntityStatus(this, EntityStatuses.STOP_LOOKING_AT_VILLAGER);
        }
    }
    ...
    public boolean canSpawn(WorldView world) {
        ...
        if (blockState.hasSolidTopSurface(world, blockPos2, this)) {
            for (int i = 1; i < 3; ++i) {
                ...
                BlockPos blockPos3 = blockPos.net_minecraft_util_math_BlockPos_up(i);
