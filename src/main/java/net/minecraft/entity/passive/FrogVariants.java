...
public interface FrogVariants {
    final static public RegistryKey<FrogVariant> TEMPERATE = FrogVariants.of(AnimalTemperature.TEMPERATE);
    final static public RegistryKey<FrogVariant> WARM = FrogVariants.of(AnimalTemperature.WARM);
    final static public RegistryKey<FrogVariant> COLD = FrogVariants.of(AnimalTemperature.COLD);
