...
implements Bucketable {
    final static public int PLAY_DEAD_TICKS = 200;
    final static private int field_52482 = 10;
    final static protected ImmutableList<? extends SensorType<? extends Sensor<? super AxolotlEntity>>> SENSORS = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_ADULT, SensorType.HURT_BY, SensorType.AXOLOTL_ATTACKABLES, SensorType.AXOLOTL_TEMPTATIONS);
    final static protected ImmutableList<? extends MemoryModuleType<?>> MEMORY_MODULES = ImmutableList.of(MemoryModuleType.BREED_TARGET, MemoryModuleType.MOBS, MemoryModuleType.VISIBLE_MOBS, MemoryModuleType.NEAREST_VISIBLE_PLAYER, MemoryModuleType.NEAREST_VISIBLE_TARGETABLE_PLAYER, MemoryModuleType.LOOK_TARGET, MemoryModuleType.WALK_TARGET, MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleType.PATH, MemoryModuleType.ATTACK_TARGET, MemoryModuleType.ATTACK_COOLING_DOWN, MemoryModuleType.NEAREST_VISIBLE_ADULT, (Object[])new MemoryModuleType[]{MemoryModuleType.HURT_BY_ENTITY, MemoryModuleType.PLAY_DEAD_TICKS, MemoryModuleType.NEAREST_ATTACKABLE, MemoryModuleType.TEMPTING_PLAYER, MemoryModuleType.TEMPTATION_COOLDOWN_TICKS, MemoryModuleType.IS_TEMPTED, MemoryModuleType.HAS_HUNTING_COOLDOWN, MemoryModuleType.IS_PANICKING});
    final static private TrackedData<Integer> VARIANT = DataTracker.registerData(AxolotlEntity.class, TrackedDataHandlerRegistry.INTEGER);
    final static private TrackedData<Boolean> PLAYING_DEAD = DataTracker.registerData(AxolotlEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private TrackedData<Boolean> FROM_BUCKET = DataTracker.registerData(AxolotlEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static public double BUFF_RANGE = 20.0;
    final static public int BLUE_BABY_CHANCE = 1200;
    final static private int MAX_AIR = 6000;
    final static public String VARIANT_KEY = "Variant";
    final static private int HYDRATION_BY_POTION = 1800;
    final static private int MAX_REGENERATION_BUFF_DURATION = 2400;
    final static private boolean DEFAULT_FROM_BUCKET = false;
    final public InterpolatedFlipFlop playingDeadFf = new InterpolatedFlipFlop(10, MathHelper::easeInOutSine);
    final public InterpolatedFlipFlop inWaterFf = new InterpolatedFlipFlop(10, MathHelper::easeInOutSine);
    final public InterpolatedFlipFlop onGroundFf = new InterpolatedFlipFlop(10, MathHelper::easeInOutSine);
    final public InterpolatedFlipFlop isMovingFf = new InterpolatedFlipFlop(10, MathHelper::easeInOutSine);
    final static private int BUFF_DURATION = 100;
    ...
    public void baseTick() {
        ...
        int i = this.getAir();
        super.baseTick();
        if (!this.isAiDisabled() && (world = this.net_minecraft_world_World_getWorld()) instanceof ServerWorld) {
    ...
    public boolean damage(ServerWorld world, DamageSource source, float amount) {
        ...
        if (!this.isAiDisabled() && this.net_minecraft_world_World_getWorld().random.nextInt(3) == 0 && ((float)this.net_minecraft_world_World_getWorld().random.nextInt(3) < amount || f / this.getMaxHealth() < 0.5f) && amount < f && this.isTouchingWater() && (source.getAttacker() != null || source.getSource() != null) && !this.isPlayingDead()) {
    ...
    public static boolean canSpawn(EntityType<? extends LivingEntity> type, ServerWorldAccess world, SpawnReason reason, BlockPos pos, Random random) {
        return world.getBlockState(pos.net_minecraft_util_math_BlockPos_down()).isIn(BlockTags.AXOLOTLS_SPAWNABLE_ON);
    }

    static class AxolotlMoveControl
    extends AquaticMoveControl {
        final private AxolotlEntity axolotl;
    ...
    implements StringIdentifiable {
        final static public Variant LUCY = new Variant(0, "lucy", true);
        final static public Variant WILD = new Variant(1, "wild", true);
        final static public Variant GOLD = new Variant(2, "gold", true);
        final static public Variant CYAN = new Variant(3, "cyan", true);
        final static public Variant BLUE = new Variant(4, "blue", false);
        ...
        @Deprecated
        final static public Codec<Variant> INDEX_CODEC;
        final private int index;
        final private String id;
        final private boolean natural;
        final static private Variant[] field_28350;
    ...
    extends Enum<State> {
        final static public State PLAYING_DEAD = new State();
        final static public State IN_WATER = new State();
        final static public State ON_GROUND = new State();
        final static public State IN_AIR = new State();
        final static private State[] field_52487;
