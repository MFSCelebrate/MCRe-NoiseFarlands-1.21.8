...
implements ConsumableComponent.ConsumableSoundProvider {
    final static private int DEFAULT_DESPAWN_DELAY = 0;
    @Nullable
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(0, new HoldInHandsGoal<WanderingTraderEntity>(this, PotionContentsComponent.createStack(Items.POTION, Potions.INVISIBILITY), SoundEvents.ENTITY_WANDERING_TRADER_DISAPPEARED, wanderingTrader -> this.net_minecraft_world_World_getWorld().isNight() && !wanderingTrader.isInvisible()));
        this.goalSelector.add(0, new HoldInHandsGoal<WanderingTraderEntity>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.ENTITY_WANDERING_TRADER_REAPPEARED, wanderingTrader -> this.net_minecraft_world_World_getWorld().isDay() && wanderingTrader.isInvisible()));
