...
extends AmbientEntity {
    final static public float field_46966 = 0.5f;
    final static public float field_46967 = 10.0f;
    final static private TrackedData<Byte> BAT_FLAGS = DataTracker.registerData(BatEntity.class, TrackedDataHandlerRegistry.BYTE);
    final static private int ROOSTING_FLAG = 1;
    final static private TargetPredicate CLOSE_PLAYER_PREDICATE = TargetPredicate.createNonAttackable().setBaseMaxDistance(4.0);
    final static private byte DEFAULT_BAT_FLAGS = 0;
    ...
    protected void readCustomData(ReadView view) {
        ...
        this.dataTracker.set(BAT_FLAGS, view.getByte("BatFlags", 0));
    }
    ...
    public static boolean canSpawn(EntityType<BatEntity> type, WorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
        ...
        if (!world.getBlockState(pos.net_minecraft_util_math_BlockPos_down()).isIn(BlockTags.BATS_SPAWNABLE_ON)) {
            return false;
        }
