...
extends SchoolingFishEntity {
    ...
    public static boolean canTropicalFishSpawn(EntityType<TropicalFishEntity> type, WorldAccess world, SpawnReason reason, BlockPos pos, Random random) {
        return world.getFluidState(pos.net_minecraft_util_math_BlockPos_down()).isIn(FluidTags.WATER) && world.getBlockState(pos.net_minecraft_util_math_BlockPos_up()).isOf(Blocks.WATER) && (world.getBiome(pos).isIn(BiomeTags.ALLOWS_TROPICAL_FISH_SPAWNS_AT_ANY_HEIGHT) || WaterCreatureEntity.canSpawn(type, world, reason, pos, random));
    }
    ...
    TooltipAppender {
        final static public Pattern KOB = new Pattern("kob", Size.SMALL, 0);
        final static public Pattern SUNSTREAK = new Pattern("sunstreak", Size.SMALL, 1);
        final static public Pattern SNOOPER = new Pattern("snooper", Size.SMALL, 2);
        final static public Pattern DASHER = new Pattern("dasher", Size.SMALL, 3);
        final static public Pattern BRINELY = new Pattern("brinely", Size.SMALL, 4);
        final static public Pattern SPOTTY = new Pattern("spotty", Size.SMALL, 5);
        final static public Pattern FLOPPER = new Pattern("flopper", Size.LARGE, 0);
        final static public Pattern STRIPEY = new Pattern("stripey", Size.LARGE, 1);
        final static public Pattern GLITTER = new Pattern("glitter", Size.LARGE, 2);
        final static public Pattern BLOCKFISH = new Pattern("blockfish", Size.LARGE, 3);
        final static public Pattern BETTY = new Pattern("betty", Size.LARGE, 4);
        final static public Pattern CLAYFISH = new Pattern("clayfish", Size.LARGE, 5);
        final static public Codec<Pattern> CODEC;
        final static private IntFunction<Pattern> INDEX_MAPPER;
        final static public PacketCodec<ByteBuf, Pattern> PACKET_CODEC;
        final private String id;
        final private Text text;
        final private Size size;
        final private int index;
        final static private Pattern[] field_6886;
    ...
    public record Variant(Pattern pattern, DyeColor baseColor, DyeColor patternColor) {
        final static public Codec<Variant> CODEC = Codec.INT.xmap(Variant::new, Variant::getId);
    ...
    extends Enum<Size> {
        final static public Size SMALL = new Size(0);
        final static public Size LARGE = new Size(1);
        final int index;
        final static private Size[] field_41577;
