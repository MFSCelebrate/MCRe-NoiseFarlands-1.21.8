...
public class ChickenVariants {
    final static public RegistryKey<ChickenVariant> TEMPERATE = ChickenVariants.of(AnimalTemperature.TEMPERATE);
    final static public RegistryKey<ChickenVariant> WARM = ChickenVariants.of(AnimalTemperature.WARM);
    final static public RegistryKey<ChickenVariant> COLD = ChickenVariants.of(AnimalTemperature.COLD);
    final static public RegistryKey<ChickenVariant> DEFAULT = TEMPERATE;
