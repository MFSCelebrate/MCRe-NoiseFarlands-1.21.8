...
public class PigVariants {
    final static public RegistryKey<PigVariant> TEMPERATE = PigVariants.of(AnimalTemperature.TEMPERATE);
    final static public RegistryKey<PigVariant> WARM = PigVariants.of(AnimalTemperature.WARM);
    final static public RegistryKey<PigVariant> COLD = PigVariants.of(AnimalTemperature.COLD);
    final static public RegistryKey<PigVariant> DEFAULT = TEMPERATE;
