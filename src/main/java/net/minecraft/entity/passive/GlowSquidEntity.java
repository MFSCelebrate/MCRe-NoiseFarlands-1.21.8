...
extends SquidEntity {
    final static private TrackedData<Integer> DARK_TICKS_REMAINING = DataTracker.registerData(GlowSquidEntity.class, TrackedDataHandlerRegistry.INTEGER);
    final static private int DEFAULT_DARK_TICKS_REMAINING = 0;
    ...
    public void tickMovement() {
        ...
        this.net_minecraft_world_World_getWorld().addParticleClient(ParticleTypes.GLOW, this.getParticleX(0.6), this.getRandomBodyY(), this.getParticleZ(0.6), 0.0, 0.0, 0.0);
    }
