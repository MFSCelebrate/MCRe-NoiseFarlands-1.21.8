...
implements Shearable {
    final static private int MAX_GRASS_TIMER = 40;
    final static private TrackedData<Byte> COLOR = DataTracker.registerData(SheepEntity.class, TrackedDataHandlerRegistry.BYTE);
    final static private DyeColor DEFAULT_COLOR = DyeColor.WHITE;
    final static private boolean DEFAULT_SHEARED = false;
        ...
        if (itemStack.isOf(Items.SHEARS)) {
            ...
            if (world instanceof ServerWorld) {
                ...
                if (this.isShearable()) {
                    ...
                    itemStack.damage(1, (LivingEntity)player, SheepEntity.getSlotForHand(hand));
    ...
    @Override
    @Nullable
    public SheepEntity net_minecraft_entity_passive_SheepEntity_createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
    ...
    public PassiveEntity net_minecraft_entity_passive_PassiveEntity_createChild(ServerWorld world, PassiveEntity entity) {
        return this.net_minecraft_entity_passive_SheepEntity_createChild(world, entity);
    }
}
