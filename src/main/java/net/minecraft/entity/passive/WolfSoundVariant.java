...
public record WolfSoundVariant(RegistryEntry<SoundEvent> ambientSound, RegistryEntry<SoundEvent> deathSound, RegistryEntry<SoundEvent> growlSound, RegistryEntry<SoundEvent> hurtSound, RegistryEntry<SoundEvent> pantSound, RegistryEntry<SoundEvent> whineSound) {
    final static public Codec<WolfSoundVariant> CODEC = WolfSoundVariant.createCodec();
    final static public Codec<WolfSoundVariant> NETWORK_CODEC = WolfSoundVariant.createCodec();
    final static public Codec<RegistryEntry<WolfSoundVariant>> ENTRY_CODEC = RegistryFixedCodec.of(RegistryKeys.WOLF_SOUND_VARIANT);
    final static public PacketCodec<RegistryByteBuf, RegistryEntry<WolfSoundVariant>> PACKET_CODEC = PacketCodecs.registryEntry(RegistryKeys.WOLF_SOUND_VARIANT);
