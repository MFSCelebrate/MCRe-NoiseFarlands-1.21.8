...
{
    final static public MapCodec<BiomeSpawnCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)RegistryCodecs.entryList(RegistryKeys.BIOME).fieldOf("biomes").forGetter(BiomeSpawnCondition::requiredBiomes)).apply((Applicative)instance, BiomeSpawnCondition::new));
