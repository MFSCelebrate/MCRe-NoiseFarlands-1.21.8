...
{
    final static public MapCodec<StructureSpawnCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)RegistryCodecs.entryList(RegistryKeys.STRUCTURE).fieldOf("structures").forGetter(StructureSpawnCondition::requiredStructures)).apply((Applicative)instance, StructureSpawnCondition::new));
