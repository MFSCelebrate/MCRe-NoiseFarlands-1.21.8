...
public interface VariantSelectorProvider<Context, Condition extends SelectorCondition<Context>> {
    ...
    extends Record {
        ...
        final static public Comparator<UnwrappedSelector<?, ?>> PRIORITY_COMPARATOR = Comparator.comparingInt(UnwrappedSelector::priority).reversed();

        public UnwrappedSelector(T object, int i, SelectorCondition<C> selectorCondition) {
            this.entry = object;
            this.priority = i;
