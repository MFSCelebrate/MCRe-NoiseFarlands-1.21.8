...
extends StatusEffect {
    final static private int field_51373 = 2;
    final static public int field_51372 = 2;
    final private ToIntFunction<Random> slimeCountFunction;
    ...
    public void onEntityRemoval(ServerWorld world, LivingEntity entity, int amplifier, Entity.RemovalReason reason) {
        ...
        for (int l = 0; l < k; ++l) {
            this.spawnSlime(entity.net_minecraft_world_World_getWorld(), entity.getX(), entity.getY() + 0.5, entity.getZ());
        }
    }
    ...
    protected static interface SlimeCounter {
        ...
        public static SlimeCounter around(LivingEntity entity) {
            return limit -> {
                ...
                entity.net_minecraft_world_World_getWorld().collectEntitiesByType(EntityType.SLIME, entity.getBoundingBox().expand(2.0), slime -> slime != entity, list, limit);
                return list.size();
            };
        }
    }
