...
implements ToggleableFeature {
    final static public Codec<RegistryEntry<StatusEffect>> ENTRY_CODEC = Registries.STATUS_EFFECT.getEntryCodec();
    final static public PacketCodec<RegistryByteBuf, RegistryEntry<StatusEffect>> ENTRY_PACKET_CODEC = PacketCodecs.registryEntry(RegistryKeys.STATUS_EFFECT);
    final static private int AMBIENT_PARTICLE_ALPHA = MathHelper.floor(38.25f);
    final private Map<RegistryEntry<EntityAttribute>, EffectAttributeModifierCreator> attributeModifiers = new Object2ObjectOpenHashMap();
    final private StatusEffectCategory category;
    final private int color;
    final private Function<StatusEffectInstance, ParticleEffect> particleFactory;
    @Nullable
    ...
    public void playApplySound(LivingEntity entity, int amplifier) {
        this.applySound.ifPresent(sound -> entity.net_minecraft_world_World_getWorld().playSound(null, entity.getX(), entity.getY(), entity.getZ(), (SoundEvent)sound, entity.getSoundCategory(), 1.0f, 1.0f));
    }
