...
extends RaiderEntity {
    ...
    extends Enum<State> {
        final static public State CROSSED = new State();
        final static public State ATTACKING = new State();
        final static public State SPELLCASTING = new State();
        final static public State BOW_AND_ARROW = new State();
        final static public State CROSSBOW_HOLD = new State();
        final static public State CROSSBOW_CHARGE = new State();
        final static public State CELEBRATING = new State();
        final static public State NEUTRAL = new State();
        final static private State[] field_7209;
