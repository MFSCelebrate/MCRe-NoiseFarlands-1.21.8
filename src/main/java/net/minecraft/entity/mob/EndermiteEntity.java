...
extends HostileEntity {
    final static private int DESPAWN_TIME = 2400;
    final static private int DEFAULT_LIFETIME = 0;
    ...
    public void tickMovement() {
        ...
        if (this.net_minecraft_world_World_getWorld().isClient) {
            for (int i = 0; i < 2; ++i) {
                this.net_minecraft_world_World_getWorld().addParticleClient(ParticleTypes.PORTAL, this.getParticleX(0.5), this.getRandomBodyY(), this.getParticleZ(0.5), (this.random.nextDouble() - 0.5) * 2.0, -this.random.nextDouble(), (this.random.nextDouble() - 0.5) * 2.0);
            }
        } else {
