...
public class HoglinBrain {
    final static public int field_30533 = 8;
    final static public int field_30534 = 4;
    final static private UniformIntProvider AVOID_MEMORY_DURATION = TimeHelper.betweenSeconds(5, 20);
    final static private int field_30535 = 200;
    final static private int field_30536 = 8;
    final static private int field_30537 = 15;
    final static private int ADULT_MELEE_ATTACK_COOLDOWN = 40;
    final static private int BABY_MELEE_ATTACK_COOLDOWN = 15;
    final static private int field_30540 = 200;
    final static private UniformIntProvider WALK_TOWARD_CLOSEST_ADULT_RANGE = UniformIntProvider.create(5, 16);
    final static private float field_30541 = 1.0f;
    final static private float AVOID_TARGET_SPEED = 1.3f;
    final static private float field_30543 = 0.6f;
    final static private float field_30544 = 0.4f;
    final static private float field_30545 = 0.6f;
    ...
    private static void avoid(HoglinEntity hoglin, LivingEntity target) {
        ...
        hoglin.getBrain().remember(MemoryModuleType.AVOID_TARGET, target, AVOID_MEMORY_DURATION.get(hoglin.net_minecraft_world_World_getWorld().random));
    }
