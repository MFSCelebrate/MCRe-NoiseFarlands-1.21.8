...
implements Ownable {
    final static public float field_30502 = 45.836624f;
    final static public int field_28645 = MathHelper.ceil(3.9269907f);
    final static protected TrackedData<Byte> VEX_FLAGS = DataTracker.registerData(VexEntity.class, TrackedDataHandlerRegistry.BYTE);
    final static private int CHARGING_FLAG = 1;
    @Nullable
    ...
    @Override
    @Nullable
    public MobEntity net_minecraft_entity_mob_MobEntity_getOwner() {
        return LazyEntityReference.resolve(this.owner, this.net_minecraft_world_World_getWorld(), MobEntity.class);
    }
    ...
    private void setVexFlag(int mask, boolean value) {
        ...
        this.dataTracker.set(VEX_FLAGS, 1);
    }
    ...
    public void setOwner(MobEntity owner) {
        this.owner = new LazyEntityReference<MobEntity>(owner);
    }
    ...
    public Entity net_minecraft_entity_Entity_getOwner() {
        return this.net_minecraft_entity_mob_MobEntity_getOwner();
    }
    ...
    extends Goal {
        ...
        public void tick() {
            ...
            if (VexEntity.this.getBoundingBox().intersects(livingEntity.getBoundingBox())) {
                VexEntity.this.tryAttack(ChargeTargetGoal.castToServerWorld(VexEntity.this.net_minecraft_world_World_getWorld()), livingEntity);
                VexEntity.this.setCharging(false);
            } else {
    ...
    extends Goal {
        ...
        public void tick() {
            ...
            for (int i = 0; i < 3; ++i) {
                BlockPos blockPos2 = blockPos.net_minecraft_util_math_BlockPos_add(VexEntity.this.random.nextInt(15) - 7, VexEntity.this.random.nextInt(11) - 5, VexEntity.this.random.nextInt(15) - 7);
                if (!VexEntity.this.net_minecraft_world_World_getWorld().isAir(blockPos2)) continue;
    ...
    extends TrackTargetGoal {
        final private TargetPredicate targetPredicate;
        ...
        @Override
        public boolean canStart() {
            MobEntity mobEntity = VexEntity.this.net_minecraft_entity_mob_MobEntity_getOwner();
