...
extends PathAwareEntity {
    final static public int MIN_AMBIENT_SOUND_DELAY = 120;
    ...
    public static boolean canSpawn(EntityType<? extends WaterCreatureEntity> type, WorldAccess world, SpawnReason reason, BlockPos pos, Random random) {
        ...
        int j = i - 13;
        return pos.getY() >= j && pos.getY() <= i && world.getFluidState(pos.net_minecraft_util_math_BlockPos_down()).isIn(FluidTags.WATER) && world.getBlockState(pos.net_minecraft_util_math_BlockPos_up()).isOf(Blocks.WATER);
    }
}
