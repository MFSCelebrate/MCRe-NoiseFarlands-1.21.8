...
InventoryOwner {
    final static private TrackedData<Boolean> CHARGING = DataTracker.registerData(PillagerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private int field_30478 = 5;
    final static private int field_30476 = 300;
    final private SimpleInventory inventory = new SimpleInventory(5);
