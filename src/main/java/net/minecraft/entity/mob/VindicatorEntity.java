...
extends IllagerEntity {
    final static private String JOHNNY_KEY = "Johnny";
    final static Predicate<Difficulty> DIFFICULTY_ALLOWS_DOOR_BREAKING_PREDICATE = difficulty -> difficulty == Difficulty.NORMAL || difficulty == Difficulty.HARD;
    final static private boolean DEFAULT_JOHNNY = false;
