...
public class PiglinBrain {
    final static public int field_30565 = 8;
    final static public int field_30566 = 4;
    final static public Item BARTERING_ITEM = Items.GOLD_INGOT;
    final static private int field_30567 = 16;
    final static private int field_30568 = 600;
    final static private int field_30569 = 119;
    final static private int field_30570 = 9;
    final static private int field_30571 = 200;
    final static private int field_30572 = 200;
    final static private int field_30573 = 300;
    final static protected UniformIntProvider HUNT_MEMORY_DURATION = TimeHelper.betweenSeconds(30, 120);
    final static private int AVOID_TARGET_EXPIRY = 100;
    final static private int ADMIRING_DISABLED_EXPIRY = 400;
    final static private int field_30576 = 8;
    final static private UniformIntProvider MEMORY_TRANSFER_TASK_DURATION = TimeHelper.betweenSeconds(10, 40);
    final static private UniformIntProvider RIDE_TARGET_MEMORY_DURATION = TimeHelper.betweenSeconds(10, 30);
    final static private UniformIntProvider AVOID_MEMORY_DURATION = TimeHelper.betweenSeconds(5, 20);
    final static private int field_30577 = 20;
    final static private int field_30578 = 200;
    final static private int field_30579 = 12;
    final static private int field_30580 = 8;
    final static private int field_30581 = 14;
    final static private int field_30582 = 8;
    final static private int field_30583 = 5;
    final static private float CROSSBOW_ATTACK_FORWARD_MOVEMENT = 0.75f;
    final static private int field_30585 = 6;
    final static private UniformIntProvider GO_TO_ZOMBIFIED_MEMORY_DURATION = TimeHelper.betweenSeconds(5, 7);
    final static private UniformIntProvider GO_TO_NEMESIS_MEMORY_DURATION = TimeHelper.betweenSeconds(5, 7);
    final static private float field_30557 = 0.1f;
    final static private float field_30558 = 1.0f;
    final static private float field_30559 = 1.0f;
    final static private float START_RIDING_SPEED = 0.8f;
    final static private float field_30561 = 1.0f;
    final static private float field_30562 = 1.0f;
    final static private float field_30563 = 0.6f;
    final static private float field_30564 = 0.6f;
    ...
    private static List<ItemStack> getBarteredItem(PiglinEntity piglin) {
        LootTable lootTable = piglin.net_minecraft_world_World_getWorld().getServer().getReloadableRegistries().getLootTable(LootTables.PIGLIN_BARTERING_GAMEPLAY);
        ObjectArrayList<ItemStack> list = lootTable.generateLoot(new LootWorldContext.Builder((ServerWorld)piglin.net_minecraft_world_World_getWorld()).add(LootContextParameters.THIS_ENTITY, piglin).build(LootContextTypes.BARTER));
        return list;
    }
    ...
    private static boolean isHuntingTarget(LivingEntity piglin, LivingEntity target) {
        ...
        return Random.create(piglin.net_minecraft_world_World_getWorld().getTime()).nextFloat() < 0.1f;
    }
    ...
    public static void onGuardedBlockInteracted(ServerWorld world, PlayerEntity player, boolean blockOpen) {
        List<PiglinEntity> list = player.net_minecraft_world_World_getWorld().getNonSpectatingEntities(PiglinEntity.class, player.getBoundingBox().expand(16.0));
    ...
    private static Task<LivingEntity> makeRememberRideableHoglinTask() {
        ...
        return MemoryTransferTask.create(entity -> entity.isBaby() && interval.shouldRun(entity.net_minecraft_world_World_getWorld().random), MemoryModuleType.NEAREST_VISIBLE_BABY_HOGLIN, MemoryModuleType.RIDE_TARGET, RIDE_TARGET_MEMORY_DURATION);
    }
    ...
    private static void runAwayFrom(PiglinEntity piglin, LivingEntity target) {
        ...
        piglin.getBrain().forget(MemoryModuleType.WALK_TARGET);
        piglin.getBrain().remember(MemoryModuleType.AVOID_TARGET, target, AVOID_MEMORY_DURATION.get(piglin.net_minecraft_world_World_getWorld().random));
        PiglinBrain.rememberHunting(piglin);
    }

    protected static void rememberHunting(AbstractPiglinEntity piglin) {
        piglin.getBrain().remember(MemoryModuleType.HUNTED_RECENTLY, true, HUNT_MEMORY_DURATION.get(piglin.net_minecraft_world_World_getWorld().random));
    }
