...
extends AbstractPiglinEntity {
    final static private int MAX_HEALTH = 50;
    final static private float MOVEMENT_SPEED = 0.35f;
    final static private int ATTACK_DAMAGE = 7;
    final static private double FOLLOW_RANGE = 12.0;
    final static protected ImmutableList<SensorType<? extends Sensor<? super PiglinBruteEntity>>> SENSOR_TYPES = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS, SensorType.NEAREST_ITEMS, SensorType.HURT_BY, SensorType.PIGLIN_BRUTE_SPECIFIC_SENSOR);
