...
extends HostileEntity {
    final static protected TrackedData<Boolean> IMMUNE_TO_ZOMBIFICATION = DataTracker.registerData(AbstractPiglinEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static public int TIME_TO_ZOMBIFY = 300;
    final static private boolean DEFAULT_IS_IMMUNE_TO_ZOMBIFICATION = false;
    final static private boolean field_60362 = true;
