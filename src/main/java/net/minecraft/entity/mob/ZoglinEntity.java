...
implements Hoglin {
    final static private TrackedData<Boolean> BABY = DataTracker.registerData(ZoglinEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private int field_30514 = 40;
    final static private int field_30505 = 1;
    final static private float DEFAULT_KNOCKBACK_RESISTANCE = 0.6f;
    final static private int DEFAULT_ATTACK_DAMAGE = 6;
    final static private float BABY_ATTACK_DAMAGE = 0.5f;
    final static private int ADULT_MELEE_ATTACK_COOLDOWN = 40;
    final static private int BABY_MELEE_ATTACK_COOLDOWN = 15;
    final static private int ATTACK_TARGET_DURATION = 200;
    final static private float DEFAULT_MOVEMENT_SPEED = 0.3f;
    final static private float field_30513 = 0.4f;
    final static private boolean DEFAULT_IS_BABY = false;
    private int movementCooldownTicks;
    final static protected ImmutableList<? extends SensorType<? extends Sensor<? super ZoglinEntity>>> USED_SENSORS = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS);
    final static protected ImmutableList<? extends MemoryModuleType<?>> USED_MEMORY_MODULES = ImmutableList.of(MemoryModuleType.MOBS, MemoryModuleType.VISIBLE_MOBS, MemoryModuleType.NEAREST_VISIBLE_PLAYER, MemoryModuleType.NEAREST_VISIBLE_TARGETABLE_PLAYER, MemoryModuleType.LOOK_TARGET, MemoryModuleType.WALK_TARGET, MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleType.PATH, MemoryModuleType.ATTACK_TARGET, MemoryModuleType.ATTACK_COOLING_DOWN);
    ...
    public void setBaby(boolean baby) {
        ...
        if (!this.net_minecraft_world_World_getWorld().isClient && baby) {
