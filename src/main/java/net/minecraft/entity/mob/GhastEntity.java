...
extends MobEntity
implements Monster {
    final static private TrackedData<Boolean> SHOOTING = DataTracker.registerData(GhastEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private byte DEFAULT_FIREBALL_STRENGTH = 1;
    ...
    protected void readCustomData(ReadView view) {
        ...
        this.fireballStrength = view.getByte("ExplosionPower", 1);
    }
    ...
    extends MoveControl {
        final private MobEntity ghast;
        private int collisionCheckCooldown;
        final private boolean happy;
        final private BooleanSupplier shouldStayStill;
        ...
        private boolean willCollide(Vec3d movement) {
            ...
            if (this.happy) {
                for (BlockPos blockPos : BlockPos.iterate(box2.expand(1.0))) {
                    if (this.canPassThrough(this.ghast.net_minecraft_world_World_getWorld(), null, null, blockPos, false, false)) continue;
                    return false;
                }
            }
            ...
            return BlockView.collectCollisionsBetween(vec3d, vec3d2, box2, (pos, version) -> {
                ...
                return this.canPassThrough(this.ghast.net_minecraft_world_World_getWorld(), vec3d, vec3d2, pos, bl, bl2);
            });
        }
    ...
    extends Goal {
        final static private int field_59707 = 64;
        final private MobEntity ghast;
        final private int blockCheckDistance;
        ...
        public static Vec3d locateTarget(MobEntity ghast, int blockCheckDistance) {
            BlockPos blockPos;
            int j;
            World world = ghast.net_minecraft_world_World_getWorld();
        ...
        private static boolean isTargetValid(World world, Vec3d pos, int blockCheckDistance) {
            ...
            for (Direction direction : Direction.values()) {
                for (int i = 1; i < blockCheckDistance; ++i) {
                    BlockPos blockPos2 = blockPos.net_minecraft_util_math_BlockPos_offset(direction, i);
    ...
    extends Goal {
        final private GhastEntity ghast;
        public int cooldown;
        ...
        public void tick() {
            ...
            if (livingEntity.squaredDistanceTo(this.ghast) < 4096.0 && this.ghast.canSee(livingEntity)) {
                World world = this.ghast.net_minecraft_world_World_getWorld();
                ++this.cooldown;
