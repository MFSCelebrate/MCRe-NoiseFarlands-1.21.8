...
public class PiglinBruteBrain {
    final static private int ANGRY_AT_EXPIRY = 600;
    final static private int MELEE_ATTACK_COOLDOWN = 20;
    final static private double field_30591 = 0.0125;
    final static private int field_30592 = 8;
    final static private int field_30593 = 8;
    final static private float field_30595 = 0.6f;
    final static private int field_30596 = 2;
    final static private int field_30597 = 100;
    final static private int field_30598 = 5;
    ...
    protected static void setCurrentPosAsHome(PiglinBruteEntity piglinBrute) {
        GlobalPos globalPos = GlobalPos.create(piglinBrute.net_minecraft_world_World_getWorld().getRegistryKey(), piglinBrute.getBlockPos());
    ...
    protected static void playSoundRandomly(PiglinBruteEntity piglinBrute) {
        if ((double)piglinBrute.net_minecraft_world_World_getWorld().random.nextFloat() < 0.0125) {
            PiglinBruteBrain.playSoundIfAngry(piglinBrute);
        }
    }
