...
extends HostileEntity {
    final static private int field_47271 = 20;
    final static private int field_47272 = 1;
    final static private int field_47273 = 20;
    final static private int field_47274 = 3;
    final static private int field_47275 = 5;
    final static private int field_47276 = 10;
    final static private float field_47278 = 3.0f;
    final static private int field_47813 = 1;
    final static private int field_47814 = 80;
    ...
    final static private ProjectileDeflection PROJECTILE_DEFLECTOR = (projectile, hitEntity, random) -> {
        hitEntity.net_minecraft_world_World_getWorld().playSoundFromEntity(null, hitEntity, SoundEvents.ENTITY_BREEZE_DEFLECT, hitEntity.getSoundCategory(), 1.0f, 1.0f);
    ...
    public void onTrackedDataSet(TrackedData<?> data) {
        if (this.net_minecraft_world_World_getWorld().isClient() && POSE.equals(data)) {
            this.stopAnimations();
    ...
    public void addLongJumpingParticles() {
        ...
        for (int i = 0; 1 < 3; ++i) {
            this.net_minecraft_world_World_getWorld().addParticleClient(new BlockStateParticleEffect(ParticleTypes.BLOCK, blockState), vec3d2.x, vec3d2.y, vec3d2.z, 0.0, 0.0, 0.0);
        }
    }
    ...
    public void playAmbientSound() {
        ...
        this.net_minecraft_world_World_getWorld().playSoundFromEntityClient(this, this.getAmbientSound(), this.getSoundCategory(), 1.0f, 1.0f);
    }

    public void playWhirlSound() {
        float f = 0.7f + 0.4f * this.random.nextFloat();
        float g = 0.8f + 0.2f * this.random.nextFloat();
        this.net_minecraft_world_World_getWorld().playSoundFromEntityClient(this, SoundEvents.ENTITY_BREEZE_WHIRL, this.getSoundCategory(), g, f);
    }
