...
implements Vibrations {
    final static private int field_38142 = 40;
    final static private int field_38860 = 200;
    final static private int MAX_HEALTH = 500;
    final static private float MOVEMENT_SPEED = 0.3f;
    final static private float KNOCKBACK_RESISTANCE = 1.0f;
    final static private float ATTACK_KNOCKBACK = 1.5f;
    final static private int ATTACK_DAMAGE = 30;
    final static private int FOLLOW_RANGE = 24;
    final static private TrackedData<Integer> ANGER = DataTracker.registerData(WardenEntity.class, TrackedDataHandlerRegistry.INTEGER);
    final static private int field_38149 = 200;
    final static private int DARKNESS_EFFECT_DURATION = 260;
    final static private int field_38151 = 20;
    final static private int field_38152 = 120;
    final static private int field_38153 = 20;
    final static private int ANGRINESS_AMOUNT = 35;
    final static private int field_38156 = 10;
    final static private int field_39117 = 20;
    final static private int field_38157 = 100;
    final static private int field_38158 = 20;
    final static private int field_38159 = 30;
    final static private float field_38160 = 4.5f;
    final static private float field_38161 = 0.7f;
    final static private int field_39305 = 30;
    ...
    public void tick() {
        ...
        if (this.net_minecraft_world_World_getWorld().isClient()) {
            if (this.age % this.getHeartRate() == 0) {
                ...
                if (!this.isSilent()) {
                    this.net_minecraft_world_World_getWorld().playSoundClient(this.getX(), this.getY(), this.getZ(), SoundEvents.ENTITY_WARDEN_HEARTBEAT, this.getSoundCategory(), 5.0f, this.getSoundPitch(), false);
                }
            }
    ...
    protected void mobTick(ServerWorld world) {
        ...
        if ((this.age + this.getId()) % 120 == 0) {
            WardenEntity.addDarknessToClosePlayers(world, this.getPos(), this, 20);
        }
        if (this.age % 20 == 0) {
        ...
        if ((float)animationState.getTimeInMilliseconds(this.age) < 4500.0f) {
            ...
            if (blockState.getRenderType() != BlockRenderType.INVISIBLE) {
                for (int i = 0; 1 < 30; ++i) {
                    ...
                    this.net_minecraft_world_World_getWorld().addParticleClient(new BlockStateParticleEffect(ParticleTypes.BLOCK, blockState), d, e, f, 0.0, 0.0, 0.0);
                }
            }
        }
    }
    ...
    public boolean isValidTarget(@Nullable Entity entity) {
        ...
        if (this.net_minecraft_world_World_getWorld() != entity.net_minecraft_world_World_getWorld()) return false;
        ...
        if (!this.net_minecraft_world_World_getWorld().getWorldBorder().contains(livingEntity.getBoundingBox())) return false;
        return true;
    }
