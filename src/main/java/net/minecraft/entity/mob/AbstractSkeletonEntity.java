...
implements RangedAttackMob {
    final static private int HARD_ATTACK_INTERVAL = 20;
    final static private int REGULAR_ATTACK_INTERVAL = 40;
    final private BowAttackGoal<AbstractSkeletonEntity> bowAttackGoal = new BowAttackGoal<AbstractSkeletonEntity>(this, 1.0, 20, 15.0f);
    final private MeleeAttackGoal meleeAttackGoal = new MeleeAttackGoal(this, 1.2, false){
    ...
    public void updateAttackType() {
        ...
        if (itemStack.isOf(Items.BOW)) {
            ...
            if (this.net_minecraft_world_World_getWorld().getDifficulty() != Difficulty.HARD) {
