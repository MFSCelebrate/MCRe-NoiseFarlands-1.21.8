...
implements Shearable {
    final static private int HARD_ATTACK_INTERVAL = 50;
    final static private int REGULAR_ATTACK_INTERVAL = 70;
    final static private TrackedData<Boolean> SHEARED = DataTracker.registerData(BoggedEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private String SHEARED_KEY = "sheared";
    ...
    protected ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (itemStack.isOf(Items.SHEARS) && this.isShearable()) {
            ...
            if (world instanceof ServerWorld) {
                ...
                itemStack.damage(1, (LivingEntity)player, BoggedEntity.getSlotForHand(hand));
            }
