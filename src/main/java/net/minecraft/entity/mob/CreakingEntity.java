...
extends HostileEntity {
    final static private TrackedData<Boolean> UNROOTED = DataTracker.registerData(CreakingEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private TrackedData<Boolean> ACTIVE = DataTracker.registerData(CreakingEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private TrackedData<Boolean> CRUMBLING = DataTracker.registerData(CreakingEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private TrackedData<Optional<BlockPos>> HOME_POS = DataTracker.registerData(CreakingEntity.class, TrackedDataHandlerRegistry.OPTIONAL_BLOCK_POS);
    final static private int field_54573 = 15;
    final static private int field_54574 = 1;
    final static private float ATTACK_DAMAGE = 3.0f;
    final static private float field_54576 = 32.0f;
    final static private float field_54577 = 144.0f;
    final static public int field_54566 = 40;
    final static private float field_54578 = 0.4f;
    final static public float field_54567 = 0.3f;
    final static public int field_54569 = 16545810;
    final static public int field_54580 = 0x5F5F5F;
    final static public int field_55485 = 8;
    final static public int field_55486 = 45;
    final static private int field_55488 = 4;
    ...
    public boolean damage(ServerWorld world, DamageSource source, float amount) {
        ...
        this.net_minecraft_world_World_getWorld().sendEntityStatus(this, EntityStatuses.INVULNERABLE_CREAKING_HIT);
        this.emitGameEvent(GameEvent.ENTITY_ACTION);
        BlockEntity blockEntity = this.net_minecraft_world_World_getWorld().getBlockEntity(blockPos);
    ...
    protected void mobTick(ServerWorld world) {
        ...
        this.getBrain().tick((ServerWorld)this.net_minecraft_world_World_getWorld(), this);
        profiler.pop();
    ...
    public void tick() {
        BlockPos blockPos;
        if (!this.net_minecraft_world_World_getWorld().isClient && (blockPos = this.getHomePos()) != null) {
            CreakingHeartBlockEntity creakingHeartBlockEntity;
            boolean bl;
            BlockEntity blockEntity = this.net_minecraft_world_World_getWorld().getBlockEntity(blockPos);
    ...
    protected void updatePostDeath() {
        if (this.isTransient() && this.isCrumbling()) {
            ++this.deathTime;
            if (!this.net_minecraft_world_World_getWorld().isClient() && this.deathTime > 45 && !this.isRemoved()) {
    ...
    extends LandPathNodeMaker {
        final static private int field_54896 = 1024;
