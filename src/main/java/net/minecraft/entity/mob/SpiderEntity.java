...
extends HostileEntity {
    final static private TrackedData<Byte> SPIDER_FLAGS = DataTracker.registerData(SpiderEntity.class, TrackedDataHandlerRegistry.BYTE);
    final static private float field_30498 = 0.1f;
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        if (random.nextInt(100) == 0 && (skeletonEntity = EntityType.SKELETON.create(this.net_minecraft_world_World_getWorld(), SpawnReason.JOCKEY)) != null) {
