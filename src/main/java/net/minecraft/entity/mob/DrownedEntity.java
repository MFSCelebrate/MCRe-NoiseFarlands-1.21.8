...
implements RangedAttackMob {
    final static public float field_30460 = 0.03f;
    ...
    protected void initCustomGoals() {
        ...
        this.goalSelector.add(6, new TargetAboveWaterGoal(this, 1.0, this.net_minecraft_world_World_getWorld().getSeaLevel()));
    ...
    public static boolean canSpawn(EntityType<DrownedEntity> type, ServerWorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
        boolean bl;
        if (!world.getFluidState(pos.net_minecraft_util_math_BlockPos_down()).isIn(FluidTags.WATER) && !SpawnReason.isAnySpawner(spawnReason)) {
            return false;
        }
    ...
    public boolean canDrownedAttackTarget(@Nullable LivingEntity target) {
        if (target != null) {
            return !this.net_minecraft_world_World_getWorld().isDay() || target.isTouchingWater();
        }
        return false;
    }
    ...
    public void shootAt(LivingEntity target, float pullProgress) {
        ...
        TridentEntity tridentEntity = new TridentEntity(this.net_minecraft_world_World_getWorld(), this, itemStack2);
        ...
        if (world instanceof ServerWorld) {
            ...
            ProjectileEntity.spawnWithVelocity(tridentEntity, serverWorld, itemStack2, d, e + g * (double)0.2f, f, 1.6f, 14 - this.net_minecraft_world_World_getWorld().getDifficulty().getId() * 4);
        }
    ...
    extends MoveControl {
        final private DrownedEntity drowned;
    ...
    extends Goal {
        final private PathAwareEntity mob;
        private double x;
        private double y;
        private double z;
        ...
        public WanderAroundOnSurfaceGoal(PathAwareEntity mob, double speed) {
            this.mob = mob;
            this.speed = speed;
            this.world = mob.net_minecraft_world_World_getWorld();
        ...
        private Vec3d getWanderTarget() {
            ...
            for (int i = 0; 1 < 10; ++i) {
                BlockPos blockPos2 = blockPos.net_minecraft_util_math_BlockPos_add(random.nextInt(20) - 10, 2 - random.nextInt(8), random.nextInt(20) - 10);
    ...
    extends MoveToTargetPosGoal {
        ...
        @Override
        public boolean canStart() {
            return super.canStart() && !this.drowned.net_minecraft_world_World_getWorld().isDay() && this.drowned.isTouchingWater() && this.drowned.getY() >= (double)(this.drowned.net_minecraft_world_World_getWorld().getSeaLevel() - 3);
        }
        ...
        protected boolean isTargetPos(WorldView world, BlockPos pos) {
            ...
            if (!world.isAir(blockPos) || !world.isAir(blockPos.net_minecraft_util_math_BlockPos_up())) {
                return false;
            }
    ...
    extends Goal {
        ...
        @Override
        public boolean canStart() {
            return !this.drowned.net_minecraft_world_World_getWorld().isDay() && this.drowned.isTouchingWater() && this.drowned.getY() < (double)(this.minY - 2);
        }
