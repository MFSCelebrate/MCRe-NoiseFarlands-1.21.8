...
extends AbstractHorseEntity {
    final private SkeletonHorseTrapTriggerGoal trapTriggerGoal = new SkeletonHorseTrapTriggerGoal(this);
    final static private int DESPAWN_AGE = 18000;
    final static private boolean DEFAULT_TRAPPED = false;
    final static private int DEFAULT_TRAP_TIME = 0;
    final static private EntityDimensions BABY_BASE_DIMENSIONS = EntityType.SKELETON_HORSE.getDimensions().withAttachments(EntityAttachments.builder().add(EntityAttachmentType.PASSENGER, 0.0f, EntityType.SKELETON_HORSE.getHeight() - 0.03125f, 0.0f)).scaled(0.5f);
