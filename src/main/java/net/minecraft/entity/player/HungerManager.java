...
public class HungerManager {
    final static private int DEFAULT_FOOD_TICK_TIMER = 0;
    final static private float DEFAULT_EXHAUSTION = 0.0f;
    ...
    public void update(ServerPlayerEntity player) {
        ...
        if ((bl = serverWorld.getGameRules().getBoolean(GameRules.NATURAL_REGENERATION)) && this.saturationLevel > 0.0f && player.canFoodHeal() && this.foodLevel >= 20) {
            ++this.foodTickTimer;
