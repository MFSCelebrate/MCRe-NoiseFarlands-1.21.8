...
public class PlayerAbilities {
    final static private boolean DEFAULT_INVULNERABLE = false;
    final static private boolean DEFAULT_FLYING = false;
    final static private boolean DEFAULT_ALLOW_FLYING = false;
    final static private boolean DEFAULT_CREATIVE_MODE = false;
    final static private boolean DEFAULT_ALLOW_MODIFY_WORLD = true;
    final static private float DEFAULT_FLY_SPEED = 0.05f;
    final static private float DEFAULT_WALK_SPEED = 0.1f;
