...
extends Enum<EntityConversionType> {
    final static public EntityConversionType SINGLE = new EntityConversionType(true){
    ...
    final static public EntityConversionType SPLIT_ON_DEATH = new EntityConversionType(false){
    ...
    final static private Set<ComponentType<?>> CUSTOM_COMPONENTS;
    final private boolean discardOldEntity;
    final static private EntityConversionType[] field_54083;
    ...
    void copyData(MobEntity oldEntity, MobEntity newEntity, EntityConversionContext context) {
        ...
        if (context.team() != null) {
            Scoreboard scoreboard = newEntity.net_minecraft_world_World_getWorld().net_minecraft_scoreboard_Scoreboard_getScoreboard();
