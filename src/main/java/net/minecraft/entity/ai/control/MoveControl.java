...
implements Control {
    final static public float field_30197 = 5.0E-4f;
    final static public float REACHED_DESTINATION_DISTANCE_SQUARED = 2.5000003E-7f;
    final static protected int field_30199 = 90;
    ...
    public void tick() {
        if (this.state == State.STRAFE) {
            ...
            BlockState blockState = this.entity.net_minecraft_world_World_getWorld().getBlockState(blockPos);
            VoxelShape voxelShape = blockState.getCollisionShape(this.entity.net_minecraft_world_World_getWorld(), blockPos);
    ...
    extends Enum<State> {
        final static public State WAIT = new State();
        final static public State MOVE_TO = new State();
        final static public State STRAFE = new State();
        final static public State JUMPING = new State();
        final static private State[] field_6375;
