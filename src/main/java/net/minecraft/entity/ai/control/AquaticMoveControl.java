...
extends MoveControl {
    final static private float field_40123 = 10.0f;
    final static private float field_40124 = 60.0f;
    final private int pitchChange;
    final private int yawChange;
    final private float speedInWater;
    final private float speedInAir;
    final private boolean buoyant;
