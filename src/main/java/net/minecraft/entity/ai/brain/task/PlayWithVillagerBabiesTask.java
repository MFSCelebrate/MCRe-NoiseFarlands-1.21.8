...
public class PlayWithVillagerBabiesTask {
    final static private int HORIZONTAL_RANGE = 20;
    final static private int VERTICAL_RANGE = 8;
    final static private float WALK_SPEED = 0.6f;
    final static private float PLAYING_WALK_SPEED = 0.6f;
    final static private int MAX_BABY_INTERACTION_COUNT = 5;
    final static private int RUN_CHANCE = 10;
