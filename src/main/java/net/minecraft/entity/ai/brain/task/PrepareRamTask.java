...
extends MultiTickTask<E> {
    final static public int RUN_TIME = 160;
    final private ToIntFunction<E> cooldownFactory;
    final private int minRamDistance;
    final private int maxRamDistance;
    final private float speed;
    final private TargetPredicate targetPredicate;
    final private int prepareTime;
    final private Function<E, SoundEvent> soundFactory;
    ...
    public static class Ram {
        final private BlockPos start;
        final private BlockPos end;
