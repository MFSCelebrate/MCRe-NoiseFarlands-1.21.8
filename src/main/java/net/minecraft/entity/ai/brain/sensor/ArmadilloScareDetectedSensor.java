...
extends Sensor<T> {
    final private BiPredicate<T, LivingEntity> threateningEntityPredicate;
    final private Predicate<T> canRollUpPredicate;
    final private MemoryModuleType<Boolean> memoryModuleType;
    final private int expiry;
