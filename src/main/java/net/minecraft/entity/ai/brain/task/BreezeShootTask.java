...
extends MultiTickTask<BreezeEntity> {
    final static private int MAX_SQUARED_RANGE = 256;
    final static private int BASE_PROJECTILE_DIVERGENCY = 5;
    final static private int PROJECTILE_DIVERGENCY_DIFFICULTY_MODIFIER = 4;
    final static private float PROJECTILE_SPEED = 0.7f;
    final static private int SHOOT_CHARGING_EXPIRY = Math.round(15.0f);
    final static private int RECOVER_EXPIRY = Math.round(4.0f);
    final static private int SHOOT_COOLDOWN_EXPIRY = Math.round(10.0f);
