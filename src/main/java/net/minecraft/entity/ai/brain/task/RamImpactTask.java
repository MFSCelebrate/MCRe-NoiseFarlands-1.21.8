...
extends MultiTickTask<GoatEntity> {
    final static public int RUN_TIME = 200;
    final static public float SPEED_STRENGTH_MULTIPLIER = 1.65f;
    final private Function<GoatEntity, UniformIntProvider> cooldownRangeFactory;
    final private TargetPredicate targetPredicate;
    final private float speed;
    final private ToDoubleFunction<GoatEntity> strengthMultiplierFactory;
    private Vec3d direction;
    final private Function<GoatEntity, SoundEvent> impactSoundFactory;
    final private Function<GoatEntity, SoundEvent> hornBreakSoundFactory;
    ...
    private boolean shouldSnapHorn(ServerWorld world, GoatEntity goat) {
        ...
        return world.getBlockState(blockPos).isIn(BlockTags.SNAPS_GOAT_HORN) || world.getBlockState(blockPos.net_minecraft_util_math_BlockPos_up()).isIn(BlockTags.SNAPS_GOAT_HORN);
    }
