...
extends MultiTickTask<PathAwareEntity> {
    final static public int TEMPTATION_COOLDOWN_TICKS = 100;
    final static public double DEFAULT_STOP_DISTANCE = 2.5;
    final static public double LARGE_ENTITY_STOP_DISTANCE = 3.5;
    final private Function<LivingEntity, Float> speed;
    final private Function<LivingEntity, Double> stopDistanceGetter;
    final private boolean useEyeHeight;
