...
extends MultiTickTask<E> {
    final static private int COMPLETION_RANGE = 3;
    final static private int ITEM_PICKUP_COOLDOWN_TICKS = 60;
    final private Function<LivingEntity, Optional<LookTarget>> lookTargetFunction;
    ...
    private void triggerCriterion(LookTarget target, ItemStack stack, ServerPlayerEntity player) {
        BlockPos blockPos = target.getBlockPos().net_minecraft_util_math_BlockPos_down();
