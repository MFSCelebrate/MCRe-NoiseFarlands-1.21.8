...
public class VillagerTaskListProvider {
    final static private float JOB_WALKING_SPEED = 0.4f;
    final static public int field_48329 = 5;
    final static public int field_48330 = 2;
    final static public float field_48331 = 0.5f;
