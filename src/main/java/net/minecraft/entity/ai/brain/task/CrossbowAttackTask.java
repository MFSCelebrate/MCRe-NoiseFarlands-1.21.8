...
extends MultiTickTask<E> {
    final static private int RUN_TIME = 1200;
    ...
    extends Enum<CrossbowState> {
        final static public CrossbowState UNCHARGED = new CrossbowState();
        final static public CrossbowState CHARGING = new CrossbowState();
        final static public CrossbowState CHARGED = new CrossbowState();
        final static public CrossbowState READY_TO_ATTACK = new CrossbowState();
        final static private CrossbowState[] field_22299;
