...
extends MultiTickTask<AnimalEntity> {
    final static private int MAX_RANGE = 3;
    final static private int MIN_BREED_TIME = 60;
    final static private int RUN_TIME = 110;
    final private EntityType<? extends AnimalEntity> targetType;
    final private float speed;
    final private int approachDistance;
    final static private int DEFAULT_APPROACH_DISTANCE = 2;
