...
implements Task<E> {
    final private Map<MemoryModuleType<?>, MemoryModuleState> requiredMemoryState;
    final private Set<MemoryModuleType<?>> memoriesToForgetWhenStopped;
    final private Order order;
    final private RunMode runMode;
    final private WeightedList<Task<? super E>> tasks = new WeightedList();
    ...
    extends Enum<Order> {
        final static public Order ORDERED = new Order(list -> {});
        final static public Order SHUFFLED = new Order(WeightedList::shuffle);
        final private Consumer<WeightedList<?>> listModifier;
        final static private Order[] field_18351;
    ...
    extends Enum<RunMode> {
        final static public RunMode RUN_ONE = new RunMode(){
        ...
        final static public RunMode TRY_ALL = new RunMode(){
        ...
        final static private RunMode[] field_18857;
