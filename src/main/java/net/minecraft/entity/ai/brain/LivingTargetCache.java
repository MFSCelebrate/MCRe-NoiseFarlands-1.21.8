...
public class LivingTargetCache {
    final static private LivingTargetCache EMPTY = new LivingTargetCache();
    final private List<LivingEntity> entities;
    final private Predicate<LivingEntity> targetPredicate;
