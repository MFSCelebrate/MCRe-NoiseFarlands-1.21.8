...
extends MultiTickTask<WardenEntity> {
    final static private int HORIZONTAL_RANGE = 15;
    final static private int VERTICAL_RANGE = 20;
    final static private double field_38852 = 0.5;
    final static private double field_38853 = 2.5;
    final static public int COOLDOWN = 40;
    final static private int SOUND_DELAY = MathHelper.ceil(34.0);
    final static private int RUN_TIME = MathHelper.ceil(60.0f);
