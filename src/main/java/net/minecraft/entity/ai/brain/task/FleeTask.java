...
extends MultiTickTask<E> {
    final static private int MIN_RUN_TIME = 100;
    final static private int MAX_RUN_TIME = 120;
    final static private int HORIZONTAL_RANGE = 5;
    final static private int VERTICAL_RANGE = 4;
    final private float speed;
    final private Function<PathAwareEntity, TagKey<DamageType>> entityToDangerousDamageTypes;
    final private Function<E, Vec3d> pathFinder;
    ...
    public FleeTask(float speed, int startHeight) {
        this(speed, entity -> DamageTypeTags.PANIC_CAUSES, entity -> NoPenaltySolidTargeting.find(entity, 5, 4, startHeight, entity.getRotationVec(0.0f).x, entity.getRotationVec(0.0f).z, 1.5707963705062866));
    }
