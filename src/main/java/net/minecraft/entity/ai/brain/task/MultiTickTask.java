...
implements Task<E> {
    final static public int DEFAULT_RUN_TIME = 60;
    final protected Map<MemoryModuleType<?>, MemoryModuleState> requiredMemoryStates;
    private Status status = Status.STOPPED;
    private long endTime;
    final private int minRunTime;
    final private int maxRunTime;
    ...
    extends Enum<Status> {
        final static public Status STOPPED = new Status();
        final static public Status RUNNING = new Status();
        final static private Status[] field_18339;
