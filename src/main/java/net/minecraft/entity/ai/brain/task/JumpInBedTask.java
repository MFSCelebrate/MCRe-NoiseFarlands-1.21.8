...
extends MultiTickTask<MobEntity> {
    final static private int MAX_TICKS_OUT_OF_BED = 100;
    final static private int MIN_JUMP_TICKS = 3;
    final static private int JUMP_TIME_VARIANCE = 6;
    final static private int TICKS_TO_NEXT_JUMP = 5;
