...
public class WalkTowardsFuzzyPosTask {
    private static BlockPos fuzz(MobEntity mob, BlockPos pos) {
        Random random = mob.net_minecraft_world_World_getWorld().random;
        return pos.net_minecraft_util_math_BlockPos_add(WalkTowardsFuzzyPosTask.fuzz(random), 0, WalkTowardsFuzzyPosTask.fuzz(random));
    }
