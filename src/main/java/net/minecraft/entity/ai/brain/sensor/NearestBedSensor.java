...
extends Sensor<MobEntity> {
    final static private int REMEMBER_TIME = 40;
    final static private int MAX_TRIES = 5;
    final static private int MAX_EXPIRY_TIME = 20;
    final private Long2LongMap positionToExpiryTime = new Long2LongOpenHashMap();
    private int tries;
