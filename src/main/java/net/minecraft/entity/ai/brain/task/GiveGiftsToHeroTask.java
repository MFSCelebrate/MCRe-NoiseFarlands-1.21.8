...
extends MultiTickTask<VillagerEntity> {
    ...
    private void giveGifts(ServerWorld world2, VillagerEntity villager, LivingEntity recipient) {
        villager.forEachGiftedItem(world2, GiveGiftsToHeroTask.getGiftLootTable(villager), (world, stack) -> TargetUtil.give(villager, stack, recipient.getPos()));
    }
