...
extends MultiTickTask<E> {
    final static protected int MAX_TARGET_SEARCH_TIME = 20;
    final static private int JUMP_WINDUP_TIME = 40;
    final static protected int PATHING_DISTANCE = 8;
    final static private int RUN_TIME = 200;
    final static private List<Integer> RAM_RANGES = Lists.newArrayList((Object[])new Integer[]{65, 70, 75, 80});
    final private UniformIntProvider cooldownRange;
    final protected int verticalRange;
    final protected int horizontalRange;
    final protected float maxRange;
    ...
    final private Function<E, SoundEvent> entityToSound;
    final private BiPredicate<E, BlockPos> jumpToPredicate;
    ...
    public static <E extends MobEntity> boolean shouldJumpTo(E entity, BlockPos pos) {
        ...
        return world.getBlockState(blockPos = pos.net_minecraft_util_math_BlockPos_down()).isOpaqueFullCube() && entity.getPathfindingPenalty(LandPathNodeMaker.getLandNodeType(entity, pos)) == 0.0f;
    }
    ...
    protected boolean shouldKeepRunning(ServerWorld serverWorld, MobEntity mobEntity, long l) {
        boolean bl;
        boolean bl2 = bl = this.startPos.isPresent() && this.startPos.get().equals(mobEntity.getPos()) && this.targetSearchTime > 0 && !mobEntity.isTouchingWater() && (this.currentTarget != null || !this.potentialTargets.isEmpty());
    ...
    protected void run(ServerWorld serverWorld, E mobEntity, long l) {
        ...
        this.startPos = Optional.of(((Entity)mobEntity).getPos());
