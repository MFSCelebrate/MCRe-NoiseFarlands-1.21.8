...
extends Goal {
    final static private TargetPredicate TEMPTING_ENTITY_PREDICATE = TargetPredicate.createNonAttackable().ignoreVisibility();
    final static private double DEFAULT_RANGE = 2.5;
    final private TargetPredicate predicate;
    final protected MobEntity mob;
    ...
    final private Predicate<ItemStack> temptItemPredicate;
    final private boolean canBeScared;
    ...
    TemptGoal(MobEntity entity, double speed, Predicate<ItemStack> temptItemPredicate, boolean canBeScared, double range) {
        this.mob = entity;
        this.speed = speed;
