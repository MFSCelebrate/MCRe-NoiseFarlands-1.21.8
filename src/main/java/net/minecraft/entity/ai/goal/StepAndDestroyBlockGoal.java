...
extends MoveToTargetPosGoal {
    final private Block targetBlock;
    final private MobEntity stepAndDestroyMob;
    private int counter;
    final static private int MAX_COOLDOWN = 20;
    ...
    public void tick() {
        super.tick();
        World world = this.stepAndDestroyMob.net_minecraft_world_World_getWorld();
    ...
    private BlockPos tweakToProperPos(BlockPos pos, BlockView world) {
        ...
        for (BlockPos blockPos : blockPoss = new BlockPos[]{pos.net_minecraft_util_math_BlockPos_down(), pos.net_minecraft_util_math_BlockPos_west(), pos.net_minecraft_util_math_BlockPos_east(), pos.net_minecraft_util_math_BlockPos_north(), pos.net_minecraft_util_math_BlockPos_south(), pos.net_minecraft_util_math_BlockPos_down().net_minecraft_util_math_BlockPos_down()}) {
    ...
    protected boolean isTargetPos(WorldView world, BlockPos pos) {
        ...
        if (chunk != null) {
            return chunk.getBlockState(pos).isOf(this.targetBlock) && chunk.getBlockState(pos.net_minecraft_util_math_BlockPos_up()).isAir() && chunk.getBlockState(pos.net_minecraft_util_math_BlockPos_up(2)).isAir();
        }
        return false;
    }
}
