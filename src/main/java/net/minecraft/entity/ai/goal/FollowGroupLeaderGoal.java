...
extends Goal {
    final static private int MIN_SEARCH_DELAY = 200;
    final private SchoolingFishEntity fish;
    ...
    public boolean canStart() {
        ...
        List<SchoolingFishEntity> list = this.fish.net_minecraft_world_World_getWorld().getEntitiesByClass(this.fish.getClass(), this.fish.getBoundingBox().expand(8.0, 8.0, 8.0), predicate);
