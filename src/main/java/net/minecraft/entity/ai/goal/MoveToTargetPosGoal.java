...
extends Goal {
    final static private int MIN_WAITING_TIME = 1200;
    final static private int MAX_TRYING_TIME = 1200;
    final static private int MIN_INTERVAL = 200;
    final protected PathAwareEntity mob;
    ...
    final private int maxYDifference;
    ...
    public boolean shouldContinue() {
        return this.tryingTime >= -this.safeWaitingTime && this.tryingTime <= 1200 && this.isTargetPos(this.mob.net_minecraft_world_World_getWorld(), this.targetPos);
    }
    ...
    protected BlockPos getTargetPos() {
        return this.targetPos.net_minecraft_util_math_BlockPos_up();
    }
            ...
            for (int l = 0; l < i; ++l) {
                ...
                while (m <= l) {
                    ...
                    while (n <= l) {
                        ...
                        if (this.mob.isInPositionTargetRange(mutable) && this.isTargetPos(this.mob.net_minecraft_world_World_getWorld(), mutable)) {
