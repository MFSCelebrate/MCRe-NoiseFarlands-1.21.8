...
extends Goal {
    final public LlamaEntity llama;
    private double speed;
    final static private int MAX_CARAVAN_LENGTH = 8;
    private int counter;
    ...
    public boolean canStart() {
        ...
        List<Entity> list = this.llama.net_minecraft_world_World_getWorld().getOtherEntities(this.llama, this.llama.getBoundingBox().expand(9.0, 4.0, 9.0), entity -> {
