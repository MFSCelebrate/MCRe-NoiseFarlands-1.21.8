...
extends Goal {
    final static public int HORIZONTAL_CHECK_RANGE = 8;
    final static public int VERTICAL_CHECK_RANGE = 4;
    final static public int MIN_DISTANCE = 3;
    final private AnimalEntity animal;
    @Nullable
    ...
    public boolean canStart() {
        ...
        List<?> list = this.animal.net_minecraft_world_World_getWorld().getNonSpectatingEntities(this.animal.getClass(), this.animal.getBoundingBox().expand(8.0, 4.0, 8.0));
