...
extends Goal {
    final static public UniformIntProvider COOLDOWN_RANGE = TimeHelper.betweenSeconds(1, 2);
    final private T actor;
    private Stage stage = Stage.UNCHARGED;
    final private double speed;
    final private float squaredRange;
    ...
    extends Enum<Stage> {
        final static public Stage UNCHARGED = new Stage();
        final static public Stage CHARGING = new Stage();
        final static public Stage CHARGED = new Stage();
        final static public Stage READY_TO_ATTACK = new Stage();
        final static private Stage[] field_16531;
