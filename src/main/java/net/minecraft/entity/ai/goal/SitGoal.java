...
extends Goal {
    final private TameableEntity tameable;
    ...
    public boolean canStart() {
        ...
        if (livingEntity == null || livingEntity.net_minecraft_world_World_getWorld() != this.tameable.net_minecraft_world_World_getWorld()) {
            return true;
        }
