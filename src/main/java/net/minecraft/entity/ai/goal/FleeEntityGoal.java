...
extends Goal {
    ...
    final private double slowSpeed;
    final private double fastSpeed;
    @Nullable
    protected T targetEntity;
    final protected float fleeDistance;
    @Nullable
    protected Path fleePath;
    final protected EntityNavigation fleeingEntityNavigation;
    final protected Class<T> classToFleeFrom;
    final protected Predicate<LivingEntity> extraInclusionSelector;
    final protected Predicate<LivingEntity> inclusionSelector;
    final private TargetPredicate withinRangePredicate;
