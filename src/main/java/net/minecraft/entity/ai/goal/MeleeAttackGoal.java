...
extends Goal {
    ...
    final private boolean pauseWhenMobIdle;
    private Path path;
    ...
    final private int attackIntervalTicks = 20;
    private long lastUpdateTime;
    final static private long MAX_ATTACK_TIME = 20L;
    ...
    public boolean canStart() {
        long l = this.mob.net_minecraft_world_World_getWorld().getTime();
