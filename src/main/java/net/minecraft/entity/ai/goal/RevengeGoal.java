...
extends TrackTargetGoal {
    final static private TargetPredicate VALID_AVOIDABLES_PREDICATE = TargetPredicate.createAttackable().ignoreVisibility().ignoreDistanceScalingFactor();
    final static private int BOX_VERTICAL_EXPANSION = 10;
    private boolean groupRevenge;
    private int lastAttackedTime;
    final private Class<?>[] noRevengeTypes;
    @Nullable
    ...
    protected void callSameTypeForRevenge() {
        ...
        List<Entity> list = this.mob.net_minecraft_world_World_getWorld().getEntitiesByClass(this.mob.getClass(), box, EntityPredicates.EXCEPT_SPECTATOR);
