...
public class GoalSelector {
    final static private PrioritizedGoal REPLACEABLE_GOAL = new PrioritizedGoal(Integer.MAX_VALUE, new Goal(){
    ...
    final private Map<Goal.Control, PrioritizedGoal> goalsByControl = new EnumMap<Goal.Control, PrioritizedGoal>(Goal.Control.class);
    final private Set<PrioritizedGoal> goals = new ObjectLinkedOpenHashSet();
    final private EnumSet<Goal.Control> disabledControls = EnumSet.noneOf(Goal.Control.class);
