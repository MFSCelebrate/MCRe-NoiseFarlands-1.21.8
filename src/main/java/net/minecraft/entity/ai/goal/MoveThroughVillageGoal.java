...
extends Goal {
    ...
    final private boolean requiresNighttime;
    final private List<BlockPos> visitedTargets = Lists.newArrayList();
    final private int distance;
    final private BooleanSupplier doorPassingThroughGetter;
    ...
    public boolean canStart() {
        ...
        if (this.requiresNighttime && this.mob.net_minecraft_world_World_getWorld().isDay()) {
            return false;
        }
        ...
        for (int i = 0; i < this.targetPath.getLength(); ++i) {
            ...
            if (!DoorBlock.canOpenByHand(this.mob.net_minecraft_world_World_getWorld(), blockPos2)) continue;
