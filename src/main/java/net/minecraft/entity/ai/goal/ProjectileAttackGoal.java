...
extends Goal {
    ...
    final private RangedAttackMob owner;
    @Nullable
    private LivingEntity target;
    private int updateCountdownTicks = -1;
    final private double mobSpeed;
    private int seenTargetTicks;
    final private int minIntervalTicks;
    final private int maxIntervalTicks;
    final private float maxShootRange;
    final private float squaredMaxShootRange;
