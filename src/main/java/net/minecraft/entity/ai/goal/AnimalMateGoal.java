...
extends Goal {
    final static private TargetPredicate VALID_MATE_PREDICATE = TargetPredicate.createNonAttackable().setBaseMaxDistance(8.0).ignoreVisibility();
    final protected AnimalEntity animal;
    final private Class<? extends AnimalEntity> entityClass;
    final protected ServerWorld world;
    @Nullable
