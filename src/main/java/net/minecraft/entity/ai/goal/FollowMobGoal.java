...
extends Goal {
    ...
    final private Predicate<MobEntity> targetPredicate;
    @Nullable
    private MobEntity target;
    final private double speed;
    final private EntityNavigation navigation;
    ...
    public boolean canStart() {
        List<MobEntity> list = this.mob.net_minecraft_world_World_getWorld().getEntitiesByClass(MobEntity.class, this.mob.getBoundingBox().expand(this.maxDistance), this.targetPredicate);
        if (!list.isEmpty()) {
