...
extends Goal {
    ...
    final private T mob;
    final private boolean triggerOthers;
    ...
    public boolean canStart() {
        return UniversalAngerGoal.getServerWorld(this.mob).getGameRules().getBoolean(GameRules.UNIVERSAL_ANGER) && this.canStartUniversalAnger();
    }
    ...
    private List<? extends MobEntity> getOthersInRange() {
        ...
        return ((Entity)this.mob).net_minecraft_world_World_getWorld().getEntitiesByClass(this.mob.getClass(), box, EntityPredicates.EXCEPT_SPECTATOR);
    }
}
