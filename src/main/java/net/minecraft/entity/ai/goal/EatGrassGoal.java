...
extends Goal {
    final static private int MAX_TIMER = 40;
    final static private Predicate<BlockState> EDIBLE_PREDICATE = state -> state.isIn(BlockTags.EDIBLE_FOR_SHEEP);
    final private MobEntity mob;
    ...
    public boolean canStart() {
        ...
        return this.world.getBlockState(blockPos.net_minecraft_util_math_BlockPos_down()).isOf(Blocks.GRASS_BLOCK);
    }
