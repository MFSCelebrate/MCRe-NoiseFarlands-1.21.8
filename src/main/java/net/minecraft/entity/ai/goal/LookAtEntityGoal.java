...
extends Goal {
    final static public float DEFAULT_CHANCE = 0.02f;
    final protected MobEntity mob;
    @Nullable
    protected Entity target;
    final protected float range;
    private int lookTime;
    final protected float chance;
    final private boolean lookForward;
    final protected Class<? extends LivingEntity> targetType;
    final protected TargetPredicate targetPredicate;
