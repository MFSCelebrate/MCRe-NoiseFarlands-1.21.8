...
extends Goal {
    final static private int field_30228 = 10;
    final private PathAwareEntity mob;
    final private int searchRange;
    @Nullable
    ...
    public boolean canStart() {
        ...
        if (this.mob.net_minecraft_world_World_getWorld().isDay()) {
            return false;
        }
    ...
    public void tick() {
        ...
        if (entityNavigation.isIdle() && !this.targetPosition.isWithinDistance(this.mob.getPos(), 10.0)) {
            ...
            blockPos = this.mob.net_minecraft_world_World_getWorld().getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, blockPos);
    ...
    private void findOtherWaypoint() {
        ...
        BlockPos blockPos = this.mob.net_minecraft_world_World_getWorld().getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, this.mob.getBlockPos().net_minecraft_util_math_BlockPos_add(-8 + random.nextInt(16), 0, -8 + random.nextInt(16)));
