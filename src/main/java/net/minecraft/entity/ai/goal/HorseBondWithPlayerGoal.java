...
extends Goal {
    final private AbstractHorseEntity horse;
    ...
    public void tick() {
        if (!this.horse.isTame() && this.horse.getRandom().nextInt(this.getTickCount(50)) == 0) {
            ...
            if (entity instanceof PlayerEntity) {
                ...
                if (j > 0 && this.horse.getRandom().nextInt(j) < 1) {
            ...
            this.horse.net_minecraft_world_World_getWorld().sendEntityStatus(this.horse, EntityStatuses.ADD_NEGATIVE_PLAYER_REACTION_PARTICLES);
        }
    }
}
