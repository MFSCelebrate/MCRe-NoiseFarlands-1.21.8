...
extends TrackTargetGoal {
    final static private int DEFAULT_RECIPROCAL_CHANCE = 10;
    final protected Class<T> targetClass;
    final protected int reciprocalChance;
    @Nullable
