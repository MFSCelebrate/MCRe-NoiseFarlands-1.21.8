...
extends Goal {
    ...
    final static private int CAN_TRACK = 1;
    final static private int CANNOT_TRACK = 2;
    final protected MobEntity mob;
    final protected boolean checkVisibility;
    final private boolean checkCanNavigate;
    ...
    private boolean canNavigateToEntity(LivingEntity entity) {
        ...
        return (double)(1 + (j = pathNode.z - entity.getBlockZ()) * j) <= 2.25;
    }
