...
public class TargetPredicate {
    final static public TargetPredicate DEFAULT = TargetPredicate.createAttackable();
    final static private double MIN_DISTANCE = 2.0;
    final private boolean attackable;
