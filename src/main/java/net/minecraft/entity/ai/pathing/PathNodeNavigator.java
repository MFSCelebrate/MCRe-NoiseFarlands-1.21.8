...
public class PathNodeNavigator {
    final static private float TARGET_DISTANCE_MULTIPLIER = 1.5f;
    final private PathNode[] successors = new PathNode[32];
    private int range;
    final private PathNodeMaker pathNodeMaker;
    final static private boolean field_31808 = false;
    final private PathMinHeap minHeap = new PathMinHeap();
