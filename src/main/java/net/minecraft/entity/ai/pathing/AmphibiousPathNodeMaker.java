...
extends LandPathNodeMaker {
    final private boolean penalizeDeepWater;
    ...
    public int getSuccessors(PathNode[] successors, PathNode node) {
        ...
        for (int k = 0; k < 1; ++k) {
            ...
            if (pathNode3.type != PathNodeType.WATER || !this.penalizeDeepWater || pathNode3.y >= this.entity.net_minecraft_world_World_getWorld().getSeaLevel() - 10) continue;
