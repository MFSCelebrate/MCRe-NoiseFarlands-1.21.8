...
public abstract class EntityNavigation {
    final static private int RECALCULATE_COOLDOWN = 20;
    final static private int field_41545 = 100;
    final static private float field_41546 = 0.25f;
    final protected MobEntity entity;
    ...
    final private PathNodeNavigator pathNodeNavigator;
    ...
    protected Path findPathToAny(Set<BlockPos> positions, int range, boolean useHeadPos, int distance, float followRange) {
        ...
        BlockPos blockPos = useHeadPos ? this.entity.getBlockPos().net_minecraft_util_math_BlockPos_up() : this.entity.getBlockPos();
        int i = (int)(followRange + (float)range);
        ChunkCache chunkCache = new ChunkCache(this.world, blockPos.net_minecraft_util_math_BlockPos_add(-i, -i, -i), blockPos.net_minecraft_util_math_BlockPos_add(i, i, i));
    ...
    protected double adjustTargetY(Vec3d pos) {
        ...
        return this.world.getBlockState(blockPos.net_minecraft_util_math_BlockPos_down()).isAir() ? pos.y : LandPathNodeMaker.getFeetY(this.world, blockPos);
    }
    ...
    protected static boolean doesNotCollide(MobEntity entity, Vec3d startPos, Vec3d entityPos, boolean includeFluids) {
        ...
        return entity.net_minecraft_world_World_getWorld().raycast(new RaycastContext(startPos, vec3d, RaycastContext.ShapeType.COLLIDER, includeFluids ? RaycastContext.FluidHandling.ANY : RaycastContext.FluidHandling.NONE, entity)).getType() == HitResult.Type.MISS;
    }
