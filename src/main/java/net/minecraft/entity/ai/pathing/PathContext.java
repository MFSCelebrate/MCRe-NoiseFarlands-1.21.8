...
public class PathContext {
    ...
    @Nullable
    final private PathNodeTypeCache nodeTypeCache;
    final private BlockPos entityPos;
    final private BlockPos.Mutable lastNodePos = new BlockPos.Mutable();

    public PathContext(CollisionView world, MobEntity entity) {
        this.world = world;
        World world2 = entity.net_minecraft_world_World_getWorld();
