...
public abstract class PathNodeMaker {
    ...
    final protected Int2ObjectMap<PathNode> pathNodeCache = new Int2ObjectOpenHashMap();
    ...
    public PathNodeType getDefaultNodeType(MobEntity entity, BlockPos pos) {
        return this.getDefaultNodeType(new PathContext(entity.net_minecraft_world_World_getWorld(), entity), pos.getX(), pos.getY(), pos.getZ());
    }
