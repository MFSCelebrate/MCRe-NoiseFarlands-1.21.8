...
public class PathNodeTypeCache {
    final static private int field_49417 = 4096;
    final static private int field_49418 = 4095;
    final private long[] positions = new long[4096];
    final private PathNodeType[] cache = new PathNodeType[4096];
