...
public class Path {
    final private List<PathNode> nodes;
    @Nullable
    private DebugNodeInfo debugNodeInfos;
    private int currentNodeIndex;
    final private BlockPos target;
    final private float manhattanDistanceFromTarget;
    final private boolean reachesTarget;
    ...
    public void toBuf(PacketByteBuf buf2) {
        ...
        buf2.net_minecraft_network_PacketByteBuf_writeBoolean(this.reachesTarget);
        buf2.net_minecraft_network_PacketByteBuf_writeInt(this.currentNodeIndex);
    ...
    extends Record {
        final private PathNode[] openSet;
        final private PathNode[] closedSet;
        final Set<TargetPathNode> targetNodes;

        public DebugNodeInfo(PathNode[] pathNodes, PathNode[] pathNodes2, Set<TargetPathNode> set) {
