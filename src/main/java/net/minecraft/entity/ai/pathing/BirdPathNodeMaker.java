...
extends LandPathNodeMaker {
    final private Long2ObjectMap<PathNodeType> pathNodes = new Long2ObjectOpenHashMap();
    final static private float field_49843 = 1.0f;
    final static private float field_41681 = 1.1f;
    final static private int field_41682 = 10;
