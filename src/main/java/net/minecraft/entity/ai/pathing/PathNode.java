...
public class PathNode {
    ...
    public void write(PacketByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeInt(this.x);
        buf.net_minecraft_network_PacketByteBuf_writeInt(this.y);
        buf.net_minecraft_network_PacketByteBuf_writeInt(this.z);
        buf.net_minecraft_network_PacketByteBuf_writeFloat(this.pathLength);
        buf.net_minecraft_network_PacketByteBuf_writeFloat(this.penalty);
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.visited);
        buf.writeEnumConstant(this.type);
        buf.net_minecraft_network_PacketByteBuf_writeFloat(this.heapWeight);
    }
