...
extends PersistentProjectileEntity {
    final static private int DEFAULT_DURATION = 200;
    ...
    public void tick() {
        super.tick();
        if (this.net_minecraft_world_World_getWorld().isClient && !this.isInGround()) {
            this.net_minecraft_world_World_getWorld().addParticleClient(ParticleTypes.INSTANT_EFFECT, this.getX(), this.getY(), this.getZ(), 0.0, 0.0, 0.0);
        }
    }
