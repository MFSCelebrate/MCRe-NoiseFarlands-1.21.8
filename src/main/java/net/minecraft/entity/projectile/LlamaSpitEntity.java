...
extends ProjectileEntity {
    ...
    public void tick() {
        ...
        this.updateRotation();
        float g = 0.99f;
        if (this.net_minecraft_world_World_getWorld().getStatesInBox(this.getBoundingBox()).noneMatch(AbstractBlock.AbstractBlockState::isAir)) {
            this.discard();
            return;
        }
    ...
    public void onSpawnPacket(EntitySpawnS2CPacket packet) {
        ...
        for (int i = 0; i < 7; ++i) {
            ...
            this.net_minecraft_world_World_getWorld().addParticleClient(ParticleTypes.SPIT, this.getX(), this.getY(), this.getZ(), d * g, e, f * g);
        }
