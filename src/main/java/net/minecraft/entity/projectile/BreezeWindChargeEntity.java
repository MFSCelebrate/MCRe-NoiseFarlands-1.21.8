...
extends AbstractWindChargeEntity {
    final static private float EXPLOSION_POWER = 3.0f;
    ...
    protected void createExplosion(Vec3d pos) {
        this.net_minecraft_world_World_getWorld().createExplosion(this, null, EXPLOSION_BEHAVIOR, pos.getX(), pos.getY(), pos.getZ(), 3.0f, false, World.ExplosionSourceType.TRIGGER, ParticleTypes.GUST_EMITTER_SMALL, ParticleTypes.GUST_EMITTER_LARGE, SoundEvents.ENTITY_BREEZE_WIND_BURST);
    }
}
