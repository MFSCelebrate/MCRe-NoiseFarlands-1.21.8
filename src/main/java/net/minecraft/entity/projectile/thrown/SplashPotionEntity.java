...
extends PotionEntity {
    ...
    public void spawnAreaEffectCloud(ServerWorld world, ItemStack stack, HitResult hitResult) {
        ...
        List<LivingEntity> list = this.net_minecraft_world_World_getWorld().getNonSpectatingEntities(LivingEntity.class, box2);
            ...
            for (LivingEntity livingEntity : list) {
                ...
                for (StatusEffectInstance statusEffectInstance : iterable) {
                    ...
                    if (registryEntry.value().isInstant()) {
                        registryEntry.value().applyInstantEffect(world, this, this.net_minecraft_entity_Entity_getOwner(), livingEntity, statusEffectInstance.getAmplifier(), e);
                        continue;
                    }
