...
extends ProjectileEntity {
    final static private float field_52510 = 12.25f;
    ...
    private void tickInitialBubbleColumnCollision() {
        if (this.firstUpdate) {
            for (BlockPos blockPos : BlockPos.iterate(this.getBoundingBox())) {
                ...
                blockState.onEntityCollision(this.net_minecraft_world_World_getWorld(), blockPos, this, EntityCollisionHandler.DUMMY);
            }
        }
    }
