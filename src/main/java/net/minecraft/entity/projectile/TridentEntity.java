...
extends PersistentProjectileEntity {
    final static private TrackedData<Byte> LOYALTY = DataTracker.registerData(TridentEntity.class, TrackedDataHandlerRegistry.BYTE);
    final static private TrackedData<Boolean> ENCHANTED = DataTracker.registerData(TridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    final static private float DRAG_IN_WATER = 0.99f;
    final static private boolean DEFAULT_DEALT_DAMAGE = false;
    ...
    public void onPlayerCollision(PlayerEntity player) {
        if (this.isOwner(player) || this.net_minecraft_entity_Entity_getOwner() == null) {
