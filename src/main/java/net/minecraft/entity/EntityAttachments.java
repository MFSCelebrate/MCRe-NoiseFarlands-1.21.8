...
public class EntityAttachments {
    final private Map<EntityAttachmentType, List<Vec3d>> points;
    ...
    public static class Builder {
        final private Map<EntityAttachmentType, List<Vec3d>> points = new EnumMap<EntityAttachmentType, List<Vec3d>>(EntityAttachmentType.class);
