...
public class SaddledComponent {
    final static private int MIN_BOOST_TIME = 140;
    final static private int field_30061 = 700;
    final private DataTracker dataTracker;
    final private TrackedData<Integer> boostTime;
