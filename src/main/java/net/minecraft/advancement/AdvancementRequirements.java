...
public record AdvancementRequirements(List<List<String>> requirements) {
    final static public Codec<AdvancementRequirements> CODEC = Codec.STRING.listOf().listOf().xmap(AdvancementRequirements::new, AdvancementRequirements::requirements);
    final static public AdvancementRequirements EMPTY = new AdvancementRequirements(List.of());
    ...
    private static String method_54926(Set set, Set set2) {
    ...
    public static interface CriterionMerger {
        final static public CriterionMerger AND = AdvancementRequirements::allOf;
        final static public CriterionMerger OR = AdvancementRequirements::anyOf;
