...
extends AbstractCriterion<Conditions> {
    ...
    {
        final static public Codec<Conditions> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(Conditions::player), (App)Recipe.KEY_CODEC.fieldOf("recipe").forGetter(Conditions::recipe)).apply((Applicative)instance, Conditions::new));
