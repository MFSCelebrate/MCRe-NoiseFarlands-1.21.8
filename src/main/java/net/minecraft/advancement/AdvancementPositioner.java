...
public class AdvancementPositioner {
    ...
    @Nullable
    final private AdvancementPositioner parent;
    @Nullable
    final private AdvancementPositioner previousSibling;
    final private int childrenSize;
    final private List<AdvancementPositioner> children = Lists.newArrayList();
    ...
    private void calculateRecursively() {
        ...
        float f = (this.children.get(0).row + this.children.get((int)(this.children.size() - 1)).row) / 2.0f;
