...
public record Advancement(Optional<Identifier> parent, Optional<AdvancementDisplay> display, AdvancementRewards rewards, Map<String, AdvancementCriterion<?>> criteria, AdvancementRequirements requirements, boolean sendsTelemetryEvent, Optional<Text> name) {
    ...
    final static public PacketCodec<RegistryByteBuf, Advancement> PACKET_CODEC = PacketCodec.of(Advancement::write, Advancement::read);
    ...
    private void write(RegistryByteBuf buf) {
        ...
        buf.net_minecraft_network_PacketByteBuf_writeBoolean(this.sendsTelemetryEvent);
    }
    ...
    public static class Builder {
        ...
        final private ImmutableMap.Builder<String, AdvancementCriterion<?>> criteria = ImmutableMap.builder();
        ...
        private AdvancementRequirements method_53633(Map map) {
