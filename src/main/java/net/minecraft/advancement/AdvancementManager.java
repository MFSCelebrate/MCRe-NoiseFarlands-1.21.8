...
public class AdvancementManager {
    ...
    final private Map<Identifier, PlacedAdvancement> advancements = new Object2ObjectOpenHashMap();
    final private Set<PlacedAdvancement> roots = new ObjectLinkedOpenHashSet();
    final private Set<PlacedAdvancement> dependents = new ObjectLinkedOpenHashSet();
    @Nullable
