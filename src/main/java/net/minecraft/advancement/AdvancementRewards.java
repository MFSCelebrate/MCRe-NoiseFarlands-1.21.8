...
public record AdvancementRewards(int experience, List<RegistryKey<LootTable>> loot, List<RegistryKey<Recipe<?>>> recipes, Optional<LazyContainer> function) {
    ...
    public static class Builder {
        ...
        final private ImmutableList.Builder<RegistryKey<LootTable>> loot = ImmutableList.builder();
        final private ImmutableList.Builder<RegistryKey<Recipe<?>>> recipes = ImmutableList.builder();
