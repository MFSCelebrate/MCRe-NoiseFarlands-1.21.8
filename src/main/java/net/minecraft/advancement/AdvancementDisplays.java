...
public class AdvancementDisplays {
    final static private int DISPLAY_DEPTH = 2;
    ...
    extends Enum<Status> {
        final static public Status SHOW = new Status();
        final static public Status HIDE = new Status();
        final static public Status NO_CHANGE = new Status();
        final static private Status[] field_41741;
