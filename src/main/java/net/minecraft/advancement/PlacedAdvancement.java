...
public class PlacedAdvancement {
    final private AdvancementEntry advancementEntry;
    @Nullable
    final private PlacedAdvancement parent;
    final private Set<PlacedAdvancement> children = new ReferenceOpenHashSet();
