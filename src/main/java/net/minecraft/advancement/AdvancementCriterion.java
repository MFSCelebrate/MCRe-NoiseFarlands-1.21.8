...
public record AdvancementCriterion<T extends CriterionConditions>(Criterion<T> trigger, T conditions) {
    final static private MapCodec<AdvancementCriterion<?>> MAP_CODEC = Codecs.parameters("trigger", "conditions", Criteria.CODEC, AdvancementCriterion::trigger, AdvancementCriterion::getCodec);
    final static public Codec<AdvancementCriterion<?>> CODEC = MAP_CODEC.codec();
