...
extends Property<Boolean> {
    final static private List<Boolean> VALUES = List.of(Boolean.valueOf(true), Boolean.valueOf(false));
    final static private int TRUE_ORDINAL = 0;
    final static private int FALSE_ORDINAL = 1;
    ...
    @Override
    public int ordinal(Comparable value) {
        return this.ordinal((Boolean)value);
    }

    @Override
    public String name(Comparable value) {
