...
public abstract class Property<T extends Comparable<T>> {
    ...
    final private Codec<T> codec = Codec.STRING.comapFlatMap(value -> this.parse((String)value).map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Unable to read property: " + String.valueOf(this) + " with value: " + value)), this::name);
    final private Codec<Value<T>> valueCodec = this.codec.xmap(this::createValue, Value::value);
