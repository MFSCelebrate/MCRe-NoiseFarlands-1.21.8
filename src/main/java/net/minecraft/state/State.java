...
public abstract class State<O, S> {
    ...
    final static public String PROPERTIES = "Properties";
    final static private Function<Map.Entry<Property<?>, Comparable<?>>, String> PROPERTY_MAP_PRINTER = new Function<Map.Entry<Property<?>, Comparable<?>>, String>(){
    ...
    final protected O owner;
    final private Reference2ObjectArrayMap<Property<?>, Comparable<?>> propertyMap;
    private Map<Property<?>, S[]> withMap;
    final protected MapCodec<S> codec;
    ...
    private <T extends Comparable<T>, V extends T> S with(Property<T> property, V newValue, Comparable<?> oldValue) {
        ...
        return this.withMap.get(property)[1];
    }
