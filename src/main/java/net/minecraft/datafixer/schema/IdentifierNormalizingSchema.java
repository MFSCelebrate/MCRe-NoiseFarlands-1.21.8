...
extends Schema {
    final static public PrimitiveCodec<String> CODEC = new PrimitiveCodec<String>(){
    ...
    final static private Type<String> IDENTIFIER_TYPE = new Const.PrimitiveType(CODEC);
