...
extends IdentifierNormalizingSchema {
    final static public String SPECIAL_TYPE = "_special";
    final static protected Hook.HookFunction field_34014 = new Hook.HookFunction(){
    ...
    final static protected Hook.HookFunction field_34015 = new Hook.HookFunction(){
