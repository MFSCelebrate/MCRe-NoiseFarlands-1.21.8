...
extends Schema {
    ...
    final static Map<String, String> BLOCKS_TO_BLOCK_ENTITIES = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
    ...
    final static public Map<String, String> field_49718 = Map.of("minecraft:armor_stand", "ArmorStand", "minecraft:painting", "Painting");
    final static protected Hook.HookFunction field_5747 = new Hook.HookFunction(){
