...
extends DataFix {
    final static private String WORLD_GEN_SETTINGS_KEY = "WorldGenSettings";
    final static private List<String> SETTINGS_TO_FIX = List.of("RandomSeed", "generatorName", "generatorOptions", "generatorVersion", "legacy_custom_options", "MapFeatures", "BonusChest");
