...
extends DataFix {
    final static private Set<String> FULL_SADDLE_STACK_ENTITY_IDS = Set.of("minecraft:horse", "minecraft:skeleton_horse", "minecraft:zombie_horse", "minecraft:donkey", "minecraft:mule", "minecraft:camel", "minecraft:llama", "minecraft:trader_llama");
    final static private Set<String> BOOLEAN_SADDLE_ENTITY_IDS = Set.of("minecraft:pig", "minecraft:strider");
    final static private String OLD_NBT_KEY = "Saddle";
    final static private String NEW_NBT_KEY = "saddle";
