...
extends DataFix {
    final static public String KEY_UNKNOWN = "key.unknown";
    final static private Int2ObjectMap<String> NUMERICAL_KEY_IDS_TO_KEY_NAMES = (Int2ObjectMap)DataFixUtils.make((Object)new Int2ObjectOpenHashMap(), map -> {
