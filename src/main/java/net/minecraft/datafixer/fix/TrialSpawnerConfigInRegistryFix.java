...
extends ChoiceFix {
    ...
    static final class Replacements {
        final static public Map<Pair<Dynamic<NbtElement>, Dynamic<NbtElement>>, Identifier> REPLACEMENTS = new HashMap<Pair<Dynamic<NbtElement>, Dynamic<NbtElement>>, Identifier>();
        ...
        private static void register(Identifier id, String normal, String ominous) {
            try {
                ...
                NbtCompound nbtCompound3 = nbtCompound.net_minecraft_nbt_NbtCompound_copy().copyFrom(nbtCompound2);
                NbtCompound nbtCompound4 = Replacements.removeDefaults(nbtCompound3.net_minecraft_nbt_NbtCompound_copy());
