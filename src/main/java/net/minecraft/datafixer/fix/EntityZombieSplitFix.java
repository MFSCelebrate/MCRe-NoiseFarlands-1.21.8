...
extends EntityTransformFix {
    final private Supplier<Type<?>> ZOMBIE_VILLAGER_TYPE = Suppliers.memoize(() -> this.getOutputSchema().getChoiceType(TypeReferences.ENTITY, "ZombieVillager"));
    ...
    protected Pair<String, Typed<?>> transform(String choice, Typed<?> entityTyped) {
        ...
        return Pair.of((Object)string, (Object)(switch (i) {
            ...
            case 1, 2, 3, 4, 5 -> {
                ...
                yield this.setZombieVillagerProfession(entityTyped, 0);
            }
            case 6 -> {
                string = "Husk";
                yield entityTyped;
