...
extends EntityRenameFix {
    final static public Map<String, String> RENAMES = ImmutableMap.builder().put((Object)"minecraft:zombie_pigman_spawn_egg", (Object)"minecraft:zombified_piglin_spawn_egg").build();
