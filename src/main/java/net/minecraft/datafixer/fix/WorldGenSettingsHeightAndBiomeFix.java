...
extends DataFix {
    final static private String NAME = "WorldGenSettingsHeightAndBiomeFix";
    final static public String HAS_INCREASED_HEIGHT_ALREADY_KEY = "has_increased_height_already";
