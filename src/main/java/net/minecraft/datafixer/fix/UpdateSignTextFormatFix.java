...
extends ChoiceWriteReadFix {
    final static public List<String> field_55629 = List.of("Text1", "Text2", "Text3", "Text4", "FilteredText1", "FilteredText2", "FilteredText3", "FilteredText4", "Color", "GlowingText");
    final static public String FILTERED_CORRECT = "_filtered_correct";
