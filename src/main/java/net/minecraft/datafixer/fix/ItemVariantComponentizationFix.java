...
extends DataFix {
    ...
    private static <T> Dynamic<T> fixTropicalFishBucket(Dynamic<T> dynamic2, Dynamic<T> dynamic22) {
        ...
        String string = ItemVariantComponentizationFix.getTropicalFishPatternName(1);
        String string2 = ItemVariantComponentizationFix.getTropicalFishBaseColorName(1);
        String string3 = ItemVariantComponentizationFix.getTropicalFishPatternColorName(1);
