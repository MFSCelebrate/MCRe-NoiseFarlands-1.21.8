...
extends DataFix {
    final static private int SPLASH_POTION_FLAG = 16384;
    final static private String[] ID_TO_POTIONS = (String[])DataFixUtils.make((Object)new String[128], potions -> {
        potions[0] = WATER;
    ...
    final static public String WATER = "minecraft:water";
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemPotionFix", type, itemStack -> {
            ...
            if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:potion")) {
                ...
                short s = dynamic.get("Damage").asShort(0);
                if (optional2.isPresent()) {
                    ...
                    if (s != 0) {
                        dynamic = dynamic.set("Damage", dynamic.createShort(0));
                    }
