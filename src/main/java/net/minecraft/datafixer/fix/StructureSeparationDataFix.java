...
extends DataFix {
    final static private String VILLAGE_STRUCTURE_ID = "minecraft:village";
    final static private String DESERT_PYRAMID_STRUCTURE_ID = "minecraft:desert_pyramid";
    final static private String IGLOO_STRUCTURE_ID = "minecraft:igloo";
    final static private String JUNGLE_PYRAMID_STRUCTURE_ID = "minecraft:jungle_pyramid";
    final static private String SWAMP_HUT_STRUCTURE_ID = "minecraft:swamp_hut";
    final static private String PILLAGER_OUTPOST_STRUCTURE_ID = "minecraft:pillager_outpost";
    final static private String END_CITY_STRUCTURE_ID = "minecraft:endcity";
    final static private String MANSION_STRUCTURE_ID = "minecraft:mansion";
    final static private String MONUMENT_STRUCTURE_ID = "minecraft:monument";
    final static private ImmutableMap<String, Information> STRUCTURE_SPACING = ImmutableMap.builder().put((Object)"minecraft:village", (Object)new Information(32, 8, 10387312)).put((Object)"minecraft:desert_pyramid", (Object)new Information(32, 8, 14357617)).put((Object)"minecraft:igloo", (Object)new Information(32, 8, 14357618)).put((Object)"minecraft:jungle_pyramid", (Object)new Information(32, 8, 14357619)).put((Object)"minecraft:swamp_hut", (Object)new Information(32, 8, 14357620)).put((Object)"minecraft:pillager_outpost", (Object)new Information(32, 8, 165745296)).put((Object)"minecraft:monument", (Object)new Information(32, 5, 10387313)).put((Object)"minecraft:endcity", (Object)new Information(20, 11, 10387313)).put((Object)"minecraft:mansion", (Object)new Information(80, 20, 10387319)).build();
    ...
    private static <T> Map<Dynamic<T>, Dynamic<T>> createFlatWorldStructureSettings(DynamicOps<T> worldGenSettingsDynamicOps, OptionalDynamic<T> generatorOptionsDynamic) {
        ...
        if (mutableBoolean.isTrue()) {
            builder.put((Object)generatorOptionsDynamic.createString("stronghold"), (Object)generatorOptionsDynamic.createMap((Map)ImmutableMap.of((Object)generatorOptionsDynamic.createString("distance"), (Object)generatorOptionsDynamic.createInt(mutableInt.getValue().intValue()), (Object)generatorOptionsDynamic.createString("spread"), (Object)generatorOptionsDynamic.createInt(mutableInt2.getValue().intValue()), (Object)generatorOptionsDynamic.createString("count"), (Object)generatorOptionsDynamic.createInt(mutableInt3.getValue().intValue()))));
        }
