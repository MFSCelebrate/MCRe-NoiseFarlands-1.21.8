...
extends DataFix {
    final static private int ELEMENT_BIT_SHIFT = 6;
    final static private int CHUNK_WIDTH = 16;
    final static private int CHUNK_LENGTH = 16;
    final static private int MAX_BLOCK_STATE_ID = 4096;
    final static private int HEIGHT_VALUE_BITS = 9;
    final static private int MAX_HEIGHT_VALUE = 256;
