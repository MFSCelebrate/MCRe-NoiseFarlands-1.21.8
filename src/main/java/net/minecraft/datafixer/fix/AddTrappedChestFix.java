...
extends DataFix {
    ...
    final static private int field_29910 = 4096;
    final static private short field_29911 = 12;
    ...
    private static Typed method_5176(TaggedChoice.TaggedChoiceType taggedChoiceType, int i, int j, IntSet intSet, Typed typed2) {
