...
extends EntityRenameFix {
    final static public Map<String, String> ITEMS = ImmutableMap.builder().put((Object)"minecraft:illager_beast_spawn_egg", (Object)"minecraft:ravager_spawn_egg").build();
