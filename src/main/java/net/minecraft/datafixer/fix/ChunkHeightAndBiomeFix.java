...
extends DataFix {
    final static public String CONTEXT = "__context";
    final static private String NAME = "ChunkHeightAndBiomeFix";
    final static private int CHUNK_SECTIONS_IN_OLD_CHUNK = 16;
    final static private int CHUNK_SECTIONS_IN_NEW_CHUNK = 24;
    final static private int MIN_CHUNK_SECTION_Y = -4;
    final static public int field_36214 = 4096;
    final static private int field_36215 = 64;
    final static private int field_35022 = 9;
    final static private long field_35023 = 511L;
    final static private int field_35024 = 64;
    final static private String[] HEIGHTMAP_KEYS = new String[]{"WORLD_SURFACE_WG", "WORLD_SURFACE", "WORLD_SURFACE_IGNORE_SNOW", "OCEAN_FLOOR_WG", "OCEAN_FLOOR", "MOTION_BLOCKING", "MOTION_BLOCKING_NO_LEAVES"};
    final static private Set<String> STATUSES_TO_SKIP_UPDATE = Set.of("surface", "carvers", "liquid_carvers", "features", "light", "spawn", "heightmaps", "full");
    final static private Set<String> field_35668 = Set.of("noise", "surface", "carvers", "liquid_carvers", "features", "light", "spawn", "heightmaps", "full");
    final static private Set<String> SURFACE_BLOCKS = Set.of("minecraft:air", "minecraft:basalt", "minecraft:bedrock", "minecraft:blackstone", "minecraft:calcite", "minecraft:cave_air", "minecraft:coarse_dirt", "minecraft:crimson_nylium", "minecraft:dirt", "minecraft:end_stone", "minecraft:grass_block", "minecraft:gravel", "minecraft:ice", "minecraft:lava", "minecraft:mycelium", "minecraft:nether_wart_block", "minecraft:netherrack", "minecraft:orange_terracotta", "minecraft:packed_ice", "minecraft:podzol", "minecraft:powder_snow", "minecraft:red_sand", "minecraft:red_sandstone", "minecraft:sand", "minecraft:sandstone", "minecraft:snow_block", "minecraft:soul_sand", "minecraft:soul_soil", "minecraft:stone", "minecraft:terracotta", "minecraft:warped_nylium", "minecraft:warped_wart_block", "minecraft:water", "minecraft:white_terracotta");
    final static private int field_35026 = 16;
    final static private int field_35027 = 64;
    final static private int field_35028 = 1008;
    final static public String PLAINS_ID = "minecraft:plains";
    final static private Int2ObjectMap<String> RAW_BIOME_IDS = new Int2ObjectOpenHashMap();
    ...
    private static Dynamic<?> fixLevel(Dynamic<?> level, boolean overworld, boolean heightAlreadyUpdated, boolean atNoiseStatus, Supplier<ProtoChunkTickListFix.PalettedSection> supplier) {
        Dynamic dynamic;
        String string;
            ...
            indices.getMapValues().ifSuccess(indicesMap -> indicesMap.forEach((key, value) -> {
                try {
                    key.asString().result().map(Integer::parseInt).ifPresent(index -> {
                        int i = index - -4;
                        map.put(key.createString(Integer.toString(1)), value);
                    });
                }
    ...
    private static Dynamic method_38801(Set set, Dynamic dynamic, int i, Dynamic[] dynamics, IntSet intSet, MutableObject mutableObject, Dynamic dynamic2) {
