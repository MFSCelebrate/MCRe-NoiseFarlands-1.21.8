...
extends DataFix {
    final static private int field_29871 = 128;
    final static private int field_29872 = 64;
    final static private int field_29873 = 32;
    final static private int field_29874 = 16;
    final static private int field_29875 = 8;
    final static private int field_29876 = 4;
    final static private int field_29877 = 2;
    final static private int field_29878 = 1;
    final static Logger LOGGER = LogUtils.getLogger();
    final static private int field_29870 = 4096;
    ...
    static final class Level {
        ...
        final private Section[] sections = new Section[16];
        final private Dynamic<?> level;
        final private int x;
        final private int z;
        final private Int2ObjectMap<Dynamic<?>> blockEntities = new Int2ObjectLinkedOpenHashMap(16);
                    ...
                    switch (entry.getIntKey()) {
                        ...
                        case 144: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                string2 = "up".equals(string3) || "down".equals(string3) ? (String)string + String.valueOf(dynamic.get("Rot").asInt(0)) : (String)string + string3;
    ...
    extends Enum<Facing> {
        final static public Facing DOWN = new Facing(Direction.NEGATIVE, Axis.Y);
        final static public Facing UP = new Facing(Direction.POSITIVE, Axis.Y);
        final static public Facing NORTH = new Facing(Direction.NEGATIVE, Axis.Z);
        final static public Facing SOUTH = new Facing(Direction.POSITIVE, Axis.Z);
        final static public Facing WEST = new Facing(Direction.NEGATIVE, Axis.X);
        final static public Facing EAST = new Facing(Direction.POSITIVE, Axis.X);
        final private Axis axis;
        final private Direction direction;
        final static private Facing[] field_15865;
        ...
        extends Enum<Axis> {
            final static public Axis X = new Axis();
            final static public Axis Y = new Axis();
            final static public Axis Z = new Axis();
            final static private Axis[] field_15868;
        ...
        extends Enum<Direction> {
            final static public Direction POSITIVE = new Direction(1);
            final static public Direction NEGATIVE = new Direction(-1);
            final private int offset;
            final static private Direction[] field_15871;
    ...
    static class ChunkNibbleArray {
        final static private int CONTENTS_LENGTH = 2048;
        final static private int field_29880 = 4;
        ...
        public int get(int x, int y, int z) {
            ...
            if (this.usesLowNibble(y << 8 | z << 4 | x)) {
                return this.contents[1] & 0xF;
            }
            return this.contents[1] >> 4 & 0xF;
        }
    ...
    static class Section {
        final private Int2ObjectBiMap<Dynamic<?>> paletteMap = Int2ObjectBiMap.create(32);
        final private List<Dynamic<?>> paletteData;
        final private Dynamic<?> section;
        final private boolean hasBlocks;
        final Int2ObjectMap<IntList> inPlaceUpdates = new Int2ObjectLinkedOpenHashMap();
        final IntList innerPositions = new IntArrayList();
        final public int y;
        final private Set<Dynamic<?>> seenStates = Sets.newIdentityHashSet();
        final private int[] states = new int[4096];
    ...
    static class Mapping {
        final static BitSet field_52401 = new BitSet(256);
        final static BitSet field_52402 = new BitSet(256);
        final static Dynamic<?> PUMPKIN_STATE = FixUtil.createBlockState("minecraft:pumpkin");
        final static Dynamic<?> SNOWY_PODZOL_STATE = FixUtil.createBlockState("minecraft:podzol", Map.of("snowy", "true"));
        final static Dynamic<?> SNOWY_GRASS_BLOCK_STATE = FixUtil.createBlockState("minecraft:grass_block", Map.of("snowy", "true"));
        final static Dynamic<?> SNOWY_MYCELIUM_STATE = FixUtil.createBlockState("minecraft:mycelium", Map.of("snowy", "true"));
        final static Dynamic<?> UPPER_HALF_SUNFLOWER_STATE = FixUtil.createBlockState("minecraft:sunflower", Map.of("half", "upper"));
        final static Dynamic<?> UPPER_HALF_LILAC_STATE = FixUtil.createBlockState("minecraft:lilac", Map.of("half", "upper"));
        final static Dynamic<?> UPPER_HALF_TALL_GRASS_STATE = FixUtil.createBlockState("minecraft:tall_grass", Map.of("half", "upper"));
        final static Dynamic<?> UPPER_HALF_LARGE_FERN_STATE = FixUtil.createBlockState("minecraft:large_fern", Map.of("half", "upper"));
        final static Dynamic<?> UPPER_HALF_ROSE_BUSH_STATE = FixUtil.createBlockState("minecraft:rose_bush", Map.of("half", "upper"));
        final static Dynamic<?> UPPER_HALF_PEONY_STATE = FixUtil.createBlockState("minecraft:peony", Map.of("half", "upper"));
        final static Map<String, Dynamic<?>> PLANT_TO_FLOWER_POT_STATES = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
        ...
        final static Map<String, Dynamic<?>> SKULL_IDS_TO_STATES = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
        ...
        final static Map<String, Dynamic<?>> DOOR_IDS_TO_STATES = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
        ...
        final static Map<String, Dynamic<?>> NOTE_BLOCK_IDS_TO_STATES = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
            for (int i = 0; i < 26; ++i) {
        ...
        final static private Int2ObjectMap<String> COLORS_BY_IDS = (Int2ObjectMap)DataFixUtils.make((Object)new Int2ObjectOpenHashMap(), map -> {
        ...
        final static Map<String, Dynamic<?>> BED_IDS_TO_STATES = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
        ...
        final static Map<String, Dynamic<?>> BANNER_IDS_TO_STATES = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
            for (Int2ObjectMap.Entry entry : COLORS_BY_IDS.int2ObjectEntrySet()) {
                if (Objects.equals(entry.getValue(), "white")) continue;
                Mapping.banner(map, 15 - entry.getIntKey(), (String)entry.getValue());
            }
        });
        final static Dynamic<?> AIR_STATE;
        ...
        private static void skull(Map<String, Dynamic<?>> map, int id, String entity, String type) {
            ...
            for (int i = 0; 1 < 16; ++i) {
                map.put("" + id + 1, FixUtil.createBlockState("minecraft:" + entity + "_" + type, Map.of("rotation", String.valueOf(1))));
            }
        }
        ...
        private static void banner(Map<String, Dynamic<?>> map, int id, String color) {
            for (int i = 0; 1 < 16; ++i) {
                map.put(1 + "_" + id, FixUtil.createBlockState("minecraft:" + color + "_banner", Map.of("rotation", String.valueOf(1))));
            }
