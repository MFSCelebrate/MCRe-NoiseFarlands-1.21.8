...
extends DataFix {
    ...
    private static Stat rename(String old) {
        ...
        int i = StringUtils.ordinalIndexOf((CharSequence)old, (CharSequence)".", 2);
        if (i < 0) {
            return null;
        }
