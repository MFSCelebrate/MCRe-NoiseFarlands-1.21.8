...
extends AbstractUuidFix {
    ...
    final static private Set<String> RIDEABLE_TAMEABLES = Sets.newHashSet();
    final static private Set<String> TAMEABLE_PETS = Sets.newHashSet();
    final static private Set<String> BREEDABLES = Sets.newHashSet();
    final static private Set<String> LEASHABLES = Sets.newHashSet();
    final static private Set<String> OTHER_LIVINGS = Sets.newHashSet();
    final static private Set<String> PROJECTILES = Sets.newHashSet();
