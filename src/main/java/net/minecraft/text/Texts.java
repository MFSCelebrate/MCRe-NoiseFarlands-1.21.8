...
public class Texts {
    ...
    final static public Text GRAY_DEFAULT_SEPARATOR_TEXT = Text.literal(", ").formatted(Formatting.GRAY);
    final static public Text DEFAULT_SEPARATOR_TEXT = Text.literal(", ");
