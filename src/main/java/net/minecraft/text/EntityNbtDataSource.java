...
{
    final static public MapCodec<EntityNbtDataSource> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.STRING.fieldOf("entity").forGetter(EntityNbtDataSource::rawSelector)).apply((Applicative)instance, EntityNbtDataSource::new));
    final static public NbtDataSource.Type<EntityNbtDataSource> TYPE = new NbtDataSource.Type<EntityNbtDataSource>(CODEC, "entity");
