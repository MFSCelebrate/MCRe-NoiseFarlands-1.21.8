...
public interface NbtDataSource {
    final static public MapCodec<NbtDataSource> CODEC = TextCodecs.dispatchingCodec((StringIdentifiable[])new Type[]{EntityNbtDataSource.TYPE, BlockNbtDataSource.TYPE, StorageNbtDataSource.TYPE}, Type::codec, NbtDataSource::getType, (String)"source");
