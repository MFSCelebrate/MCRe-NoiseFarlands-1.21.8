...
implements TextContent {
    final static public MapCodec<KeybindTextContent> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.STRING.fieldOf("keybind").forGetter(content -> content.key)).apply((Applicative)instance, KeybindTextContent::new));
    final static public TextContent.Type<KeybindTextContent> TYPE = new TextContent.Type<KeybindTextContent>(CODEC, "keybind");
