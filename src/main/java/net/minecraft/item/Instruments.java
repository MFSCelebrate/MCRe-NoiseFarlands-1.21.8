...
public interface Instruments {
    final static public int GOAT_HORN_RANGE = 256;
    final static public float GOAT_HORN_USE_DURATION = 7.0f;
    final static public RegistryKey<Instrument> PONDER_GOAT_HORN = Instruments.of("ponder_goat_horn");
    final static public RegistryKey<Instrument> SING_GOAT_HORN = Instruments.of("sing_goat_horn");
    final static public RegistryKey<Instrument> SEEK_GOAT_HORN = Instruments.of("seek_goat_horn");
    final static public RegistryKey<Instrument> FEEL_GOAT_HORN = Instruments.of("feel_goat_horn");
    final static public RegistryKey<Instrument> ADMIRE_GOAT_HORN = Instruments.of("admire_goat_horn");
    final static public RegistryKey<Instrument> CALL_GOAT_HORN = Instruments.of("call_goat_horn");
    final static public RegistryKey<Instrument> YEARN_GOAT_HORN = Instruments.of("yearn_goat_horn");
    final static public RegistryKey<Instrument> DREAM_GOAT_HORN = Instruments.of("dream_goat_horn");
