...
extends Item {
    final private EntityType<? extends AbstractMinecartEntity> type;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (world instanceof ServerWorld) {
            ...
            serverWorld.emitGameEvent(GameEvent.ENTITY_PLACE, blockPos, GameEvent.Emitter.of(context.getPlayer(), serverWorld.getBlockState(blockPos.net_minecraft_util_math_BlockPos_down())));
        }
