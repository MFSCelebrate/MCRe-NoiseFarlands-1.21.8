...
extends RangedWeaponItem {
    final static private float DEFAULT_PULL_TIME = 1.25f;
    final static public int RANGE = 8;
    private boolean charged = false;
    private boolean loaded = false;
    final static private float CHARGE_PROGRESS = 0.2f;
    final static private float LOAD_PROGRESS = 0.5f;
    final static private float DEFAULT_SPEED = 3.15f;
    final static private float FIREWORK_ROCKET_SPEED = 1.6f;
    final static public float field_49258 = 1.6f;
    final static private LoadingSounds DEFAULT_LOADING_SOUNDS = new LoadingSounds(Optional.of(SoundEvents.ITEM_CROSSBOW_LOADING_START), Optional.of(SoundEvents.ITEM_CROSSBOW_LOADING_MIDDLE), Optional.of(SoundEvents.ITEM_CROSSBOW_LOADING_END));
    ...
    protected void shoot(LivingEntity shooter, ProjectileEntity projectile, int index, float speed, float divergence, float yaw, @Nullable LivingEntity target) {
        ...
        shooter.net_minecraft_world_World_getWorld().playSound(null, shooter.getX(), shooter.getY(), shooter.getZ(), SoundEvents.ITEM_CROSSBOW_SHOOT, shooter.getSoundCategory(), 1.0f, h);
    }
