...
extends Item {
    final static public int field_30851 = 3;
    final static public int field_30852 = 1;
    final static public int field_30853 = 3;
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        BlockPos blockPos2 = blockPos.net_minecraft_util_math_BlockPos_offset(context.getSide());
    ...
    public static boolean useOnGround(ItemStack stack, World world, BlockPos blockPos, @Nullable Direction facing) {
        ...
        block0: for (int i = 0; i < 128; ++i) {
            ...
            for (int j = 0; j < i / 16; ++j) {
                if (world.getBlockState(blockPos2 = blockPos2.net_minecraft_util_math_BlockPos_add(random.nextInt(3) - 1, (random.nextInt(3) - 1) * random.nextInt(3) / 2, random.nextInt(3) - 1)).isFullCube(world, blockPos2)) continue block0;
            }
