...
public class ArmorTrimMaterials {
    final static public RegistryKey<ArmorTrimMaterial> QUARTZ = ArmorTrimMaterials.of("quartz");
    final static public RegistryKey<ArmorTrimMaterial> IRON = ArmorTrimMaterials.of("iron");
    final static public RegistryKey<ArmorTrimMaterial> NETHERITE = ArmorTrimMaterials.of("netherite");
    final static public RegistryKey<ArmorTrimMaterial> REDSTONE = ArmorTrimMaterials.of("redstone");
    final static public RegistryKey<ArmorTrimMaterial> COPPER = ArmorTrimMaterials.of("copper");
    final static public RegistryKey<ArmorTrimMaterial> GOLD = ArmorTrimMaterials.of("gold");
    final static public RegistryKey<ArmorTrimMaterial> EMERALD = ArmorTrimMaterials.of("emerald");
    final static public RegistryKey<ArmorTrimMaterial> DIAMOND = ArmorTrimMaterials.of("diamond");
    final static public RegistryKey<ArmorTrimMaterial> LAPIS = ArmorTrimMaterials.of("lapis");
    final static public RegistryKey<ArmorTrimMaterial> AMETHYST = ArmorTrimMaterials.of("amethyst");
    final static public RegistryKey<ArmorTrimMaterial> RESIN = ArmorTrimMaterials.of("resin");
