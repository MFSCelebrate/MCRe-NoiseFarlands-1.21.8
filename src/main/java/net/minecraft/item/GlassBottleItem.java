...
extends Item {
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        List<AreaEffectCloudEntity> list = world.getEntitiesByClass(AreaEffectCloudEntity.class, user.getBoundingBox().expand(2.0), entity -> entity != null && entity.isAlive() && entity.net_minecraft_entity_LivingEntity_getOwner() instanceof EnderDragonEntity);
