...
extends Item {
    final static public int ANIMATION_DURATION = 10;
    final static private int MAX_BRUSH_TIME = 200;
    ...
    record DustParticlesOffset(double xd, double yd, double zd) {
        final static private double field_42685 = 1.0;
        final static private double field_42686 = 0.1;
