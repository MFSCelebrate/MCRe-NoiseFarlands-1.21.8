...
extends Item {
    final static public int TOOLTIP_STACKS_COLUMNS = 4;
    final static public int TOOLTIP_STACKS_ROWS = 3;
    final static public int MAX_TOOLTIP_STACKS_SHOWN = 12;
    final static public int MAX_TOOLTIP_STACKS_SHOWN_WHEN_TOO_MANY_TYPES = 11;
    final static private int FULL_ITEM_BAR_COLOR = ColorHelper.fromFloats(1.0f, 1.0f, 0.33f, 0.33f);
    final static private int ITEM_BAR_COLOR = ColorHelper.fromFloats(1.0f, 0.44f, 0.53f, 1.0f);
    final static private int field_54109 = 10;
    final static private int field_54110 = 2;
    final static private int MAX_USE_TIME = 200;
    ...
    private static void playRemoveOneSound(Entity entity) {
        entity.playSound(SoundEvents.ITEM_BUNDLE_REMOVE_ONE, 0.8f, 0.8f + entity.net_minecraft_world_World_getWorld().getRandom().nextFloat() * 0.4f);
    }

    private static void playInsertSound(Entity entity) {
        entity.playSound(SoundEvents.ITEM_BUNDLE_INSERT, 0.8f, 0.8f + entity.net_minecraft_world_World_getWorld().getRandom().nextFloat() * 0.4f);
    }
    ...
    private static void playDropContentsSound(World world, Entity entity) {
        world.playSound(null, entity.getBlockPos(), SoundEvents.ITEM_BUNDLE_DROP_CONTENTS, SoundCategory.PLAYERS, 0.8f, 0.8f + entity.net_minecraft_world_World_getWorld().getRandom().nextFloat() * 0.4f);
    }
