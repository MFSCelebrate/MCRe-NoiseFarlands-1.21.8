...
public class ItemGroups {
    final static private Identifier INVENTORY_TAB_TEXTURE_ID = ItemGroup.getTabTextureId("inventory");
    final static private Identifier ITEM_SEARCH_TAB_TEXTURE_ID = ItemGroup.getTabTextureId("item_search");
    final static public RegistryKey<ItemGroup> BUILDING_BLOCKS = ItemGroups.register("building_blocks");
    final static public RegistryKey<ItemGroup> COLORED_BLOCKS = ItemGroups.register("colored_blocks");
    final static public RegistryKey<ItemGroup> NATURAL = ItemGroups.register("natural_blocks");
    final static public RegistryKey<ItemGroup> FUNCTIONAL = ItemGroups.register("functional_blocks");
    final static public RegistryKey<ItemGroup> REDSTONE = ItemGroups.register("redstone_blocks");
    final static public RegistryKey<ItemGroup> HOTBAR = ItemGroups.register("hotbar");
    final static public RegistryKey<ItemGroup> SEARCH = ItemGroups.register("search");
    final static public RegistryKey<ItemGroup> TOOLS = ItemGroups.register("tools_and_utilities");
    final static public RegistryKey<ItemGroup> COMBAT = ItemGroups.register("combat");
    final static public RegistryKey<ItemGroup> FOOD_AND_DRINK = ItemGroups.register("food_and_drinks");
    final static public RegistryKey<ItemGroup> INGREDIENTS = ItemGroups.register("ingredients");
    final static public RegistryKey<ItemGroup> SPAWN_EGGS = ItemGroups.register("spawn_eggs");
    final static public RegistryKey<ItemGroup> OPERATOR = ItemGroups.register("op_blocks");
    final static public RegistryKey<ItemGroup> INVENTORY = ItemGroups.register("inventory");
    final static private Comparator<RegistryEntry<PaintingVariant>> PAINTING_VARIANT_COMPARATOR = Comparator.comparing(RegistryEntry::value, Comparator.comparingInt(PaintingVariant::getArea).thenComparing(PaintingVariant::width));
    @Nullable
    static private ItemGroup.DisplayContext displayContext;
    ...
    public static ItemGroup registerAndGetDefault(Registry<ItemGroup> registry) {
        ...
        Registry.register(registry, FUNCTIONAL, ItemGroup.create(ItemGroup.Row.TOP, 3).displayName(Text.translatable("itemGroup.functional")).icon(() -> new ItemStack(Items.OAK_SIGN)).entries((displayContext, entries) -> {
            ...
            entries.add(Items.MAGENTA_BANNER);
            entries.add(Items.PINK_BANNER);
            entries.add(Raid.createOminousBanner(displayContext.lookup().net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.BANNER_PATTERN)));
