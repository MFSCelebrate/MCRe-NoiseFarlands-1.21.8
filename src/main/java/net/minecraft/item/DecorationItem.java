...
extends Item {
    final static private Text RANDOM_TEXT = Text.translatable("painting.random").formatted(Formatting.GRAY);
    final private EntityType<? extends AbstractDecorationEntity> entityType;
