...
extends BlockItem {
    ...
    protected boolean place(ItemPlacementContext context, BlockState state) {
        ...
        BlockState blockState = world.isWater(blockPos = context.getBlockPos().net_minecraft_util_math_BlockPos_up()) ? Blocks.WATER.getDefaultState() : Blocks.AIR.getDefaultState();
