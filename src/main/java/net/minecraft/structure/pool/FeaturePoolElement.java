...
extends StructurePoolElement {
    final static public MapCodec<FeaturePoolElement> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)PlacedFeature.REGISTRY_CODEC.fieldOf("feature").forGetter(pool -> pool.feature), FeaturePoolElement.projectionGetter()).apply((Applicative)instance, FeaturePoolElement::new));
    final static private Identifier DEFAULT_NAME = Identifier.ofVanilla("bottom");
    final private RegistryEntry<PlacedFeature> feature;
