...
extends StructurePoolElement {
    final static public MapCodec<ListPoolElement> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)StructurePoolElement.CODEC.listOf().fieldOf("elements").forGetter(pool -> pool.elements), ListPoolElement.projectionGetter()).apply((Applicative)instance, ListPoolElement::new));
    final private List<StructurePoolElement> elements;
