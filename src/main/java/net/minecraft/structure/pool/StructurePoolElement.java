...
public abstract class StructurePoolElement {
    final static public Codec<StructurePoolElement> CODEC = Registries.STRUCTURE_POOL_ELEMENT.getCodec().dispatch("element_type", StructurePoolElement::getType, StructurePoolElementType::codec);
    final static private RegistryEntry<StructureProcessorList> EMPTY_PROCESSORS = RegistryEntry.of(new StructureProcessorList(List.of()));
    @Nullable
