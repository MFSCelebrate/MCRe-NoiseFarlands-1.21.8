...
public class NetherFortressGenerator {
    final static private int field_31557 = 30;
    final static private int field_31558 = 10;
    final static public int field_34730 = 64;
    final static PieceData[] ALL_BRIDGE_PIECES = new PieceData[]{new PieceData(Bridge.class, 30, 0, true), new PieceData(BridgeCrossing.class, 10, 4), new PieceData(BridgeSmallCrossing.class, 10, 4), new PieceData(BridgeStairs.class, 10, 3), new PieceData(BridgePlatform.class, 5, 2), new PieceData(CorridorExit.class, 5, 1)};
    final static PieceData[] ALL_CORRIDOR_PIECES = new PieceData[]{new PieceData(SmallCorridor.class, 25, 0, true), new PieceData(CorridorCrossing.class, 15, 5), new PieceData(CorridorRightTurn.class, 5, 10), new PieceData(CorridorLeftTurn.class, 5, 10), new PieceData(CorridorStairs.class, 10, 3, true), new PieceData(CorridorBalcony.class, 7, 2), new PieceData(CorridorNetherWartsRoom.class, 5, 2)};
    ...
    static class PieceData {
        ...
        final public boolean repeatable;
    ...
    extends Piece {
        ...
        final static private int SIZE_Y = 10;
        final static private int SIZE_Z = 19;
    ...
    extends Piece {
        final static private int SIZE_X = 19;
        final static private int SIZE_Y = 10;
        final static private int SIZE_Z = 19;
    ...
    extends Piece {
        final static private int SIZE_X = 7;
        final static private int SIZE_Y = 9;
    ...
    extends Piece {
        final static private int SIZE_X = 7;
        final static private int SIZE_Y = 8;
        final static private int SIZE_Z = 9;
    ...
    extends Piece {
        final static private int SIZE_X = 13;
        final static private int SIZE_Y = 14;
        final static private int SIZE_Z = 13;
    ...
    extends Piece {
        final static private int SIZE_X = 5;
        final static private int SIZE_Y = 7;
    ...
    extends Piece {
        final static private int SIZE_X = 5;
        final static private int SIZE_Y = 14;
        final static private int SIZE_Z = 10;
    ...
    extends Piece {
        final static private int SIZE_X = 9;
        final static private int SIZE_Y = 7;
        final static private int SIZE_Z = 9;
        ...
        public void fillOpenings(StructurePiece start, StructurePiecesHolder holder, Random random) {
            ...
            this.fillNWOpening((Start)start, holder, random, 0, 1, random.nextInt(8) > 0);
            this.fillSEOpening((Start)start, holder, random, 0, 1, random.nextInt(8) > 0);
        }
