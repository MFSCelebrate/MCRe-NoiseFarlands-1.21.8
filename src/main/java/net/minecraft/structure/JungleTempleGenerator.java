...
extends ShiftableStructurePiece {
    final static public int field_34727 = 12;
    final static public int DEPTH = 15;
    private boolean placedMainChest;
    private boolean placedHiddenChest;
    private boolean placedTrap1;
    private boolean placedTrap2;
    final static private CobblestoneRandomizer COBBLESTONE_RANDOMIZER = new CobblestoneRandomizer();
