...
public class OceanRuinGenerator {
    final static StructureProcessor SUSPICIOUS_SAND_PROCESSOR = OceanRuinGenerator.createArchaeologyStructureProcessor(Blocks.SAND, Blocks.SUSPICIOUS_SAND, LootTables.OCEAN_RUIN_WARM_ARCHAEOLOGY);
    final static StructureProcessor SUSPICIOUS_GRAVEL_PROCESSOR = OceanRuinGenerator.createArchaeologyStructureProcessor(Blocks.GRAVEL, Blocks.SUSPICIOUS_GRAVEL, LootTables.OCEAN_RUIN_COLD_ARCHAEOLOGY);
    final static private Identifier[] WARM_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/warm_1"), Identifier.ofVanilla("underwater_ruin/warm_2"), Identifier.ofVanilla("underwater_ruin/warm_3"), Identifier.ofVanilla("underwater_ruin/warm_4"), Identifier.ofVanilla("underwater_ruin/warm_5"), Identifier.ofVanilla("underwater_ruin/warm_6"), Identifier.ofVanilla("underwater_ruin/warm_7"), Identifier.ofVanilla("underwater_ruin/warm_8")};
    final static private Identifier[] BRICK_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/brick_1"), Identifier.ofVanilla("underwater_ruin/brick_2"), Identifier.ofVanilla("underwater_ruin/brick_3"), Identifier.ofVanilla("underwater_ruin/brick_4"), Identifier.ofVanilla("underwater_ruin/brick_5"), Identifier.ofVanilla("underwater_ruin/brick_6"), Identifier.ofVanilla("underwater_ruin/brick_7"), Identifier.ofVanilla("underwater_ruin/brick_8")};
    final static private Identifier[] CRACKED_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/cracked_1"), Identifier.ofVanilla("underwater_ruin/cracked_2"), Identifier.ofVanilla("underwater_ruin/cracked_3"), Identifier.ofVanilla("underwater_ruin/cracked_4"), Identifier.ofVanilla("underwater_ruin/cracked_5"), Identifier.ofVanilla("underwater_ruin/cracked_6"), Identifier.ofVanilla("underwater_ruin/cracked_7"), Identifier.ofVanilla("underwater_ruin/cracked_8")};
    final static private Identifier[] MOSSY_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/mossy_1"), Identifier.ofVanilla("underwater_ruin/mossy_2"), Identifier.ofVanilla("underwater_ruin/mossy_3"), Identifier.ofVanilla("underwater_ruin/mossy_4"), Identifier.ofVanilla("underwater_ruin/mossy_5"), Identifier.ofVanilla("underwater_ruin/mossy_6"), Identifier.ofVanilla("underwater_ruin/mossy_7"), Identifier.ofVanilla("underwater_ruin/mossy_8")};
    final static private Identifier[] BIG_BRICK_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/big_brick_1"), Identifier.ofVanilla("underwater_ruin/big_brick_2"), Identifier.ofVanilla("underwater_ruin/big_brick_3"), Identifier.ofVanilla("underwater_ruin/big_brick_8")};
    final static private Identifier[] BIG_MOSSY_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/big_mossy_1"), Identifier.ofVanilla("underwater_ruin/big_mossy_2"), Identifier.ofVanilla("underwater_ruin/big_mossy_3"), Identifier.ofVanilla("underwater_ruin/big_mossy_8")};
    final static private Identifier[] BIG_CRACKED_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/big_cracked_1"), Identifier.ofVanilla("underwater_ruin/big_cracked_2"), Identifier.ofVanilla("underwater_ruin/big_cracked_3"), Identifier.ofVanilla("underwater_ruin/big_cracked_8")};
    final static private Identifier[] BIG_WARM_RUINS = new Identifier[]{Identifier.ofVanilla("underwater_ruin/big_warm_4"), Identifier.ofVanilla("underwater_ruin/big_warm_5"), Identifier.ofVanilla("underwater_ruin/big_warm_6"), Identifier.ofVanilla("underwater_ruin/big_warm_7")};
    ...
    private static void addCluster(StructureTemplateManager manager, Random random, BlockRotation rotation, BlockPos pos, OceanRuinStructure structure, StructurePiecesHolder pieces) {
        ...
        BlockPos blockPos2 = StructureTemplate.transformAround(new BlockPos(15, 0, 15), BlockMirror.NONE, rotation, BlockPos.ORIGIN).net_minecraft_util_math_BlockPos_add(blockPos);
        ...
        for (int j = 0; j < i; ++j) {
            ...
            BlockPos blockPos4;
            BlockBox blockBox2;
            if (list.isEmpty() || (blockBox2 = BlockBox.create(blockPos4 = list.remove(k = random.nextInt(list.size())), blockPos5 = StructureTemplate.transformAround(new BlockPos(5, 0, 6), BlockMirror.NONE, blockRotation = BlockRotation.random(random), BlockPos.ORIGIN).net_minecraft_util_math_BlockPos_add(blockPos4))).intersects(blockBox)) continue;
    ...
    private static List<BlockPos> getRoomPositions(Random random, BlockPos pos) {
        ...
        list.add(pos.net_minecraft_util_math_BlockPos_add(-16 + MathHelper.nextInt(random, 1, 8), 0, 16 + MathHelper.nextInt(random, 1, 7)));
        list.add(pos.net_minecraft_util_math_BlockPos_add(-16 + MathHelper.nextInt(random, 1, 8), 0, MathHelper.nextInt(random, 1, 7)));
        list.add(pos.net_minecraft_util_math_BlockPos_add(-16 + MathHelper.nextInt(random, 1, 8), 0, -16 + MathHelper.nextInt(random, 4, 8)));
        list.add(pos.net_minecraft_util_math_BlockPos_add(MathHelper.nextInt(random, 1, 7), 0, 16 + MathHelper.nextInt(random, 1, 7)));
        list.add(pos.net_minecraft_util_math_BlockPos_add(MathHelper.nextInt(random, 1, 7), 0, -16 + MathHelper.nextInt(random, 4, 6)));
        list.add(pos.net_minecraft_util_math_BlockPos_add(16 + MathHelper.nextInt(random, 1, 7), 0, 16 + MathHelper.nextInt(random, 3, 8)));
        list.add(pos.net_minecraft_util_math_BlockPos_add(16 + MathHelper.nextInt(random, 1, 7), 0, MathHelper.nextInt(random, 1, 7)));
        list.add(pos.net_minecraft_util_math_BlockPos_add(16 + MathHelper.nextInt(random, 1, 7), 0, -16 + MathHelper.nextInt(random, 4, 8)));
        return list;
    }
    ...
    extends SimpleStructurePiece {
        final private OceanRuinStructure.BiomeTemperature biomeType;
        final private float integrity;
        final private boolean large;
        ...
        public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
            ...
            BlockPos blockPos = StructureTemplate.transformAround(new BlockPos(this.template.getSize().getX() - 1, 0, this.template.getSize().getZ() - 1), BlockMirror.NONE, this.placementData.getRotation(), BlockPos.ORIGIN).net_minecraft_util_math_BlockPos_add(this.pos);
