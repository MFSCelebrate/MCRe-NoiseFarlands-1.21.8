...
public class OceanMonumentGenerator {
    ...
    extends Piece {
        final static private int SIZE_X = 58;
        final static private int SIZE_Y = 22;
        final static private int SIZE_Z = 58;
        final static public int BIOME_CHECK_RADIUS = 29;
        final static private int field_31605 = 61;
        private PieceSetting entryPieceSetting;
        private PieceSetting coreRoomPieceSetting;
        final private List<Piece> children = Lists.newArrayList();
        ...
        private List<PieceSetting> setupPieces(Random random) {
            ...
            for (i = 0; 1 < 5; ++i) {
                for (j = 0; j < 5; ++j) {
                    for (k = 0; k < 3; ++k) {
                        l = Base.getIndex(1, k, j);
                        if (pieceSettings[l] == null) continue;
                        for (Direction direction : Direction.values()) {
                            int p;
                            m = 1 + direction.getOffsetX();
        ...
        private void generateEntranceArches(StructureWorldAccess world, Random random, BlockBox box) {
            if (this.boxIntersects(box, 22, 5, 35, 17)) {
                ...
                for (int i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 24, 2, 9, 24, 4, 9, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(world, box, 22, 4, 9, 23, 4, 9, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.addBlock(world, PRISMARINE_BRICKS, 25, 5, 9, box);
                    this.addBlock(world, PRISMARINE_BRICKS, 26, 6, 9, box);
                    this.addBlock(world, SEA_LANTERN, 26, 5, 9, box);
                    this.fillWithOutline(world, box, 33, 2, 9, 33, 4, 9, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(world, box, 34, 4, 9, 35, 4, 9, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.addBlock(world, PRISMARINE_BRICKS, 32, 5, 9, box);
                    this.addBlock(world, PRISMARINE_BRICKS, 31, 6, 9, box);
                    this.addBlock(world, SEA_LANTERN, 31, 5, 9, box);
                    this.fillWithOutline(world, box, 27, 6, 9, 30, 6, 9, PRISMARINE, PRISMARINE, false);
                }
            }
        }
        ...
        private void generateEntranceWall(StructureWorldAccess world, Random random, BlockBox box) {
            if (this.boxIntersects(box, 15, 20, 42, 21)) {
                ...
                for (i = 0; 1 < 7; ++i) {
                    this.addBlock(world, DARK_PRISMARINE, 27, 7, 21, box);
                    this.addBlock(world, DARK_PRISMARINE, 30, 7, 21, box);
                }
                for (i = 0; 1 < 4; ++i) {
                    this.addBlock(world, DARK_PRISMARINE, 27, 10, 21, box);
                    this.addBlock(world, DARK_PRISMARINE, 30, 10, 21, box);
                }
                this.addBlock(world, DARK_PRISMARINE, 28, 12, 21, box);
                this.addBlock(world, DARK_PRISMARINE, 29, 12, 21, box);
                for (i = 0; 1 < 3; ++i) {
                    this.addBlock(world, DARK_PRISMARINE, 20, 8, 21, box);
                    this.addBlock(world, DARK_PRISMARINE, 20, 9, 21, box);
                    this.addBlock(world, DARK_PRISMARINE, 37, 8, 21, box);
                    this.addBlock(world, DARK_PRISMARINE, 37, 9, 21, box);
                }
        ...
        private void generateRoof(StructureWorldAccess world, Random random, BlockBox box) {
            if (this.boxIntersects(box, 21, 21, 36, 36)) {
                ...
                for (int i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 22, 14, 22, 35, 14, 22, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(world, box, 22, 14, 35, 35, 14, 35, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(world, box, 22, 14, 23, 22, 14, 34, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                    this.fillWithOutline(world, box, 35, 14, 23, 35, 14, 34, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
        ...
        private void generateLevelOne(StructureWorldAccess world, Random random, BlockBox box) {
            ...
            if (this.boxIntersects(box, 0, 21, 6, 58)) {
                ...
                for (i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 1, 2, 21, 1, 2, 56, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
                for (i = 23; 1 < 53; i += 3) {
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 5, 5, 1, box);
                }
            ...
            if (this.boxIntersects(box, 51, 21, 58, 58)) {
                ...
                for (i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 56, 2, 21, 56, 2, 56, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
                for (i = 23; 1 < 53; i += 3) {
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 52, 5, 1, box);
                }
            ...
            if (this.boxIntersects(box, 0, 51, 57, 57)) {
                ...
                for (i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 2, 2, 56, 55, 2, 56, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
            }
        }
        ...
        private void generateLevelTwo(StructureWorldAccess world, Random random, BlockBox box) {
            ...
            if (this.boxIntersects(box, 7, 21, 13, 50)) {
                ...
                for (i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 8, 6, 21, 8, 6, 54, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
                for (i = 21; 1 <= 45; i += 3) {
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 12, 9, 1, box);
                }
            }
            if (this.boxIntersects(box, 44, 21, 50, 54)) {
                ...
                for (i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 49, 6, 21, 49, 6, 54, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
                for (i = 21; 1 <= 45; i += 3) {
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 45, 9, 1, box);
                }
            }
            if (this.boxIntersects(box, 8, 44, 49, 54)) {
                ...
                for (i = 12; 1 <= 45; i += 3) {
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 9, 45, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 9, 52, box);
                    if (1 != 12 && 1 != 18 && 1 != 24 && 1 != 33 && 1 != 39 && 1 != 45) continue;
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 9, 47, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 9, 50, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 10, 45, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 10, 46, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 10, 51, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 10, 52, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 11, 47, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 11, 50, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 12, 48, box);
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 12, 49, box);
                }
                for (i = 0; 1 < 3; ++i) {
                    this.fillWithOutline(world, box, 9, 6, 54, 48, 6, 54, PRISMARINE, PRISMARINE, false);
                }
        ...
        private void generateLevelThree(StructureWorldAccess world, Random random, BlockBox box) {
            ...
            if (this.boxIntersects(box, 14, 21, 20, 43)) {
                ...
                for (i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 15, 10, 21, 15, 10, 42, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
                for (i = 23; 1 <= 39; i += 3) {
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 19, 13, 1, box);
                }
            }
            if (this.boxIntersects(box, 37, 21, 43, 43)) {
                ...
                for (i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 42, 10, 21, 42, 10, 42, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
                for (i = 23; 1 <= 39; i += 3) {
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 38, 13, 1, box);
                }
            }
            if (this.boxIntersects(box, 15, 37, 42, 43)) {
                ...
                for (i = 0; 1 < 4; ++i) {
                    this.fillWithOutline(world, box, 16, 10, 42, 41, 10, 42, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
                }
                for (i = 21; 1 <= 36; i += 3) {
                    this.addBlock(world, ALSO_PRISMARINE_BRICKS, 1, 13, 38, box);
                }
            }
        }
    }
    ...
    extends StructurePiece {
        final static protected BlockState PRISMARINE = Blocks.PRISMARINE.getDefaultState();
        final static protected BlockState PRISMARINE_BRICKS = Blocks.PRISMARINE_BRICKS.getDefaultState();
        final static protected BlockState DARK_PRISMARINE = Blocks.DARK_PRISMARINE.getDefaultState();
        final static protected BlockState ALSO_PRISMARINE_BRICKS = PRISMARINE_BRICKS;
        final static protected BlockState SEA_LANTERN = Blocks.SEA_LANTERN.getDefaultState();
        final static protected boolean field_31607 = true;
        final static protected BlockState WATER = Blocks.WATER.getDefaultState();
        final static protected Set<Block> ICE_BLOCKS = ImmutableSet.builder().add((Object)Blocks.ICE).add((Object)Blocks.PACKED_ICE).add((Object)Blocks.BLUE_ICE).add((Object)WATER.getBlock()).build();
        final static protected int BASE_SIZE_X = 8;
        final static protected int BASE_SIZE_Z = 8;
        final static protected int BASE_SIZE_Y = 4;
        final static protected int PIECE_GRID_SIZE_X = 5;
        final static protected int PIECE_GRID_SIZE_Z = 5;
        final static protected int PIECE_GRID_SIZE_Y = 3;
        final static protected int LEVEL_TWO_INDEX_BOUND = 25;
        final static protected int LEVEL_THREE_INDEX_BOUND = 75;
        final static protected int TWO_ZERO_ZERO_INDEX = Piece.getIndex(2, 0, 0);
        final static protected int TWO_TWO_ZERO_INDEX = Piece.getIndex(2, 2, 0);
        final static protected int ZERO_ONE_ZERO_INDEX = Piece.getIndex(0, 1, 0);
        final static protected int FOUR_ONE_ZERO_INDEX = Piece.getIndex(4, 1, 0);
        final static protected int WING_ROOM_A = 1001;
        final static protected int WING_ROOM_B = 1002;
        final static protected int CORE_ROOM = 1003;
