...
extends StructurePiece {
    final protected StructurePoolElement poolElement;
    protected BlockPos pos;
    final private int groundLevelDelta;
    final protected BlockRotation rotation;
    final private List<JigsawJunction> junctions = Lists.newArrayList();
    ...
    public void translate(int x, int y, int z) {
        ...
        this.pos = this.pos.net_minecraft_util_math_BlockPos_add(x, y, z);
    }
