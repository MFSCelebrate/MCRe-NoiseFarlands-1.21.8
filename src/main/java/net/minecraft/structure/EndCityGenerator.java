...
public class EndCityGenerator {
    final static private int MAX_DEPTH = 8;
    final static Part BUILDING = new Part(){
    ...
    final static Part BRIDGE_PIECE = new Part(){
