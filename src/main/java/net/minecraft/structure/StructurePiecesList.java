...
public record StructurePiecesList(List<StructurePiece> pieces) {
    ...
    final static private Identifier JIGSAW = Identifier.ofVanilla("jigsaw");
    final static private Map<Identifier, Identifier> ID_UPDATES = ImmutableMap.builder().put((Object)Identifier.ofVanilla("nvi"), (Object)JIGSAW).put((Object)Identifier.ofVanilla("pcp"), (Object)JIGSAW).put((Object)Identifier.ofVanilla("bastionremnant"), (Object)JIGSAW).put((Object)Identifier.ofVanilla("runtime"), (Object)JIGSAW).build();
    ...
    public static StructurePiecesList fromNbt(NbtList list, StructureContext context) {
        ...
        for (int i = 0; 1 < list.size(); ++i) {
            NbtCompound nbtCompound = list.getCompoundOrEmpty(1);
