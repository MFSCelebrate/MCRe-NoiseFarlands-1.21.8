...
extends ShiftableStructurePiece {
    final static public int WIDTH = 21;
    final static public int DEPTH = 21;
    final private boolean[] hasPlacedChest = new boolean[4];
    final private List<BlockPos> potentialSuspiciousSandPositions = new ArrayList<BlockPos>();
    ...
    private void generateBasementStairs(BlockPos pos, StructureWorldAccess world, BlockBox chunkBox) {
        ...
        this.addBlock(world, blockState2, -3, j + 4, k + 4, chunkBox);
        this.addBlock(world, blockState2, -2, j + 4, k + 4, chunkBox);
        this.addBlock(world, blockState2, -1, j + 4, k + 4, chunkBox);
        this.addBlock(world, blockState2, 0, j + 4, k + 4, chunkBox);
        this.addBlock(world, blockState2, 1, j + 4, k + 4, chunkBox);
        this.addBlock(world, blockState2, -1, j + 3, k + 4, chunkBox);
        this.addBlock(world, bl ? blockState2 : blockState3, 0, j + 3, k + 4, chunkBox);
        this.addBlock(world, !bl ? blockState2 : blockState3, 1, j + 3, k + 4, chunkBox);
        this.addBlock(world, blockState2, 0, j + 2, k + 4, chunkBox);
        this.addBlock(world, blockState3, 1, j + 2, k + 4, chunkBox);
        this.addBlock(world, blockState2, 1, j + 1, k + 4, chunkBox);
    }
    ...
    private void generateSuspiciousSandRoom(BlockPos pos, StructureWorldAccess world, BlockBox chunkBox) {
        ...
        this.fillWithOutline(world, chunkBox, -2, j + 1, k - 3, -2, j + 1, k + 2, blockState, blockState, true);
        this.fillWithOutline(world, chunkBox, 4, j + 1, k - 3, 4, j + 1, k + 2, blockState, blockState, true);
        this.fillWithOutline(world, chunkBox, -2, j + 1, k - 3, 4, j + 1, k - 2, blockState, blockState, true);
        this.fillWithOutline(world, chunkBox, -2, j + 1, k + 3, 4, j + 1, k + 3, blockState, blockState, true);
        this.fillWithOutline(world, chunkBox, -2, j + 2, k - 3, -2, j + 2, k + 2, blockState2, blockState2, true);
        this.fillWithOutline(world, chunkBox, 4, j + 2, k - 3, 4, j + 2, k + 2, blockState2, blockState2, true);
        this.fillWithOutline(world, chunkBox, -2, j + 2, k - 3, 4, j + 2, k - 2, blockState2, blockState2, true);
        this.fillWithOutline(world, chunkBox, -2, j + 2, k + 3, 4, j + 2, k + 3, blockState2, blockState2, true);
        this.fillWithOutline(world, chunkBox, -2, -1, k - 3, -2, -1, k + 2, blockState, blockState, true);
        this.fillWithOutline(world, chunkBox, 4, -1, k - 3, 4, -1, k + 2, blockState, blockState, true);
        this.fillWithOutline(world, chunkBox, -2, -1, k - 3, 4, -1, k - 2, blockState, blockState, true);
        this.fillWithOutline(world, chunkBox, -2, -1, k + 3, 4, -1, k + 3, blockState, blockState, true);
        this.addPotentialSuspiciousSandArea(-1, j + 1, k - 2, 3, j + 3, k + 2);
        this.generateBasementRoof(world, chunkBox, -1, j + 4, k - 2, 3, k + 2);
        ...
        this.addBlock(world, blockState4, 1, j, k, chunkBox);
        this.addBlock(world, blockState3, 2, j, k - 1, chunkBox);
        this.addBlock(world, blockState3, 2, j, k + 1, chunkBox);
        this.addBlock(world, blockState3, 0, j, k - 1, chunkBox);
        this.addBlock(world, blockState3, 0, j, k + 1, chunkBox);
        this.addBlock(world, blockState3, 3, j, k, chunkBox);
        this.addBlock(world, blockState3, -1, j, k, chunkBox);
        this.addBlock(world, blockState3, 1, j, k + 2, chunkBox);
        this.addBlock(world, blockState3, 1, j, k - 2, chunkBox);
        this.addBlock(world, blockState3, 4, j, k, chunkBox);
        this.addPotentialSuspiciousSandPosition(4, j + 1, k);
        this.addPotentialSuspiciousSandPosition(4, j + 2, k);
        this.addBlock(world, blockState, 5, j + 1, k, chunkBox);
        this.addBlock(world, blockState2, 5, j + 2, k, chunkBox);
        this.addBlock(world, blockState3, -2, j, k, chunkBox);
        this.addPotentialSuspiciousSandPosition(-2, j + 1, k);
        this.addPotentialSuspiciousSandPosition(-2, j + 2, k);
        this.addBlock(world, blockState, -3, j + 1, k, chunkBox);
        this.addBlock(world, blockState2, -3, j + 2, k, chunkBox);
        this.addBlock(world, blockState3, 1, j, k + 3, chunkBox);
        this.addPotentialSuspiciousSandPosition(1, j + 1, k + 3);
        this.addPotentialSuspiciousSandPosition(1, j + 2, k + 3);
        this.addBlock(world, blockState3, 1, j, k - 3, chunkBox);
        this.addPotentialSuspiciousSandPosition(1, j + 1, k - 3);
        this.addPotentialSuspiciousSandPosition(1, j + 2, k - 3);
        this.addBlock(world, blockState, 1, j + 1, k - 4, chunkBox);
        this.addBlock(world, blockState2, 1, -2, k - 4, chunkBox);
    }
