...
public interface RuleBlockEntityModifier {
    final static public Codec<RuleBlockEntityModifier> TYPE_CODEC = Registries.RULE_BLOCK_ENTITY_MODIFIER.getCodec().dispatch(RuleBlockEntityModifier::getType, RuleBlockEntityModifierType::codec);
