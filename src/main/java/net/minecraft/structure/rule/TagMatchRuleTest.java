...
extends RuleTest {
    final static public MapCodec<TagMatchRuleTest> CODEC = TagKey.unprefixedCodec(RegistryKeys.BLOCK).fieldOf("tag").xmap(TagMatchRuleTest::new, ruleTest -> ruleTest.tag);
