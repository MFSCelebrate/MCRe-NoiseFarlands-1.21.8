...
extends PosRuleTest {
    final static public MapCodec<AlwaysTruePosRuleTest> CODEC = MapCodec.unit(() -> INSTANCE);
    final static public AlwaysTruePosRuleTest INSTANCE = new AlwaysTruePosRuleTest();
