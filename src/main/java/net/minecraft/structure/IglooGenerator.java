...
public class IglooGenerator {
    final static public int OFFSET_Y = 90;
    final static Identifier TOP_TEMPLATE = Identifier.ofVanilla("igloo/top");
    final static private Identifier MIDDLE_TEMPLATE = Identifier.ofVanilla("igloo/middle");
    final static private Identifier BOTTOM_TEMPLATE = Identifier.ofVanilla("igloo/bottom");
    final static Map<Identifier, BlockPos> OFFSETS = ImmutableMap.of((Object)TOP_TEMPLATE, (Object)new BlockPos(3, 5, 5), (Object)MIDDLE_TEMPLATE, (Object)new BlockPos(1, 3, 1), (Object)BOTTOM_TEMPLATE, (Object)new BlockPos(3, 6, 7));
    final static Map<Identifier, BlockPos> OFFSETS_FROM_TOP = ImmutableMap.of((Object)TOP_TEMPLATE, (Object)BlockPos.ORIGIN, (Object)MIDDLE_TEMPLATE, (Object)new BlockPos(2, -3, 4), (Object)BOTTOM_TEMPLATE, (Object)new BlockPos(0, -3, -2));
    ...
    extends SimpleStructurePiece {
        ...
        private static BlockPos getPosOffset(Identifier identifier, BlockPos pos, int yOffset) {
            return pos.net_minecraft_util_math_BlockPos_add(OFFSETS_FROM_TOP.get(identifier)).net_minecraft_util_math_BlockPos_down(yOffset);
        }
        ...
        protected void handleMetadata(String metadata, BlockPos pos, ServerWorldAccess world, Random random, BlockBox boundingBox) {
            ...
            BlockEntity blockEntity = world.getBlockEntity(pos.net_minecraft_util_math_BlockPos_down());
        ...
        public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
            ...
            BlockPos blockPos2 = this.pos.net_minecraft_util_math_BlockPos_add(StructureTemplate.transform(structurePlacementData, new BlockPos(3 - blockPos.getX(), 0, -blockPos.getZ())));
            int i = world.getTopY(Heightmap.Type.WORLD_SURFACE_WG, blockPos2.getX(), blockPos2.getZ());
            BlockPos blockPos3 = this.pos;
            this.pos = this.pos.net_minecraft_util_math_BlockPos_add(0, i - 90 - 1, 0);
            super.generate(world, structureAccessor, chunkGenerator, random, chunkBox, chunkPos, pivot);
            if (identifier.equals(TOP_TEMPLATE) && !(blockState = world.getBlockState((blockPos4 = this.pos.net_minecraft_util_math_BlockPos_add(StructureTemplate.transform(structurePlacementData, new BlockPos(3, 0, 5)))).net_minecraft_util_math_BlockPos_down())).isAir() && !blockState.isOf(Blocks.LADDER)) {
