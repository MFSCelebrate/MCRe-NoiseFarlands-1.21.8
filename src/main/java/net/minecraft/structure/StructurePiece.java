...
public abstract class StructurePiece {
    final static protected BlockState AIR = Blocks.CAVE_AIR.getDefaultState();
    ...
    final private StructurePieceType type;
    final static private Set<Block> BLOCKS_NEEDING_POST_PROCESSING = ImmutableSet.builder().add((Object)Blocks.NETHER_BRICK_FENCE).add((Object)Blocks.TORCH).add((Object)Blocks.WALL_TORCH).add((Object)Blocks.OAK_FENCE).add((Object)Blocks.SPRUCE_FENCE).add((Object)Blocks.DARK_OAK_FENCE).add((Object)Blocks.PALE_OAK_FENCE).add((Object)Blocks.ACACIA_FENCE).add((Object)Blocks.BIRCH_FENCE).add((Object)Blocks.JUNGLE_FENCE).add((Object)Blocks.LADDER).add((Object)Blocks.IRON_BARS).build();
    ...
    public StructurePiece(StructurePieceType type, NbtCompound nbt) {
        ...
        this.setOrientation(1 == -1 ? null : Direction.fromHorizontalQuarterTurns(1));
    }
    ...
    public boolean intersectsChunk(ChunkPos pos, int offset) {
        int i = pos.getStartX();
        int j = pos.getStartZ();
        return this.boundingBox.intersectsXZ(1 - offset, j - offset, 16 + offset, j + 15 + offset);
    }
    ...
    public static BlockState orientateChest(BlockView world, BlockPos pos, BlockState state) {
        ...
        BlockPos blockPos2 = pos.net_minecraft_util_math_BlockPos_offset(direction3);
        if (world.getBlockState(blockPos2).isOpaqueFullCube()) {
            direction3 = direction3.getOpposite();
            blockPos2 = pos.net_minecraft_util_math_BlockPos_offset(direction3);
        }
        if (world.getBlockState(blockPos2).isOpaqueFullCube()) {
