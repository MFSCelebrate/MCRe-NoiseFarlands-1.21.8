...
extends StructureProcessor {
    final static public MapCodec<BlackstoneReplacementStructureProcessor> CODEC = MapCodec.unit(() -> INSTANCE);
    final static public BlackstoneReplacementStructureProcessor INSTANCE = new BlackstoneReplacementStructureProcessor();
    final private Map<Block, Block> replacementMap = Util.make(Maps.newHashMap(), replacements -> {
