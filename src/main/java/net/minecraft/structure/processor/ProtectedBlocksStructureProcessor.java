...
extends StructureProcessor {
    final public TagKey<Block> protectedBlocksTag;
    final static public MapCodec<ProtectedBlocksStructureProcessor> CODEC = TagKey.codec(RegistryKeys.BLOCK).xmap(ProtectedBlocksStructureProcessor::new, processor -> processor.protectedBlocksTag).fieldOf("value");
