...
extends StructureProcessor {
    final static public MapCodec<BlockAgeStructureProcessor> CODEC = Codec.FLOAT.fieldOf("mossiness").xmap(BlockAgeStructureProcessor::new, processor -> Float.valueOf(processor.mossiness));
    final static private float field_31681 = 0.5f;
    final static private float field_31682 = 0.5f;
    final static private float field_31683 = 0.15f;
    final static private BlockState[] AGEABLE_SLABS = new BlockState[]{Blocks.STONE_SLAB.getDefaultState(), Blocks.STONE_BRICK_SLAB.getDefaultState()};
    final private float mossiness;
