...
public class StrongholdGenerator {
    final static private int field_31624 = 3;
    final static private int field_31625 = 3;
    final static private int field_31626 = 50;
    final static private int field_31627 = 10;
    final static private boolean field_31628 = true;
    final static public int field_36417 = 64;
    final static private PieceData[] ALL_PIECES = new PieceData[]{new PieceData(Corridor.class, 40, 0), new PieceData(PrisonHall.class, 5, 5), new PieceData(LeftTurn.class, 20, 0), new PieceData(RightTurn.class, 20, 0), new PieceData(SquareRoom.class, 10, 6), new PieceData(Stairs.class, 5, 5), new PieceData(SpiralStaircase.class, 5, 5), new PieceData(FiveWayCrossing.class, 5, 4), new PieceData(ChestCorridor.class, 5, 4), new PieceData(Library.class, 10, 2){
    ...
    static private List<PieceData> possiblePieces;
    static Class<? extends Piece> activePieceType;
    static private int totalWeight;
    final static StoneBrickRandomizer STONE_BRICK_RANDOMIZER;
    ...
    static class PieceData {
        final public Class<? extends Piece> pieceType;
    ...
    extends Piece {
        final static private int SIZE_X = 5;
        final static private int SIZE_Y = 5;
        final static private int SIZE_Z = 7;
        final private boolean leftExitExists;
        final private boolean rightExitExists;
    ...
    extends Piece {
        final static protected int SIZE_X = 9;
        final static protected int SIZE_Y = 5;
        final static protected int SIZE_Z = 11;
    ...
    extends Piece {
        final static protected int SIZE_X = 11;
        final static protected int SIZE_Y = 7;
        final static protected int SIZE_Z = 11;
        final protected int roomType;
    ...
    extends Piece {
        final static private int SIZE_X = 5;
        final static private int SIZE_Y = 11;
        final static private int SIZE_Z = 8;
    ...
    extends Piece {
        final static private int SIZE_X = 5;
        final static private int SIZE_Y = 11;
        final static private int SIZE_Z = 5;
        final private boolean isStructureStart;
    ...
    extends Piece {
        final static protected int SIZE_X = 10;
        final static protected int SIZE_Y = 9;
        final static protected int SIZE_Z = 11;
        final private boolean lowerLeftExists;
        final private boolean upperLeftExists;
        final private boolean lowerRightExists;
        final private boolean upperRightExists;
    ...
    extends Piece {
        final static protected int SIZE_X = 14;
        final static protected int field_31636 = 6;
        final static protected int SIZE_Y = 11;
        final static protected int SIZE_Z = 15;
        final private boolean tall;
    ...
    extends Piece {
        final static protected int SIZE_X = 11;
        final static protected int SIZE_Y = 8;
        final static protected int SIZE_Z = 16;
    ...
    extends StructurePiece {
        ...
        extends Enum<EntranceType> {
            final static public EntranceType OPENING = new EntranceType();
            final static public EntranceType WOOD_DOOR = new EntranceType();
            final static public EntranceType GRATES = new EntranceType();
            final static public EntranceType IRON_DOOR = new EntranceType();
            @Deprecated
            final static public Codec<EntranceType> CODEC;
            final static private EntranceType[] field_15292;
    ...
    extends SpiralStaircase {
        ...
        final public List<StructurePiece> pieces = Lists.newArrayList();
    ...
    extends Piece {
        final static protected int SIZE_X = 5;
        final static protected int SIZE_Y = 5;
        final static protected int SIZE_Z = 5;
