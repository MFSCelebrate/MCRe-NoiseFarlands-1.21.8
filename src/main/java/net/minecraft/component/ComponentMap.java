...
ComponentsAccess {
    final static public ComponentMap EMPTY = new ComponentMap(){
    ...
    final static public Codec<ComponentMap> CODEC = ComponentMap.createCodecFromValueMap(ComponentType.TYPE_TO_VALUE_MAP_CODEC);
    ...
    implements FabricComponentMapBuilder {
        final private Reference2ObjectMap<ComponentType<?>, Object> components = new Reference2ObjectArrayMap();
