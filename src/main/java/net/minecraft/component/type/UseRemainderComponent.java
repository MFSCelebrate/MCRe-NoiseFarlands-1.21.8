...
public record UseRemainderComponent(ItemStack convertInto) {
    final static public Codec<UseRemainderComponent> CODEC = ItemStack.CODEC.xmap(UseRemainderComponent::new, UseRemainderComponent::convertInto);
    final static public PacketCodec<RegistryByteBuf, UseRemainderComponent> PACKET_CODEC = PacketCodec.tuple(ItemStack.PACKET_CODEC, UseRemainderComponent::convertInto, UseRemainderComponent::new);
