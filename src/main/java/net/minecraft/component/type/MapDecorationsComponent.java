...
public record MapDecorationsComponent(Map<String, Decoration> decorations) {
    final static public MapDecorationsComponent DEFAULT = new MapDecorationsComponent(Map.of());
    final static public Codec<MapDecorationsComponent> CODEC = Codec.unboundedMap((Codec)Codec.STRING, Decoration.CODEC).xmap(MapDecorationsComponent::new, MapDecorationsComponent::decorations);
