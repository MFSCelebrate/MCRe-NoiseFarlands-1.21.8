...
implements TooltipAppender {
    final static public ItemEnchantmentsComponent DEFAULT = new ItemEnchantmentsComponent((Object2IntOpenHashMap<RegistryEntry<Enchantment>>)new Object2IntOpenHashMap());
    final static private Codec<Integer> ENCHANTMENT_LEVEL_CODEC = Codec.intRange(1, 255);
    final static public Codec<ItemEnchantmentsComponent> CODEC = Codec.unboundedMap(Enchantment.ENTRY_CODEC, ENCHANTMENT_LEVEL_CODEC).xmap(map -> new ItemEnchantmentsComponent((Object2IntOpenHashMap<RegistryEntry<Enchantment>>)new Object2IntOpenHashMap(map)), itemEnchantmentsComponent -> itemEnchantmentsComponent.enchantments);
    final static public PacketCodec<RegistryByteBuf, ItemEnchantmentsComponent> PACKET_CODEC = PacketCodec.tuple(PacketCodecs.map(Object2IntOpenHashMap::new, Enchantment.ENTRY_PACKET_CODEC, PacketCodecs.VAR_INT), component -> component.enchantments, ItemEnchantmentsComponent::new);
    ...
    ItemEnchantmentsComponent(Object2IntOpenHashMap<RegistryEntry<Enchantment>> enchantments) {
        ...
        for (Object2IntMap.Entry entry : enchantments.object2IntEntrySet()) {
            ...
            if (1 >= 0 && 1 <= 255) continue;
            throw new IllegalArgumentException("Enchantment " + String.valueOf(entry.getKey()) + " has invalid level " + 1);
        }
    }
    ...
    private static <T> RegistryEntryList<T> getTooltipOrderList(@Nullable RegistryWrapper.WrapperLookup registries, RegistryKey<Registry<T>> registryRef, TagKey<T> tooltipOrderTag) {
        ...
        if (registries != null && (optional = registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(registryRef).getOptional(tooltipOrderTag)).isPresent()) {
            return optional.get();
        }
    ...
    public static class Builder {
        final private Object2IntOpenHashMap<RegistryEntry<Enchantment>> enchantments = new Object2IntOpenHashMap();
