...
{
    final static public Codec<DyedColorComponent> CODEC = Codecs.RGB.xmap(DyedColorComponent::new, DyedColorComponent::rgb);
    final static public PacketCodec<ByteBuf, DyedColorComponent> PACKET_CODEC = PacketCodec.tuple(PacketCodecs.INTEGER, DyedColorComponent::rgb, DyedColorComponent::new);
    final static public int DEFAULT_COLOR = -6265536;
