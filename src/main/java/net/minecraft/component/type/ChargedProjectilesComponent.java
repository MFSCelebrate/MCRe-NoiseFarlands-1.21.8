...
implements TooltipAppender {
    final static public ChargedProjectilesComponent DEFAULT = new ChargedProjectilesComponent(List.of());
    final static public Codec<ChargedProjectilesComponent> CODEC = ItemStack.CODEC.listOf().xmap(ChargedProjectilesComponent::new, chargedProjectilesComponent -> chargedProjectilesComponent.projectiles);
    final static public PacketCodec<RegistryByteBuf, ChargedProjectilesComponent> PACKET_CODEC = ItemStack.PACKET_CODEC.collect(PacketCodecs.toList()).xmap(ChargedProjectilesComponent::new, component -> component.projectiles);
    final private List<ItemStack> projectiles;
