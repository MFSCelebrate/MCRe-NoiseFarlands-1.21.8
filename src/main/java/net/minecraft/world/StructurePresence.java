...
extends Enum<StructurePresence> {
    final static public StructurePresence START_PRESENT = new StructurePresence();
    final static public StructurePresence START_NOT_PRESENT = new StructurePresence();
    final static public StructurePresence CHUNK_LOAD_NEEDED = new StructurePresence();
    final static private StructurePresence[] field_36242;
    ...
    private static StructurePresence[] method_39843() {
