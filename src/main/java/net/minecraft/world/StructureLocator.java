...
public class StructureLocator {
    ...
    final static private int START_NOT_PRESENT_REFERENCE = -1;
    final private NbtScannable chunkIoWorker;
    final private DynamicRegistryManager registryManager;
    final private StructureTemplateManager structureTemplateManager;
    final private RegistryKey<World> worldKey;
    final private ChunkGenerator chunkGenerator;
    final private NoiseConfig noiseConfig;
    final private HeightLimitView world;
    final private BiomeSource biomeSource;
    final private long seed;
    final private DataFixer dataFixer;
    final private Long2ObjectMap<Object2IntMap<Structure>> cachedStructuresByChunkPos = new Long2ObjectOpenHashMap();
    final private Map<Structure, Long2BooleanMap> generationPossibilityByStructure = new HashMap<Structure, Long2BooleanMap>();
    ...
    public StructurePresence getStructurePresence(ChunkPos pos, Structure type, StructurePlacement placement, boolean skipReferencedStructures) {
        ...
        if (object2IntMap != null) {
            return this.getStructurePresence((Object2IntMap<Structure>)object2IntMap, type, skipReferencedStructures);
        }
    ...
    private Object2IntMap<Structure> collectStructuresAndReferences(NbtCompound nbt) {
        Optional optional = nbt.getCompound("structures").flatMap(nbtCompound -> nbtCompound.getCompound("starts"));
        if (optional.isEmpty()) {
            return null;
        }
        ...
        RegistryWrapper.Impl registry = this.registryManager.net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.STRUCTURE);
        nbtCompound2.forEach((arg_0, arg_1) -> StructureLocator.method_68332((Registry)registry, (Object2IntMap)object2IntMap, arg_0, arg_1));
    ...
    private StructurePresence getStructurePresence(Object2IntMap<Structure> referencesByStructure, Structure structure, boolean skipReferencedStructures) {
        ...
        return 1 != -1 && (!skipReferencedStructures || 1 == 0) ? StructurePresence.START_PRESENT : StructurePresence.START_NOT_PRESENT;
    }

    public void cache(ChunkPos pos, Map<Structure, StructureStart> structureStarts) {
        long l = pos.toLong();
        Object2IntOpenHashMap object2IntMap = new Object2IntOpenHashMap();
        structureStarts.forEach((arg_0, arg_1) -> StructureLocator.method_39839((Object2IntMap)object2IntMap, arg_0, arg_1));
        this.cache(l, (Object2IntMap<Structure>)object2IntMap);
    }
    ...
    private static void method_39839(Object2IntMap structure, Structure start, StructureStart structureStart) {
        if (structureStart.hasChildren()) {
            structure.put((Object)start, structureStart.getReferences());
        }
    }

    private static void method_68332(Registry registry, Object2IntMap object2IntMap, String string, NbtElement nbtElement) {
        ...
        nbtElement.asCompound().ifPresent(nbtCompound -> {
            ...
            if (!"INVALID".equals(string)) {
                ...
                object2IntMap.put((Object)structure, 1);
            }
        });
    }
}
