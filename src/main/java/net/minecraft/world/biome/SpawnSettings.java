...
public class SpawnSettings {
    ...
    public record SpawnDensity(double gravityLimit, double mass) {
        final static public Codec<SpawnDensity> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Codec.DOUBLE.fieldOf("energy_budget").forGetter(spawnDensity -> spawnDensity.gravityLimit), (App)Codec.DOUBLE.fieldOf("charge").forGetter(spawnDensity -> spawnDensity.mass)).apply((Applicative)instance, SpawnDensity::new));
    ...
    public static class Builder {
        final private Map<SpawnGroup, Pool.Builder<SpawnEntry>> spawners = Util.mapEnum(SpawnGroup.class, group -> Pool.builder());
        final private Map<EntityType<?>, SpawnDensity> spawnCosts = Maps.newLinkedHashMap();
