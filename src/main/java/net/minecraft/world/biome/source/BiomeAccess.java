...
public class BiomeAccess {
    final static public int CHUNK_CENTER_OFFSET = BiomeCoords.fromBlock(8);
    final static private int field_34466 = 2;
    final static private int field_34467 = 4;
    final static private int field_34468 = 3;
