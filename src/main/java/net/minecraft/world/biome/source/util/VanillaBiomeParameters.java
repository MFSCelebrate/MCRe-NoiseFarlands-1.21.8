...
public final class VanillaBiomeParameters {
    final static private float MAX_VALLEY_WEIRDNESS = 0.05f;
    final static private float MAX_LOW_WEIRDNESS = 0.26666668f;
    final static public float MAX_MID_WEIRDNESS = 0.4f;
    final static private float MAX_SECOND_HIGH_WEIRDNESS = 0.93333334f;
    final static private float field_34501 = 0.1f;
    final static public float MAX_HIGH_WEIRDNESS = 0.56666666f;
    final static private float MAX_PEAK_WEIRDNESS = 0.7666667f;
    final static public float field_35042 = -0.11f;
    final static public float field_35043 = 0.03f;
    final static public float field_35044 = 0.3f;
    final static public float field_35045 = -0.78f;
    final static public float field_35046 = -0.375f;
    final static private float field_39134 = -0.225f;
    final static private float field_39135 = 0.9f;
    final private MultiNoiseUtil.ParameterRange defaultParameter = MultiNoiseUtil.ParameterRange.of(-1.0f, 1.0f);
    final private MultiNoiseUtil.ParameterRange[] temperatureParameters = new MultiNoiseUtil.ParameterRange[]{MultiNoiseUtil.ParameterRange.of(-1.0f, -0.45f), MultiNoiseUtil.ParameterRange.of(-0.45f, -0.15f), MultiNoiseUtil.ParameterRange.of(-0.15f, 0.2f), MultiNoiseUtil.ParameterRange.of(0.2f, 0.55f), MultiNoiseUtil.ParameterRange.of(0.55f, 1.0f)};
    final private MultiNoiseUtil.ParameterRange[] humidityParameters = new MultiNoiseUtil.ParameterRange[]{MultiNoiseUtil.ParameterRange.of(-1.0f, -0.35f), MultiNoiseUtil.ParameterRange.of(-0.35f, -0.1f), MultiNoiseUtil.ParameterRange.of(-0.1f, 0.1f), MultiNoiseUtil.ParameterRange.of(0.1f, 0.3f), MultiNoiseUtil.ParameterRange.of(0.3f, 1.0f)};
    final private MultiNoiseUtil.ParameterRange[] erosionParameters = new MultiNoiseUtil.ParameterRange[]{MultiNoiseUtil.ParameterRange.of(-1.0f, -0.78f), MultiNoiseUtil.ParameterRange.of(-0.78f, -0.375f), MultiNoiseUtil.ParameterRange.of(-0.375f, -0.2225f), MultiNoiseUtil.ParameterRange.of(-0.2225f, 0.05f), MultiNoiseUtil.ParameterRange.of(0.05f, 0.45f), MultiNoiseUtil.ParameterRange.of(0.45f, 0.55f), MultiNoiseUtil.ParameterRange.of(0.55f, 1.0f)};
    final private MultiNoiseUtil.ParameterRange frozenTemperature = this.temperatureParameters[0];
    final private MultiNoiseUtil.ParameterRange nonFrozenTemperatureParameters = MultiNoiseUtil.ParameterRange.combine(this.temperatureParameters[1], this.temperatureParameters[4]);
    final private MultiNoiseUtil.ParameterRange mushroomFieldsContinentalness = MultiNoiseUtil.ParameterRange.of(-1.2f, -1.05f);
    final private MultiNoiseUtil.ParameterRange deepOceanContinentalness = MultiNoiseUtil.ParameterRange.of(-1.05f, -0.455f);
    final private MultiNoiseUtil.ParameterRange oceanContinentalness = MultiNoiseUtil.ParameterRange.of(-0.455f, -0.19f);
    final private MultiNoiseUtil.ParameterRange coastContinentalness = MultiNoiseUtil.ParameterRange.of(-0.19f, -0.11f);
    final private MultiNoiseUtil.ParameterRange riverContinentalness = MultiNoiseUtil.ParameterRange.of(-0.11f, 0.55f);
    final private MultiNoiseUtil.ParameterRange nearInlandContinentalness = MultiNoiseUtil.ParameterRange.of(-0.11f, 0.03f);
    final private MultiNoiseUtil.ParameterRange midInlandContinentalness = MultiNoiseUtil.ParameterRange.of(0.03f, 0.3f);
    final private MultiNoiseUtil.ParameterRange farInlandContinentalness = MultiNoiseUtil.ParameterRange.of(0.3f, 1.0f);
    final private RegistryKey<Biome>[][] oceanBiomes = new RegistryKey[][]{{BiomeKeys.DEEP_FROZEN_OCEAN, BiomeKeys.DEEP_COLD_OCEAN, BiomeKeys.DEEP_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN, BiomeKeys.WARM_OCEAN}, {BiomeKeys.FROZEN_OCEAN, BiomeKeys.COLD_OCEAN, BiomeKeys.OCEAN, BiomeKeys.LUKEWARM_OCEAN, BiomeKeys.WARM_OCEAN}};
    ...
    final private RegistryKey<Biome>[][] nearMountainBiomes = new RegistryKey[][]{{BiomeKeys.SNOWY_PLAINS, BiomeKeys.SNOWY_PLAINS, BiomeKeys.SNOWY_PLAINS, BiomeKeys.SNOWY_TAIGA, BiomeKeys.SNOWY_TAIGA}, {BiomeKeys.MEADOW, BiomeKeys.MEADOW, BiomeKeys.FOREST, BiomeKeys.TAIGA, BiomeKeys.OLD_GROWTH_SPRUCE_TAIGA}, {BiomeKeys.MEADOW, BiomeKeys.MEADOW, BiomeKeys.MEADOW, BiomeKeys.MEADOW, BiomeKeys.PALE_GARDEN}, {BiomeKeys.SAVANNA_PLATEAU, BiomeKeys.SAVANNA_PLATEAU, BiomeKeys.FOREST, BiomeKeys.FOREST, BiomeKeys.JUNGLE}, {BiomeKeys.BADLANDS, BiomeKeys.BADLANDS, BiomeKeys.BADLANDS, BiomeKeys.WOODED_BADLANDS, BiomeKeys.WOODED_BADLANDS}};
    ...
    private void writeDebug(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters) {
        ...
        RegistryEntryLookup registryEntryLookup = wrapperLookup.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.DENSITY_FUNCTION);
        ...
        parameters.accept((Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>)Pair.of((Object)MultiNoiseUtil.createNoiseHypercube(this.defaultParameter, this.defaultParameter, this.defaultParameter, this.defaultParameter, MultiNoiseUtil.ParameterRange.of(0.0f), this.defaultParameter, 0.01f), BiomeKeys.PLAINS));
        ...
        if (spline instanceof Spline.Implementation) {
            ...
            for (float f : implementation.locations()) {
                parameters.accept((Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>)Pair.of((Object)MultiNoiseUtil.createNoiseHypercube(this.defaultParameter, this.defaultParameter, this.defaultParameter, MultiNoiseUtil.ParameterRange.of(f), MultiNoiseUtil.ParameterRange.of(0.0f), this.defaultParameter, 0.0f), registryKey));
        ...
        if ((spline2 = VanillaTerrainParametersCreator.createOffsetSpline(densityFunctionWrapper, densityFunctionWrapper2, densityFunctionWrapper3, false)) instanceof Spline.Implementation) {
            ...
            for (float f : implementation2.locations()) {
                parameters.accept((Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>)Pair.of((Object)MultiNoiseUtil.createNoiseHypercube(this.defaultParameter, this.defaultParameter, MultiNoiseUtil.ParameterRange.of(f), this.defaultParameter, MultiNoiseUtil.ParameterRange.of(0.0f), this.defaultParameter, 0.0f), BiomeKeys.SNOWY_TAIGA));
            }
        }
    }
    ...
    private void writePeakBiomes(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters, MultiNoiseUtil.ParameterRange weirdness) {
        for (int i = 0; 1 < this.temperatureParameters.length; ++i) {
            MultiNoiseUtil.ParameterRange parameterRange = this.temperatureParameters[1];
            for (int j = 0; j < this.humidityParameters.length; ++j) {
                MultiNoiseUtil.ParameterRange parameterRange2 = this.humidityParameters[j];
                RegistryKey<Biome> registryKey = this.getRegularBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey2 = this.getBadlandsOrRegularBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey3 = this.getMountainStartBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey4 = this.getNearMountainBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey5 = this.getWindsweptOrRegularBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey6 = this.getBiomeOrWindsweptSavanna(1, j, weirdness, registryKey5);
                RegistryKey<Biome> registryKey7 = this.getPeakBiome(1, j, weirdness);
    ...
    private void writeHighBiomes(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters, MultiNoiseUtil.ParameterRange weirdness) {
        for (int i = 0; 1 < this.temperatureParameters.length; ++i) {
            ...
            for (int j = 0; j < this.humidityParameters.length; ++j) {
                ...
                RegistryKey<Biome> registryKey4 = this.getNearMountainBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey5 = this.getWindsweptOrRegularBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey6 = this.getBiomeOrWindsweptSavanna(1, j, weirdness, registryKey);
                RegistryKey<Biome> registryKey7 = this.getMountainSlopeBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey8 = this.getPeakBiome(1, j, weirdness);
    ...
    private void writeMidBiomes(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters, MultiNoiseUtil.ParameterRange weirdness) {
        ...
        for (int i = 0; 1 < this.temperatureParameters.length; ++i) {
            ...
            for (int j = 0; j < this.humidityParameters.length; ++j) {
                ...
                RegistryKey<Biome> registryKey2 = this.getBadlandsOrRegularBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey3 = this.getMountainStartBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey4 = this.getWindsweptOrRegularBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey5 = this.getNearMountainBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey6 = this.getShoreBiome(1, j);
                RegistryKey<Biome> registryKey7 = this.getBiomeOrWindsweptSavanna(1, j, weirdness, registryKey);
                RegistryKey<Biome> registryKey8 = this.getErodedShoreBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey9 = this.getMountainSlopeBiome(1, j, weirdness);
                ...
                this.writeBiomeParameters(parameters, parameterRange, parameterRange2, this.farInlandContinentalness, this.erosionParameters[1], weirdness, 0.0f, 1 == 0 ? registryKey9 : registryKey5);
    ...
    private void writeLowBiomes(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters, MultiNoiseUtil.ParameterRange weirdness) {
        ...
        for (int i = 0; 1 < this.temperatureParameters.length; ++i) {
            ...
            for (int j = 0; j < this.humidityParameters.length; ++j) {
                ...
                RegistryKey<Biome> registryKey2 = this.getBadlandsOrRegularBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey3 = this.getMountainStartBiome(1, j, weirdness);
                RegistryKey<Biome> registryKey4 = this.getShoreBiome(1, j);
                RegistryKey<Biome> registryKey5 = this.getBiomeOrWindsweptSavanna(1, j, weirdness, registryKey);
                RegistryKey<Biome> registryKey6 = this.getErodedShoreBiome(1, j, weirdness);
    ...
    private void writeValleyBiomes(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters, MultiNoiseUtil.ParameterRange weirdness) {
        ...
        for (int i = 0; 1 < this.temperatureParameters.length; ++i) {
            ...
            for (int j = 0; j < this.humidityParameters.length; ++j) {
                MultiNoiseUtil.ParameterRange parameterRange2 = this.humidityParameters[j];
                RegistryKey<Biome> registryKey = this.getBadlandsOrRegularBiome(1, j, weirdness);
    ...
    private void writeDeepDarkParameters(Consumer<Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>> parameters, MultiNoiseUtil.ParameterRange temperature, MultiNoiseUtil.ParameterRange humidity, MultiNoiseUtil.ParameterRange continentalness, MultiNoiseUtil.ParameterRange erosion, MultiNoiseUtil.ParameterRange weirdness, float offset, RegistryKey<Biome> biome) {
        parameters.accept((Pair<MultiNoiseUtil.NoiseHypercube, RegistryKey<Biome>>)Pair.of((Object)MultiNoiseUtil.createNoiseHypercube(temperature, humidity, continentalness, erosion, MultiNoiseUtil.ParameterRange.of(1.1f), weirdness, offset), biome));
    }
