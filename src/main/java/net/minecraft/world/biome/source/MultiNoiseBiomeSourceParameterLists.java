...
public class MultiNoiseBiomeSourceParameterLists {
    final static public RegistryKey<MultiNoiseBiomeSourceParameterList> NETHER = MultiNoiseBiomeSourceParameterLists.of("nether");
    final static public RegistryKey<MultiNoiseBiomeSourceParameterList> OVERWORLD = MultiNoiseBiomeSourceParameterLists.of("overworld");
