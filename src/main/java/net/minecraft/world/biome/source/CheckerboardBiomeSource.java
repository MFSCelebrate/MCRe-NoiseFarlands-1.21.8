...
extends BiomeSource {
    final static public MapCodec<CheckerboardBiomeSource> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Biome.REGISTRY_ENTRY_LIST_CODEC.fieldOf("biomes").forGetter(biomeSource -> biomeSource.biomeArray), (App)Codec.intRange(0, 62).fieldOf("scale").orElse((Object)2).forGetter(biomeSource -> biomeSource.scale)).apply((Applicative)instance, CheckerboardBiomeSource::new));
    final private RegistryEntryList<Biome> biomeArray;
