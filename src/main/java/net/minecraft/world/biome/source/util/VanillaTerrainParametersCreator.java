...
public class VanillaTerrainParametersCreator {
    final static private float field_38024 = -0.51f;
    final static private float field_38025 = -0.4f;
    final static private float field_38026 = 0.1f;
    final static private float field_38027 = -0.15f;
    final static private ToFloatFunction<Float> IDENTITY = ToFloatFunction.IDENTITY;
    final static private ToFloatFunction<Float> OFFSET_AMPLIFIER = ToFloatFunction.fromFloat(value -> value < 0.0f ? value : value * 2.0f);
    final static private ToFloatFunction<Float> FACTOR_AMPLIFIER = ToFloatFunction.fromFloat(value -> 1.25f - 6.25f / (value + 5.0f));
    final static private ToFloatFunction<Float> JAGGEDNESS_AMPLIFIER = ToFloatFunction.fromFloat(value -> value * 2.0f);
