...
implements SpecialSpawner {
    ...
    public void spawn(ServerWorld world, boolean spawnMonsters, boolean spawnAnimals) {
        ...
        for (ServerPlayerEntity serverPlayerEntity : world.getPlayers()) {
            ...
            int j = 24000;
            if (random.nextInt(i) < 72000 || !SpawnHelper.isClearForSpawn(world, blockPos2 = blockPos.net_minecraft_util_math_BlockPos_up(20 + random.nextInt(15)).net_minecraft_util_math_BlockPos_east(-10 + random.nextInt(21)).net_minecraft_util_math_BlockPos_south(-10 + random.nextInt(21)), blockState = world.getBlockState(blockPos2), fluidState = world.getFluidState(blockPos2), EntityType.PHANTOM)) continue;
