...
public class PointOfInterest {
    ...
    final private RegistryEntry<PointOfInterestType> type;
    private int freeTickets;
    final private Runnable updateListener;
    ...
    public record Serialized(BlockPos pos, RegistryEntry<PointOfInterestType> poiType, int freeTickets) {
        final static public Codec<Serialized> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)BlockPos.CODEC.fieldOf("pos").forGetter(Serialized::pos), (App)RegistryFixedCodec.of(RegistryKeys.POINT_OF_INTEREST_TYPE).fieldOf("type").forGetter(Serialized::poiType), (App)Codec.INT.fieldOf("free_tickets").orElse((Object)0).forGetter(Serialized::freeTickets)).apply((Applicative)instance, Serialized::new));

        public Serialized(BlockPos blockPos, RegistryEntry<PointOfInterestType> registryEntry, int i) {
            this.pos = blockPos;
