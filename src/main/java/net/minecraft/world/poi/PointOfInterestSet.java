...
public class PointOfInterestSet {
    ...
    final private Short2ObjectMap<PointOfInterest> pointsOfInterestByPos = new Short2ObjectOpenHashMap();
    final private Map<RegistryEntry<PointOfInterestType>, Set<PointOfInterest>> pointsOfInterestByType = Maps.newHashMap();
    ...
    private void method_20352(Short2ObjectMap short2ObjectMap, BlockPos pos, RegistryEntry poiEntry) {
