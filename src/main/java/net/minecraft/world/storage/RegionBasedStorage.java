...
implements AutoCloseable {
    final static public String MCA_EXTENSION = ".mca";
    final static private int MAX_CACHE_SIZE = 256;
    final private Long2ObjectLinkedOpenHashMap<RegionFile> cachedRegionFiles = new Long2ObjectLinkedOpenHashMap();
    final private StorageKey storageKey;
    final private Path directory;
    final private boolean dsync;
