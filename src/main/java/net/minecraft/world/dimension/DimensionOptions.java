...
public record DimensionOptions(RegistryEntry<DimensionType> dimensionTypeEntry, ChunkGenerator chunkGenerator) {
    final static public Codec<DimensionOptions> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)DimensionType.REGISTRY_CODEC.fieldOf("type").forGetter(DimensionOptions::dimensionTypeEntry), (App)ChunkGenerator.CODEC.fieldOf("generator").forGetter(DimensionOptions::chunkGenerator)).apply((Applicative)instance, instance.stable(DimensionOptions::new)));
    final static public RegistryKey<DimensionOptions> OVERWORLD = RegistryKey.of(RegistryKeys.DIMENSION, Identifier.ofVanilla("overworld"));
    final static public RegistryKey<DimensionOptions> NETHER = RegistryKey.of(RegistryKeys.DIMENSION, Identifier.ofVanilla("the_nether"));
    final static public RegistryKey<DimensionOptions> END = RegistryKey.of(RegistryKeys.DIMENSION, Identifier.ofVanilla("the_end"));
