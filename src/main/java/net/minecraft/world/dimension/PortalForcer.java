...
public class PortalForcer {
    final static public int field_31810 = 3;
    final static private int field_52248 = 16;
    final static private int field_52249 = 128;
    final static private int field_31813 = 5;
    final static private int field_31814 = 4;
    final static private int field_31815 = 3;
    final static private int field_31816 = -1;
    final static private int field_31817 = 4;
    final static private int field_31818 = -1;
    final static private int field_31819 = 3;
    final static private int field_31820 = -1;
    final static private int field_31821 = 2;
    final static private int field_31822 = -1;
    ...
    public Optional<BlockPos> getPortalPos(BlockPos pos, boolean destIsNether, WorldBorder worldBorder) {
        ...
        return pointOfInterestStorage.getInSquare(poiType -> poiType.matchesKey(PointOfInterestTypes.NETHER_PORTAL), pos, i, PointOfInterestStorage.OccupationStatus.ANY).map(PointOfInterest::getPos).filter(worldBorder::contains).filter(portalPos -> this.world.getBlockState((BlockPos)portalPos).contains(Properties.HORIZONTAL_AXIS)).min(Comparator.comparingDouble(portalPos -> portalPos.getSquaredDistance(pos)).thenComparingInt(Vec3i::getY));
    }
    ...
    public Optional<BlockLocating.Rectangle> createPortal(BlockPos pos, Direction.Axis axis) {
        ...
        for (BlockPos.Mutable mutable2 : BlockPos.iterateInSquare(pos, 16, Direction.EAST, Direction.SOUTH)) {
            ...
            for (l = k; l >= this.world.getBottomY(); --l) {
                mutable2.net_minecraft_util_math_BlockPos$Mutable_setY(l);
