...
public class LocalDifficulty {
    final static private float field_29953 = -72000.0f;
    final static private float field_29954 = 1440000.0f;
    final static private float field_29955 = 3600000.0f;
    final private Difficulty globalDifficulty;
    final private float localDifficulty;
