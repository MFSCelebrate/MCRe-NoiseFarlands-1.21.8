...
public class WorldBorder extends SavedData {
   public static final double MAX_SIZE = 4.294967292e9;
   public static final double MAX_CENTER_COORDINATE = 2.147483646e9;
   ...
   public record Settings(
      ...
      public static final WorldBorder.Settings DEFAULT = new WorldBorder.Settings(0.0, 0.0, 0.2, 5.0, 5, 300, 4.294967292e9F, 0L, 0.0);
      public static final Codec<WorldBorder.Settings> CODEC = RecordCodecBuilder.create(
         i -> i.group(
               Codec.doubleRange(-2.147483646e9, 2.147483646e9).fieldOf("center_x").forGetter(WorldBorder.Settings::centerX),
               Codec.doubleRange(-2.147483646e9, 2.147483646e9).fieldOf("center_z").forGetter(WorldBorder.Settings::centerZ),
