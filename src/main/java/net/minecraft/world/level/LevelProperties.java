...
SaveProperties {
    ...
    final static public String LEVEL_NAME_KEY = "LevelName";
    final static protected String PLAYER_KEY = "Player";
    final static protected String WORLD_GEN_SETTINGS_KEY = "WorldGenSettings";
    private LevelInfo levelInfo;
    final private GeneratorOptions generatorOptions;
    final private SpecialProperty specialProperty;
    ...
    @Nullable
    final private NbtCompound playerData;
    ...
    final private Set<String> serverBrands;
    private boolean modded;
    final private Set<String> removedFeatures;
    final private Timer<MinecraftServer> scheduledEvents;
    ...
    private void updateProperties(DynamicRegistryManager registryManager, NbtCompound levelNbt, @Nullable NbtCompound playerNbt) {
        ...
        WorldGenSettings.encode(dynamicOps, this.generatorOptions, registryManager).resultOrPartial(Util.addPrefix("WorldGenSettings: ", arg_0 -> ((Logger)LOGGER).error(arg_0))).ifPresent(nbtElement -> levelNbt.put(WORLD_GEN_SETTINGS_KEY, (NbtElement)nbtElement));
    ...
    extends Enum<SpecialProperty> {
        final static public SpecialProperty NONE = new SpecialProperty();
        final static public SpecialProperty FLAT = new SpecialProperty();
        final static public SpecialProperty DEBUG = new SpecialProperty();
        final static private SpecialProperty[] field_40376;

        public static SpecialProperty[] values() {
            return (SpecialProperty[])field_40376.clone();
        }

        public static SpecialProperty valueOf(String string) {
            return Enum.valueOf(SpecialProperty.class, string);
        }
        ...
        static {
            field_40376 = SpecialProperty.method_45559();
        }
    }
}
