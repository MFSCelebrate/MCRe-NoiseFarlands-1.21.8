...
public class ClientEntityManager<T extends EntityLike> {
    ...
    final private LongSet tickingChunkSections = new LongOpenHashSet();
    ...
    public ClientEntityManager(Class<T> entityClass, EntityHandler<T> handler) {
        ...
        this.cache = new SectionedEntityCache<T>(entityClass, (Long2ObjectFunction<EntityTrackingStatus>)((Long2ObjectFunction)pos -> this.tickingChunkSections.contains(pos) ? EntityTrackingStatus.TICKING : EntityTrackingStatus.TRACKED));
    ...
    implements EntityChangeListener {
        ...
        final ClientEntityManager manager;
