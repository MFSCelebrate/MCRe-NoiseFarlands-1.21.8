...
public class SectionedEntityCache<T extends EntityLike> {
    final static public int field_52653 = 2;
    final static public int field_52654 = 4;
    final private Class<T> entityClass;
    final private Long2ObjectFunction<EntityTrackingStatus> posToStatus;
    final private Long2ObjectMap<EntityTrackingSection<T>> trackingSections = new Long2ObjectOpenHashMap();
    final private LongSortedSet trackedPositions = new LongAVLTreeSet();
    ...
    private static void method_31780(LongSet trackingSection, long sectionPos) {
