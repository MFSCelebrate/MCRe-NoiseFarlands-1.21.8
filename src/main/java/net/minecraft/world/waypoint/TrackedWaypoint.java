...
implements Waypoint {
    ...
    static public PacketCodec<ByteBuf, TrackedWaypoint> PACKET_CODEC = PacketCodec.of(TrackedWaypoint::writeBuf, TrackedWaypoint::fromBuf);
    final protected Either<UUID, String> source;
    final private Waypoint.Config config;
    ...
    public abstract double getRelativeYaw(World var1, YawProvider var2);

    public abstract Pitch getPitch(World var1, PitchProvider var2);
    ...
    extends Enum<Type> {
        final static public Type EMPTY = new Type((TriFunction<Either<UUID, String>, Waypoint.Config, PacketByteBuf, TrackedWaypoint>)((TriFunction)Empty::new));
        final static public Type VEC3I = new Type((TriFunction<Either<UUID, String>, Waypoint.Config, PacketByteBuf, TrackedWaypoint>)((TriFunction)Positional::new));
        final static public Type CHUNK = new Type((TriFunction<Either<UUID, String>, Waypoint.Config, PacketByteBuf, TrackedWaypoint>)((TriFunction)ChunkBased::new));
        final static public Type AZIMUTH = new Type((TriFunction<Either<UUID, String>, Waypoint.Config, PacketByteBuf, TrackedWaypoint>)((TriFunction)Azimuth::new));
        final TriFunction<Either<UUID, String>, Waypoint.Config, PacketByteBuf, TrackedWaypoint> factory;
        final static private Type[] field_59783;
    ...
    extends Enum<Pitch> {
        final static public Pitch NONE = new Pitch();
        final static public Pitch UP = new Pitch();
        final static public Pitch DOWN = new Pitch();
        final static private Pitch[] field_60426;
