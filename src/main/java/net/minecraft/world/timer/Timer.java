...
public class Timer<T> {
    ...
    final static private String CALLBACK_KEY = "Callback";
    final static private String NAME_KEY = "Name";
    final static private String TRIGGER_TIME_KEY = "TriggerTime";
    final private TimerCallbackSerializer<T> callback;
    final private Queue<Event<T>> events = new PriorityQueue<Event<T>>(Timer.createEventComparator());
    private UnsignedLong eventCounter = UnsignedLong.ZERO;
    final private Table<String, Long, Event<T>> eventsByName = HashBasedTable.create();
    ...
    public static class Event<T> {
        final public long triggerTime;
        final public UnsignedLong id;
        final public String name;
        final public TimerCallback<T> callback;
