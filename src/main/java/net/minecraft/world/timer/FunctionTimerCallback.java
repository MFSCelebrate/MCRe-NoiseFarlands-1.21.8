...
{
    final static public MapCodec<FunctionTimerCallback> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Identifier.CODEC.fieldOf("Name").forGetter(FunctionTimerCallback::name)).apply((Applicative)instance, FunctionTimerCallback::new));
