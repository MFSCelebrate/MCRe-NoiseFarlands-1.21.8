...
extends ExplosionBehavior {
    final private boolean destroyBlocks;
    final private boolean damageEntities;
    final private Optional<Float> knockbackModifier;
    final private Optional<RegistryEntryList<Block>> immuneBlocks;
