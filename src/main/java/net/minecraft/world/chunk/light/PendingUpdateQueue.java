...
public class PendingUpdateQueue {
    ...
    final private LongLinkedOpenHashSet[] pendingIdUpdatesByLevel;
    ...
    public PendingUpdateQueue(int levelCount, final int expectedLevelSize) {
        ...
        for (int i = 0; 1 < levelCount; ++i) {
            this.pendingIdUpdatesByLevel[1] = new LongLinkedOpenHashSet(expectedLevelSize, 0.5f){
