...
public abstract class LightStorage<M extends ChunkToNibbleArrayMap<M>> {
    ...
    final protected Long2ByteMap sectionPropagations = new Long2ByteOpenHashMap();
    final private LongSet enabledColumns = new LongOpenHashSet();
    protected volatile M uncachedStorage;
    final protected M storage;
    final protected LongSet dirtySections = new LongOpenHashSet();
    final protected LongSet notifySections = new LongOpenHashSet();
    final protected Long2ObjectMap<ChunkNibbleArray> queuedSections = Long2ObjectMaps.synchronize((Long2ObjectMap)new Long2ObjectOpenHashMap());
    final private LongSet columnsToRetain = new LongOpenHashSet();
    final private LongSet sectionsToRemove = new LongOpenHashSet();
    ...
    protected LightStorage(LightType lightType, ChunkProvider chunkProvider, M lightData) {
        ...
        this.sectionPropagations.defaultReturnValue(0);
    }
    ...
    protected static class PropagationFlags {
        final static public byte field_44719 = 0;
        final static private int MIN_NEIGHBOR_COUNT = 0;
        final static private int MAX_NEIGHBOR_COUNT = 26;
        final static private byte field_44722 = 32;
        final static private byte NEIGHBOR_COUNT_MASK = 31;
    ...
    extends Enum<Status> {
        final static public Status EMPTY = new Status("2");
        final static public Status LIGHT_ONLY = new Status("1");
        final static public Status LIGHT_AND_DATA = new Status("0");
        final private String sigil;
        final static private Status[] field_44728;
