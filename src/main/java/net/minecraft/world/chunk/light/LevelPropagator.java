...
public abstract class LevelPropagator {
    final static public long field_43397 = Long.MAX_VALUE;
    final static private int MAX_LEVEL = 255;
    final protected int levelCount;
    final private PendingUpdateQueue pendingUpdateQueue;
    final private Long2ByteMap pendingUpdates;
    ...
    private static void method_24207(LongPredicate longPredicate, LongList longList, long l) {
