...
implements LightingView {
    final static public int field_31714 = 1;
    final static public LightingProvider DEFAULT = new LightingProvider();
    final protected HeightLimitView world;
    @Nullable
    final private ChunkLightProvider<?, ?> blockLightProvider;
    @Nullable
    final private ChunkLightProvider<?, ?> skyLightProvider;

    public LightingProvider(ChunkProvider chunkProvider, boolean hasBlockLight, boolean hasSkyLight) {
        this.world = chunkProvider.net_minecraft_world_BlockView_getWorld();
    ...
    public boolean isLightingEnabled(long sectionPos) {
        return this.blockLightProvider == null || ((LightStorage)this.blockLightProvider.lightStorage).isColumnEnabled(sectionPos) && (this.skyLightProvider == null || ((LightStorage)this.skyLightProvider.lightStorage).isColumnEnabled(sectionPos));
    }
