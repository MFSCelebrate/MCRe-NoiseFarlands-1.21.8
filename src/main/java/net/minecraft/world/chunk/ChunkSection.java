...
public class ChunkSection {
    final static public int field_31406 = 16;
    final static public int field_31407 = 16;
    final static public int field_31408 = 4096;
    final static public int field_34555 = 2;
    private short nonEmptyBlockCount;
    private short randomTickableBlockCount;
    private short nonEmptyFluidCount;
    final private PalettedContainer<BlockState> blockStateContainer;
    ...
    public ChunkSection(Registry<Biome> biomeRegistry) {
        ...
        this.biomeContainer = new PalettedContainer<RegistryEntry.Reference>(biomeRegistry.getIndexedEntries(), biomeRegistry.getOrThrow(BiomeKeys.PLAINS), PalettedContainer.PaletteProvider.BIOME);
    }
    ...
    public void toPacket(PacketByteBuf buf) {
        buf.net_minecraft_network_PacketByteBuf_writeShort(this.nonEmptyBlockCount);
