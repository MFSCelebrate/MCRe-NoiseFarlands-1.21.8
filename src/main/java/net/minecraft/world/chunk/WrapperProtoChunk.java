...
extends ProtoChunk {
    final private WorldChunk wrapped;
    final private boolean propagateToWrapped;

    public WrapperProtoChunk(WorldChunk wrapped, boolean propagateToWrapped) {
        super(wrapped.getPos(), UpgradeData.NO_UPGRADE_DATA, wrapped.heightLimitView, (Registry<Biome>)wrapped.getWorld().getRegistryManager().net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.BIOME), wrapped.getBlendingData());
    ...
    public CarvingMask getCarvingMask() {
        ...
        throw Util.getFatalOrPause(new UnsupportedOperationException("Meaningless in this context"));
    }
