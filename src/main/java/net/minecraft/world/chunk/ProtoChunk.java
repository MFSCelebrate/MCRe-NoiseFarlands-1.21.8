...
extends Chunk {
    ...
    final private List<NbtCompound> entities = Lists.newArrayList();
    @Nullable
    private CarvingMask carvingMask;
    @Nullable
    private BelowZeroRetrogen belowZeroRetrogen;
    final private SimpleTickScheduler<Block> blockTickScheduler;
    final private SimpleTickScheduler<Fluid> fluidTickScheduler;
    ...
    public BlockState setBlockState(BlockPos pos, BlockState state, int flags) {
        ...
        int m = ChunkSectionPos.getLocalCoord(1);
    ...
    public NbtCompound getPackedBlockEntityNbt(BlockPos pos, RegistryWrapper.WrapperLookup registries) {
        ...
        if (blockEntity != null) {
            return blockEntity.createNbtWithIdentifyingData(registries);
        }
