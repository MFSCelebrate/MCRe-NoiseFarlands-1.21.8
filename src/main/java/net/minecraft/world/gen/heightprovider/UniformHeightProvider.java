...
extends HeightProvider {
    ...
    public int get(Random random, HeightContext context) {
        ...
        if (1 > (j = this.maxOffset.getY(context))) {
            if (this.warnedEmptyHeightRanges.add(0x100000000L | (long)j)) {
