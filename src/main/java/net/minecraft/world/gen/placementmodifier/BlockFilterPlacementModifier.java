...
extends AbstractConditionalPlacementModifier {
    final static public MapCodec<BlockFilterPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)BlockPredicate.BASE_CODEC.fieldOf("predicate").forGetter(placementModifier -> placementModifier.predicate)).apply((Applicative)instance, BlockFilterPlacementModifier::new));
    final private BlockPredicate predicate;
