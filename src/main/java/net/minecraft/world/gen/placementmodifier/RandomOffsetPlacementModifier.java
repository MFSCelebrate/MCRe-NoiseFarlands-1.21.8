...
extends PlacementModifier {
    final static public MapCodec<RandomOffsetPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)IntProvider.createValidatingCodec(-16, 16).fieldOf("xz_spread").forGetter(placementModifier -> placementModifier.spreadXz), (App)IntProvider.createValidatingCodec(-16, 16).fieldOf("y_spread").forGetter(placementModifier -> placementModifier.spreadY)).apply((Applicative)instance, RandomOffsetPlacementModifier::new));
    final private IntProvider spreadXz;
    final private IntProvider spreadY;
    ...
    public Stream<BlockPos> getPositions(FeaturePlacementContext context, Random random, BlockPos pos) {
        ...
        return Stream.of(new BlockPos(1, j, k));
    }
