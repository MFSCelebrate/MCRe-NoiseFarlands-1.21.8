...
extends AbstractConditionalPlacementModifier {
    final static public MapCodec<SurfaceWaterDepthFilterPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.INT.fieldOf("max_water_depth").forGetter(placementModifier -> placementModifier.maxWaterDepth)).apply((Applicative)instance, SurfaceWaterDepthFilterPlacementModifier::new));
    final private int maxWaterDepth;
