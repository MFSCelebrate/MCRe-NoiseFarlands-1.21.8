...
extends AbstractCountPlacementModifier {
    final static public MapCodec<NoiseBasedCountPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.INT.fieldOf("noise_to_count_ratio").forGetter(placementModifier -> placementModifier.noiseToCountRatio), (App)Codec.DOUBLE.fieldOf("noise_factor").forGetter(placementModifier -> placementModifier.noiseFactor), (App)Codec.DOUBLE.fieldOf("noise_offset").orElse((Object)0.0).forGetter(placementModifier -> placementModifier.noiseOffset)).apply((Applicative)instance, NoiseBasedCountPlacementModifier::new));
    final private int noiseToCountRatio;
    final private double noiseFactor;
    final private double noiseOffset;
