...
extends AbstractCountPlacementModifier {
    final static public MapCodec<NoiseThresholdCountPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.DOUBLE.fieldOf("noise_level").forGetter(placementModifier -> placementModifier.noiseLevel), (App)Codec.INT.fieldOf("below_noise").forGetter(placementModifier -> placementModifier.belowNoise), (App)Codec.INT.fieldOf("above_noise").forGetter(placementModifier -> placementModifier.aboveNoise)).apply((Applicative)instance, NoiseThresholdCountPlacementModifier::new));
    final private double noiseLevel;
    final private int belowNoise;
    final private int aboveNoise;
