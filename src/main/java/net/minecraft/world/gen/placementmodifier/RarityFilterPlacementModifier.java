...
extends AbstractConditionalPlacementModifier {
    final static public MapCodec<RarityFilterPlacementModifier> MODIFIER_CODEC = Codecs.POSITIVE_INT.fieldOf("chance").xmap(RarityFilterPlacementModifier::new, placementModifier -> placementModifier.chance);
