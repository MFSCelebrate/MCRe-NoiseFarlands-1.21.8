...
extends AbstractConditionalPlacementModifier {
    final static private BiomePlacementModifier INSTANCE = new BiomePlacementModifier();
    static public MapCodec<BiomePlacementModifier> MODIFIER_CODEC = MapCodec.unit(() -> INSTANCE);
