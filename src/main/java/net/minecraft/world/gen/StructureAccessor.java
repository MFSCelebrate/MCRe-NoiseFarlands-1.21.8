...
public class StructureAccessor {
    ...
    final private GeneratorOptions options;
    final private StructureLocator locator;
    ...
    public StructureStart getStructureContaining(BlockPos pos, Predicate<RegistryEntry<Structure>> predicate) {
        RegistryWrapper.Impl registry = this.getRegistryManager().net_minecraft_registry_RegistryWrapper$Impl_getOrThrow(RegistryKeys.STRUCTURE);
    ...
    private static boolean method_41414(Registry registry, Predicate predicate, Structure structure) {
