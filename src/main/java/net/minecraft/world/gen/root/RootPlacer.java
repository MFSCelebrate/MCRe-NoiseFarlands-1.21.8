...
public abstract class RootPlacer {
    final static public Codec<RootPlacer> TYPE_CODEC = Registries.ROOT_PLACER_TYPE.getCodec().dispatch(RootPlacer::getType, RootPlacerType::getCodec);
    final protected IntProvider trunkOffsetY;
    final protected BlockStateProvider rootProvider;
    final protected Optional<AboveRootPlacement> aboveRootPlacement;
    ...
    public BlockPos trunkOffset(BlockPos pos, Random random) {
        return pos.net_minecraft_util_math_BlockPos_up(this.trunkOffsetY.get(random));
    }
}
