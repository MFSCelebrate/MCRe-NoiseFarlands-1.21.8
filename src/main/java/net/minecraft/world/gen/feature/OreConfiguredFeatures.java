...
public class OreConfiguredFeatures {
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_MAGMA = ConfiguredFeatures.of("ore_magma");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_SOUL_SAND = ConfiguredFeatures.of("ore_soul_sand");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_NETHER_GOLD = ConfiguredFeatures.of("ore_nether_gold");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_QUARTZ = ConfiguredFeatures.of("ore_quartz");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_GRAVEL_NETHER = ConfiguredFeatures.of("ore_gravel_nether");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_BLACKSTONE = ConfiguredFeatures.of("ore_blackstone");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_DIRT = ConfiguredFeatures.of("ore_dirt");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_GRAVEL = ConfiguredFeatures.of("ore_gravel");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_GRANITE = ConfiguredFeatures.of("ore_granite");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_DIORITE = ConfiguredFeatures.of("ore_diorite");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_ANDESITE = ConfiguredFeatures.of("ore_andesite");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_TUFF = ConfiguredFeatures.of("ore_tuff");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_COAL = ConfiguredFeatures.of("ore_coal");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_COAL_BURIED = ConfiguredFeatures.of("ore_coal_buried");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_IRON = ConfiguredFeatures.of("ore_iron");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_IRON_SMALL = ConfiguredFeatures.of("ore_iron_small");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_GOLD = ConfiguredFeatures.of("ore_gold");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_GOLD_BURIED = ConfiguredFeatures.of("ore_gold_buried");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_REDSTONE = ConfiguredFeatures.of("ore_redstone");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_DIAMOND_SMALL = ConfiguredFeatures.of("ore_diamond_small");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_DIAMOND_MEDIUM = ConfiguredFeatures.of("ore_diamond_medium");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_DIAMOND_LARGE = ConfiguredFeatures.of("ore_diamond_large");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_DIAMOND_BURIED = ConfiguredFeatures.of("ore_diamond_buried");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_LAPIS = ConfiguredFeatures.of("ore_lapis");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_LAPIS_BURIED = ConfiguredFeatures.of("ore_lapis_buried");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_INFESTED = ConfiguredFeatures.of("ore_infested");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_EMERALD = ConfiguredFeatures.of("ore_emerald");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_ANCIENT_DEBRIS_LARGE = ConfiguredFeatures.of("ore_ancient_debris_large");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_ANCIENT_DEBRIS_SMALL = ConfiguredFeatures.of("ore_ancient_debris_small");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_COPPER_SMALL = ConfiguredFeatures.of("ore_copper_small");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_COPPER_LARGE = ConfiguredFeatures.of("ore_copper_large");
    final static public RegistryKey<ConfiguredFeature<?, ?>> ORE_CLAY = ConfiguredFeatures.of("ore_clay");
