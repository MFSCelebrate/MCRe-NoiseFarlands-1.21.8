...
extends Feature<DefaultFeatureConfig> {
    final static private BlockPos START_BLOCK = new BlockPos(8, 3, 8);
    final static private ChunkPos START_CHUNK = new ChunkPos(START_BLOCK);
    final static private int MAX_RADIUS = 16;
    final static private int field_31521 = 1;
