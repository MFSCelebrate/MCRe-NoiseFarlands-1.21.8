...
extends Feature<GeodeFeatureConfig> {
    ...
    public boolean generate(FeatureContext<GeodeFeatureConfig> context) {
        ...
        for (n = 0; n < k; ++n) {
            ...
            BlockPos blockPos2 = blockPos.net_minecraft_util_math_BlockPos_add(o, p = geodeFeatureConfig.outerWallDistance.get(random), q = geodeFeatureConfig.outerWallDistance.get(random));
        ...
        if (bl) {
            ...
            o = k * 2 + 1;
            if (n == 0) {
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(o, 7, 0));
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(o, 5, 0));
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(o, 1, 0));
            } else if (n == 1) {
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(0, 7, o));
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(0, 5, o));
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(0, 1, o));
            } else if (n == 2) {
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(o, 7, o));
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(o, 5, o));
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(o, 1, o));
            } else {
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(0, 7, 0));
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(0, 5, 0));
                list2.add(blockPos.net_minecraft_util_math_BlockPos_add(0, 1, 0));
            }
        }
        ArrayList list3 = Lists.newArrayList();
        Predicate<BlockState> predicate = GeodeFeature.notInBlockTagPredicate(geodeFeatureConfig.layerConfig.cannotReplace);
        for (BlockPos blockPos3 : BlockPos.iterate(blockPos.net_minecraft_util_math_BlockPos_add(i, i, i), blockPos.net_minecraft_util_math_BlockPos_add(j, j, j))) {
            ...
            if (bl && t >= l && s < e) {
                ...
                for (Direction direction : DIRECTIONS) {
                    BlockPos blockPos5 = blockPos3.net_minecraft_util_math_BlockPos_offset(direction);
        ...
        block5: for (BlockPos blockPos2 : list3) {
            ...
            for (Direction direction2 : DIRECTIONS) {
                ...
                BlockPos blockPos6 = blockPos2.net_minecraft_util_math_BlockPos_offset(direction2);
