...
public class VegetationConfiguredFeatures {
    final static public RegistryKey<ConfiguredFeature<?, ?>> BAMBOO_NO_PODZOL = ConfiguredFeatures.of("bamboo_no_podzol");
    final static public RegistryKey<ConfiguredFeature<?, ?>> BAMBOO_SOME_PODZOL = ConfiguredFeatures.of("bamboo_some_podzol");
    final static public RegistryKey<ConfiguredFeature<?, ?>> VINES = ConfiguredFeatures.of("vines");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_BROWN_MUSHROOM = ConfiguredFeatures.of("patch_brown_mushroom");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_RED_MUSHROOM = ConfiguredFeatures.of("patch_red_mushroom");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_SUNFLOWER = ConfiguredFeatures.of("patch_sunflower");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_PUMPKIN = ConfiguredFeatures.of("patch_pumpkin");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_BERRY_BUSH = ConfiguredFeatures.of("patch_berry_bush");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_TAIGA_GRASS = ConfiguredFeatures.of("patch_taiga_grass");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_GRASS = ConfiguredFeatures.of("patch_grass");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_GRASS_MEADOW = ConfiguredFeatures.of("patch_grass_meadow");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_GRASS_JUNGLE = ConfiguredFeatures.of("patch_grass_jungle");
    final static public RegistryKey<ConfiguredFeature<?, ?>> SINGLE_PIECE_OF_GRASS = ConfiguredFeatures.of("single_piece_of_grass");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_DEAD_BUSH = ConfiguredFeatures.of("patch_dead_bush");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_DRY_GRASS = ConfiguredFeatures.of("patch_dry_grass");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_MELON = ConfiguredFeatures.of("patch_melon");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_WATERLILY = ConfiguredFeatures.of("patch_waterlily");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_TALL_GRASS = ConfiguredFeatures.of("patch_tall_grass");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_LARGE_FERN = ConfiguredFeatures.of("patch_large_fern");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_BUSH = ConfiguredFeatures.of("patch_bush");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_LEAF_LITTER = ConfiguredFeatures.of("patch_leaf_litter");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_FIREFLY_BUSH = ConfiguredFeatures.of("patch_firefly_bush");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_CACTUS = ConfiguredFeatures.of("patch_cactus");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PATCH_SUGAR_CANE = ConfiguredFeatures.of("patch_sugar_cane");
    final static public RegistryKey<ConfiguredFeature<?, ?>> FLOWER_DEFAULT = ConfiguredFeatures.of("flower_default");
    final static public RegistryKey<ConfiguredFeature<?, ?>> FLOWER_FLOWER_FOREST = ConfiguredFeatures.of("flower_flower_forest");
    final static public RegistryKey<ConfiguredFeature<?, ?>> FLOWER_SWAMP = ConfiguredFeatures.of("flower_swamp");
    final static public RegistryKey<ConfiguredFeature<?, ?>> FLOWER_PLAIN = ConfiguredFeatures.of("flower_plain");
    final static public RegistryKey<ConfiguredFeature<?, ?>> FLOWER_MEADOW = ConfiguredFeatures.of("flower_meadow");
    final static public RegistryKey<ConfiguredFeature<?, ?>> FLOWER_CHERRY = ConfiguredFeatures.of("flower_cherry");
    final static public RegistryKey<ConfiguredFeature<?, ?>> FLOWER_PALE_GARDEN = ConfiguredFeatures.of("flower_pale_garden");
    final static public RegistryKey<ConfiguredFeature<?, ?>> WILDFLOWERS_BIRCH_FOREST = ConfiguredFeatures.of("wildflowers_birch_forest");
    final static public RegistryKey<ConfiguredFeature<?, ?>> WILDFLOWERS_MEADOW = ConfiguredFeatures.of("wildflowers_meadow");
    final static public RegistryKey<ConfiguredFeature<?, ?>> FOREST_FLOWERS = ConfiguredFeatures.of("forest_flowers");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PALE_FOREST_FLOWERS = ConfiguredFeatures.of("pale_forest_flowers");
    final static public RegistryKey<ConfiguredFeature<?, ?>> DARK_FOREST_VEGETATION = ConfiguredFeatures.of("dark_forest_vegetation");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PALE_GARDEN_VEGETATION = ConfiguredFeatures.of("pale_garden_vegetation");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PALE_MOSS_VEGETATION = ConfiguredFeatures.of("pale_moss_vegetation");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PALE_MOSS_PATCH = ConfiguredFeatures.of("pale_moss_patch");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PALE_MOSS_PATCH_BONEMEAL = ConfiguredFeatures.of("pale_moss_patch_bonemeal");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_FLOWER_FOREST = ConfiguredFeatures.of("trees_flower_forest");
    final static public RegistryKey<ConfiguredFeature<?, ?>> MEADOW_TREES = ConfiguredFeatures.of("meadow_trees");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_TAIGA = ConfiguredFeatures.of("trees_taiga");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_BADLANDS = ConfiguredFeatures.of("trees_badlands");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_GROVE = ConfiguredFeatures.of("trees_grove");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_SAVANNA = ConfiguredFeatures.of("trees_savanna");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_SNOWY = ConfiguredFeatures.of("trees_snowy");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_BIRCH = ConfiguredFeatures.of("trees_birch");
    final static public RegistryKey<ConfiguredFeature<?, ?>> BIRCH_TALL = ConfiguredFeatures.of("birch_tall");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_WINDSWEPT_HILLS = ConfiguredFeatures.of("trees_windswept_hills");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_WATER = ConfiguredFeatures.of("trees_water");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_BIRCH_AND_OAK = ConfiguredFeatures.of("trees_birch_and_oak_leaf_litter");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_PLAINS = ConfiguredFeatures.of("trees_plains");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_SPARSE_JUNGLE = ConfiguredFeatures.of("trees_sparse_jungle");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_OLD_GROWTH_SPRUCE_TAIGA = ConfiguredFeatures.of("trees_old_growth_spruce_taiga");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_OLD_GROWTH_PINE_TAIGA = ConfiguredFeatures.of("trees_old_growth_pine_taiga");
    final static public RegistryKey<ConfiguredFeature<?, ?>> TREES_JUNGLE = ConfiguredFeatures.of("trees_jungle");
    final static public RegistryKey<ConfiguredFeature<?, ?>> BAMBOO_VEGETATION = ConfiguredFeatures.of("bamboo_vegetation");
    final static public RegistryKey<ConfiguredFeature<?, ?>> MUSHROOM_ISLAND_VEGETATION = ConfiguredFeatures.of("mushroom_island_vegetation");
    final static public RegistryKey<ConfiguredFeature<?, ?>> MANGROVE_VEGETATION = ConfiguredFeatures.of("mangrove_vegetation");
    final static private float FALLEN_TREE_RARITY = 80.0f;
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        RegistryEntry.Reference<PlacedFeature> registryEntry6 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.PALE_OAK_CHECKED);
        RegistryEntry.Reference<PlacedFeature> registryEntry7 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.PALE_OAK_CREAKING_CHECKED);
        ...
        RegistryEntry.Reference<PlacedFeature> registryEntry18 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.BIRCH_BEES_002_LEAF_LITTER);
        RegistryEntry.Reference<PlacedFeature> registryEntry19 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FANCY_OAK_BEES_0002);
        RegistryEntry.Reference<PlacedFeature> registryEntry20 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.JUNGLE_BUSH);
        RegistryEntry.Reference<PlacedFeature> registryEntry21 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.MEGA_SPRUCE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> registryEntry22 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.MEGA_PINE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> registryEntry23 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.MEGA_JUNGLE_TREE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> registryEntry24 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.TALL_MANGROVE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> registryEntry25 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.OAK_CHECKED);
        RegistryEntry.Reference<PlacedFeature> registryEntry26 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.OAK_BEES_002);
        RegistryEntry.Reference<PlacedFeature> registryEntry27 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.SUPER_BIRCH_BEES);
        RegistryEntry.Reference<PlacedFeature> registryEntry28 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.SPRUCE_ON_SNOW);
        RegistryEntry.Reference<PlacedFeature> registryEntry29 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.OAK_BEES_0002);
        RegistryEntry.Reference<PlacedFeature> registryEntry30 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.JUNGLE_TREE);
        RegistryEntry.Reference<PlacedFeature> registryEntry31 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.MANGROVE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> registryEntry32 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.OAK_LEAF_LITTER);
        RegistryEntry.Reference<PlacedFeature> registryEntry33 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.DARK_OAK_LEAF_LITTER);
        RegistryEntry.Reference<PlacedFeature> registryEntry34 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.BIRCH_LEAF_LITTER);
        RegistryEntry.Reference<PlacedFeature> registryEntry35 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FANCY_OAK_LEAF_LITTER);
        RegistryEntry.Reference<PlacedFeature> registryEntry36 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_OAK_TREE);
        RegistryEntry.Reference<PlacedFeature> registryEntry37 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_BIRCH_TREE);
        RegistryEntry.Reference<PlacedFeature> registryEntry38 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_SUPER_BIRCH_TREE);
        RegistryEntry.Reference<PlacedFeature> registryEntry39 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_JUNGLE_TREE);
        RegistryEntry.Reference<PlacedFeature> registryEntry40 = registryEntryLookup2.getOrThrow(TreePlacedFeatures.FALLEN_SPRUCE_TREE);
        ...
        ConfiguredFeatures.register(featureRegisterable, DARK_FOREST_VEGETATION, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(PlacedFeatures.createEntry(registryEntry, new PlacementModifier[0]), 0.025f), new RandomFeatureEntry(PlacedFeatures.createEntry(registryEntry2, new PlacementModifier[0]), 0.05f), new RandomFeatureEntry(registryEntry33, 0.6666667f), new RandomFeatureEntry(registryEntry37, 0.0025f), new RandomFeatureEntry(registryEntry34, 0.2f), new RandomFeatureEntry(registryEntry36, 0.0125f), new RandomFeatureEntry(registryEntry35, 0.1f)), registryEntry32));
        ...
        ConfiguredFeatures.register(featureRegisterable, TREES_PLAINS, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(PlacedFeatures.createEntry(registryEntry3, new PlacementModifier[0]), 0.33333334f), new RandomFeatureEntry(registryEntry36, 0.0125f)), PlacedFeatures.createEntry(registryEntry4, new PlacementModifier[0])));
        ...
        ConfiguredFeatures.register(featureRegisterable, BAMBOO_VEGETATION, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(registryEntry8, 0.05f), new RandomFeatureEntry(registryEntry20, 0.15f), new RandomFeatureEntry(registryEntry23, 0.7f)), PlacedFeatures.createEntry(registryEntry5, new PlacementModifier[0])));
