...
public record ConfiguredFeature<FC extends FeatureConfig, F extends Feature<FC>>(F feature, FC config) {
    final static public Codec<ConfiguredFeature<?, ?>> CODEC = Registries.FEATURE.getCodec().dispatch(configuredFeature -> configuredFeature.feature, Feature::getCodec);
    final static public Codec<RegistryEntry<ConfiguredFeature<?, ?>>> REGISTRY_CODEC = RegistryElementCodec.of(RegistryKeys.CONFIGURED_FEATURE, CODEC);
    final static public Codec<RegistryEntryList<ConfiguredFeature<?, ?>>> LIST_CODEC = RegistryCodecs.entryList(RegistryKeys.CONFIGURED_FEATURE, CODEC);
