...
extends Feature<FallenTreeFeatureConfig> {
    final static private int field_57808 = 1;
    final static private int field_57811 = 2;
    final static private int field_57812 = 5;
    final static private int field_57813 = 2;
    final static private int field_57809 = 2;
    final static private int field_57810 = 19;
    ...
    private void generate(FallenTreeFeatureConfig config, BlockPos pos, StructureWorldAccess world, Random random) {
        ...
        BlockPos.Mutable mutable = pos.net_minecraft_util_math_BlockPos_offset(direction, 2 + random.nextInt(2)).mutableCopy();
    ...
    private boolean isSolidBelow(WorldAccess world, BlockPos pos) {
        return world.getBlockState(pos.net_minecraft_util_math_BlockPos_down()).isSideSolidFullSquare(world, pos, Direction.UP);
    }
