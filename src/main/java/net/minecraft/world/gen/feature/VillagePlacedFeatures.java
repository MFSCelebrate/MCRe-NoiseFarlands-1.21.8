...
public class VillagePlacedFeatures {
    final static public RegistryKey<PlacedFeature> PILE_HAY = PlacedFeatures.of("pile_hay");
    final static public RegistryKey<PlacedFeature> PILE_MELON = PlacedFeatures.of("pile_melon");
    final static public RegistryKey<PlacedFeature> PILE_SNOW = PlacedFeatures.of("pile_snow");
    final static public RegistryKey<PlacedFeature> PILE_ICE = PlacedFeatures.of("pile_ice");
    final static public RegistryKey<PlacedFeature> PILE_PUMPKIN = PlacedFeatures.of("pile_pumpkin");
    final static public RegistryKey<PlacedFeature> OAK = PlacedFeatures.of("oak");
    final static public RegistryKey<PlacedFeature> ACACIA = PlacedFeatures.of("acacia");
    final static public RegistryKey<PlacedFeature> SPRUCE = PlacedFeatures.of("spruce");
    final static public RegistryKey<PlacedFeature> PINE = PlacedFeatures.of("pine");
    final static public RegistryKey<PlacedFeature> PATCH_CACTUS = PlacedFeatures.of("patch_cactus");
    final static public RegistryKey<PlacedFeature> FLOWER_PLAIN = PlacedFeatures.of("flower_plain");
    final static public RegistryKey<PlacedFeature> PATCH_TAIGA_GRASS = PlacedFeatures.of("patch_taiga_grass");
    final static public RegistryKey<PlacedFeature> PATCH_BERRY_BUSH = PlacedFeatures.of("patch_berry_bush");
