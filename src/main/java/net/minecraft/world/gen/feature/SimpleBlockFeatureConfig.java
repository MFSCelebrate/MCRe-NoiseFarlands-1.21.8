...
{
    final static public Codec<SimpleBlockFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)BlockStateProvider.TYPE_CODEC.fieldOf("to_place").forGetter(config -> config.toPlace), (App)Codec.BOOL.optionalFieldOf("schedule_tick", (Object)false).forGetter(simpleBlockFeatureConfig -> simpleBlockFeatureConfig.scheduleTick)).apply((Applicative)instance, SimpleBlockFeatureConfig::new));
