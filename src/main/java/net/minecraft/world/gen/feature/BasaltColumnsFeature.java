...
extends Feature<BasaltColumnsFeatureConfig> {
    final static private ImmutableList<Block> CANNOT_REPLACE_BLOCKS = ImmutableList.of((Object)Blocks.LAVA, (Object)Blocks.BEDROCK, (Object)Blocks.MAGMA_BLOCK, (Object)Blocks.SOUL_SAND, (Object)Blocks.NETHER_BRICKS, (Object)Blocks.NETHER_BRICK_FENCE, (Object)Blocks.NETHER_BRICK_STAIRS, (Object)Blocks.NETHER_WART, (Object)Blocks.CHEST, (Object)Blocks.SPAWNER);
    final static private int field_31495 = 5;
    final static private int field_31496 = 50;
    final static private int field_31497 = 8;
    final static private int field_31498 = 15;
    ...
    private static boolean canPlaceAt(WorldAccess world, int seaLevel, BlockPos.Mutable mutablePos) {
        if (BasaltColumnsFeature.isAirOrLavaOcean(world, seaLevel, mutablePos)) {
            ...
            return !blockState.isAir() && !CANNOT_REPLACE_BLOCKS.contains((Object)blockState.getBlock());
        }
        return false;
    }
