...
public class PileConfiguredFeatures {
    final static public RegistryKey<ConfiguredFeature<?, ?>> PILE_HAY = ConfiguredFeatures.of("pile_hay");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PILE_MELON = ConfiguredFeatures.of("pile_melon");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PILE_SNOW = ConfiguredFeatures.of("pile_snow");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PILE_ICE = ConfiguredFeatures.of("pile_ice");
    final static public RegistryKey<ConfiguredFeature<?, ?>> PILE_PUMPKIN = ConfiguredFeatures.of("pile_pumpkin");
