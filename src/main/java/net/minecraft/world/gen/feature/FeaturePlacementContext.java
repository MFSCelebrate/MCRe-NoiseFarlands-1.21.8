...
extends HeightContext {
    ...
    final private Optional<PlacedFeature> placedFeature;
    ...
    public CarvingMask getOrCreateCarvingMask(ChunkPos chunkPos) {
        return ((ProtoChunk)this.world.net_minecraft_world_chunk_Chunk_getChunk(chunkPos.x, chunkPos.z)).getOrCreateCarvingMask();
    }
