...
extends Feature<DeltaFeatureConfig> {
    final static private ImmutableList<Block> CANNOT_REPLACE_BLOCKS = ImmutableList.of((Object)Blocks.BEDROCK, (Object)Blocks.NETHER_BRICKS, (Object)Blocks.NETHER_BRICK_FENCE, (Object)Blocks.NETHER_BRICK_STAIRS, (Object)Blocks.NETHER_WART, (Object)Blocks.CHEST, (Object)Blocks.SPAWNER);
    final static private Direction[] DIRECTIONS = Direction.values();
    final static private double field_31501 = 0.9;
    ...
    public boolean generate(FeatureContext<DeltaFeatureConfig> context) {
        ...
        for (BlockPos blockPos2 : BlockPos.iterateOutwards(blockPos, k, 0, l)) {
            ...
            if (!DeltaFeature.canPlace(structureWorldAccess, blockPos3 = blockPos2.net_minecraft_util_math_BlockPos_add(i, 0, j), deltaFeatureConfig)) continue;
            bl = true;
    ...
    private static boolean canPlace(WorldAccess world, BlockPos pos, DeltaFeatureConfig config) {
        ...
        for (Direction direction : DIRECTIONS) {
            boolean bl = world.getBlockState(pos.net_minecraft_util_math_BlockPos_offset(direction)).isAir();
