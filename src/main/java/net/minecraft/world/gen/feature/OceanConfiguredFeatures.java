...
public class OceanConfiguredFeatures {
    final static public RegistryKey<ConfiguredFeature<?, ?>> SEAGRASS_SHORT = ConfiguredFeatures.of("seagrass_short");
    final static public RegistryKey<ConfiguredFeature<?, ?>> SEAGRASS_SLIGHTLY_LESS_SHORT = ConfiguredFeatures.of("seagrass_slightly_less_short");
    final static public RegistryKey<ConfiguredFeature<?, ?>> SEAGRASS_MID = ConfiguredFeatures.of("seagrass_mid");
    final static public RegistryKey<ConfiguredFeature<?, ?>> SEAGRASS_TALL = ConfiguredFeatures.of("seagrass_tall");
    final static public RegistryKey<ConfiguredFeature<?, ?>> SEA_PICKLE = ConfiguredFeatures.of("sea_pickle");
    final static public RegistryKey<ConfiguredFeature<?, ?>> KELP = ConfiguredFeatures.of("kelp");
    final static public RegistryKey<ConfiguredFeature<?, ?>> WARM_OCEAN_VEGETATION = ConfiguredFeatures.of("warm_ocean_vegetation");
