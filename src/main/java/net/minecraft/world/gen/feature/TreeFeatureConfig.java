...
implements FeatureConfig {
    ...
    public static class Builder {
        final public BlockStateProvider trunkProvider;
        final private TrunkPlacer trunkPlacer;
        final public BlockStateProvider foliageProvider;
        final private FoliagePlacer foliagePlacer;
        final private Optional<RootPlacer> rootPlacer;
        private BlockStateProvider dirtProvider;
        final private FeatureSize minimumSize;
