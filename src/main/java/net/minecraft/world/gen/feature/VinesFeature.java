...
extends Feature<DefaultFeatureConfig> {
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        for (Direction direction : Direction.values()) {
            if (direction == Direction.DOWN || !VineBlock.shouldConnectTo(structureWorldAccess, blockPos.net_minecraft_util_math_BlockPos_offset(direction), direction)) continue;
