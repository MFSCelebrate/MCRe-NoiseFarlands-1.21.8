...
public class GeneratorOptions {
    final static public MapCodec<GeneratorOptions> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.LONG.fieldOf("seed").stable().forGetter(GeneratorOptions::getSeed), (App)Codec.BOOL.fieldOf("generate_features").orElse((Object)true).stable().forGetter(GeneratorOptions::shouldGenerateStructures), (App)Codec.BOOL.fieldOf("bonus_chest").orElse((Object)false).stable().forGetter(GeneratorOptions::hasBonusChest), (App)Codec.STRING.lenientOptionalFieldOf("legacy_custom_options").stable().forGetter(generatorOptions -> generatorOptions.legacyCustomOptions)).apply((Applicative)instance, instance.stable(GeneratorOptions::new)));
    final static public GeneratorOptions DEMO_OPTIONS = new GeneratorOptions("North Carolina".hashCode(), true, true);
    final private long seed;
    final private boolean generateStructures;
    final private boolean bonusChest;
    final private Optional<String> legacyCustomOptions;
    ...
    public static GeneratorOptions createTestWorld() {
        return new GeneratorOptions(GeneratorOptions.getRandomSeed(), false, false);
    }
