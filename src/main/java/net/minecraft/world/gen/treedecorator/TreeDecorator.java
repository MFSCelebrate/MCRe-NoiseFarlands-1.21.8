...
public abstract class TreeDecorator {
    final static public Codec<TreeDecorator> TYPE_CODEC = Registries.TREE_DECORATOR_TYPE.getCodec().dispatch(TreeDecorator::getType, TreeDecoratorType::getCodec);
    ...
    public static final class Generator {
        final private TestableWorld world;
        final private BiConsumer<BlockPos, BlockState> replacer;
        final private Random random;
        final private ObjectArrayList<BlockPos> logPositions;
        final private ObjectArrayList<BlockPos> leavesPositions;
        final private ObjectArrayList<BlockPos> rootPositions;
