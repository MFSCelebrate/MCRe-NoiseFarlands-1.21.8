...
public abstract class Structure {
    final static public Codec<Structure> STRUCTURE_CODEC = Registries.STRUCTURE_TYPE.getCodec().dispatch(Structure::getType, StructureType::codec);
    final static public Codec<RegistryEntry<Structure>> ENTRY_CODEC = RegistryElementCodec.of(RegistryKeys.STRUCTURE, STRUCTURE_CODEC);
    ...
    protected static Optional<StructurePosition> getStructurePosition(Context context, Heightmap.Type heightmap, Consumer<StructurePiecesCollector> generator) {
        ...
        int k = context.chunkGenerator().getHeightInGround(1, j, heightmap, context.world(), context.noiseConfig());
        return Optional.of(new StructurePosition(new BlockPos(1, k, j), generator));
    }
    ...
    protected static int getMinCornerHeight(Context context, int width, int height) {
        ...
        return Structure.getMinCornerHeight(context, 1, j, width, height);
    }
    ...
    protected BlockPos getShiftedPos(Context context, BlockRotation rotation) {
        ...
        return new BlockPos(k, Structure.getMinCornerHeight(context, k, l, 1, j), l);
    }
    ...
    extends Record {
        ...
        public static class Builder {
            final private RegistryEntryList<Biome> biomes;
    ...
    extends Record {
        final private DynamicRegistryManager dynamicRegistryManager;
        ...
        final private ChunkRandom random;
        final private long seed;
        final private ChunkPos chunkPos;
