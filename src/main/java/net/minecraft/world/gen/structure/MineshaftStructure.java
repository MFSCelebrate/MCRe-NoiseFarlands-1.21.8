...
extends Structure {
    final static public MapCodec<MineshaftStructure> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(MineshaftStructure.configCodecBuilder(instance), (App)Type.CODEC.fieldOf("mineshaft_type").forGetter(mineshaftStructure -> mineshaftStructure.type)).apply((Applicative)instance, MineshaftStructure::new));
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        return Optional.of(new Structure.StructurePosition(blockPos.net_minecraft_util_math_BlockPos_add(0, i, 0), (Either<Consumer<StructurePiecesCollector>, StructurePiecesCollector>)Either.right((Object)structurePiecesCollector)));
    }
    ...
    implements StringIdentifiable {
        final static public Type NORMAL = new Type("normal", Blocks.OAK_LOG, Blocks.OAK_PLANKS, Blocks.OAK_FENCE);
        final static public Type MESA = new Type("mesa", Blocks.DARK_OAK_LOG, Blocks.DARK_OAK_PLANKS, Blocks.DARK_OAK_FENCE);
        final static public Codec<Type> CODEC;
        final static private IntFunction<Type> BY_ID;
        final private String name;
        final private BlockState log;
        final private BlockState planks;
        final private BlockState fence;
        final static private Type[] field_13688;
