...
public abstract class BlockStateProvider {
    final static public Codec<BlockStateProvider> TYPE_CODEC = Registries.BLOCK_STATE_PROVIDER_TYPE.getCodec().dispatch(BlockStateProvider::getType, BlockStateProviderType::getCodec);
