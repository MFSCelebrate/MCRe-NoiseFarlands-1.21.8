...
extends AbstractNoiseBlockStateProvider {
    final static public MapCodec<NoiseBlockStateProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> NoiseBlockStateProvider.fillNoiseCodecFields(instance).apply((Applicative)instance, NoiseBlockStateProvider::new));
    final protected List<BlockState> states;
