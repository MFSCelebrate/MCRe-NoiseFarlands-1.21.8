...
extends NoiseBlockStateProvider {
    ...
    public BlockState get(Random random, BlockPos pos) {
        ...
        for (int j = 0; j < i; ++j) {
            list.add(this.getStateAtValue(this.states, this.getSlowNoiseValue(pos.net_minecraft_util_math_BlockPos_add(j * 54545, 0, j * 34234))));
        }
