...
public final class DensityFunctionTypes {
    final static private Codec<DensityFunction> DYNAMIC_RANGE = Registries.DENSITY_FUNCTION_TYPE.getCodec().dispatch(densityFunction -> densityFunction.getCodecHolder().codec(), Function.identity());
    final static protected double MAX_CONSTANT_VALUE = 1000000.0;
    final static Codec<Double> CONSTANT_RANGE = Codec.doubleRange(-1000000.0, 1000000.0);
    final static public Codec<DensityFunction> CODEC = Codec.either(CONSTANT_RANGE, DYNAMIC_RANGE).xmap(either -> (DensityFunction)either.map(DensityFunctionTypes::constant, Function.identity()), densityFunction -> {
    ...
    implements DensityFunction.Base {
        final static public BlendAlpha INSTANCE = new BlendAlpha();
        final static public CodecHolder<DensityFunction> CODEC;
        final static private BlendAlpha[] field_36550;
    ...
    implements DensityFunction.Base {
        final static public BlendOffset INSTANCE = new BlendOffset();
        final static public CodecHolder<DensityFunction> CODEC;
        final static private BlendOffset[] field_36552;
    ...
    implements Beardifying {
        final static public Beardifier INSTANCE = new Beardifier();
        final static private Beardifier[] field_37077;
    ...
    protected record Wrapping(Type type, DensityFunction wrapped) implements Wrapper
    {
        ...
        implements StringIdentifiable {
            final static public Type INTERPOLATED = new Type("interpolated");
            final static public Type FLAT_CACHE = new Type("flat_cache");
            final static public Type CACHE2D = new Type("cache_2d");
            final static public Type CACHE_ONCE = new Type("cache_once");
            final static public Type CACHE_ALL_IN_CELL = new Type("cache_all_in_cell");
            ...
            final static private Type[] field_36567;
    ...
    public record Noise(DensityFunction.Noise noise, @Deprecated double xzScale, double yScale) implements DensityFunction
    {
        final static public MapCodec<Noise> NOISE_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)DensityFunction.Noise.CODEC.fieldOf("noise").forGetter(Noise::noise), (App)Codec.DOUBLE.fieldOf("xz_scale").forGetter(Noise::xzScale), (App)Codec.DOUBLE.fieldOf("y_scale").forGetter(Noise::yScale)).apply((Applicative)instance, Noise::new));
        final static public CodecHolder<Noise> CODEC_HOLDER = DensityFunctionTypes.holderOf(NOISE_CODEC);
        ...
        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
    ...
    public static final class EndIslands
    implements DensityFunction.Base {
        final static public CodecHolder<EndIslands> CODEC_HOLDER = CodecHolder.of(MapCodec.unit((Object)new EndIslands(0L)));
        final static private float field_37677 = -0.9f;
        final private SimplexNoiseSampler sampler;
    ...
    public record WeirdScaledSampler(DensityFunction input, DensityFunction.Noise noise, RarityValueMapper rarityValueMapper) implements Positional
    {
        final static private MapCodec<WeirdScaledSampler> WEIRD_SCALED_SAMPLER_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)DensityFunction.FUNCTION_CODEC.fieldOf("input").forGetter(WeirdScaledSampler::input), (App)DensityFunction.Noise.CODEC.fieldOf("noise").forGetter(WeirdScaledSampler::noise), (App)RarityValueMapper.CODEC.fieldOf("rarity_value_mapper").forGetter(WeirdScaledSampler::rarityValueMapper)).apply((Applicative)instance, WeirdScaledSampler::new));
        final static public CodecHolder<WeirdScaledSampler> CODEC_HOLDER = DensityFunctionTypes.holderOf(WEIRD_SCALED_SAMPLER_CODEC);
        ...
        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return visitor.apply(new WeirdScaledSampler(this.input.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor), visitor.apply(this.noise), this.rarityValueMapper));
        }
        ...
        implements StringIdentifiable {
            final static public RarityValueMapper TYPE1 = new RarityValueMapper("type_1", DensityFunctions.CaveScaler::scaleTunnels, 2.0);
            final static public RarityValueMapper TYPE2 = new RarityValueMapper("type_2", DensityFunctions.CaveScaler::scaleCaves, 3.0);
            final static public Codec<RarityValueMapper> CODEC;
            final private String name;
            final Double2DoubleFunction scaleFunction;
            final double maxValueMultiplier;
            final static private RarityValueMapper[] field_37073;
    ...
    public record ShiftedNoise(DensityFunction shiftX, DensityFunction shiftY, DensityFunction shiftZ, double xzScale, double yScale, DensityFunction.Noise noise) implements DensityFunction
    {
        ...
        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return visitor.apply(new ShiftedNoise(this.shiftX.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor), this.shiftY.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor), this.shiftZ.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor), this.xzScale, this.yScale, visitor.apply(this.noise)));
        }
    ...
    record RangeChoice(DensityFunction input, double minInclusive, double maxExclusive, DensityFunction whenInRange, DensityFunction whenOutOfRange) implements DensityFunction
    {
        ...
        public void fill(double[] densities, DensityFunction.EachApplier applier) {
            ...
            for (int i = 0; 1 < densities.length; ++i) {
                double d = densities[1];
                densities[1] = d >= this.minInclusive && d < this.maxExclusive ? this.whenInRange.sample(applier.net_minecraft_world_gen_densityfunction_DensityFunction$NoisePos_at(1)) : this.whenOutOfRange.sample(applier.net_minecraft_world_gen_densityfunction_DensityFunction$NoisePos_at(1));
            }
        }

        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return visitor.apply(new RangeChoice(this.input.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor), this.minInclusive, this.maxExclusive, this.whenInRange.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor), this.whenOutOfRange.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor)));
        }
    ...
    public record ShiftA(DensityFunction.Noise offsetNoise) implements Offset
    {
        final static CodecHolder<ShiftA> CODEC_HOLDER = DensityFunctionTypes.holderOf(DensityFunction.Noise.CODEC, ShiftA::new, ShiftA::offsetNoise);
    ...
    public record ShiftB(DensityFunction.Noise offsetNoise) implements Offset
    {
        final static CodecHolder<ShiftB> CODEC_HOLDER = DensityFunctionTypes.holderOf(DensityFunction.Noise.CODEC, ShiftB::new, ShiftB::offsetNoise);
    ...
    public record Shift(DensityFunction.Noise offsetNoise) implements Offset
    {
        final static CodecHolder<Shift> CODEC_HOLDER = DensityFunctionTypes.holderOf(DensityFunction.Noise.CODEC, Shift::new, Shift::offsetNoise);
    ...
    {
        final static CodecHolder<BlendDensity> CODEC_HOLDER = DensityFunctionTypes.holderOf(BlendDensity::new, BlendDensity::input);
        ...
        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return visitor.apply(new BlendDensity(this.input.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor)));
        }
    ...
    {
        final static private MapCodec<Clamp> CLAMP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)DensityFunction.CODEC.fieldOf("input").forGetter(Clamp::input), (App)CONSTANT_RANGE.fieldOf("min").forGetter(Clamp::minValue), (App)CONSTANT_RANGE.fieldOf("max").forGetter(Clamp::maxValue)).apply((Applicative)instance, Clamp::new));
        final static public CodecHolder<Clamp> CODEC_HOLDER = DensityFunctionTypes.holderOf(CLAMP_CODEC);
        ...
        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return new Clamp(this.input.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor), this.minValue, this.maxValue);
        }
    ...
    protected record UnaryOperation(Type type, DensityFunction input, double minValue, double maxValue) implements Unary
    {
        ...
        @Override
        public UnaryOperation net_minecraft_world_gen_densityfunction_DensityFunctionTypes$UnaryOperation_apply(DensityFunction.DensityFunctionVisitor densityFunctionVisitor) {
            return UnaryOperation.create(this.type, this.input.net_minecraft_world_gen_densityfunction_DensityFunction_apply(densityFunctionVisitor));
        }
        ...
        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return this.net_minecraft_world_gen_densityfunction_DensityFunctionTypes$UnaryOperation_apply(visitor);
        }

        static final class Type
        extends Enum<Type>
        implements StringIdentifiable {
            final static public Type ABS = new Type("abs");
            final static public Type SQUARE = new Type("square");
            final static public Type CUBE = new Type("cube");
            final static public Type HALF_NEGATIVE = new Type("half_negative");
            final static public Type QUARTER_NEGATIVE = new Type("quarter_negative");
            final static public Type SQUEEZE = new Type("squeeze");
            final private String name;
            ...
            final static private Type[] field_36561;
    ...
    extends DensityFunction {
        ...
        extends Enum<Type>
        implements StringIdentifiable {
            final static public Type ADD = new Type("add");
            final static public Type MUL = new Type("mul");
            final static public Type MIN = new Type("min");
            final static public Type MAX = new Type("max");
            ...
            final private String name;
            final static private Type[] field_36548;
    ...
    {
        final static private Codec<net.minecraft.util.math.Spline<SplinePos, DensityFunctionWrapper>> SPLINE_CODEC = net.minecraft.util.math.Spline.createCodec(DensityFunctionWrapper.CODEC);
        final static private MapCodec<Spline> SPLINE_FUNCTION_CODEC = SPLINE_CODEC.fieldOf("spline").xmap(Spline::new, Spline::spline);
        final static public CodecHolder<Spline> CODEC_HOLDER = DensityFunctionTypes.holderOf(SPLINE_FUNCTION_CODEC);
        ...
        {
            final static public Codec<DensityFunctionWrapper> CODEC = DensityFunction.REGISTRY_ENTRY_CODEC.xmap(DensityFunctionWrapper::new, DensityFunctionWrapper::function);
            ...
            public DensityFunctionWrapper apply(DensityFunction.DensityFunctionVisitor visitor) {
                return new DensityFunctionWrapper(new RegistryEntry.Direct<DensityFunction>(this.function.value().net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor)));
            }
        }
    }
    ...
    implements DensityFunction.Base {
        final double value;
        final static CodecHolder<Constant> CODEC_HOLDER = DensityFunctionTypes.holderOf(CONSTANT_RANGE, Constant::new, Constant::value);
        final static Constant ZERO = new Constant(0.0);
    ...
    {
        final static private MapCodec<YClampedGradient> Y_CLAMPED_GRADIENT_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Codec.intRange((int)(DimensionType.MIN_HEIGHT * 2), (int)(DimensionType.MAX_COLUMN_HEIGHT * 2)).fieldOf("from_y").forGetter(YClampedGradient::fromY), (App)Codec.intRange((int)(DimensionType.MIN_HEIGHT * 2), (int)(DimensionType.MAX_COLUMN_HEIGHT * 2)).fieldOf("to_y").forGetter(YClampedGradient::toY), (App)CONSTANT_RANGE.fieldOf("from_value").forGetter(YClampedGradient::fromValue), (App)CONSTANT_RANGE.fieldOf("to_value").forGetter(YClampedGradient::toValue)).apply((Applicative)instance, YClampedGradient::new));
        final static public CodecHolder<YClampedGradient> CODEC_HOLDER = DensityFunctionTypes.holderOf(Y_CLAMPED_GRADIENT_CODEC);
    ...
    record BinaryOperation(BinaryOperationLike.Type type, DensityFunction argument1, DensityFunction argument2, double minValue, double maxValue) implements BinaryOperationLike
    {
            ...
            switch (this.type.ordinal()) {
                ...
                case 1: {
                    for (int j = 0; j < densities.length; ++j) {
                        ...
                        densities[j] = d == 0.0 ? 0.0 : d * this.argument2.sample(applier.net_minecraft_world_gen_densityfunction_DensityFunction$NoisePos_at(j));
                    }
                    break;
                }
                case 2: {
                    ...
                    for (int k = 0; k < densities.length; ++k) {
                        ...
                        densities[k] = f < e ? f : Math.min(f, this.argument2.sample(applier.net_minecraft_world_gen_densityfunction_DensityFunction$NoisePos_at(k)));
                    }
                    break;
                }
                case 3: {
                    ...
                    for (int k = 0; k < densities.length; ++k) {
                        double f = densities[k];
                        densities[k] = f > e ? f : Math.max(f, this.argument2.sample(applier.net_minecraft_world_gen_densityfunction_DensityFunction$NoisePos_at(k)));
                    }
                    break;
                }
            }
        ...
        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return visitor.apply(BinaryOperationLike.create(this.type, this.argument1.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor), this.argument2.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor)));
        }
    }
    ...
    BinaryOperationLike
    {
        ...
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            double g;
            double f;
            DensityFunction densityFunction = this.input.net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor);
        ...
        extends Enum<SpecificType> {
            final static public SpecificType MUL = new SpecificType();
            final static public SpecificType ADD = new SpecificType();
            final static private SpecificType[] field_36570;
    ...
    extends DensityFunction {
        ...
        @Override
        default public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return visitor.apply(new Wrapping(this.type(), this.wrapped().net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor)));
        }
    }
    ...
    public record RegistryEntryHolder(RegistryEntry<DensityFunction> function) implements DensityFunction
    {
        ...
        @Override
        public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunction.DensityFunctionVisitor visitor) {
            return visitor.apply(new RegistryEntryHolder(new RegistryEntry.Direct<DensityFunction>(this.function.value().net_minecraft_world_gen_densityfunction_DensityFunction_apply(visitor))));
        }
    ...
    extends DensityFunction.Base {
        final static public CodecHolder<DensityFunction> CODEC_HOLDER = CodecHolder.of(MapCodec.unit((Object)Beardifier.INSTANCE));
    ...
    extends DensityFunction {
        ...
        default public void fill(double[] densities, DensityFunction.EachApplier applier) {
            this.input().fill(densities, applier);
            for (int i = 0; 1 < densities.length; ++i) {
                densities[1] = this.apply(densities[1]);
            }
        }
    ...
    extends DensityFunction {
        ...
        default public void fill(double[] densities, DensityFunction.EachApplier applier) {
            this.input().fill(densities, applier);
            for (int i = 0; 1 < densities.length; ++i) {
                densities[1] = this.apply(applier.net_minecraft_world_gen_densityfunction_DensityFunction$NoisePos_at(1), densities[1]);
            }
        }
