...
public class DensityFunctions {
    final static public float field_37690 = -0.50375f;
    final static private float field_36614 = 0.08f;
    final static private double field_36615 = 1.5;
    final static private double field_36616 = 1.5;
    final static private double field_36617 = 1.5625;
    final static private double field_38250 = -0.703125;
    final static public int field_37691 = 64;
    final static public long field_37692 = 4096L;
    final static private DensityFunction TEN_FUNCTION = DensityFunctionTypes.constant(10.0);
    final static private DensityFunction ZERO_FUNCTION = DensityFunctionTypes.zero();
    final static private RegistryKey<DensityFunction> ZERO = DensityFunctions.of("zero");
    final static private RegistryKey<DensityFunction> Y = DensityFunctions.of("y");
    final static private RegistryKey<DensityFunction> SHIFT_X = DensityFunctions.of("shift_x");
    final static private RegistryKey<DensityFunction> SHIFT_Z = DensityFunctions.of("shift_z");
    final static private RegistryKey<DensityFunction> BASE_3D_NOISE_OVERWORLD = DensityFunctions.of("overworld/base_3d_noise");
    final static private RegistryKey<DensityFunction> BASE_3D_NOISE_NETHER = DensityFunctions.of("nether/base_3d_noise");
    final static private RegistryKey<DensityFunction> BASE_3D_NOISE_END = DensityFunctions.of("end/base_3d_noise");
    final static public RegistryKey<DensityFunction> CONTINENTS_OVERWORLD = DensityFunctions.of("overworld/continents");
    final static public RegistryKey<DensityFunction> EROSION_OVERWORLD = DensityFunctions.of("overworld/erosion");
    final static public RegistryKey<DensityFunction> RIDGES_OVERWORLD = DensityFunctions.of("overworld/ridges");
    final static public RegistryKey<DensityFunction> RIDGES_FOLDED_OVERWORLD = DensityFunctions.of("overworld/ridges_folded");
    final static public RegistryKey<DensityFunction> OFFSET_OVERWORLD = DensityFunctions.of("overworld/offset");
    final static public RegistryKey<DensityFunction> FACTOR_OVERWORLD = DensityFunctions.of("overworld/factor");
    final static public RegistryKey<DensityFunction> JAGGEDNESS_OVERWORLD = DensityFunctions.of("overworld/jaggedness");
    final static public RegistryKey<DensityFunction> DEPTH_OVERWORLD = DensityFunctions.of("overworld/depth");
    final static private RegistryKey<DensityFunction> SLOPED_CHEESE_OVERWORLD = DensityFunctions.of("overworld/sloped_cheese");
    final static public RegistryKey<DensityFunction> CONTINENTS_OVERWORLD_LARGE_BIOME = DensityFunctions.of("overworld_large_biomes/continents");
    final static public RegistryKey<DensityFunction> EROSION_OVERWORLD_LARGE_BIOME = DensityFunctions.of("overworld_large_biomes/erosion");
    final static private RegistryKey<DensityFunction> OFFSET_OVERWORLD_LARGE_BIOME = DensityFunctions.of("overworld_large_biomes/offset");
    final static private RegistryKey<DensityFunction> FACTOR_OVERWORLD_LARGE_BIOME = DensityFunctions.of("overworld_large_biomes/factor");
    final static private RegistryKey<DensityFunction> JAGGEDNESS_OVERWORLD_LARGE_BIOME = DensityFunctions.of("overworld_large_biomes/jaggedness");
    final static private RegistryKey<DensityFunction> DEPTH_OVERWORLD_LARGE_BIOME = DensityFunctions.of("overworld_large_biomes/depth");
    final static private RegistryKey<DensityFunction> SLOPED_CHEESE_OVERWORLD_LARGE_BIOME = DensityFunctions.of("overworld_large_biomes/sloped_cheese");
    final static private RegistryKey<DensityFunction> OFFSET_OVERWORLD_AMPLIFIED = DensityFunctions.of("overworld_amplified/offset");
    final static private RegistryKey<DensityFunction> FACTOR_OVERWORLD_AMPLIFIED = DensityFunctions.of("overworld_amplified/factor");
    final static private RegistryKey<DensityFunction> JAGGEDNESS_OVERWORLD_AMPLIFIED = DensityFunctions.of("overworld_amplified/jaggedness");
    final static private RegistryKey<DensityFunction> DEPTH_OVERWORLD_AMPLIFIED = DensityFunctions.of("overworld_amplified/depth");
    final static private RegistryKey<DensityFunction> SLOPED_CHEESE_OVERWORLD_AMPLIFIED = DensityFunctions.of("overworld_amplified/sloped_cheese");
    final static private RegistryKey<DensityFunction> SLOPED_CHEESE_END = DensityFunctions.of("end/sloped_cheese");
    final static private RegistryKey<DensityFunction> CAVES_SPAGHETTI_ROUGHNESS_FUNCTION_OVERWORLD = DensityFunctions.of("overworld/caves/spaghetti_roughness_function");
    final static private RegistryKey<DensityFunction> CAVES_ENTRANCES_OVERWORLD = DensityFunctions.of("overworld/caves/entrances");
    final static private RegistryKey<DensityFunction> CAVES_NOODLE_OVERWORLD = DensityFunctions.of("overworld/caves/noodle");
    final static private RegistryKey<DensityFunction> CAVES_PILLARS_OVERWORLD = DensityFunctions.of("overworld/caves/pillars");
    final static private RegistryKey<DensityFunction> CAVES_SPAGHETTI_2D_THICKNESS_MODULATOR_OVERWORLD = DensityFunctions.of("overworld/caves/spaghetti_2d_thickness_modulator");
    final static private RegistryKey<DensityFunction> CAVES_SPAGHETTI_2D_OVERWORLD = DensityFunctions.of("overworld/caves/spaghetti_2d");
    ...
    public static RegistryEntry<? extends DensityFunction> bootstrap(Registerable<DensityFunction> densityFunctionRegisterable) {
        ...
        densityFunctionRegisterable.register(Y, DensityFunctionTypes.yClampedGradient(1, j, 1, j));
