...
public interface DensityFunction {
    final static public Codec<DensityFunction> CODEC = DensityFunctionTypes.CODEC;
    final static public Codec<RegistryEntry<DensityFunction>> REGISTRY_ENTRY_CODEC = RegistryElementCodec.of(RegistryKeys.DENSITY_FUNCTION, CODEC);
    final static public Codec<DensityFunction> FUNCTION_CODEC = REGISTRY_ENTRY_CODEC.xmap(DensityFunctionTypes.RegistryEntryHolder::new, function -> {
    ...
    public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunctionVisitor var1);
    ...
    extends DensityFunction {
        ...
        @Override
        default public DensityFunction net_minecraft_world_gen_densityfunction_DensityFunction_apply(DensityFunctionVisitor visitor) {
    ...
    public record Noise(RegistryEntry<DoublePerlinNoiseSampler.NoiseParameters> noiseData, @Nullable DoublePerlinNoiseSampler noise) {
        final static public Codec<Noise> CODEC = DoublePerlinNoiseSampler.NoiseParameters.REGISTRY_ENTRY_CODEC.xmap(noiseData -> new Noise((RegistryEntry<DoublePerlinNoiseSampler.NoiseParameters>)noiseData, null), Noise::noiseData);
    ...
    public static interface EachApplier {
        public NoisePos net_minecraft_world_gen_densityfunction_DensityFunction$NoisePos_at(int var1);
