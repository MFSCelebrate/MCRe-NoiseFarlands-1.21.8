...
public class FlatLevelGeneratorPresets {
    final static public RegistryKey<FlatLevelGeneratorPreset> CLASSIC_FLAT = FlatLevelGeneratorPresets.of("classic_flat");
    final static public RegistryKey<FlatLevelGeneratorPreset> TUNNELERS_DREAM = FlatLevelGeneratorPresets.of("tunnelers_dream");
    final static public RegistryKey<FlatLevelGeneratorPreset> WATER_WORLD = FlatLevelGeneratorPresets.of("water_world");
    final static public RegistryKey<FlatLevelGeneratorPreset> OVERWORLD = FlatLevelGeneratorPresets.of("overworld");
    final static public RegistryKey<FlatLevelGeneratorPreset> SNOWY_KINGDOM = FlatLevelGeneratorPresets.of("snowy_kingdom");
    final static public RegistryKey<FlatLevelGeneratorPreset> BOTTOMLESS_PIT = FlatLevelGeneratorPresets.of("bottomless_pit");
    final static public RegistryKey<FlatLevelGeneratorPreset> DESERT = FlatLevelGeneratorPresets.of("desert");
    final static public RegistryKey<FlatLevelGeneratorPreset> REDSTONE_READY = FlatLevelGeneratorPresets.of("redstone_ready");
    final static public RegistryKey<FlatLevelGeneratorPreset> THE_VOID = FlatLevelGeneratorPresets.of("the_void");
    ...
    static class Registrar {
        final private Registerable<FlatLevelGeneratorPreset> presetRegisterable;
        ...
        public void bootstrap() {
            this.createAndRegister(CLASSIC_FLAT, Blocks.GRASS_BLOCK, BiomeKeys.PLAINS, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(StructureSetKeys.VILLAGES), false, false, new FlatChunkGeneratorLayer(1, Blocks.GRASS_BLOCK), new FlatChunkGeneratorLayer(2, Blocks.DIRT), new FlatChunkGeneratorLayer(1, Blocks.BEDROCK));
            this.createAndRegister(TUNNELERS_DREAM, Blocks.STONE, BiomeKeys.WINDSWEPT_HILLS, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(StructureSetKeys.MINESHAFTS, StructureSetKeys.STRONGHOLDS), true, false, new FlatChunkGeneratorLayer(1, Blocks.GRASS_BLOCK), new FlatChunkGeneratorLayer(5, Blocks.DIRT), new FlatChunkGeneratorLayer(230, Blocks.STONE), new FlatChunkGeneratorLayer(1, Blocks.BEDROCK));
            this.createAndRegister(WATER_WORLD, Items.WATER_BUCKET, BiomeKeys.DEEP_OCEAN, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(StructureSetKeys.OCEAN_RUINS, StructureSetKeys.SHIPWRECKS, StructureSetKeys.OCEAN_MONUMENTS), false, false, new FlatChunkGeneratorLayer(90, Blocks.WATER), new FlatChunkGeneratorLayer(5, Blocks.GRAVEL), new FlatChunkGeneratorLayer(5, Blocks.DIRT), new FlatChunkGeneratorLayer(5, Blocks.STONE), new FlatChunkGeneratorLayer(64, Blocks.DEEPSLATE), new FlatChunkGeneratorLayer(1, Blocks.BEDROCK));
            this.createAndRegister(OVERWORLD, Blocks.SHORT_GRASS, BiomeKeys.PLAINS, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(StructureSetKeys.VILLAGES, StructureSetKeys.MINESHAFTS, StructureSetKeys.PILLAGER_OUTPOSTS, StructureSetKeys.RUINED_PORTALS, StructureSetKeys.STRONGHOLDS), true, true, new FlatChunkGeneratorLayer(1, Blocks.GRASS_BLOCK), new FlatChunkGeneratorLayer(3, Blocks.DIRT), new FlatChunkGeneratorLayer(59, Blocks.STONE), new FlatChunkGeneratorLayer(1, Blocks.BEDROCK));
            this.createAndRegister(SNOWY_KINGDOM, Blocks.SNOW, BiomeKeys.SNOWY_PLAINS, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(StructureSetKeys.VILLAGES, StructureSetKeys.IGLOOS), false, false, new FlatChunkGeneratorLayer(1, Blocks.SNOW), new FlatChunkGeneratorLayer(1, Blocks.GRASS_BLOCK), new FlatChunkGeneratorLayer(3, Blocks.DIRT), new FlatChunkGeneratorLayer(59, Blocks.STONE), new FlatChunkGeneratorLayer(1, Blocks.BEDROCK));
            this.createAndRegister(BOTTOMLESS_PIT, Items.FEATHER, BiomeKeys.PLAINS, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(StructureSetKeys.VILLAGES), false, false, new FlatChunkGeneratorLayer(1, Blocks.GRASS_BLOCK), new FlatChunkGeneratorLayer(3, Blocks.DIRT), new FlatChunkGeneratorLayer(2, Blocks.COBBLESTONE));
            this.createAndRegister(DESERT, Blocks.SAND, BiomeKeys.DESERT, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(StructureSetKeys.VILLAGES, StructureSetKeys.DESERT_PYRAMIDS, StructureSetKeys.MINESHAFTS, StructureSetKeys.STRONGHOLDS), true, false, new FlatChunkGeneratorLayer(8, Blocks.SAND), new FlatChunkGeneratorLayer(52, Blocks.SANDSTONE), new FlatChunkGeneratorLayer(3, Blocks.STONE), new FlatChunkGeneratorLayer(1, Blocks.BEDROCK));
            this.createAndRegister(REDSTONE_READY, Items.REDSTONE, BiomeKeys.DESERT, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(), false, false, new FlatChunkGeneratorLayer(116, Blocks.SANDSTONE), new FlatChunkGeneratorLayer(3, Blocks.STONE), new FlatChunkGeneratorLayer(1, Blocks.BEDROCK));
            this.createAndRegister(THE_VOID, Blocks.BARRIER, BiomeKeys.THE_VOID, (Set<RegistryKey<StructureSet>>)ImmutableSet.of(), true, false, new FlatChunkGeneratorLayer(1, Blocks.AIR));
        }
    }
}
