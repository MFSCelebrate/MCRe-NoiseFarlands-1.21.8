...
extends FoliagePlacer {
    final static public MapCodec<MegaPineFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> MegaPineFoliagePlacer.fillFoliagePlacerFields(instance).and((App)IntProvider.createValidatingCodec(0, 24).fieldOf("crown_height").forGetter(placer -> placer.crownHeight)).apply((Applicative)instance, MegaPineFoliagePlacer::new));
    final private IntProvider crownHeight;
