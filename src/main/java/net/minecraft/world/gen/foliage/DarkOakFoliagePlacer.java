...
extends FoliagePlacer {
    final static public MapCodec<DarkOakFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> DarkOakFoliagePlacer.fillFoliagePlacerFields(instance).apply((Applicative)instance, DarkOakFoliagePlacer::new));
