...
extends FoliagePlacer {
    final static public MapCodec<AcaciaFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> AcaciaFoliagePlacer.fillFoliagePlacerFields(instance).apply((Applicative)instance, AcaciaFoliagePlacer::new));
