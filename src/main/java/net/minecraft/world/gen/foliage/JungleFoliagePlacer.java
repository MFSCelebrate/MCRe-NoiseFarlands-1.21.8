...
extends FoliagePlacer {
    final static public MapCodec<JungleFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> JungleFoliagePlacer.fillFoliagePlacerFields(instance).and((App)Codec.intRange(0, 16).fieldOf("height").forGetter(placer -> placer.height)).apply((Applicative)instance, JungleFoliagePlacer::new));
