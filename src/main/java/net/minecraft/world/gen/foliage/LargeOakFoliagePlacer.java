...
extends BlobFoliagePlacer {
    final static public MapCodec<LargeOakFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> LargeOakFoliagePlacer.createCodec(instance).apply((Applicative)instance, LargeOakFoliagePlacer::new));

    public LargeOakFoliagePlacer(IntProvider intProvider, IntProvider intProvider2, int i) {
        super(intProvider, intProvider2, 1);
    }
