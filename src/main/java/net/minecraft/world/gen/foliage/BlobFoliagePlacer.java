...
extends FoliagePlacer {
    final static public MapCodec<BlobFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> BlobFoliagePlacer.createCodec(instance).apply((Applicative)instance, BlobFoliagePlacer::new));
    ...
    protected static <P extends BlobFoliagePlacer> Products.P3<RecordCodecBuilder.Mu<P>, IntProvider, IntProvider, Integer> createCodec(RecordCodecBuilder.Instance<P> builder) {
        return BlobFoliagePlacer.fillFoliagePlacerFields(builder).and((App)Codec.intRange(0, 16).fieldOf("height").forGetter(placer -> placer.height));
    }
