...
extends BlobFoliagePlacer {
    final static public MapCodec<BushFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> BushFoliagePlacer.createCodec(instance).apply((Applicative)instance, BushFoliagePlacer::new));
