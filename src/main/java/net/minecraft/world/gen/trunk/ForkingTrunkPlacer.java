...
extends TrunkPlacer {
    final static public MapCodec<ForkingTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> ForkingTrunkPlacer.fillTrunkPlacerFields(instance).apply((Applicative)instance, ForkingTrunkPlacer::new));
    ...
    public List<FoliagePlacer.TreeNode> generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random, int height, BlockPos startPos, TreeFeatureConfig config) {
        int n;
        ForkingTrunkPlacer.setToDirt(world, replacer, random, startPos.net_minecraft_util_math_BlockPos_down(), config);
