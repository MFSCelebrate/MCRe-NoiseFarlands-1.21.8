...
extends TrunkPlacer {
    final static public MapCodec<BendingTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(instance -> BendingTrunkPlacer.fillTrunkPlacerFields(instance).and(instance.group((App)Codecs.POSITIVE_INT.optionalFieldOf("min_height_for_leaves", (Object)1).forGetter(placer -> placer.minHeightForLeaves), (App)IntProvider.createValidatingCodec(1, 64).fieldOf("bend_length").forGetter(placer -> placer.bendLength))).apply((Applicative)instance, BendingTrunkPlacer::new));
    final private int minHeightForLeaves;
    final private IntProvider bendLength;
    ...
    public List<FoliagePlacer.TreeNode> generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, Random random, int height, BlockPos startPos, TreeFeatureConfig config) {
        ...
        Vec3i blockPos = mutable.net_minecraft_util_math_Vec3i_down();
