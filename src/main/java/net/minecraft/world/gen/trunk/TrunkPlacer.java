...
public abstract class TrunkPlacer {
    final static public Codec<TrunkPlacer> TYPE_CODEC = Registries.TRUNK_PLACER_TYPE.getCodec().dispatch(TrunkPlacer::getType, TrunkPlacerType::getCodec);
    final static private int MAX_BASE_HEIGHT = 32;
    final static private int MAX_RANDOM_HEIGHT = 24;
    final static public int field_31530 = 80;
    final protected int baseHeight;
    final protected int firstRandomHeight;
    final protected int secondRandomHeight;
    ...
    protected static <P extends TrunkPlacer> Products.P3<RecordCodecBuilder.Mu<P>, Integer, Integer, Integer> fillTrunkPlacerFields(RecordCodecBuilder.Instance<P> instance) {
        return instance.group((App)Codec.intRange(0, 32).fieldOf("base_height").forGetter(placer -> placer.baseHeight), (App)Codec.intRange(0, 24).fieldOf("height_rand_a").forGetter(placer -> placer.firstRandomHeight), (App)Codec.intRange(0, 24).fieldOf("height_rand_b").forGetter(placer -> placer.secondRandomHeight));
    }
