...
public record GenerationShapeConfig(int minimumY, int height, int horizontalSize, int verticalSize) {
    final static public Codec<GenerationShapeConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Codec.intRange((int)DimensionType.MIN_HEIGHT, (int)DimensionType.MAX_COLUMN_HEIGHT).fieldOf("min_y").forGetter(GenerationShapeConfig::minimumY), (App)Codec.intRange(0, (int)DimensionType.MAX_HEIGHT).fieldOf("height").forGetter(GenerationShapeConfig::height), (App)Codec.intRange(1, 4).fieldOf("size_horizontal").forGetter(GenerationShapeConfig::horizontalSize), (App)Codec.intRange(1, 4).fieldOf("size_vertical").forGetter(GenerationShapeConfig::verticalSize)).apply((Applicative)instance, GenerationShapeConfig::new)).comapFlatMap(GenerationShapeConfig::checkHeight, Function.identity());
    final static protected GenerationShapeConfig SURFACE = GenerationShapeConfig.create(-64, 384, 1, 2);
    final static protected GenerationShapeConfig NETHER = GenerationShapeConfig.create(0, 128, 1, 2);
    final static protected GenerationShapeConfig END = GenerationShapeConfig.create(0, 128, 2, 1);
    final static protected GenerationShapeConfig CAVES = GenerationShapeConfig.create(-64, 192, 1, 2);
    final static protected GenerationShapeConfig FLOATING_ISLANDS = GenerationShapeConfig.create(0, 256, 2, 1);
    ...
    public static GenerationShapeConfig create(int minimumY, int height, int horizontalSize, int verticalSize) {
        ...
        GenerationShapeConfig.checkHeight(generationShapeConfig).error().ifPresent(error -> {
