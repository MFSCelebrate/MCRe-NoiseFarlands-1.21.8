...
public interface AquiferSampler {
    ...
    implements AquiferSampler {
        final static private int field_31451 = 10;
        final static private int field_31452 = 9;
        final static private int field_31453 = 10;
        final static private int field_31454 = 6;
        final static private int field_31455 = 3;
        final static private int field_31456 = 6;
        final static private int field_31457 = 16;
        final static private int field_31458 = 12;
        final static private int field_31459 = 16;
        final static private int field_36220 = 11;
        final static private double NEEDS_FLUID_TICK_DISTANCE_THRESHOLD = Impl.maxDistance(MathHelper.square(10), MathHelper.square(12));
        final private ChunkNoiseSampler chunkNoiseSampler;
        final private DensityFunction barrierNoise;
        final private DensityFunction fluidLevelFloodednessNoise;
        final private DensityFunction fluidLevelSpreadNoise;
        final private DensityFunction fluidTypeNoise;
        final private RandomSplitter randomDeriver;
        final private FluidLevel[] waterLevels;
        final private long[] blockPositions;
        final private FluidLevelSampler fluidLevelSampler;
        final private DensityFunction erosionDensityFunction;
        final private DensityFunction depthDensityFunction;
        ...
        final private int sizeZ;
        final static private int[][] CHUNK_POS_OFFSETS = new int[][]{{0, 0}, {-2, -1}, {-1, -1}, {0, -1}, {1, -1}, {-3, 0}, {-2, 0}, {-1, 0}, {1, 0}, {-2, 1}, {-1, 1}, {0, 1}, {1, 1}};
        ...
        private int index(int x, int y, int z) {
            ...
            int j = y - this.startY;
            int k = z - this.startZ;
            return (j * this.sizeZ + k) * this.sizeX + 1;
        }
                ...
                for (int x = -1; x <= 1; ++x) {
                    for (int y = 0; y <= 1; ++y) {
                        ...
                        if (ad != Long.MAX_VALUE) {
                            ...
                            this.blockPositions[ac] = ae = BlockPos.asLong(z * 16 + random.nextInt(10), aa * 12 + random.nextInt(9), ab * 16 + random.nextInt(10));
                        }
