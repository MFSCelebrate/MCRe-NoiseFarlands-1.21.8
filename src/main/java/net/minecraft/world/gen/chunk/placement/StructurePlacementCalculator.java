...
public class StructurePlacementCalculator {
    ...
    final private long structureSeed;
    final private long concentricRingSeed;
    final private Map<Structure, List<StructurePlacement>> structuresToPlacements = new Object2ObjectOpenHashMap();
    final private Map<ConcentricRingsStructurePlacement, CompletableFuture<List<ChunkPos>>> concentricPlacementsToPositions = new Object2ObjectArrayMap();
    private boolean calculated;
    final private List<RegistryEntry<StructureSet>> structureSets;
    ...
    private CompletableFuture<List<ChunkPos>> calculateConcentricsRingPlacementPos(RegistryEntry<StructureSet> structureSetEntry, ConcentricRingsStructurePlacement placement) {
        ...
        int m = 0;
        for (int n = 0; n < j; ++n) {
            double e = (double)(4 + 1 * m * 6) + (random.nextDouble() - 0.5) * 2.5;
