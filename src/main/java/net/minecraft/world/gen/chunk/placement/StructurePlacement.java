...
public abstract class StructurePlacement {
    final static public Codec<StructurePlacement> TYPE_CODEC = Registries.STRUCTURE_PLACEMENT.getCodec().dispatch(StructurePlacement::getType, StructurePlacementType::codec);
    final static private int ARBITRARY_SALT = 10387320;
    final private Vec3i locateOffset;
    final private FrequencyReductionMethod frequencyReductionMethod;
    final private float frequency;
    final private int salt;
    final private Optional<ExclusionZone> exclusionZone;
    ...
    public BlockPos getLocatePos(ChunkPos chunkPos) {
        return new BlockPos(chunkPos.getStartX(), 0, chunkPos.getStartZ()).net_minecraft_util_math_BlockPos_add(this.getLocateOffset());
    }
    ...
    implements StringIdentifiable {
        final static public FrequencyReductionMethod DEFAULT = new FrequencyReductionMethod("default", StructurePlacement::defaultShouldGenerate);
        final static public FrequencyReductionMethod LEGACY_TYPE_1 = new FrequencyReductionMethod("legacy_type_1", StructurePlacement::legacyType1ShouldGenerate);
        final static public FrequencyReductionMethod LEGACY_TYPE_2 = new FrequencyReductionMethod("legacy_type_2", StructurePlacement::legacyType2ShouldGenerate);
        final static public FrequencyReductionMethod LEGACY_TYPE_3 = new FrequencyReductionMethod("legacy_type_3", StructurePlacement::legacyType3ShouldGenerate);
        final static public Codec<FrequencyReductionMethod> CODEC;
        final private String name;
        final private GenerationPredicate generationPredicate;
        final static private FrequencyReductionMethod[] field_37789;
    ...
    public record ExclusionZone(RegistryEntry<StructureSet> otherSet, int chunkCount) {
        final static public Codec<ExclusionZone> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)RegistryElementCodec.of(RegistryKeys.STRUCTURE_SET, StructureSet.CODEC, false).fieldOf("other_set").forGetter(ExclusionZone::otherSet), (App)Codec.intRange(1, 16).fieldOf("chunk_count").forGetter(ExclusionZone::chunkCount)).apply((Applicative)instance, ExclusionZone::new));
