...
implements BlockPredicate {
    ...
    public boolean test(StructureWorldAccess structureWorldAccess, BlockPos blockPos) {
        return this.state.canPlaceAt(structureWorldAccess, blockPos.net_minecraft_util_math_BlockPos_add(this.offset));
    }
