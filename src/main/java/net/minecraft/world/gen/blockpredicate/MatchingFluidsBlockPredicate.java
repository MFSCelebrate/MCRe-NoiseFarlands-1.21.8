...
extends OffsetPredicate {
    final private RegistryEntryList<Fluid> fluids;
    final static public MapCodec<MatchingFluidsBlockPredicate> CODEC = RecordCodecBuilder.mapCodec(instance -> MatchingFluidsBlockPredicate.registerOffsetField(instance).and((App)RegistryCodecs.entryList(RegistryKeys.FLUID).fieldOf("fluids").forGetter(predicate -> predicate.fluids)).apply((Applicative)instance, MatchingFluidsBlockPredicate::new));
