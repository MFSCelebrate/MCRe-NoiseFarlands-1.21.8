...
extends OffsetPredicate {
    ...
    final static public MapCodec<MatchingBlockTagPredicate> CODEC = RecordCodecBuilder.mapCodec(instance -> MatchingBlockTagPredicate.registerOffsetField(instance).and((App)TagKey.unprefixedCodec(RegistryKeys.BLOCK).fieldOf("tag").forGetter(predicate -> predicate.tag)).apply((Applicative)instance, MatchingBlockTagPredicate::new));
