...
extends BiPredicate<StructureWorldAccess, BlockPos> {
    final static public Codec<BlockPredicate> BASE_CODEC = Registries.BLOCK_PREDICATE_TYPE.getCodec().dispatch(BlockPredicate::getType, BlockPredicateType::codec);
    final static public BlockPredicate IS_AIR = BlockPredicate.matchingBlocks(Blocks.AIR);
    final static public BlockPredicate IS_AIR_OR_WATER = BlockPredicate.matchingBlocks(Blocks.AIR, Blocks.WATER);
