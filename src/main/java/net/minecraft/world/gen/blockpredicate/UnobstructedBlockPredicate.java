...
{
    static public MapCodec<UnobstructedBlockPredicate> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)Vec3i.CODEC.optionalFieldOf("offset", (Object)Vec3i.ZERO).forGetter(UnobstructedBlockPredicate::offset)).apply((Applicative)instance, UnobstructedBlockPredicate::new));
