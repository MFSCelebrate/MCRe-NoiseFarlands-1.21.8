...
public class VanillaSurfaceRules {
    final static private MaterialRules.MaterialRule AIR = VanillaSurfaceRules.block(Blocks.AIR);
    final static private MaterialRules.MaterialRule BEDROCK = VanillaSurfaceRules.block(Blocks.BEDROCK);
    final static private MaterialRules.MaterialRule WHITE_TERRACOTTA = VanillaSurfaceRules.block(Blocks.WHITE_TERRACOTTA);
    final static private MaterialRules.MaterialRule ORANGE_TERRACOTTA = VanillaSurfaceRules.block(Blocks.ORANGE_TERRACOTTA);
    final static private MaterialRules.MaterialRule TERRACOTTA = VanillaSurfaceRules.block(Blocks.TERRACOTTA);
    final static private MaterialRules.MaterialRule RED_SAND = VanillaSurfaceRules.block(Blocks.RED_SAND);
    final static private MaterialRules.MaterialRule RED_SANDSTONE = VanillaSurfaceRules.block(Blocks.RED_SANDSTONE);
    final static private MaterialRules.MaterialRule STONE = VanillaSurfaceRules.block(Blocks.STONE);
    final static private MaterialRules.MaterialRule DEEPSLATE = VanillaSurfaceRules.block(Blocks.DEEPSLATE);
    final static private MaterialRules.MaterialRule DIRT = VanillaSurfaceRules.block(Blocks.DIRT);
    final static private MaterialRules.MaterialRule PODZOL = VanillaSurfaceRules.block(Blocks.PODZOL);
    final static private MaterialRules.MaterialRule COARSE_DIRT = VanillaSurfaceRules.block(Blocks.COARSE_DIRT);
    final static private MaterialRules.MaterialRule MYCELIUM = VanillaSurfaceRules.block(Blocks.MYCELIUM);
    final static private MaterialRules.MaterialRule GRASS_BLOCK = VanillaSurfaceRules.block(Blocks.GRASS_BLOCK);
    final static private MaterialRules.MaterialRule CALCITE = VanillaSurfaceRules.block(Blocks.CALCITE);
    final static private MaterialRules.MaterialRule GRAVEL = VanillaSurfaceRules.block(Blocks.GRAVEL);
    final static private MaterialRules.MaterialRule SAND = VanillaSurfaceRules.block(Blocks.SAND);
    final static private MaterialRules.MaterialRule SANDSTONE = VanillaSurfaceRules.block(Blocks.SANDSTONE);
    final static private MaterialRules.MaterialRule PACKED_ICE = VanillaSurfaceRules.block(Blocks.PACKED_ICE);
    final static private MaterialRules.MaterialRule SNOW_BLOCK = VanillaSurfaceRules.block(Blocks.SNOW_BLOCK);
    final static private MaterialRules.MaterialRule MUD = VanillaSurfaceRules.block(Blocks.MUD);
    final static private MaterialRules.MaterialRule POWDER_SNOW = VanillaSurfaceRules.block(Blocks.POWDER_SNOW);
    final static private MaterialRules.MaterialRule ICE = VanillaSurfaceRules.block(Blocks.ICE);
    final static private MaterialRules.MaterialRule WATER = VanillaSurfaceRules.block(Blocks.WATER);
    final static private MaterialRules.MaterialRule LAVA = VanillaSurfaceRules.block(Blocks.LAVA);
    final static private MaterialRules.MaterialRule NETHERRACK = VanillaSurfaceRules.block(Blocks.NETHERRACK);
    final static private MaterialRules.MaterialRule SOUL_SAND = VanillaSurfaceRules.block(Blocks.SOUL_SAND);
    final static private MaterialRules.MaterialRule SOUL_SOIL = VanillaSurfaceRules.block(Blocks.SOUL_SOIL);
    final static private MaterialRules.MaterialRule BASALT = VanillaSurfaceRules.block(Blocks.BASALT);
    final static private MaterialRules.MaterialRule BLACKSTONE = VanillaSurfaceRules.block(Blocks.BLACKSTONE);
    final static private MaterialRules.MaterialRule WARPED_WART_BLOCK = VanillaSurfaceRules.block(Blocks.WARPED_WART_BLOCK);
    final static private MaterialRules.MaterialRule WARPED_NYLIUM = VanillaSurfaceRules.block(Blocks.WARPED_NYLIUM);
    final static private MaterialRules.MaterialRule NETHER_WART_BLOCK = VanillaSurfaceRules.block(Blocks.NETHER_WART_BLOCK);
    final static private MaterialRules.MaterialRule CRIMSON_NYLIUM = VanillaSurfaceRules.block(Blocks.CRIMSON_NYLIUM);
    final static private MaterialRules.MaterialRule END_STONE = VanillaSurfaceRules.block(Blocks.END_STONE);
    ...
    public static MaterialRules.MaterialRule createDefaultRule(boolean surface, boolean bedrockRoof, boolean bedrockFloor) {
        ...
        if (bedrockRoof) {
            builder.add((Object)MaterialRules.condition(MaterialRules.not(MaterialRules.verticalGradient("bedrock_roof", YOffset.belowTop(5), YOffset.getTop())), BEDROCK));
        }
        if (bedrockFloor) {
            builder.add((Object)MaterialRules.condition(MaterialRules.verticalGradient("bedrock_floor", YOffset.getBottom(), YOffset.aboveBottom(5)), BEDROCK));
        }
        MaterialRules.MaterialRule materialRule10 = MaterialRules.condition(MaterialRules.surface(), materialRule9);
        builder.add((Object)(surface ? materialRule10 : materialRule9));
        builder.add((Object)MaterialRules.condition(MaterialRules.verticalGradient("deepslate", YOffset.fixed(0), YOffset.fixed(8)), DEEPSLATE));
