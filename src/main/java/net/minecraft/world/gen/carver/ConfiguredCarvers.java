...
public class ConfiguredCarvers {
    final static public RegistryKey<ConfiguredCarver<?>> CAVE = ConfiguredCarvers.register("cave");
    final static public RegistryKey<ConfiguredCarver<?>> CAVE_EXTRA_UNDERGROUND = ConfiguredCarvers.register("cave_extra_underground");
    final static public RegistryKey<ConfiguredCarver<?>> CANYON = ConfiguredCarvers.register("canyon");
    final static public RegistryKey<ConfiguredCarver<?>> NETHER_CAVE = ConfiguredCarvers.register("nether_cave");
