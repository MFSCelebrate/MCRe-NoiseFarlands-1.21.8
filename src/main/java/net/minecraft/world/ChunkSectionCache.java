...
implements AutoCloseable {
    ...
    final private Long2ObjectMap<ChunkSection> cache = new Long2ObjectOpenHashMap();
    @Nullable
    ...
    public ChunkSection getSection(BlockPos pos) {
        ...
        if (this.cachedSection == null || this.sectionPos != l2) {
            this.cachedSection = (ChunkSection)this.cache.computeIfAbsent(l2, l -> {
                Chunk chunk = this.world.net_minecraft_world_chunk_Chunk_getChunk(ChunkSectionPos.getSectionCoord(pos.getX()), ChunkSectionPos.getSectionCoord(pos.getZ()));
    ...
    public BlockState getBlockState(BlockPos pos) {
        ...
        return chunkSection.getBlockState(1, j, k);
    }
