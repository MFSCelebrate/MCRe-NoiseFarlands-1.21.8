...
implements GameEventDispatcher {
    final private List<GameEventListener> listeners = Lists.newArrayList();
    final private Set<GameEventListener> toRemove = Sets.newHashSet();
    final private List<GameEventListener> toAdd = Lists.newArrayList();
    private boolean dispatching;
    final private ServerWorld world;
    final private int ySectionCoord;
    final private DisposalCallback disposalCallback;
