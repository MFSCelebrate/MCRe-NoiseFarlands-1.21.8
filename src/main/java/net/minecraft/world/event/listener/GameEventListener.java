...
public interface GameEventListener {
    ...
    extends Enum<TriggerOrder> {
        final static public TriggerOrder UNSPECIFIED = new TriggerOrder();
        final static public TriggerOrder BY_DISTANCE = new TriggerOrder();
        final static private TriggerOrder[] field_40355;
