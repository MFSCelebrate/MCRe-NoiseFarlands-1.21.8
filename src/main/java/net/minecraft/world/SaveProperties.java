...
public interface SaveProperties {
    final static public int ANVIL_FORMAT_ID = 19133;
    final static public int MCREGION_FORMAT_ID = 19132;
    ...
    default public void populateCrashReport(CrashReportSection section) {
        ...
        section.add("Level storage version", () -> {
            ...
            return String.format(Locale.ROOT, "0x%05X - %s", 12, this.getFormatName(12));
        });
    }
