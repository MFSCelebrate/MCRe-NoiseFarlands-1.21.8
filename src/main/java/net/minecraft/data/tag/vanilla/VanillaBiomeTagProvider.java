...
extends SimpleTagProvider<Biome> {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries) {
        ...
        this.builder(BiomeTags.INCREASED_FIRE_BURNOUT).add(BiomeKeys.BAMBOO_JUNGLE).add(BiomeKeys.MUSHROOM_FIELDS).add(BiomeKeys.MANGROVE_SWAMP).add(BiomeKeys.SNOWY_SLOPES).add(BiomeKeys.FROZEN_PEAKS).add(BiomeKeys.JAGGED_PEAKS).add(BiomeKeys.SWAMP).add(BiomeKeys.JUNGLE);
