...
extends ValueLookupTagProvider<Item> {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries) {
        ...
        this.builder(ItemTags.CLUSTER_MAX_HARVESTABLES).add((Item[])new Item[]{Items.DIAMOND_PICKAXE, Items.GOLDEN_PICKAXE, Items.IRON_PICKAXE, Items.NETHERITE_PICKAXE, Items.STONE_PICKAXE, Items.WOODEN_PICKAXE});
        ...
        this.builder(ItemTags.SWORDS).add(Items.DIAMOND_SWORD).add(Items.STONE_SWORD).add(Items.GOLDEN_SWORD).add(Items.NETHERITE_SWORD).add(Items.WOODEN_SWORD).add(Items.IRON_SWORD);
        this.builder(ItemTags.AXES).add(Items.DIAMOND_AXE).add(Items.STONE_AXE).add(Items.GOLDEN_AXE).add(Items.NETHERITE_AXE).add(Items.WOODEN_AXE).add(Items.IRON_AXE);
        this.builder(ItemTags.PICKAXES).add(Items.DIAMOND_PICKAXE).add(Items.STONE_PICKAXE).add(Items.GOLDEN_PICKAXE).add(Items.NETHERITE_PICKAXE).add(Items.WOODEN_PICKAXE).add(Items.IRON_PICKAXE);
        this.builder(ItemTags.SHOVELS).add(Items.DIAMOND_SHOVEL).add(Items.STONE_SHOVEL).add(Items.GOLDEN_SHOVEL).add(Items.NETHERITE_SHOVEL).add(Items.WOODEN_SHOVEL).add(Items.IRON_SHOVEL);
        this.builder(ItemTags.HOES).add(Items.DIAMOND_HOE).add(Items.STONE_HOE).add(Items.GOLDEN_HOE).add(Items.NETHERITE_HOE).add(Items.WOODEN_HOE).add(Items.IRON_HOE);
        ...
        this.builder(ItemTags.PIGLIN_PREFERRED_WEAPONS).add(Items.CROSSBOW);
        ...
        this.builder(ItemTags.FOOT_ARMOR).add((Item[])new Item[]{Items.LEATHER_BOOTS, Items.CHAINMAIL_BOOTS, Items.GOLDEN_BOOTS, Items.IRON_BOOTS, Items.DIAMOND_BOOTS, Items.NETHERITE_BOOTS});
        this.builder(ItemTags.LEG_ARMOR).add((Item[])new Item[]{Items.LEATHER_LEGGINGS, Items.CHAINMAIL_LEGGINGS, Items.GOLDEN_LEGGINGS, Items.IRON_LEGGINGS, Items.DIAMOND_LEGGINGS, Items.NETHERITE_LEGGINGS});
        this.builder(ItemTags.CHEST_ARMOR).add((Item[])new Item[]{Items.LEATHER_CHESTPLATE, Items.CHAINMAIL_CHESTPLATE, Items.GOLDEN_CHESTPLATE, Items.IRON_CHESTPLATE, Items.DIAMOND_CHESTPLATE, Items.NETHERITE_CHESTPLATE});
        this.builder(ItemTags.HEAD_ARMOR).add((Item[])new Item[]{Items.LEATHER_HELMET, Items.CHAINMAIL_HELMET, Items.GOLDEN_HELMET, Items.IRON_HELMET, Items.DIAMOND_HELMET, Items.NETHERITE_HELMET, Items.TURTLE_HELMET});
        ...
        this.builder(ItemTags.TRIM_MATERIALS).add(registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.ITEM).streamEntries().filter(entry -> ((Item)entry.value()).getComponents().contains(DataComponentTypes.PROVIDES_TRIM_MATERIAL)).sorted(Comparator.comparing(entry -> entry.registryKey().getValue())).map(RegistryEntry.Reference::value));
        ...
        this.builder(ItemTags.FIRE_ASPECT_ENCHANTABLE).addTag(ItemTags.SWORD_ENCHANTABLE).add(Items.MACE);
    ...
    implements ProvidedTagBuilder<Block, Block> {
        final private ProvidedTagBuilder<Item, Item> parent;
