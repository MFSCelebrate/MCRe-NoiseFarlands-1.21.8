...
implements DataProvider {
    final protected DataOutput.PathResolver pathResolver;
    final private CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture;
    final private CompletableFuture<Void> registryLoadFuture = new CompletableFuture();
    final private CompletableFuture<TagLookup<T>> parentTagLookupFuture;
    final protected RegistryKey<? extends Registry<T>> registryRef;
    final private Map<Identifier, TagBuilder> tagBuilders = Maps.newLinkedHashMap();
    ...
    public CompletableFuture<?> run(DataWriter writer) {
        ...
        return ((CompletableFuture)((CompletableFuture)this.getRegistriesFuture().thenApply(registriesFuture -> {
            ...
            RegistryEntryLookup impl = info.contents.net_minecraft_registry_RegistryEntryLookup_getOrThrow(this.registryRef);
    ...
    private boolean method_46832(RegistryWrapper.Impl impl, Identifier id) {
