...
public interface CraftingRecipeJsonBuilder {
    final static public Identifier ROOT = Identifier.ofVanilla("recipes/root");

    public CraftingRecipeJsonBuilder net_minecraft_data_recipe_CraftingRecipeJsonBuilder_criterion(String var1, AdvancementCriterion<?> var2);

    public CraftingRecipeJsonBuilder net_minecraft_data_recipe_CraftingRecipeJsonBuilder_group(@Nullable String var1);
