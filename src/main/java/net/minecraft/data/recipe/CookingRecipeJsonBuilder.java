...
implements CraftingRecipeJsonBuilder {
    ...
    @Override
    public CookingRecipeJsonBuilder net_minecraft_data_recipe_CookingRecipeJsonBuilder_criterion(String string, AdvancementCriterion<?> advancementCriterion) {
        this.criteria.put(string, advancementCriterion);
        return this;
    }

    @Override
    public CookingRecipeJsonBuilder net_minecraft_data_recipe_CookingRecipeJsonBuilder_group(@Nullable String string) {
        this.group = string;
        return this;
    }
    ...
    public CraftingRecipeJsonBuilder net_minecraft_data_recipe_CraftingRecipeJsonBuilder_group(@Nullable String group) {
        return this.net_minecraft_data_recipe_CookingRecipeJsonBuilder_group(group);
    }
