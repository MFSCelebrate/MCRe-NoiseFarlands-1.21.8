...
public record VanillaEquipmentLootTableGenerator(RegistryWrapper.WrapperLookup registries) implements LootTableGenerator
{
    ...
    public void accept(BiConsumer<RegistryKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
        RegistryEntryLookup impl = this.registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.TRIM_PATTERN);
        RegistryEntryLookup impl2 = this.registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.TRIM_MATERIAL);
        RegistryEntryLookup impl3 = this.registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.ENCHANTMENT);
    ...
    public static LootTable.Builder createEquipmentTableBuilder(Item helmet, Item chestplate, ArmorTrim trim, RegistryWrapper.Impl<Enchantment> enchantmentRegistryWrapper) {
        return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).net_minecraft_loot_LootPool$Builder_conditionally(RandomChanceLootCondition.builder(0.5f)).with((LootPoolEntry.Builder<?>)((Object)((LeafEntry.Builder)ItemEntry.builder(helmet).apply(SetComponentsLootFunction.builder(DataComponentTypes.TRIM, trim))).apply(new SetEnchantmentsLootFunction.Builder().enchantment(enchantmentRegistryWrapper.getOrThrow(Enchantments.PROTECTION), ConstantLootNumberProvider.create(4.0f)).enchantment(enchantmentRegistryWrapper.getOrThrow(Enchantments.PROJECTILE_PROTECTION), ConstantLootNumberProvider.create(4.0f)).enchantment(enchantmentRegistryWrapper.getOrThrow(Enchantments.FIRE_PROTECTION), ConstantLootNumberProvider.create(4.0f)))))).pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f)).net_minecraft_loot_LootPool$Builder_conditionally(RandomChanceLootCondition.builder(0.5f)).with((LootPoolEntry.Builder<?>)((Object)((LeafEntry.Builder)ItemEntry.builder(chestplate).apply(SetComponentsLootFunction.builder(DataComponentTypes.TRIM, trim))).apply(new SetEnchantmentsLootFunction.Builder().enchantment(enchantmentRegistryWrapper.getOrThrow(Enchantments.PROTECTION), ConstantLootNumberProvider.create(4.0f)).enchantment(enchantmentRegistryWrapper.getOrThrow(Enchantments.PROJECTILE_PROTECTION), ConstantLootNumberProvider.create(4.0f)).enchantment(enchantmentRegistryWrapper.getOrThrow(Enchantments.FIRE_PROTECTION), ConstantLootNumberProvider.create(4.0f))))));
    }
}
