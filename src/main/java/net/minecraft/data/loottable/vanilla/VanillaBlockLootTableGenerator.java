...
extends BlockLootTableGenerator {
    final static private float[] JUNGLE_SAPLING_DROP_CHANCE = new float[]{0.025f, 0.027777778f, 0.03125f, 0.041666668f, 0.1f};
    final static private Set<Item> EXPLOSION_IMMUNE = Stream.of(Blocks.DRAGON_EGG, Blocks.BEACON, Blocks.CONDUIT, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.CREEPER_HEAD, Blocks.DRAGON_HEAD, Blocks.PIGLIN_HEAD, Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX).map(ItemConvertible::asItem).collect(Collectors.toSet());
    ...
    protected void generate() {
        ...
        RegistryEntryLookup impl2 = this.registries.net_minecraft_registry_RegistryEntryLookup_getOrThrow(RegistryKeys.ITEM);
        ...
        this.addDrop(Blocks.COMPOSTER, (Block block) -> LootTable.builder().pool(LootPool.builder().with((LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ItemEntry.builder(Items.COMPOSTER)))).pool(LootPool.builder().with(ItemEntry.builder(Items.BONE_MEAL)).net_minecraft_loot_LootPool$Builder_conditionally(BlockStatePropertyLootCondition.builder(block).properties(StatePredicate.Builder.create().exactMatch(ComposterBlock.LEVEL, 8)))));
        ...
        this.addDrop(Blocks.MANGROVE_PROPAGULE, this.applyExplosionDecay(Blocks.MANGROVE_PROPAGULE, LootTable.builder().pool(LootPool.builder().net_minecraft_loot_LootPool$Builder_conditionally(builder4).with(ItemEntry.builder(Items.MANGROVE_PROPAGULE)))));
        ...
        this.addDrop(Blocks.CARROTS, this.applyExplosionDecay(Blocks.CARROTS, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.CARROT))).pool(LootPool.builder().net_minecraft_loot_LootPool$Builder_conditionally(builder3).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(Items.CARROT).apply(ApplyBonusLootFunction.binomialWithBonusCount(impl.getOrThrow(Enchantments.FORTUNE), 0.5714286f, 3)))))));
        ...
        this.addDrop(Blocks.POTATOES, this.applyExplosionDecay(Blocks.POTATOES, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.POTATO))).pool(LootPool.builder().net_minecraft_loot_LootPool$Builder_conditionally(builder5).with((LootPoolEntry.Builder<?>)((Object)ItemEntry.builder(Items.POTATO).apply(ApplyBonusLootFunction.binomialWithBonusCount(impl.getOrThrow(Enchantments.FORTUNE), 0.5714286f, 3))))).pool(LootPool.builder().net_minecraft_loot_LootPool$Builder_conditionally(builder5).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.POISONOUS_POTATO).conditionally(RandomChanceLootCondition.builder(0.02f))))));
    ...
    private LootTable.Builder method_60395(RegistryWrapper.Impl impl, RegistryWrapper.Impl impl2, Block block) {
    ...
    private LootTable.Builder method_60407(RegistryWrapper.Impl impl, Block block) {
    ...
    private LootTable.Builder method_60411(RegistryWrapper.Impl impl, Block block) {
    ...
    private LootTable.Builder method_32226(RegistryWrapper.Impl impl, Block block) {
    ...
    private LootTable.Builder method_65288(RegistryWrapper.Impl impl, Block block) {
    ...
    private LootTable.Builder method_60412(RegistryWrapper.Impl impl, Block block) {
    ...
    private LootTable.Builder method_60413(RegistryWrapper.Impl impl, Block block) {
    ...
    private LootTable.Builder method_60414(RegistryWrapper.Impl impl, Block block) {
    ...
    private LootTable.Builder method_60415(RegistryWrapper.Impl impl, Block block) {
    ...
    private LootTable.Builder method_60416(RegistryWrapper.Impl impl, Block block) {
        return this.applyExplosionDecay(block, LootTable.builder().pool(LootPool.builder().net_minecraft_loot_LootPool$Builder_conditionally(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).properties(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 3))).with(ItemEntry.builder(Items.SWEET_BERRIES)).net_minecraft_loot_LootPool$Builder_apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 3.0f))).net_minecraft_loot_LootPool$Builder_apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE)))).pool(LootPool.builder().net_minecraft_loot_LootPool$Builder_conditionally(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).properties(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 2))).with(ItemEntry.builder(Items.SWEET_BERRIES)).net_minecraft_loot_LootPool$Builder_apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 2.0f))).net_minecraft_loot_LootPool$Builder_apply(ApplyBonusLootFunction.uniformBonusCount(impl.getOrThrow(Enchantments.FORTUNE)))));
    }
}
