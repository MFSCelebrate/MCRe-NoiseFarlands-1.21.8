...
implements DataProvider {
    ...
    final private Set<RegistryKey<LootTable>> lootTableIds;
    final private List<LootTypeGenerator> lootTypeGenerators;
    ...
    private static void method_10410(RegistryWrapper.WrapperLookup wrapperLookup, Map map, MutableRegistry mutableRegistry, LootTypeGenerator lootTypeGenerator) {
    ...
    extends Record {
        final private Function<RegistryWrapper.WrapperLookup, LootTableGenerator> provider;
