...
implements ParticleEffect {
    final static private Codec<ItemStack> ITEM_STACK_CODEC = Codec.withAlternative(ItemStack.UNCOUNTED_CODEC, Item.ENTRY_CODEC, ItemStack::new);
    final private ParticleType<ItemStackParticleEffect> type;
